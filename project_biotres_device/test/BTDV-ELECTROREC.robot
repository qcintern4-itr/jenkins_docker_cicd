*** Settings ***
Documentation   Biotres device electrocardiogram recording verification test suite
Metadata        sid     BTDV-ELECTROREC
Metadata        owner   Nang Phung
Library         corelib/AssertionExtension.py
Library         corelib/WebHandler.py   ${BROWSER}  ${HEADLESS}

Force Tags      BTDV-ELECTROREC     device
Test Timeout    1h

*** Test Cases ***
BTDV-ELECTROREC-01: ECG
    ...
    [Tags]  BTDV-ELECTROREC-01    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BTDV-ELECTROREC-02: ECG
    [Documentation]     Author: Nang Phung
    ...
    ...     Description: The device software shall apply the compression while storing electrocardiogram (ECG) signals into storage.
    ...     Test Setup and Input:
    ...     - 1. Complete all the steps from Section 12 “Verification Sequence & Expected Results”.
    ...     - 2. Initiate the Start Study command with the parameters below:
    ...          PatientId=123456
    ...
    ...     - 5. Once the study has started, using an ECG Simulation tool, generate 80 BPM normal sinus signal.
    ...     Test Output:
    ...     - 1. Wait for 10 minutes for study to complete.
    ...
    [Tags]  BTDV-ELECTROREC-02    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BTDV-ELECTROREC-03: Recorded electrocardiogram
    [Documentation]     Author: Nang Phung
    ...
    ...     Description: The device software shall support wireless upload of the recorded electrocardiogram (ECG) to the server via Biotres gateway
    ...     Test Setup and Input:
    ...     - 1. Complete all the steps from Section 12 “Verification Sequence & Expected Results”.
    ...     - 2. Initiate the Start Study command with the parameters below:
    ...          PatientId=123456
    ...
    ...     - 2. Locate the getecg.txt file in the test case input folder. Open the getecg.txt file in a text editor, configure to obtain a most recent 5-minutes segment of data
    ...          and send getecg command using WinSCP. Confirm the file has the following structure:
    ...
    ...     - 5. Within the device folder, verify there are 2 files with the format:
    ...          stopstudy-done-mm-dd-yy-hh-mm-ss+timezone.txt
    ...          note-mm-dd-yy-hh-mm-ss+timezone.txt
    ...     - 6. After the study has stopped, locate and send the uploadstudy using uploadstudy.txt using WinSCP.
    ...     - 7. In WinSCP, within the user folder for the given device, locate the device acknowledgement of the upload study command. Verify there is a file with the format:
    ...          uploadstudy-processing-mm-dd-yy-hh-mm-ss+timezone.txt
    ...     - 8. Within the device folder, locate the device acknowledgement of the upload study command. Verify there is a file with the format: uploadstudy-done-mm-dd-yy-hh-mm-ss+timezone.txt
    ...     - 9. In WinSCP, within the device folder, verify there are 2 data files with the format:
    ...          data-all-mm-dd-yy-hh-mm-ss+timezone.hea
    ...          data-all-mm-dd-yy-hh-mm-ss+timezone.dat
    ...
    ...     - 19. Locate erasestudy.txt and using WinSCP, send the erasestudy command.
    [Tags]  BTDV-ELECTROREC-03    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BTDV-ELECTROREC-04: The device software shall check the integrity of the ECG data
    [Documentation]     Author: Nang Phung
    ...
    ...     Description: The device software shall check the integrity of the ECG data during upload from the Biotres device to the server.
    ...     Test Setup and Input:
    ...     - 1. Complete all the steps from Section 12 “Verification Sequence & Expected Results”.
    ...
    ...     - 6. Once the study has started, using an ECG Simulation tool, generate 80 BPM normal sinus signal.
    ...     Test Output:
    ...     - 1. Wait for 5 minutes while the study is in progress.
    ...     - 2. Locate the getecg.txt file in the test Input folder. Open the getecg.txt file in a text editor, configure to obtain a most recent 5-minutes segment of data
    ...          and send getecg command using WinSCP. Confirm the file has the following structure:
    ...          Start Date of the record “MM/DD/YYYY”
    ...          Start Time of the record “HH:MM:SS” Time should be local device time.
    ...          Stop Date of the record “MM/DD/YYYY”
    ...          Stop Time of the record “HH:MM:SS” Time should be local time.
    ...          Time Zone 0
    ...     - 3. Within the device folder, locate the device acknowledgement of the getecg completed upload command. Verify there are following files with format:
    ...          getecg-done-mm-dd-yy-hh-mm-ss+timezone.txt
    ...          data-get-mm-dd-yy-hh-mm-ss+timezone.hea
    ...          data-get-mm-dd-yy-hh-mm-ss+timezone.dat
    ...          As mentioned in Input step 2, due to file transfer protocol used being FTP, it confirms the integrity of the getecg response data from the Biotres device to the server.
    ...     - 4. Send the stopstudy command using stopstudy.txt on WinSCP interface.
    ...     - 5. Within the device folder, locate the device acknowledgement of the stop study command. Verify there are 2 files with the format:
    ...          stopstudy-done-mm-dd-yy-hh-mm-ss+timezone.txt
    ...          note-mm-dd-yy-hh-mm-ss+timezone.txt
    ...     - 6. After the study has stopped, locate and send the uploadstudy using uploadstudy.txt using WinSCP.
    ...     - 7. In WinSCP, within the user folder for the given device, locate the device acknowledgement of the upload study command. Verify there is a file with the format: uploadstudy-processing-mm-dd-yy-hh-mm-ss+timezone.txt
    ...     - 8. Within the device folder, locate the device acknowledgement of the upload study command. Verify there are 3 files with the format:
    ...           uploadstudy-done-mm-dd-yy-hh-mm-ss+timezone.txt
    ...           data-all-mm-dd-yy-hh-mm-ss+timezone.hea
    ...           data-all-mm-dd-yy-hh-mm-ss+timezone.dat
    ...          As mentioned in Input step 2, due to file transfer protocol used being FTP, it confirms the integrity of the uploadstudy response data from the Biotres device to the server.
    ...
    ...     - 12. Copy the yyyymmdd-hhmmss.dat file in the “rec” folder to the “SD card” folder.
    ...
    ...     - 18. Locate erasestudy.txt and using WinSCP, send the erasestudy command.
    [Tags]  BTDV-ELECTROREC-04    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BTDV-ELECTROREC-05: User notifications
    [Documentation]     Author: Nang Phung
    ...
    ...     Description: The device software shall provide User notifications after the study period has reached Study Duration time.
    ...     Test Setup and Input:
    ...     - 1. Complete all the steps from Section 12 “Verification Sequence & Expected Results”.
    ...     - 2. Initiate the Start Study command with the parameters below:
    ...          PatientId=123456
    ...
    ...     Test Output:
    ...     - 1. Wait for 5 minutes for study to complete.
    ...     - 2. Within the device folder, locate the device notification associated with study completion. Verify there is a file with the format: note-mm-dd-yy-hh-mm-ss+timezone.txt
    ...     - 3. Using WinSCP, transfer the file note-mm-dd-yy-hh-mm-ss+timezone.txt identified in previous step, to a local folder on the PC and open with text editor.
    ...
    ...     - 10. Locate erasestudy.txt and using WinSCP, send the erasestudy command.
    [Tags]  BTDV-ELECTROREC-05    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BTDV-ELECTROREC-06: Detect lead on/off
    [Documentation]     Author: Nang Phung
    ...
    ...     Description: The device software shall be able to detect the patient’s cable connection.
    ...     Test Setup and Input:
    ...     - 1. Complete all the steps from Section 12 “Verification Sequence & Expected Results”.
    ...     - 2. Initiate the Start Study command with the parameters below:
    ...          PatientId=123456
    ...
    ...     - 2. Wait for 30 seconds to device send the Lead off detection notification.
    ...     - 3. Reconnect the lead.
    ...     - 4. Wait for 30 seconds device send the lead connection notification.
    ...
    [Tags]  BTDV-ELECTROREC-06    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BTDV-ELECTROREC-07: leads are disconnected
    [Documentation]     Author: Nang Phung
    ...
    ...     Description:
    ...
    [Tags]  BTDV-ELECTROREC-07    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BTDV-ELECTROREC-08: Detect beat
    ...
    [Tags]  BTDV-ELECTROREC-08    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BTDV-ELECTROREC-09: Detect beat
    [Documentation]     Author: Han Nguyen
    ...
    ...
    ...          221209:041144	UI	Display LED: STUDY_ONGOING
    ...     - 2. Wait 1 minute.
    ...     - 3. Then observe the log showing the device monitor program. Verify the following contents are found:
    ...          221209:045834	ECGA	Calib OK
    ...
    [Tags]  BTDV-ELECTROREC-09    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BTDV-ELECTROREC-10: Detect beat
    [Documentation]     Author: Han Nguyen
    ...
    ...
    ...     - 2. Wait 1 minute.
    ...     - 3. Then observe the log showing the device monitor program. Verify the following contents are found:
    ...          221209:045834	ECGA	Restarted (0 beat)
    ...
    [Tags]  BTDV-ELECTROREC-10    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
