...
Metadata        sid     BTDV-GATEWAYCOMM
Metadata        owner   Nang Phung
Library         corelib/AssertionExtension.py
Library         corelib/WebHandler.py   ${BROWSER}  ${HEADLESS}

Force Tags      BTDV-GATEWAYCOMM        device
Test Timeout    1h

*** Test Cases ***
BTDV-GATEWAYCOMM-01: Device software shall support wireless communication over Bluetooth
    [Documentation]     Author: Nang Phung
    ...
    ...     Description: Device software shall support wireless communication over Bluetooth when authenticated Biotres gateway is present.
    ...
    [Tags]  BTDV-GATEWAYCOMM-01    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BTDV-GATEWAYCOMM-02: The device shall report its status to the Biotres gateway
    [Documentation]     Author: Nang Phung
    ...
    ...     Description: The device shall report its status to the Biotres gateway:
    ...     - 1. Study status
    ...     - 2. Lead-off status
    ...     - 3. Battery status
    ...     Test Setup and Input:
    ...
    [Tags]  BTDV-GATEWAYCOMM-02    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BTDV-GATEWAYCOMM-03: Wireless communication over Bluetooth with the authenticated Biotres gateway
    [Documentation]     Author: Nang Phung
    ...
    ...     Description: Wireless communication over Bluetooth with the authenticated Biotres gateway shall be encrypted.
    ...     Test Setup and Input:
    ...
    ...     Test Output:
    ...     - 1. Connect the device to the Biotres Device Monitor Software. Issue the following command to disable Bluetooth communication encryption SM+ENCRYPT=0
    ...
    ...     - 5. Press the [Scan] button and wait until the scanning process finishes The Biotres Device is displayed on the scan result as BTCY-BIOTRES-XXXXXXXXXX (with XXXXXXXXXX is ID of the Biotres Device)
    ...
    [Tags]  BTDV-GATEWAYCOMM-03    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
