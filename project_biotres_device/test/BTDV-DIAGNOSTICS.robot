...
Metadata        sid     BTDV-DIAGNOSTICS
Metadata        owner   Nang Phung
Library         corelib/AssertionExtension.py
Library         corelib/WebHandler.py   ${BROWSER}  ${HEADLESS}

Force Tags      BTDV-DIAGNOSTICS        device
Test Timeout    1h

*** Test Cases ***
BTDV-DIAGNOSTICS-01: The device software shall maintain a log of the following software\system events
    [Documentation]     Author: Nang Phung
    ...
    ...     Description: The device software shall maintain a log of the following software\system events:
    ...
    ...     - 2. Refresh the WinSCP view, within the device folder, verify the file with the format:
    ...
    [Tags]  BTDV-DIAGNOSTICS-01    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BTDV-DIAGNOSTICS-02: Device notifications
    [Documentation]     Author: Nang Phung
    ...
    ...     Description: The device software shall maintain battery measurement trending data in order to assess the remaining usage before the next charge.
    ...     Test Setup and Input:
    ...
    ...           log-data-mm-dd-yy-hh-mm-ss+timezone.txt
    ...           log-daily-mm-dd-yy-hh-mm-ss+timezone.txt
    ...     - 12. Within device log and device notifications, verify the notifications below: Battery Critical, Battery Charging
    ...
    [Tags]  BTDV-DIAGNOSTICS-02    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
