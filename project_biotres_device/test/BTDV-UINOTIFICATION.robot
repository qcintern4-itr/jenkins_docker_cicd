...
Metadata        sid     BTDV-UINOTIFICATION
Metadata        owner   Nang Phung
Library         corelib/AssertionExtension.py
Library         corelib/WebHandler.py   ${BROWSER}  ${HEADLESS}

Force Tags      BTDV-UINOTIFICATION     device
Test Timeout    1h

*** Test Cases ***
BTDV-UINOTIFICATION-01: LED interface
    [Documentation]     Author: Nang Phung
    ...
    ...     Description:
    ...     - 1. The device software shall incorporate LED interface for the User notifications. When the device is turned off by pressing and holding the Home Button,
    ...          the device shall provide User an LED-based notification.
    ...
    ...     - 13. Using Device Monitor program, write a different value at address 0x0807FFF than read in the previous step.
    ...
    [Tags]  BTDV-UINOTIFICATION-01    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BTDV-UINOTIFICATION-02: Verify that the LED of the device
    [Documentation]     Author: Nang Phung
    ...
    ...     Description:
    ...     - 1. The device software shall incorporate LED interface for the User notifications. When the device is turned off by pressing and holding the Home Button,
    ...
    [Tags]  BTDV-UINOTIFICATION-02    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BTDV-UINOTIFICATION-03: The device shall request the Biotres gateway to display a Symptoms screen
    [Documentation]     Author: Nang Phung
    ...
    ...     Description:
    ...     - 1. Upon accepting the User commanded cardiac event, the device shall request the Biotres gateway to display a Symptoms screen with pre-selected list of symptoms
    ...          and store the returned symptom which is chosen by the User.
    ...     Test Setup and Input:
    ...     - 1. Complete all the steps from Section 12 "Verification Sequence & Expected Results".
    ...     - 2. Initiate the Start Study command with the parameters below:
    ...          PatientId=123456
    ...
    [Tags]  BTDV-UINOTIFICATION-03    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
