...
try:
    ...
    from project_services_and_distribution_portal.lib import ConfigHandler
...
class WebPage(WebPageModel):
    ...
    def __init__(self, browser, env, locators):
        super().__init__(project_name='services_and_distribution_portal', browser=browser, env=env, locators=locators)
