...
Force Tags      BCP-PHY-PTDET-HM        web
Test Timeout    1h

*** Test Cases ***
BCP-PHY-PTDET-HM-01: Prescribe A Bioflux Heart Study
    ...
    [Tags]    BCP-PHY-PTDET-HM-01    manual     inactive
...
BCP-PHY-PTDET-HM-02: Prescribe A Biotres Heart Study
    ...
    ...  Expected Output:
    ...  - The study prescription card is displayed
    [Tags]    BCP-PHY-PTDET-HM-02    manual    inactive
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}
#    Navigate To Patients Active
...
BCP-PHY-PTDET-HM-03: Create A Heart Study
    [Documentation]    Author: Khang Nguyen
    ...
    ...  Test Steps:
    ...
    [Tags]    BCP-PHY-PTDET-HM-03     manual
...
BCP-PHY-PTDET-HM-04: Resend Biotres Reference Code
    [Documentation]    Author: Khang Nguyen
    ...
    ...  Test Steps:
    ...
    [Tags]    BCP-PHY-PTDET-HM-04     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}


BCP-PHY-PTDET-HM-05: Stop An On-Going Heart Study
    [Documentation]    Author: Khang Nguyen
    ...
    ...  Test Steps:
    ...
    [Tags]    BCP-PHY-PTDET-HM-05     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-PHY-PTDET-HM-06: Cancel A Study Prescription
    [Documentation]    Author: Khang Nguyen
    ...
    ...  Test Steps:
    ...
    [Tags]    BCP-PHY-PTDET-HM-06    manual     inactive
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}
#    Navigate To Patients Active
...
BCP-PHY-PTDET-HM-07: Enable Bioheart Monitor
    [Documentation]    Author: Khang Nguyen
    ...
    ...  Test Steps:
    ...
    [Tags]    BCP-PHY-PTDET-HM-07     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-PHY-PTDET-HM-08: Retry Generating A Bioheart Report Successfully
    [Documentation]    Author: Khang Nguyen
    ...
    ...  Test Steps:
    ...
    [Tags]    BCP-PHY-PTDET-HM-08     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-PHY-PTDET-HM-09: Disable Bioheart Monitor
    [Documentation]    Author: Khang Nguyen
    ...
    ...  Test Steps:
    ...
    [Tags]    BCP-PHY-PTDET-HM-09     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-PHY-PTDET-HM-10: Edit Frequency
    [Documentation]    Author: Khang Nguyen
    ...
    ...  Test Steps:
    ...  - Click Edit button on the Bioheart monitor page
    ...
    [Tags]    BCP-PHY-PTDET-HM-10     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-PHY-PTDET-HM-11: Collapse patient brief info for patient has linked care plan
    ...
    [Tags]    BCP-PHY-PTDET-HM-11     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-PHY-PTDET-HM-12: Collapse patient brief info for patient has not linked care plan
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  1. Scroll down the page
    ...
    ...  - In step 3, the brief info header will be expanded
    [Tags]    BCP-PHY-PTDET-HM-12     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-PHY-PTDET-HM-13: Collapse patient brief info for patient which has missing info
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  1. Scroll down the page
    ...
    [Tags]    BCP-PHY-PTDET-HM-13     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-PHY-PTDET-HM-14: Collapse patient brief info for patient which has deleted their account
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  1. Scroll down the page
    ...
    ...  - In step 4, the brief info header will be expanded
    [Tags]    BCP-PHY-PTDET-HM-14     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-PHY-PTDET-HM-15: Collapse patient brief info for patient which has missing info and has deleted their account
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  1. Scroll down the page
    ...
    [Tags]    BCP-PHY-PTDET-HM-15     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-PHY-PTDET-HM-16: Column visibility - Hide/show column(s) on any tab(s) of the page
    [Documentation]    Author: Hoang Le
    ...
    [Tags]    BCP-PHY-PTDET-HM-16        manual      [BCP-2.17]
    Manual Should Be Passed    ${TEST NAME}     ${TEST DOCUMENTATION}
...
Cancel Prescription - Study
    ...
    ${studies}      Get Heart Monitor Prescription Studies
    View Heart Monitor Prescription Study Details On    patient_name=${studies}[0][Patient name]
    ${pre_study}      Get Patient Details Heart Monitor Current Study
    Run Keyword And Continue On Failure     Should Not Contain    ${pre_study}      There is no study yet
    Cancel Study Prescription
    ${msg}      Get Success Message
