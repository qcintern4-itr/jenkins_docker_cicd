...
Force Tags      BCP-NURSE-PTACT     web
Test Timeout    1h

*** Test Cases ***
BCP-NURSE-PTACT-01: Filter Active patients by "My patients"
    ...
    [Tags]   BCP-NURSE-PTACT-01     manual    inactive
...
BCP-NURSE-PTACT-02: Filter Active patients by "All patients"
    [Documentation]     Author: Hoang Le
    ...
    ...   Test Steps:
    ...   - Go to Active patients page
    ...
    ...   Expected Result:
    ...   - A patient's details page shall be displayed.
    [Tags]   BCP-NURSE-PTACT-02     manual    inactive
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}
#    [Template]    Filter Patients - Active
#    All patients      Care Plan ID
#    All patients      Patient Name

BCP-NURSE-PTACT-03: Go to the Patient Details Page By Clicking Patient Name Hyperlink
    [Documentation]     Author: Hoang Le
    ...
    ...   Test Steps:
    ...
    [Tags]   BCP-NURSE-PTACT-03     manual    inactive
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}
...
BCP-NURSE-PTACT-04: Stop An Active Care Plan
    [Documentation]     Author: Hoang Le
    ...
    ...   Test Steps:
    ...
    [Tags]   BCP-NURSE-PTACT-04     manual    inactive
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}

BCP-NURSE-PTACT-05: Column visibility - Hide/show column(s) on page
    [Documentation]    Author: Hoang Le
    ...
    [Tags]    BCP-NURSE-PTACT-05        manual      [BCP-2.17]
    Manual Should Be Passed    ${TEST NAME}     ${TEST DOCUMENTATION}

BCP-NURSE-PTACT-06: Flag program on the Active page
    [Documentation]    Author: Hoang Le
    ...  Pre-condition: user is on the Active patient page
    ...  Test steps:
    ...  Expected result:
    ...  The user shall be able to flag the program as (high/medium/low).
    [Tags]    BCP-NURSE-PTACT-06        manual      [BCP-2.17]
    Manual Should Be Passed    ${TEST NAME}     ${TEST DOCUMENTATION}

BCP-NURSE-PTACT-07: Flag program on the patient details
    [Documentation]    Author: Hoang Le
    ...  Pre-condition: user is on the patient details page
    ...  Test steps:
    ...  Expected result:
    ...  The user shall be able to flag the program as (high/medium/low).
    [Tags]    BCP-NURSE-PTACT-07        manual      [BCP-2.17]
    Manual Should Be Passed    ${TEST NAME}     ${TEST DOCUMENTATION}

BCP-NURSE-PTACT-08: Update the flag on the Active page
    [Documentation]    Author: Hoang Le
    ...  Pre-condition: user is on the Active patient page
    ...  Test steps:
    ...  Expected result:
    ...  The user shall be able to edit the flag of the program as (high/medium/low).
    [Tags]    BCP-NURSE-PTACT-08        manual      [BCP-2.17]
    Manual Should Be Passed    ${TEST NAME}     ${TEST DOCUMENTATION}

BCP-NURSE-PTACT-09: Update the flag on patient details
    [Documentation]    Author: Hoang Le
    ...  Pre-condition: user is on the patient details page
    ...  Test steps:
    ...  Expected result:
    ...  The user shall be able to edit the flag of the program as (high/medium/low).
    [Tags]    BCP-NURSE-PTACT-09        manual      [BCP-2.17]
    Manual Should Be Passed    ${TEST NAME}     ${TEST DOCUMENTATION}

BCP-NURSE-PTACT-10: Add notes NOT included on the report for the program
    [Documentation]    Author: Hoang Le
    ...
    [Tags]    BCP-NURSE-PTACT-10        manual      [BCP-2.17]
    Manual Should Be Passed    ${TEST NAME}     ${TEST DOCUMENTATION}

BCP-NURSE-PTACT-11: Add notes included on the report for the program
    [Documentation]    Author: Hoang Le
    ...
    [Tags]    BCP-NURSE-PTACT-11        manual      [BCP-2.17]
    Manual Should Be Passed    ${TEST NAME}     ${TEST DOCUMENTATION}

BCP-NURSE-PTACT-11-01: Edit Notes of the program
    [Documentation]    Author: Hoang Le
    ...  Pre-condition: there is a Note added to the program
    ...  Test steps:
    ...  Expected result:
    ...  The Notes shall be updated as the user inputs.
    [Tags]    BCP-NURSE-PTACT-11-01        manual      [BCP-2.17]
    Manual Should Be Passed    ${TEST NAME}     ${TEST DOCUMENTATION}

BCP-NURSE-PTACT-12: Delete Notes of the program
    [Documentation]    Author: Hoang Le
    ...  Pre-condition: there is a Note added to the program
    ...  Test steps:
    ...  Expected result:
    ...  The Notes shall be deleted from the program.
    [Tags]    BCP-NURSE-PTACT-12        manual      [BCP-2.17]
    Manual Should Be Passed    ${TEST NAME}     ${TEST DOCUMENTATION}
