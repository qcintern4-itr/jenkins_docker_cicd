*** Settings ***
Documentation   Cardiac Patient Details page > Overview test suite
Metadata    sid     BCP-NURSE-PTDET-OVERVIEW
...
Force Tags      BCP-NURSE-PTDET-OVERVIEW    web
Test Timeout    1h

*** Test Cases ***
BCP-NURSE-PTDET-OVERVIEW-01: View multiple records of Heart rate/Blood pressure/Oxygen saturation/Body temperature/Weight-BMI chart for view day mode
   [Documentation]    Author: Xuan Trinh
    ...
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-01     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-02: View multiple records of Activity chart for view day mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to patient details page of a specific patient care plan
    ...
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-02     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-03: View multiple records of Prescribed medication adherence chart for view day mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to patient details page of a specific patient care plan
    ...
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-03     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-04: View multiple records of Sleep chart for view day mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to patient details page of a specific patient care plan
    ...
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-04     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-05: View multiple records of Heart rate/Blood pressure/Oxygen saturation/Body temperature/Weight-BMI chart for view week/month mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-05     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-06: View multiple records of Activity chart for view week/month mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    ...   - In step 5, it will display the date, and point’s value.
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-06     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-07: View multiple records of Prescribed medication adherence chart for view week mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    ...   - In step 4, it will display The avg/day, min and max values of the week/month
    ...   - In step 5, it will display the date, and point’s value.
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-07     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-08: View multiple records of Sleep chart for view week/month mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    ...   - In step 4, it will display The avg/day, min and max values of the week/month
    ...   - In step 5, it will display the date, and point’s value.
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-08     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-09: View multiple records of Heart rate/Blood pressure/Oxygen saturation/Body temperature/Weight-BMI chart for view 3 months/6 months mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-09     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-10: View multiple records of Activity chart for view 3 months/6 months mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    ...   - In step 5, it will display the date range, and point’s value.
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-10     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-11: View multiple records of Prescribed medication adherence chart for view 3 months/6 months mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    ...   - In step 5, it will display the date range, and point’s value.
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-11     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-12: View multiple records of Sleep chart for view 3 months/6 months mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    ...   - In step 4, it will display The avg/day, min, and max values of that 3 months/6 months
    ...   - In step 5, it will display the date range, and point’s value.
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-12     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-13: View multiple records of Heart rate/Blood pressure/Oxygen saturation/Body temperature/Weight-BMI chart for view 9 months/1 year mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-13     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-14: View multiple records of Activity chart for view 9 months/1 year mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    ...   - In step 5, it will display the month, and point’s value.
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-14     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-15: View multiple records of Prescribed medication adherence chart for view 9 months/1 year mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    ...   - In step 5, it will display the month, and point’s value.
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-15     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-16: View multiple records of Sleep chart for view 9 months/1 year mode
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    ...   - In step 5, it will display the month, and point’s value.
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-16     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-17: View multiple records of Custom view with selected range is one day
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-17     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-18: View multiple records of Custom view with selected range is from 2 days to 7 days
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    ...   - In step 7, user can not go backward or forward
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-18     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-19: View multiple records of Custom view with selected range is from 8 days to 30 days
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    ...   - In step 7, user can not go backward or forward
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-19     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-20: View multiple records of Custom view with selected range is from 31 days to 180 days
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    ...   - In step 7, user can not go backward or forward
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-20     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-21: View multiple records of Custom view with selected range is more than 180 days but less than 360 days
   [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1. Go to Patient details page
    ...
    ...   - In step 7, user can not go backward or forward
    [Tags]    BCP-NURSE-PTDET-OVERVIEW-21     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-22: RPM Overview - Maximum device types
    [Documentation]    Author: Hoang Le
    ...
    ...  Pre-condition:
    ...  User is on the Overview tab of the patient details
    ...  There are 4 registered devices for a program
    ...  Test steps:
    ...  Expected results:
    ...  On the device section, all of the Device types shall be displayed
    ...  On the device section, the Trans.this month of a specific device shall be displayed
    ...  On the device section, the Last reading of a specific device shall be displayed.
    [Tags]      BCP-NURSE-PTDET-OVERVIEW-22       manual      [BCP-2.15]
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-23: RPM Overview - At least one device type
    [Documentation]    Author: Hoang Le
    ...
    ...  Pre-condition:
    ...  User is on the Overview tab of the patient details
    ...  There is only 1 registered device for a program
    ...  Test steps:
    ...  Expected results:
    ...  On the device section, the Device type shall be displayed
    ...  On the device section, the Trans.this month of a device shall be displayed
    ...  On the device section, the Last reading of a device shall be displayed.
    [Tags]      BCP-NURSE-PTDET-OVERVIEW-23       manual      [BCP-2.15]
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-24: Overview - No device types
    [Documentation]    Author: Hoang Le
    ...
    ...  Pre-condition:
    ...  User is on the Overview tab of the patient details
    ...  There is no registered devices for a program
    ...  Test steps:
    ...  Expected results:
    ...  The device section shall not be displayed
    ...  There is no charts displayed also.
    [Tags]      BCP-NURSE-PTDET-OVERVIEW-24       manual      [BCP-2.15]
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-OVERVIEW-25: RPM Overview - No Heart monitor tab
    [Documentation]    Author: Hoang Le
    ...
    ...  Pre-condition: User is on the patient details page
    ...  Test steps:
    ...  Expected result:
    ...  There shall be no Heart monitor tab for this plan type.
    [Tags]      BCP-NURSE-PTDET-OVERVIEW-25       manual      [BCP-2.15]
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
