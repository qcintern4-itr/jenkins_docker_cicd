*** Settings ***
Documentation   Cardiac Devices Bioheart Report page test suite
Metadata    sid     BCP-NURSE-DEVICES-BIOHEART
...
Force Tags      BCP-NURSE-DEVICES-BIOHEART      web
Test Timeout    1h

*** Test Cases ***
BCP-NURSE-DEVICES-BIOHEART-01: Filter Bioheart reports list
    ...
    [Tags]    BCP-NURSE-DEVICES-BIOHEART-01      manual
...
BCP-NURSE-DEVICES-BIOHEART-02: Go To The Patient Details Page By Clicking Patient Name Hyperlink
    [Documentation]    Author: Hoang Le
    ...
    [Tags]    BCP-NURSE-DEVICES-BIOHEART-02      manual
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}

BCP-NURSE-DEVICES-BIOHEART-03: Column visibility - Hide/show column(s) on page
    [Documentation]    Author: Hoang Le
    ...
    [Tags]    BCP-NURSE-DEVICES-BIOHEART-03        manual      [BCP-2.17]
    Manual Should Be Passed    ${TEST NAME}     ${TEST DOCUMENTATION}
...
Filter Bioheart reports  # Create HM Biohearts: TBD
