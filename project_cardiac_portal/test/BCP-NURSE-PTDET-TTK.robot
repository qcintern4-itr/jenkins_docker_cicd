...
Metadata    sid     BCP-NURSE-PTDET-TTK
...
Force Tags      BCP-NURSE-PTDET-TTK       web
Test Timeout    1h

*** Test Cases ***
BCP-NURSE-PTDET-TTK-01: Add new time log in the Time tracking tab of a specific patient
    ...
    [Tags]   BCP-NURSE-PTDET-TTK-01     manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-02: Add new time log in the details page of a specific current calendar month
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  - Go to Time tracking tab in Patient details page of specific patient
    ...
    ...  Expected Output:
    ...  - The time log will be saved and displayed on the time log list
    [Tags]   BCP-NURSE-PTDET-TTK-02     manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-03: Filter Billable status of the calendar month
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  - Go to Time tracking tab in Patient details page of specific patient
    ...
    [Tags]   BCP-NURSE-PTDET-TTK-03     manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-04: Filter Unbillable status of the calendar month
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  - Go to Time tracking tab in Patient details page of specific patient
    ...
    [Tags]   BCP-NURSE-PTDET-TTK-04     manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-05: Edit all required fields of the auto time log in the current calendar month
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  - Go to Time tracking tab in Patient details page of specific patient
    ...
    [Tags]   BCP-NURSE-PTDET-TTK-05     manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-06: Edit random field of the auto time log in the current calendar month
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  - Go to Time tracking tab in Patient details page of specific patient
    ...
    ...  Expected Output:
    ...  - The time log will be saved as user edits
    [Tags]   BCP-NURSE-PTDET-TTK-06     manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-07: Edit all required fields of the manual time log in the current calendar month
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  - Go to Time tracking tab in Patient details page of specific patient
    ...
    ...  Expected Output:
    ...  - The time log will be saved as user edits
    [Tags]   BCP-NURSE-PTDET-TTK-07     manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-08: Edit random field of the manual time log in the current calendar month
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  - Go to Time tracking tab in Patient details page of specific patient
    ...
    ...  Expected Output:
    ...  - The time log will be saved as user edits
    [Tags]   BCP-NURSE-PTDET-TTK-08     manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-09: Delete auto time log in the current calendar month
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  - Go to Time tracking tab in Patient details page of specific patient
    ...
    [Tags]    BCP-NURSE-PTDET-TTK-09        manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-10: Delete manual time log in the current calendar month
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  - Go to Time tracking tab in Patient details page of specific patient
    ...
    ...  Expected Output:
    ...  - The time log will be deleted successfully with a toast displayed
    [Tags]    BCP-NURSE-PTDET-TTK-10        manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-11: Display pop up Time out after 2 minutes of inactivity on the patient details page
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...
    [Tags]   BCP-NURSE-PTDET-TTK-11     manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-12: Reappear pop up Time out after another 2 minutes of inactivity on the patient details page
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  1. Go to Patient details page of specific patient
    ...
    [Tags]   BCP-NURSE-PTDET-TTK-12     manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-13: Not response pop up Time out within 30s after 2 minutes of inactivity
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  1. Go to Patient details page of specific patient
    ...
    [Tags]   BCP-NURSE-PTDET-TTK-13     manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-14: Responds to the pop-up after 30s appear pop-up Time out
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  1. Go to Patient details page of specific patient
    ...
    [Tags]   BCP-NURSE-PTDET-TTK-14     manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-15: Display pop up Time out after 1 minutes of hiding web Browser window
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  1. Go to Patient details page of specific patient
    ...
    [Tags]   BCP-NURSE-PTDET-TTK-15     manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-16: Not response pop up Time out within 30s after 1 minutes of hiding web Browser window
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  1. Go to Patient details page of specific patient
    ...
    ...  - The auto time tracking will restart and the pop-up will close.
    [Tags]   BCP-NURSE-PTDET-TTK-16     manual     BCP-2.16
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-17: Add An Auto Time Log Via Timer For Active - Unlinked Patient
    [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...
    [Tags]    BCP-NURSE-PTDET-TTK-17     manual     BCP-2.16
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}

BCP-NURSE-PTDET-TTK-18: Add An Auto Time Log Via Timer For Active - Linked Patient
    [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1.Log in to the portal as a Clinic user
    ...
    ...   - At step 4, user can choose Activity which base on RPM/CCM/CCM&RPM plan type
    ...   - At step 7, the Activity's duration will be logged to the Time-tracking of the current month
    [Tags]    BCP-NURSE-PTDET-TTK-18     manual     BCP-2.16
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}

BCP-NURSE-PTDET-TTK-19: Add A Manual Time Log Via Timer For Active - Unlinked Patient
    [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1.Log in to the portal as a Clinic user
    ...
    [Tags]    BCP-NURSE-PTDET-TTK-19     manual     BCP-2.16
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}

BCP-NURSE-PTDET-TTK-20: Add A Manual Time Log Via Timer For Active - Linked Patient
    [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1.Log in to the portal as a Clinic user
    ...
    ...   - At step 5, user can choose Activity which base on RPM/CCM/CCM&RPM plan type
    ...   - At step 9, the Activity will be logged to the Time-tracking of the current month
    [Tags]    BCP-NURSE-PTDET-TTK-20     manual     BCP-2.16
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}

BCP-NURSE-PTDET-TTK-21: Discard Data On The Timer
    [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1.Log in to the portal as a Clinic user
    ...
    [Tags]    BCP-NURSE-PTDET-TTK-21     manual     BCP-2.16
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}

BCP-NURSE-PTDET-TTK-22: See auto time log reporting in Time tracking list
    [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1.Log in to the portal as a Clinic user
    ...
    [Tags]    BCP-NURSE-PTDET-TTK-22     manual     BCP-2.16
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}

BCP-NURSE-PTDET-TTK-23: See manual time log reporting in Time tracking list
    [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1.Log in to the portal as a Clinic user
    ...
    ...   -It will navigate to Time tracking details page of a specific current calendar month
    ...   -The Activity will be logged to the Time-tracking list of the current month
    [Tags]    BCP-NURSE-PTDET-TTK-23     manual     BCP-2.16
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}

BCP-NURSE-PTDET-TTK-24: Change the Auto timer to Manual
    [Documentation]    Author: Xuan Trinh
    ...
    ...   Test Steps:
    ...   1.Log in to the portal as a Clinic user
    ...
    [Tags]    BCP-NURSE-PTDET-TTK-24     manual     BCP-2.16
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}

BCP-NURSE-PTDET-TTK-25: Create Super Bill
    ...
    [Tags]    BCP-NURSE-PTDET-TTK-25        manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Patients New
#    Filter Registered Patients    search_by=Patient name     text_search=${PATIENTS}[3]
...
#    Filter Active Patients    by_patient=My patients    search_by=Patient name      text_search=${PATIENTS}[3]
#    View Active Patient Details On    row=1
#    # Time tracking tab
#    Navigate To Patient Details Tab    tab=Time tracking
#    PatientDetails.View Time Tracking Details On      row=1
#    # Time tracking details > create superbill
#    Create Superbill    diagnoses=I09.81      services=99490    amount_paid=50      status=Ready for biller
#    ${msg}      Get Success Message
#    Run Keyword And Continue On Failure    Should Be Equal    ${msg}    Superbill is added successfully!
#    Back From Time Tracking Details
#    PatientDetails.View Time Tracking Details On      row=1
#    ${tlog_details}      Get Patient Details Time Tracking Details
#    Run Keyword And Continue On Failure    Should Not Be Empty    ${tlog_details}     Not time log found
#    Run Keyword And Continue On Failure    Should Contain    ${tlog_details}[0][Superbill]      Ready for biller
#    Run Keyword And Continue On Failure    Should Contain    ${tlog_details}[0][Superbill]      Diagnoses (ICD-10), I09.81
#    Run Keyword And Continue On Failure    Should Contain    ${tlog_details}[0][Superbill]      Services, 99490
#    Run Keyword And Continue On Failure    Should Contain    ${tlog_details}[0][Superbill]      Amount paid: $50.00     # verify dollar
#    # Navigate to time tracking + verify
#    Navigate To Time Tracking
#    Filter Time Tracking    by_patient=My patients    by_status=Ready for biller    search_by=Patient name     text_search=${patient_name}
#    ${ttk}      Get Time Tracking
#    Run Keyword And Continue On Failure    Should Contain   ${tlog_details}[0][Superbill]      ${ttk}[0][Superbill]

BCP-NURSE-PTDET-TTK-26: Edit Super Bill
    [Documentation]    Author: Khang Nguyen
    ...
    ...  Test Steps:
    ...
    [Tags]    BCP-NURSE-PTDET-TTK-26     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-27: Create Master Bill
    [Documentation]    Author: Khang Nguyen
    ...
    ...  Test Steps:
    ...
    [Tags]    BCP-NURSE-PTDET-TTK-27     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BCP-NURSE-PTDET-TTK-28: Print Bill
    [Documentation]    Author: Khang Nguyen
    ...
    ...  Test Steps:
    ...
    [Tags]    BCP-NURSE-PTDET-TTK-28     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-29: Collapse patient brief info for patient has linked care plan
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...
    [Tags]    BCP-NURSE-PTDET-TTK-29     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-30: Collapse patient brief info for patient has not linked care plan
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  1. Scroll down the page
    ...
    ...  - In step 3, the brief info header will be expanded
    [Tags]    BCP-NURSE-PTDET-TTK-30     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-31: Collapse patient brief info for patient which has missing info
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  1. Scroll down the page
    ...
    [Tags]    BCP-NURSE-PTDET-TTK-31     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-32: Collapse patient brief info for patient which has deleted their account
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  1. Scroll down the page
    ...
    ...  - In step 4, the brief info header will be expanded
    [Tags]    BCP-NURSE-PTDET-TTK-32     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BCP-NURSE-PTDET-TTK-33: Collapse patient brief info for patient which has missing info and has deleted their account
    [Documentation]    Author: Xuan Trinh
    ...
    ...  Test Steps:
    ...  1. Scroll down the page
    ...
    [Tags]    BCP-NURSE-PTDET-TTK-33     manual
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}
