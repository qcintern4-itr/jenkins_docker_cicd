...
Force Tags      BCP-PHY-PTINACT     web
Test Timeout    1h

*** Test Cases ***
BCP-PHY-PTINACT-01: Filter Inactive patients by "My patients"
    ...
    [Tags]   BCP-PHY-PTINACT-01    manual    inactive
...
BCP-PHY-PTINACT-02: Filter Inactive patients by "All patients"
    [Documentation]    Author: Hoang Le
    ...
    ...   Test Steps:
    ...   - Go to Inactive patients page
    ...
    ...   Expected Result:
    ...   - A patient's details page shall be displayed.
    [Tags]   BCP-PHY-PTINACT-02    manual    inactive
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}
#    [Template]    Filter Patients - Inactive
#    All patients     Patient Name
#    All patients     Care Plan ID

BCP-PHY-PTINACT-03: Go To The Patient Details Page By Clicking Patient Name Hyperlink
    [Documentation]     Author: Hoang Le
    ...
    ...   Test Steps:
    ...
    [Tags]   BCP-PHY-PTINACT-03    manual    inactive
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}
...
BCP-PHY-PTINACT-04: Reactivate An Inactive Care Plan
    [Documentation]     Author: Hoang Le
    ...
    ...   Test Steps:
    ...
    [Tags]   BCP-PHY-PTINACT-04    manual
    Manual Should Be Passed    ${TEST NAME}    ${TEST DOCUMENTATION}

BCP-PHY-PTINACT-05: Column visibility - Hide/show column(s) on page
    [Documentation]    Author: Hoang Le
    ...
    [Tags]    BCP-PHY-PTINACT-05        manual      [BCP-2.17]
    Manual Should Be Passed    ${TEST NAME}     ${TEST DOCUMENTATION}
...
Inactive Care - Plan
    ...
    Run Keyword If      ${active_patients} != None and '${patient_name}' == '${active_patients}[0][Patient Name]'    Run Keywords
    ...  View Active Patient Details On    row=1
    ...  AND    Stop Health Care Program
...
Reactive Care - Plan
    ...
    Run Keyword If      ${inac_patients} != None and '${patient_name}' == '${inac_patients}[0][Patient Name]'     Run Keywords
    ...  View Inactive Patient Details On    row=1
