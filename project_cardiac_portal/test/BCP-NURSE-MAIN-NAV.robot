...
Metadata    sid     BCP-NURSE-MAIN-NAV
...
Force Tags      BCP-NURSE-MAIN-NAV      web
Test Timeout    1h

*** Test Cases ***
BCP-NURSE-MAIN-NAV-01: Go To Appointment Details Page By Accessing Care Plan Info Side Tab
    ...
    [Tags]    BCP-NURSE-MAIN-NAV-01      manual
