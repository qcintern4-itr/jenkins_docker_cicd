...
Metadata    sid     BSP-PATIENT
Metadata    owner   Linh Phan
Library     corelib/AssertionExtension.py
Library     corelib/WebHandler.py   ${BROWSER}  ${HEADLESS}
Library     project_support_portal/lib/BspConfigHandler.py    ${ENV}

Suite Setup     Suite Setup
Suite Teardown      Suite Teardown
Force Tags      BSP-PATIENT     web
Test Timeout    1h

*** Test Cases ***
BSP-PATIENT-VIEWLIST-OPEN-01: View list of OPEN Patient Support tickets
    ...
    [Tags]    BSP-PATIENT-VIEWLIST-OPEN-01      BSP-SRS-002-FRS-01-1   R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-VIEWLIST-OPEN-02: Observe the order of the list
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-VIEWLIST-OPEN-02      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-VIEWLIST-OPEN-03: Check the pagination
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-VIEWLIST-OPEN-03      BSP-SRS-002-FRS-01-1   R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-VIEWLIST-OPEN-04: Check the pagination
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Check the pagination
    ...
    ...
    [Tags]    BSP-PATIENT-VIEWLIST-OPEN-04      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-VIEWLIST-CLOSED-01: View list of closed Patient Support tickets
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-VIEWLIST-CLOSED-01      BSP-SRS-002-FRS-01-1   R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-VIEWLIST-CLOSED-02: Observe the order of the list
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Observe the order of the list
    ...
    ...
    [Tags]    BSP-PATIENT-VIEWLIST-CLOSED-02      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-VIEWLIST-CLOSED-03: Check the pagination
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Check the pagination
    ...
    ...
    [Tags]    BSP-PATIENT-VIEWLIST-CLOSED-03      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-VIEWLIST-CLOSED-04: Check the pagination
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Check the pagination
    ...
    ...
    [Tags]    BSP-PATIENT-VIEWLIST-CLOSED-04      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-02: Search options
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-02      BSP-SRS-002-FRS-01-1   R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-03: Enter a Ticket ID into the search bar
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-03      BSP-SRS-002-FRS-01-1   R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-04: Select other tabs on the page
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-04      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-05: Switches pages on the portal
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Enter a Ticket ID into the search bar
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-05      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-06: Search by Study ID
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-06      BSP-SRS-002-FRS-01-1   R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-07: Select other tabs on the page
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select other tabs on the page
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-07      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-08: Select other tabs on the page
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select other tabs on the page
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-08      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-09: Search by Device ID
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-09      BSP-SRS-002-FRS-01-1   R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-10: Select other tabs on the page
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select other tabs on the page
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-10      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-11: Select other tabs on the page
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select other tabs on the page
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-11      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-12: Search by Patient Name
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-12      BSP-SRS-002-FRS-01-1   R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-13: Select other tabs on the page
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select other tabs on the page
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-13      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-14: Select other tabs on the page
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select other tabs on the page
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-14      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-15: Search by Phone
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-15      BSP-SRS-002-FRS-01-1   R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-16: Select other tabs on the page
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select other tabs on the page
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-16      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-SEARCH-OPEN-17: Select other tabs on the page
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select other tabs on the page
    ...
    ...
    [Tags]    BSP-PATIENT-SEARCH-OPEN-17      BSP-SRS-002-FRS-01-1   R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-CREATE-01: Observe the “New Support Ticket” page
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-CREATE-01     BSP-SRS-002-FRS-03   R1      manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-CREATE-02: Search by Patient’s Name
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-CREATE-02      BSP-SRS-002-FRS-03   R1     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-CREATE-03: Mouse over on the result and click on "Add ticket" button
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-CREATE-03      BSP-SRS-002-FRS-03   R1     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-CREATE-04: Search by Date of Birth
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-CREATE-04      BSP-SRS-002-FRS-03   R1     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-CREATE-05: Mouse over on the result and click on "Add ticket" button
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: The user creates a ticket
    ...
    ...
    [Tags]    BSP-PATIENT-CREATE-05      BSP-SRS-002-FRS-03   R1     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-CREATE-06: Search by phone number
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-CREATE-06      BSP-SRS-002-FRS-03   R1     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-CREATE-07: Mouse over on the result and click on "Add ticket" button
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: The user creates a ticket
    ...
    ...
    [Tags]    BSP-PATIENT-CREATE-07      BSP-SRS-002-FRS-03   R1     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-VIEWTICKET-OPEN-02: View an Open Patient Support ticket details
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-VIEWTICKET-OPEN-02    BSP-SRS-002-FRS-04   R1     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-VIEWTICKET-OPEN-04: View an Closed Patient Support ticket details
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: View an Closed Patient Support ticket details
    ...
    ...     Precondition: The user should be redirected to the details page
    ...
    ...     Test Steps
    ...
    [Tags]    BSP-PATIENT-VIEWTICKET-OPEN-04    BSP-SRS-002-FRS-04   R1     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-VIEWTICKET-OPEN-05: Edit open ticket
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-VIEWTICKET-OPEN-05    BSP-SRS-002-FRS-04   R1     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-RESET-01: Resetting a device from a Patient Support ticket
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-RESET-01    BSP-SRS-002-FRS-05   R2     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-CREATERMA-01: Create an RMA ticket from a patient support ticket
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-CREATERMA-01    BSP-SRS-002-FRS-06   R1     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-RESOLVE-01: Resolve a patient support ticket
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:
    ...
    ...
    [Tags]    BSP-PATIENT-RESOLVE-01    BSP-SRS-002-FRS-07   R1     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-REOPEN-01: Re-open a Patient Support ticket
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-REOPEN-01    BSP-SRS-002-FRS-08   R1     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-QUICKACCESS-01: Quick access to Study information in the open tab
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-PATIENT-QUICKACCESS-01    BSP-SRS-002-FRS-08   R2     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-PATIENT-QUICKACCESS-02: Quick access to Study information in the CLOSED tab
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Quick access to Study information
    ...
    ...
    [Tags]    BSP-PATIENT-QUICKACCESS-02    BSP-SRS-002-FRS-08   R2     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}
