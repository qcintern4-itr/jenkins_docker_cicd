...
Force Tags      BSP-RMA     web
Test Timeout    1h

*** Test Cases ***

# * VIEW LIST - NEW
BSP-RMA-VIEWLIST-NEW-01: Observe the RMA list section
    ...
    [Tags]    BSP-RMA-VIEWLIST-NEW-01   FRS-018-02    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-VIEWLIST-NEW-03: Sort the RMA ticket list by RMA ID
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-VIEWLIST-NEW-03   FRS-018-02    R2    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-VIEWLIST-NEW-04: Pagination-Move to other pages
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-VIEWLIST-NEW-04   FRS-018-02    R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-VIEWLIST-NEW-05: Pagination-View quantity of tickets display per page
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-VIEWLIST-NEW-05   FRS-018-02    R2   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

#SEARCH

BSP-RMA-SEARCH-NEW-03: Enter a RMA ID into the search bar
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-SEARCH-NEW-03       FRS-019-01    R1   SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-SEARCH-NEW-05: Enter a Device ID into the search bar
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-SEARCH-NEW-05       FRS-019-01        R1      SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-SEARCH-NEW-07: Enter a Facility name into the search bar
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-SEARCH-NEW-07    FRS-019-01    R1   SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-SEARCH-NEW-11: Enter a Requester name into the search bar
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-SEARCH-NEW-11      FRS-019-01    R1   SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

#VIEW - QUICK ACCESS

BSP-RMA-QA-01: Check that the RMA device are displayed correctly in Inbound Devices sidebar
    ...
    [Tags]    BSP-RMA-QA-01    RS-037-01    R2    manual    SC-1.14.0
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-QA-03: Check that Facility Information quick access is displayed when clicking hyperlink
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-QA-03   manual    SC-1.14.0     R2
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-QA-04: Quick access to Patient Impact Information
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-QA-04    RS-040-01    manual     R2
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-QA-05: Quick Access to Bioflux/Biotres Device details Information
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-QA-05    FRS-039-01    manual     R2
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

#COMMENT
BSP-RMA-COMMENT-01: Check the "New Comment" icon in the list of new RMA
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-01    RS-044-01    R2   SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-02: Check the "Comment" icon in the list of new RMA
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-02    RS-044-01    R2    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-03: Check the comment icon the case the read comment is edited
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-03    RS-044-01    R2   SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-04: Check the comment icon the case the unread comment is edited
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-04    RS-044-01    R2   SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-05: Check the icon in the case all the comments (read) is deleted
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-05    RS-044-01    R2   SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-06: Check the comment icon in the case all the unread comments is deleted
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-06    RS-044-01    R2   SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-07: Check the comment icon in the case all the comments (read/unread) is deleted
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:
    ...
    ...
    [Tags]  BSP-RMA-COMMENT-07    RS-044-01    R2   SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-08: View the comment sidebar in the case there is no comment yet
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-08    RS-044-01    R2   SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-09: View the comment sidebar in the case there is a/some read comments
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-09    RS-044-01    R2   SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-10: View the comment sidebar in the case there is a new comment submitted by OM
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-10    RS-044-01    R2   SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-11: The user inputs their comment into comment textbox
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-11    RS-044-01    R1   SC-1.14.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-12: Click on “Add comment” button when the comment textbox is empty
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-12    RS-044-01    R2   SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-13: Check the option when the comment owner clicks on "More" button
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-13    RS-044-01    R2   SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-14: The person who is not the comment owner hovering over the comment
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-14    RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-15: The person who is not the comment owner hovering over the comment
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: The person who is not the comment owner hovering over the comment
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-15     RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-18: The person who is not the comment owner hovering over the comment
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: The person who is not the comment owner hovering over the comment
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-18      RS-044-01    R2        SC-1.14.0         manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-19: The person who is not the comment owner hovering over the comment
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: The person who is not the comment owner hovering over the comment
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-19     RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-20: The comment owner edits the comment
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-20     RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-21: The comment owner edits the comment
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-21     RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-22: The comment owner edits the comment and clicks on "Cancel"
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-22     RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-23: Observe the confirmation modal when clicks on "Delete" option
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-23     RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-24: The comment owner selects "Delete" option in the confirmation modal
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-24     RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-25: The comment owner selects "Cancel" option in the confirmation modal
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-25     RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-26: The comment owner selects "Cancel" option in the confirmation modal
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: The comment owner selects "Cancel" option in the confirmation modal
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-26     RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-27: Check the "Last read" line
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-27     RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-28: View the comment sidebar in the case there is a new comment
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: View the comment sidebar in the case there is a new comment
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-28     RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-29: View the “New Comment” icon, red dot by the owner (OM submit)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-29     RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-30: View the “New Comment” icon, red dot by another OM (OM submit)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-30    RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-31: View the “New Comment” icon, red dot by OS (OM submit)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-31    RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-32: View the “New Comment” icon, red dot by Support Staff (OM submit)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-32      RS-044-01    R2    SC-1.14.0      manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-COMMENT-33: Click on “Add comment” button when the comment textbox only contains spaces
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-COMMENT-33      RS-044-01    R2    SC-1.14.0       manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

#BIOFT - CREATE NEW
BSP-RMA-CREATE-BIOFT-01: Select device type "Bioflux/Biotres" in the Device type modal
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOFT-01    FRS-20-01       R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-F-01: Check that user can select Ship from Facility (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOFT-F-01   FRS-20-02    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-F-03: Check that shipping information must be automatically filled in when Ship from Facility (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOFT-F-03   FRS-20-02    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-F-04: Check that shipping information can be edited when Ship from Facility (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...
	...     - 4. Display the inputted text

    [Tags]    BSP-RMA-CREATE-BIOFT-F-04   FRS-20-02    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-F-05: Check that Country can be selected when Ship from Facility (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOFT-F-05   FRS-20-02    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-F-06: Check that default Country is United States when Ship from Facility (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-CREATE-BIOFT-F-06   FRS-20-02    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-F-08: Check that Secondary Address can be empty when Ship from Facility (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOFT-F-08   FRS-20-02    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-F-09: Check that required fields must not be empty when Ship from Facility (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...
	[Tags]    BSP-RMA-CREATE-BIOFT-F-09   FRS-20-02    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-P-03: Check that user can search Patient name when Ship from Patient (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOFT-P-03   FRS-20-02    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-P-04: Check that Patient address must be automatically filled in when Ship from Patient (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOFT-P-04   FRS-20-02    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-P-05: Check that address information can be edited when Ship from Patient (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...
	...     - 2. Select "Patient" option in the Inbound tab
	...     - 3. Search and select Patient name in Sender name textbox.
	...     - 4. Edit the address information (address, secondary address, city, state, zipcode, contact phone number, contact email)
	...     - 5. Input Secondary Address
	...
	...     Expected Results:
	...     - 1. Address is recommended based on the input of user
	...     - 2. Address information (address, city, state, zip code) is automatically filled in based on address input.

    [Tags]    BSP-RMA-CREATE-BIOFT-P-05   FRS-20-02    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-P-06: Check that Country can be selected when Ship from Patient (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOFT-P-06   FRS-20-02    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-P-07: Check that default Country is United States when Ship from Patient (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOFT-P-07   FRS-20-02    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-P-10: Check that required fields must not be empty when Ship from Patient (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOFT-P-10   FRS-20-02    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-S-03: Check that shipping information must be automatically filled in when Ship from Sales Rep (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-CREATE-BIOFT-S-03   FRS-20-02    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-S-04: Check that shipping information can be edited when Ship from Sales Rep (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...
	...     - 2. Select " Sales Rep" option in the Inbound tab
	...     - 3. Edit the sender name/address information (address, secondary address, city, state, zipcode, contact phone number, contact email)
	...     - 4. The Secondary address
	...
	...     Expected Results:
	...     - 1. Address is recommended based on the input of user.
	...     - 2. Address information (address, city, state, zipcode) is automatically filled in based on address input.

    [Tags]    BSP-RMA-CREATE-BIOFT-S-04   FRS-20-02    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-S-05: Check that Country can be selected when Ship from Sales Rep (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOFT-S-05   FRS-20-02    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-S-06: Check that default Country is United States when Ship from Sales Rep (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOFT-S-06   FRS-20-02    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-S-09: Check that required fields must not be empty when Ship from Sales Rep (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In Shipping Information section, with ticket Ship from Patient, check required fields must not be empty
	...
    ...
    [Tags]    BSP-RMA-CREATE-BIOFT-S-09   FRS-20-02    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOFT-10: Check the information in the created ticket on service portal
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: Check the information in the created ticket on service portal
	...
	...     Precondition:
	...     - 1. The SS is on Create new RMA request page
	...     - 2. The device type is Bioflux/Biotres
	...
	...     Test Steps:
	...     - 1. Create ticket on Support portal
	...     - 2. Check the information in the RMA ticket
	...     - 3. Check noti on service portal
	...
	...     Expected Results:
	...     - 1. Display ticket in the inprocess tab
	...     - 2. Display the noti

    [Tags]    BSP-RMA-CREATE-BIOFT-10   FRS-20-02    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

#VIEW NEW - BIOFT
BSP-RMA-VIEW-NEW-BIOFT-01: Check that New RMA Request ticket details must be fully displayed.
	[Documentation]  Author: Linh Nguyen
    ...
	...
	...     - + Shipping/Returning Address (Sender/Recipient Name, Country, City, Address,Secondary Address, State, Zip code, Contact Phone Number, Contact Email)
	...     - + Notification email
	...     - + Notes
    ...
    [Tags]    BSP-RMA-VIEW-NEW-BIOFT-01    FRS-021-01    R1     manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

#EDIT NEW - BIOFT
BSP-RMA-EDIT-NEW-BIOFT-01: Check that other information can be edited
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-EDIT-NEW-BIOFT-01   FRS-022-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-02: Check that notification emails can not be empty
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-EDIT-NEW-BIOFT-02   FRS-022-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-03: Check that notification emails can be entered using Space bar or [,] key
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-EDIT-NEW-BIOFT-03   FRS-022-01    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-04: Check that sender address can be edited.
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-EDIT-NEW-BIOFT-04   FRS-022-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-05: Check that sender address edit mode must be exited when clicking Cancel button
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-EDIT-NEW-BIOFT-05   FRS-022-01    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-06: Check that sender address information is automatically filled in.
	[Documentation]  Author: Linh Nguyen
    ...
	...
	[Tags]    BSP-RMA-EDIT-NEW-BIOFT-06   FRS-022-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-07: Check that Country in sender address can be selected
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-EDIT-NEW-BIOFT-07   FRS-022-01    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-08: Check that required fields in sender address must not be empty.
	[Documentation]  Author: Linh Nguyen
    ...
	...
	[Tags]    BSP-RMA-EDIT-NEW-BIOFT-08   FRS-022-01    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-09: Check that contact phone number in sender address is valid
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-EDIT-NEW-BIOFT-09   FRS-022-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-10: Check that contact email in sender address is valid
	[Documentation]  Author: Linh Nguyen
    ...
	...
	[Tags]    BSP-RMA-EDIT-NEW-BIOFT-10   FRS-022-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-11: Check that recipient address can be edited.
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-EDIT-NEW-BIOFT-11   FRS-022-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-12: Check that recipient address edit mode must be exited when clicking Cancel button
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-EDIT-NEW-BIOFT-12   FRS-022-01    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-13: Check that recipient address information is automatically filled in.
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-EDIT-NEW-BIOFT-13   FRS-022-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-14: Check that Country in recipient address can be selected
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-EDIT-NEW-BIOFT-14   FRS-022-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-15: Check that required fields in recipient address must not be empty.
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-EDIT-NEW-BIOFT-15   FRS-022-01    R2    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-16: Check that contact phone number in sender address is valid
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-EDIT-NEW-BIOFT-16   FRS-022-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-EDIT-NEW-BIOFT-17: Check that contact email in recipient address is valid
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-EDIT-NEW-BIOFT-17   FRS-022-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

#APPROVE/REJECT NEW - BIOFT
BSP-RMA-APPROVE-BIOFT-01: Check that the confirmation modal must be displayed correctly when clicking Approve button
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-APPROVE-BIOFT-01    FRS-023-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-APPROVE-BIOFT-02: Check that the ticket can be approved after confirming.
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-APPROVE-BIOFT-02   FRS-023-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-APPROVE-BIOFT-03: Check that the ticket the modal must be exited when clicking Cancel button
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-APPROVE-BIOFT-03   FRS-023-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-APPROVE-BIOFT-04: Check that email must be sent when the reason is "Return to Stock"
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-APPROVE-BIOFT-04   FRS-023-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-APPROVE-BIOFT-05: Check that message must be displayed when ticket is being updated by another user
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-APPROVE-BIOFT-05   FRS-023-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-REJECT-BIOFT-01: Check that the confirmation modal must be displayed correctly when clicking Reject button
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-REJECT-BIOFT-01   FRS-024-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-REJECT-BIOFT-02: Check that the ticket can be rejected after confirming.
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-REJECT-BIOFT-02   FRS-024-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-REJECT-BIOFT-03: Check that Cancel confirm modal must be exited when clicking Cancel button
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In New RMA ticket detail page, the ticket the modal must be exited when clicking Cancel button
	...
    ...
    [Tags]	BSP-RMA-REJECT-BIOFT-03   FRS-024-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-REJECT-BIOFT-04: Check that devices status included in the RMA ticket changed to “Active” after being rejected
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]	BSP-RMA-REJECT-BIOFT-04   FRS-024-01    R1    manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

#CREATE - BIOH

BSP-RMA-CREATE-BIOH-F-02: Select “Facility” customer type
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-02     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-04: Select "Facility" option in the inbound tab (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-04     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-05: Select "Patient" option in the inbound tab
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-05     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-06: Select a patient name in the sender name field (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-06     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-07: Select "Sale rep" option in the inbound tab (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-07     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-08: Select "Facility" option in the Outbound tab (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-08     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-09: Select "Patient" option in the Outbound tab (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-09     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-10: Select a patient name in the sender name field (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select a patient name in the sender name field
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-10     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-11: Select "Sale rep" option in the Outbound tab (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-11     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-12: The user edits the address (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-12     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-13: The user edits the address (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: The user edits the address
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-13     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-14: The user edits the address of the Sales representative (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: The user edits the address
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-14     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-15: Search and select Device ID in the RMA Details section (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-15     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-16: Search an invalid Device ID in the RMA Details section (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-16     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-17: Select the reason for RMA in the RMA Details section (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-17     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-18: Select options from the Reason for RMA drop down list (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-18     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-19: Remove selected "Reason for RMA" option (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-19     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-20: Check the "Add device" button (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-20     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-21: Check the [Delete] button on each row (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-21     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-23: Check the [Delete] button on each row (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Check the [Delete] button on each row
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-23     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-27: Enter emails into Notification Email textbox (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-27     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-28: Remove emails in the Notification Email textbox (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-28     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-29: Enter text in the Notes textbox (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-29     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-31: Check the message when the ticket is created by Support Staff (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-31     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-32: Select "Confirm" button in the confirmation pop-up (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-32     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-33: Select "Back" button in the confirmation pop-up (the customer type is “Facility”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-33     FRS-020-03    R2     SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-34: Check the email content sent to service@biotricity.com and the people who are in the “Notification email”
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-34     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-35: There is an email send to Billing and Service in the case the ticket has “Return to Stock” reason
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-35     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-F-36: Click on [Return] button when the user makes changes in the "New RMA ticket"
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-F-36     FRS-020-03    R2    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-01: Customer type is "End User", valid value
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-01     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-02: Customer type is "End User", invalid value
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Customer type is "End User"
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-02      FRS-020-03    R2    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-03: Observe the Shipping Information section (the customer type is “End User”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-03     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-04: Change the Shipping Information section (the customer type is “End User”)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Observe the Shipping Information section in the case the customer type is" End User"
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-04     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-05: Change the Shipping Information (the customer type is “End User”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-05     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-06: Search and select Device ID in the RMA Details section (the customer type is “End User”)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Search and select Device ID in the RMA Details section
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-06     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-07: Search an invalid Device ID in the RMA Details section (the customer type is “End User”)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-07     FRS-020-03    R2    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-08: Select the reason for RMA in the RMA Details section (the customer type is “End User”)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select the reason for RMA in the RMA Details section
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-08     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-09: Select options from the Reason for RMA drop down list (End User)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select options from the Reason for RMA drop down list
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-09     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-10: Remove selected "Reason for RMA" option (End User)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Remove selected "Reason for RMA" option
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-10     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-11: Enter text in the Notes textbox (the customer type is “End User”)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Enter text in the Notes textbox
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-11     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-13: Check the message when the ticket is created by Support Staff (the customer type is “End User”)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Check the message when the ticket is created by Support Staff
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-13     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-14: Select "Confirm" button in the confirmation pop-up (the customer type is “End User”)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:  Select "Confirm" button in the confirmation pop-up
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-14     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-15: Select "Back" button in the confirmation pop-up (the customer type is “End User”)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:  Select "Back" button in the confirmation pop-up
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-15     FRS-020-03    R2    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-16: Check the email content sent to service@biotricity.com and the people who are in the “Notification email”
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:  Check the email content
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-16     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-17: There is an email send to Billing and Service in the case the ticket has “Return to Stock” reason
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:  There is an email send to Billing and Service in the case the ticket has “Return to Stock” reason
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-17     FRS-020-03    R1    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOH-E-18: Click on [Return] button when the user makes changes in the "New RMA ticket"
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Click on [Return] button when the user makes changes in the "New RMA ticket"
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOH-E-18     FRS-020-03    R2    SC-1.10.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}


#CREATE BIOK
BSP-RMA-CREATE-BIOK-03: Check that Create Biokit RMA Request ticket page must be displayed all sections
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-03    RS-020-04   R1    manual    SC-1.14.0
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

#OTHER INFORMATION
BSP-RMA-CREATE-BIOK-04: Check that notification emails can not be empty
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-04	RS-020-04   R1    manual    SC-1.14.0
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-05: Check that notification emails can be entered using Space bar or [,] key
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-05    RS-020-04   R2    manual    SC-1.14.0
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-06: Check that Notes field is optional
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-06    RS-020-04   R2    manual    SC-1.14.0
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

#SHIP INFORMATION
# FACILITY - INBOUND
BSP-RMA-CREATE-BIOK-SHIPINFO-01: Check that user can select Ship from Facility (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In Shipping Information section, user can select Ship from Facility
	...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-01   RS-020-04   R1    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-03: Check that shipping information must be automatically filled in when Ship from Facility (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In Shipping Information section, with ticket Ship from Facility, check shipping information must be automatically filled in based on Facility Information
	...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-03   RS-020-04   R1    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-04: Check that shipping information can be edited when Ship from Facility (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In Shipping Information section, with ticket Ship from Facility, check shipping information can be edited
	...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-04   RS-020-04   R1    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-05: Check that Country can be selected when Ship from Facility (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In Shipping Information section, with ticket Ship from Facility, check country information can be selected in dropdown menu
	...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-05   RS-020-04   R1    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-06: Check that default Country is United States when Ship from Facility (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In Shipping Information section, with ticket Ship from Facility, check that default Country is United States
	...
    ...
    [Tags]		BSP-RMA-CREATE-BIOK-SHIPINFO-06   RS-020-04   R2    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-09: Check that required fields must not be empty when Ship from Facility (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In Shipping Information section, with ticket Ship from Facility, check required fields must not be empty
	...
	...
	[Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-09   RS-020-04   R2    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-12: Check that Patient can be searched and selected in Sender name (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-12   RS-020-04   R1    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-13: Check that shipping information must be automatically filled in when Ship from Patient (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-13   RS-020-04   R1    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-14: Check that shipping information can be edited when Ship from Patient (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-14   RS-020-04   R1    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-15: Check that Country can be selected when Ship from Patient (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In Shipping Information section, with ticket Ship from Patient, check country information can be selected in dropdown menu
	...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-15   RS-020-04   R1    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-16: Check that default Country is United States when Ship from Patient (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In Shipping Information section, with ticket Ship from Patient, check that default Country is United States
	...
    ...
    [Tags]		BSP-RMA-CREATE-BIOK-SHIPINFO-16   RS-020-04   R2    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-19: Check that required fields must not be empty when Ship from Patient (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In Shipping Information section, with ticket Ship from Patient, check required fields must not be empty
	...
	...
	[Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-19   RS-020-04   R2    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-20: Check that user can select Ship from Sales rep (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-20   RS-020-04   R1    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-22: Check that shipping information must be automatically filled in when Ship from Sales rep (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-22   RS-020-04   R1    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-23: Check that shipping information can be edited when Ship from Sales rep (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In Shipping Information section, with ticket Ship from Sales rep, check shipping information can be edited
	...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-23   RS-020-04   R1    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-24: Check that Country can be selected when Ship from Sales rep (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In Shipping Information section, with ticket Ship from Sales rep, check country information can be selected in dropdown menu
	...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-24   RS-020-04   R2    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-25: Check that default Country is United States when Ship from Sales rep (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In Shipping Information section, with ticket Ship from Sales rep, check that default Country is United States
	...
    ...
    [Tags]		BSP-RMA-CREATE-BIOK-SHIPINFO-25   RS-020-04   R2    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-28: Check that required fields must not be empty when Ship from Sales rep (Inbound)
	[Documentation]  Author: Linh Nguyen
    ...
	...
	[Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-28  RS-020-04   R2    SC-1.14.0	manual
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

# FACILITY - OUTBOUND

BSP-RMA-CREATE-BIOK-SHIPINFO-31: Check that shipping information must be automatically filled in when Ship from Facility (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Facility, check shipping information must be automatically filled in based on Facility Information
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-31   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-32: Check that shipping information can be edited when Ship from Facility (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Facility, check shipping information can be edited
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-32   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-33: Check that Country can be selected when Ship from Facility (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Facility, check country information can be selected in dropdown menu
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-33   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-34: Check that default Country is United States when Ship from Facility (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Facility, check that default Country is United States
    ...
    ...
    [Tags]     BSP-RMA-CREATE-BIOK-SHIPINFO-34   RS-020-04   R2    SC-1.14.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-37: Check that required fields must not be empty when Ship from Facility (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Facility, check required fields must not be empty
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-37   RS-020-04   R2    SC-1.14.0  manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-40: Check that Patient can be searched and selected in Sender name (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Patient, check Patient can be searched and selected in Sender name
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-40   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-41: Check that shipping information must be automatically filled in when Ship from Patient (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Patient, check shipping information must be automatically filled in based on Patient Information
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-41   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-42: Check that shipping information can be edited when Ship from Patient (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Patient, check shipping information can be edited
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-42   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-43: Check that Country can be selected when Ship from Patient (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Patient, check country information can be selected in dropdown menu
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-43   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-44: Check that default Country is United States when Ship from Patient (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Patient, check that default Country is United States
    ...
    ...
    [Tags]     BSP-RMA-CREATE-BIOK-SHIPINFO-44   RS-020-04   R2    SC-1.14.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-47: Check that required fields must not be empty when Ship from Patient (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Patient, check required fields must not be empty
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-47   RS-020-04   R2    SC-1.14.0  manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-50: Check that shipping information must be automatically filled in when Ship from Sales rep (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Sales rep, check shipping information must be automatically filled in based on Sales rep Information
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-50   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-51: Check that shipping information can be edited when Ship from Sales rep (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Sales rep, check shipping information can be edited
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-51   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-52: Check that Country can be selected when Ship from Sales rep (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Sales rep, check country information can be selected in dropdown menu
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-52   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-53: Check that default Country is United States when Ship from Sales rep (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Sales rep, check that default Country is United States
    ...
    ...
    [Tags]     BSP-RMA-CREATE-BIOK-SHIPINFO-53   RS-020-04   R2    SC-1.14.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-56: Check that required fields must not be empty when Ship from Sales rep (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with ticket Ship from Sales rep, check required fields must not be empty
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-56  RS-020-04   R2    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

# END USER - INBOUND
BSP-RMA-CREATE-BIOK-SHIPINFO-58: Check that shipping information must be automatically filled in when customer type is End User (Inbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-58   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-59: Check that Country can be selected when customer type is End User (Inbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-59   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-60: Check that default Country is United States when customer type is End User (Inbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]     BSP-RMA-CREATE-BIOK-SHIPINFO-60   RS-020-04   R1    SC-1.14.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-61: Check that Shipping information has Secondary Address (optional) when customer type is End User (Inbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-61   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-62: Check that Secondary Address can be empty when customer type is End User (Inbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-62   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-63: Check that required fields must not be empty when customer type is End User (Inbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-63   RS-020-04   R1    SC-1.14.0  manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-71: Check that Inbound shipping information is automatically filled when toggle "Use Customer Information" is on (End User)
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-71   RS-020-04   R1    SC-1.14.0  manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

#END USER - OUTBOUND
BSP-RMA-CREATE-BIOK-SHIPINFO-64: Check that hint text of sender name when customer type is End User (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-64   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-65: Check that shipping information must be automatically filled in when customer type is End User (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with customer type is End User, check shipping information must be automatically filled in based on Facility Information
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-65   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-66: Check that Country can be selected when customer type is End User (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with customer type is End User, check country information can be selected in dropdown menu
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-66   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-67: Check that default Country is United States when customer type is End User (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with customer type is End User, check that default Country is United States
    ...
    ...
    [Tags]     BSP-RMA-CREATE-BIOK-SHIPINFO-67   RS-020-04   R1    SC-1.14.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-68: Check that Shipping information has Secondary Address (optional) when customer type is End User (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with customer type is End User, should has Secondary Address (optional) field
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-68   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-69: Check that Secondary Address can be empty when customer type is End User (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with customer type is End User, Secondary Address can be empty
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-69   RS-020-04   R1    SC-1.14.0   manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-SHIPINFO-70: Check that required fields must not be empty when customer type is End User (Outbound)
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: In Shipping Information section, with customer type is End User, check required fields must not be empty
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-SHIPINFO-70   RS-020-04   R1    SC-1.14.0  manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

#Customer Information
BSP-RMA-CREATE-BIOK-CUS-01: Check that Customer type must have 2 options End User and Facility
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-CUS-01    RS-020-04   R1    manual    SC-1.14.0
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-CUS-02: Check that additional fields are displayed when user select customer type is End User
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-CUS-02    RS-020-04   R1    manual    SC-1.14.0
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-CUS-03: Check that Secondary Address field must be optional (End User)
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-CUS-03	RS-020-04   R1    manual    SC-1.14.0
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-CUS-04: Check that Address information can be automatically filled in based on user entered address (End User)
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-CUS-04    RS-020-04   R1    manual    SC-1.14.0
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-CUS-05: Check that contact email must be valid in End User information
	[Documentation]  Author: Linh Nguyen
    ...
	...     Description: In New RMA ticket detail page, check email in sender address is valid
	...
	...
	[Tags]    BSP-RMA-CREATE-BIOK-CUS-05   RS-020-04   R1    manual       SC-1.14.0
	Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-CUS-06: Check that additional fields are displayed when user select customer type is Facility
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-CUS-06    RS-020-04   R1    manual    SC-1.14.0
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-CUS-07: Check that Facility name can be suggested when user type in dropdown menu (Facility)
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-CUS-07    RS-020-04   R1    manual    SC-1.14.0
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-CUS-08: Check that suggested Facility name information must be correct (Facility)
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-CUS-08    RS-020-04   R1    manual    SC-1.14.0
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

#RMA DETAIL
BSP-RMA-CREATE-BIOK-RD-01: Search and select Kit device in the RMA Details section (Facility)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-RD-01     RS-020-04   R1    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-RD-02: Search and select standalone device in the RMA Details section (Facility)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-RD-02     RS-020-04   R1    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-RD-03: Search and select Kit device in the RMA Details section (End User)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: In Create Biokit RMA Request page, and select Kit Device in the RMA Details section
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-RD-03     RS-020-04   R1    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-RD-04: Search and select standalone device in the RMA Details section (End User)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: In Create Biokit RMA Request page, and select standalone device in the RMA Details section
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-RD-04     RS-020-04   R1    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-RD-05: Search an invalid Device ID in the RMA Details section (Facility)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Search an invalid Device ID in the RMA Details section
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-RD-05     RS-020-04   R1    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-RD-06: Search an invalid Device ID in the RMA Details section (End User)
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Search an invalid Device ID in the RMA Details section
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-RD-06     RS-020-04   R1    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-RD-08: Select options from the Reason for RMA drop down list
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select options from the Reason for RMA drop down list
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-RD-08     RS-020-04   R1    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-RD-10: Remove selected "Reason for RMA" option
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Remove selected "Reason for RMA" option
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-RD-10     RS-020-04   R1    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-RD-11: Check the "Add device" button
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Check the "Add device" button
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-RD-11     RS-020-04   R1    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-RD-12: Check the [Delete] button on each row
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Check the [Delete] button on each row
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-RD-12     RS-020-04   R1    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-RD-13: The reason for RMA must be reset when device ID is changed to the other model
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: In Create Biokit RMA Request page, and select Kit Device in the RMA Details section
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-RD-13     RS-020-04   R1    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-RD-07: Select the reason for RMA (Blood Pressure Cuff) in the RMA Details section
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select the reason for RMA in the RMA Details section
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-RD-07     RS-020-04   R1    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-RD-14: Select the reason for RMA (Digital Thermometer) in the RMA Details section
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select the reason for RMA in the RMA Details section
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-RD-14     RS-020-04   R1    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-RD-15: Select the reason for RMA (Pulse Oximeter) in the RMA Details section
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Select the reason for RMA in the RMA Details section
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-RD-15     RS-020-04   R1    SC-1.14.0     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
#CREATE
BSP-RMA-CREATE-BIOK-08: Check the message when the ticket is created by Support Staff
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Check the message when the ticket is created by Support Staff
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-08     RS-020-04   R1    SC-1.14.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-10: Check that the ticket can be created after confirming
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-10    RS-020-04   R1    manual    SC-1.14.0
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-11: Check that the ticket the modal must be exited when clicking Back button
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-11    RS-020-04   R1    manual    SC-1.14.0
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-12: Check the email content sent to service@biotricity.com and the people who are in the “Notification email”
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:  Check the email content
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-12     RS-020-04   R1    SC-1.14.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-13: There is an email send to Billing and Service in the case the ticket has “Return to Stock” reason
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:  There is an email send to Billing and Service in the case the ticket has “Return to Stock” reason
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-13     RS-020-04   R1    SC-1.14.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-CREATE-BIOK-14: Click on [Cancel]/[Return] button when the user makes changes in the "New RMA ticket"
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-CREATE-BIOK-14     RS-020-04   R1    SC-1.14.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

#TODO: WARNING
BSP-RMA-WARNING-01: Unusual RMA activity warning
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-RMA-WARNING-01  RS-100-01   R1     SC-1.14.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

# * RMA LIMIT
BSP-RMA-LIMIT-CREATE-01: The message indicating the device limit per RMA ticket is displayed
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-LIMIT-CREATE-01   RS-020    SC-1.15.0    R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-LIMIT-CREATE-02: Check when clicking Add device button, if reasons other than Lost Device/Return to Stock then user cannot add more than the device limit number
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-LIMIT-CREATE-02   RS-020   R1    SC-1.15.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-LIMIT-CREATE-03: Check that RMA ticket can be created
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-LIMIT-CREATE-03   RS-020    SC-1.15.0    R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-LIMIT-CREATE-04: Check that error message is displayed when clicking Create ticket button if the number of devices exceed the daily RMA devices for the facility
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-LIMIT-CREATE-04   RS-020    SC-1.15.0    R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-LIMIT-CREATE-05: Check that error message is displayed when clicking Create ticket button if the ticket were to exceed the daily RMA tickets approval limit set for Support Team
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-LIMIT-CREATE-05   RS-020    SC-1.15.0    R1     manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-LIMIT-CREATE-06: Check that Reason for RMA must be displayed correctly
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-LIMIT-CREATE-06   RS-020    SC-1.15.0    R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-LIMIT-CREATE-07: Check that select Reason for RMA is “Device Issues” then cannot select “Lost Device” or “Return to Stock”
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-LIMIT-CREATE-07   RS-020    SC-1.15.0    R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-LIMIT-CREATE-08: Check that select Reason for RMA is “Lost Device” or “Return to Stock” then cannot select “Device Issues”
    [Documentation]  Author: Linh Nguyen
    ...
    ...
    [Tags]    BSP-RMA-LIMIT-CREATE-08   RS-020    SC-1.15.0    R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-LIMIT-APPROVE-01: Check that error message is displayed when clicking Create ticket button if the number of devices exceed the daily RMA devices for the facility
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: error message is displayed when clicking Create ticket button if the number of devices exceed the daily RMA devices for the facility
    ...
    ...
    [Tags]    BSP-RMA-LIMIT-APPROVE-01   RS-020    SC-1.15.0    R1    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-LIMIT-APPROVE-02: Check that error message is displayed when clicking Create ticket button if the ticket were to exceed the daily RMA tickets approval limit set for Support Team
    [Documentation]  Author: Linh Nguyen
    ...
    ...     Description: error message is displayed when clicking Create ticket button if the ticket were to exceed the daily RMA tickets approval limit set for Support Team
    ...
    ...
    [Tags]    BSP-RMA-LIMIT-APPROVE-02   RS-020  R1    SC-1.15.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-LIMIT-APPROVE-03: Check Bioheart, Biokit should not be limited (exceed the daily RMA tickets approval limit set for Support Team)
    [Documentation]  Author: Linh Phan
    ...

    [Tags]    BSP-RMA-LIMIT-APPROVE-03  RS-020  R1    SC-1.15.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-LIMIT-APPROVE-04: Check Bioheart, Biokit should not be limited (exceed the daily RMA tickets approval limit set for a facility)
    [Documentation]  Author: Linh Phan
    ...

    [Tags]    BSP-RMA-LIMIT-APPROVE-04  RS-020  R1    SC-1.15.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-RMA-LIMIT-APPROVE-05: Check Bioheart, Biokit should not be limited (exceed the devices in a ticket)
    [Documentation]  Author: Linh Phan
    ...

    [Tags]    BSP-RMA-LIMIT-APPROVE-05  RS-020  R1    SC-1.15.0    manual
    Manual Should Be Passed   ${TEST_NAME}    ${TEST_DOCUMENTATION}
