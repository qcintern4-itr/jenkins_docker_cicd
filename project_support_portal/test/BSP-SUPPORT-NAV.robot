...
Force Tags      BSP-SUPPORT-NAV    web
Test Timeout    1h

*** Test Cases ***
BSP-SUPPORT-NAV-MENU-11:The user is on the Support portal, observe the number of the New Patient Support ticket
    ...
    [Tags]    BSP-SUPPORT-NAV-MENU-11       BSP-SRS-007-FBS-01   R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-MENU-12:The user is on the Support portal, observe the number of the New Clinic Support ticket
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-MENU-12             BSP-SRS-007-FBS-01   R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-MENU-13:The user is on the Support portal, observe the number of the New RMA Request ticket
    [Documentation]  Author: Linh Phan
    ...
    ...     Description:
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-MENU-13      BSP-SRS-007-FBS-01   R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-QA-10: Quick access to the other Portals (Support Portal, Support staff)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-QA-10  BSP-SRS-007-FBS-02    R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-QA-11: Quick access to the other Portals (Support portal, Support staff)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-QA-11  BSP-SRS-007-FBS-02    R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-QA-12: Quick access to the other Portals (Support portal)
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-QA-12  BSP-SRS-007-FBS-02    R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-NOTISP-01: Notification on Support portal
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-NOTISP-01   BSP-SRS-007-FBS-03-1    R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-NOTISP-02: Notification on Support portal
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-NOTISP-02      BSP-SRS-007-FBS-03-1    R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-NOTISP-03: Notification on Support portal
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-NOTISP-03     BSP-SRS-007-FBS-03-1    R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-NOTISP-04: Notification on Support portal
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-NOTISP-04     BSP-SRS-007-FBS-03-1    R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-NOTISP-05: Notification on Support portal
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-NOTISP-05      BSP-SRS-007-FBS-03-1    R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-NOTISP-06: Notification on Support portal
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-NOTISP-06      BSP-SRS-007-FBS-03-1    R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-NOTISP-07: Notification on Support portal
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-NOTISP-07      BSP-SRS-007-FBS-03-1    R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-NOTISP-08: Notification on Support portal
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-NOTISP-08      BSP-SRS-007-FBS-03-1    R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-NOTISP-09: Notification on Support portal
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-NOTISP-09     BSP-SRS-007-FBS-03-1    R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-NOTISP-10: Notification on Support portal
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]    BSP-SUPPORT-NAV-NOTISP-10      BSP-SRS-007-FBS-06-1     R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-NOTISP-11: Notification on Support Portal
    [Documentation]  Author: Linh Phan
    ...
    [Tags]    BSP-SUPPORT-NAV-NOTISP-11      BSP-SRS-007-FBS-06-1     R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-NOTISP-12: Notification on Support portal
    [Documentation]  Author: Linh Phan
    ...
    ...
    [Tags]     BSP-SUPPORT-NAV-NOTISP-12     BSP-SRS-007-FBS-06-2     R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-NOTISP-13: Notification on Support Portal
    [Documentation]  Author: Linh Phan
    ...
    [Tags]    BSP-SUPPORT-NAV-NOTISP-13     BSP-SRS-007-FBS-06-2     R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BSP-SUPPORT-NAV-NOTISP-14: Notification on Support portal
    [Documentation]  Author: Linh Phan
    ...
    ...     Description: Receive notification when there is an RMA request
    ...
    ...
    [Tags]     BSP-SUPPORT-NAV-NOTISP-14     BSP-SRS-007-FBS-06-2     R1    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
