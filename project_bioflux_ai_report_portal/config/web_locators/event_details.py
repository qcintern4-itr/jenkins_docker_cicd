...
EDET_EVENT_DURATION = 'xpath://div[@class="relative"]//input[@name="eventDuration"]'

# event report
EVENT_REPORT_STATUS = 'xpath://button[@id="report-status-btn"]'
EVENT_REPORT_ASSIGN = 'xpath://button[@id="assign-this-report-to-me"]'
EVENT_REPORT_ASSIGNED = 'xpath://div[@id="assignee-info-box"]'
EVENT_REPORT_DISMISS = 'xpath://button[@id="dismiss-reenable-btn"]'
EVENT_REPORT_UPLOAD = 'xpath://button[@id="bt-upload"]'
EVENT_REPORT_PRIORITY = 'xpath://button[@id="report-status-btn"]/..//div[contains(@class,"custom-select-input")]'
...
INTERIM_REPORT_STATUS = 'xpath://div[@id="aborted-update-send-report-btn"]//button'
