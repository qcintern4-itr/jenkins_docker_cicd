...
try:
    ...
    from project_bioflux_ai_report_portal.config.web_locators import studies as locators
...
class Studies(WebPage):
    ...
    def navigate_to_studies_clinic(self):
        """
        Navigate to studies page on clinic portal
        :return: None
        """
        self.browser.open_page(self.URL_CLINIC + '/studies')
    ...
    def wait_active_studies_available(self):
        ...
        :return:
        """
        self.browser.wait_visibility_of_all_elements_located(self.LCT.ACTIVE_DATA_HEADER)
        self.browser.wait_visibility_of_all_elements_located(self.LCT.ACTIVE_DATA_CONTENT)
    ...
    def wait_completed_studies_available(self):
        ...
        :return:
        """
        self.browser.wait_visibility_of_all_elements_located(self.LCT.COMPLETED_DATA_HEADER)
    ...
    def navigate_to_studies_type(self, tab):
        ...
        while True:
            if self.browser.wait_visibility_of_all_elements_located(self.LCT.TABS) and self.browser.get_elements(self.LCT.TABS + '/a')[0].get_attribute('disabled') is None:
                self.browser.wait_visibility_of_all_elements_located(self.LCT.TABS + '/a')
