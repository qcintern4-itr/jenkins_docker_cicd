...
Metadata    sid     BFCC-AIRP-ECG-EVENT-MINHR
...
Force Tags      BFCC-AIRP-ECG-EVENT-MINHR  web
Test Timeout    30m

*** Test Cases ***
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-01: Verify the menu option on Min HR section
    ...
    ...     3. Hover to Min HR tab -> Observe the result
    ...
    ...     Expected Results:
    ...
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-01      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-ECG-EVENT-MINHR-VIEW-02: Verify the panel information on "Min HR" page
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: Check the panel information on "Min HR" page
    ...
    ...     Precondition:
    ...     - The user is on the AI report processing screen
    ...
    ...
    ...     Create date: 04/05/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-ECG-EVENT-MINHR-VIEW-03: Verify the HR chart is working properly
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     1. Click ECG Events tab
    ...     2. Navigate to Rhythm events
    ...     3. Click on the "Min HR" button -> Click the zoom in, zoom out tool -> Observe the result
    ...
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-03      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-ECG-EVENT-MINHR-RHYTHM-CAPTURE-01: The captured blue highlight will disappear when switching to the Minute info tab
    ...
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-RHYTHM-CAPTURE-01      manual    AIRP-1.9.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-ECG-EVENT-MINHR-RHYTHM-EDIT-01: Can not update beats in the nodata area
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 05/27/2024 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-RHYTHM-EDIT-01      manual    AIRP-1.9.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-ECG-EVENT-MINHR-RHYTHM-CAPTURE-02: Can not capture in the nodata area
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 05/27/2024 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-RHYTHM-CAPTURE-02      manual    AIRP-1.9.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-ECG-EVENT-MINHR-VIEW-04:Verify that the checkbox 'Use 100% available time' appears in the 'Add New Event' modal when the event type is set to AFib.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-04       AIRP-1.14.0             auto      R1
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-05:Verify that the checkbox 'Use 100% available time' can be marked when adding a new event with the event type AFib.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/12/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-05       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
...
BFCC-AIRP-ECG-EVENT-MINHR-MARK-01:Verify that when marking the checkbox 'Use 100% available time', the start time is set to the beginning of the study.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-MARK-01       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
...
BFCC-AIRP-ECG-EVENT-MINHR-MARK-02:Verify that when marking the checkbox 'Use 100% available time', the stop time is set to the end of the study
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-MARK-02       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-06:Verify that using the 'Jump to' button for the start time will set it to the beginning of the day when the checkbox 'Use 100% available time' is marked
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Update date: 10/02/2024 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-06       AIRP-1.14.0             manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-ECG-EVENT-MINHR-VIEW-07:Verify that using the 'Jump to' button for the stop time will set it to the end of the day when the checkbox 'Use 100% available time' is marked
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Update date: 10/02/2024 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-07       AIRP-1.14.0             manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-ECG-EVENT-MINHR-VIEW-08:Verify that the 'Use 100% available time' checkbox is hidden when selecting the Tachy type.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-08      AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-08.1:Verify that the 'Use 100% available time' checkbox is hidden when selecting the Brady type.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-08.1       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-08.2:Verify that the 'Use 100% available time' checkbox is hidden when selecting the Pause type.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-08.2       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab   Min HR
    Navigate To Add New Event
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-08.3:Verify that the 'Use 100% available time' checkbox is hidden when selecting the VT type.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-08.3       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-08.4:Verify that the 'Use 100% available time' checkbox is hidden when selecting the SVT type.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-08.4       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-08.5:Verify that the 'Use 100% available time' checkbox is hidden when selecting the 2nd Deg HB type.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-08.5       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-08.6:Verify that the 'Use 100% available time' checkbox is hidden when selecting the 3rd Deg HB type.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-08.6       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-09:Verify that when adding a new AFib event with the duration as 100% available time, all AFib events within that duration will be deleted.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-09       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
    Filter Thumbnail Option    select_event_type=AFib    use_add_all_afib=${True}
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-10:Verify that when adding a new AFib event with the duration as 100% available time, all Tachy events within that duration will be deleted.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-10       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
    Filter Thumbnail Option    select_event_type=AFib    use_add_all_afib=${True}
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-11:Verify that when adding a new AFib event with the duration as 100% available time, all Brady events within that duration will be deleted.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-11      AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
    Filter Thumbnail Option    select_event_type=AFib    use_add_all_afib=${True}
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-12:Verify that when adding a new AFib event with the duration as 100% available time, all SVT events within that duration will be deleted.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-12       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
    Filter Thumbnail Option    select_event_type=AFib    use_add_all_afib=${True}
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-13:Verify that when adding a new AFib event with the duration as 100% available time, all 2nd Deg HB events within that duration will be deleted.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-13       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
    Filter Thumbnail Option    select_event_type=AFib    use_add_all_afib=${True}
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-14:Verify that when adding a new AFib event with the duration as 100% available time, all 3rd Deg HB events within that duration will be deleted.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-14      AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
    Filter Thumbnail Option    select_event_type=AFib    use_add_all_afib=${True}
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-15:Verify that when adding a new AFib event with the duration as 100% available time, all SVE couplet events within that duration will be deleted.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-15      AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
    Filter Thumbnail Option    select_event_type=AFib    use_add_all_afib=${True}
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-16:Verify that when adding a new AFib event with the duration as 100% available time, all SVE Run events within that duration will be deleted.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-16       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
    Filter Thumbnail Option    select_event_type=AFib    use_add_all_afib=${True}
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-17:Verify that when adding a new AFib event with the duration as 100% available time, all SVE Bigeminy events within that duration will be deleted.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-17       AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Max HR
    Navigate To Add New Event
    Filter Thumbnail Option    select_event_type=AFib    use_add_all_afib=${True}
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-18:Verify that when adding a new AFib event with the duration as 100% available time, all SVE Trigeminy events within that duration will be deleted.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-18      AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
    Filter Thumbnail Option    select_event_type=AFib    use_add_all_afib=${True}
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-19:Verify that when adding a new AFib event with the duration as 100% available time, all SVE Quadrigeminy events within that duration will be deleted.
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Auto create: 05/15/2025 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-19      AIRP-1.14.0             auto      R1
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Min HR
    Navigate To Add New Event
    Filter Thumbnail Option    select_event_type=AFib    use_add_all_afib=${True}
...
BFCC-AIRP-ECG-EVENT-MINHR-VIEW-20:Verify that when adding a new AFib event with the duration as 100% available time, all beats S will be deleted
    [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Update date: 10/02/2024 - Hoang Nguyen
    ...
    [Tags]      BFCC-AIRP-ECG-EVENT-MINHR-VIEW-20       AIRP-1.14.0             manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
