...
Metadata    sid     BFCC-AIRP-STRIPS-MANAGEMENT-OTHER
...
Force Tags      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER  web
Test Timeout    30m

*** Test Cases ***
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-ADD-01: Create the event from Study to Other page with event type manual
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: Create the event from Study to Other page
    ...
    ...     Precondition:
    ...     - The user is on the AI report processing screen
    ...     - The event has been closed and not marked "Include in report"
    ...     - The event validity is Valid and has the symptoms is Baseline/Resume study/Evaluation strip
    ...
    ...     Test Steps:
    ...     1. Navigate to study "Events" page
    ...     2. Select the value "Invalid" -> Select event type "Manual" -> click on "Edit" button
    ...
    ...     6. Click on the "Other" link
    ...     7. Observe the result
    ...
    ...     Expected Results:
    ...     2. Just edit the events that has the Symptoms value as Baseline/Resume study/Evaluation strip
    ...     3. Verify the check box "Include in report" has been not marked and the event has been closed
    ...     7. Verify the new event displayed on page
    ...
    ...     **Others**
    ...     Create date: 05/16/2024 - Thang Tran
    ...     Auto Create: 05/28/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-ADD-01      auto
    [Setup]     SUITE SETUP
    Create The Event On Other Page In The Device Event Tab With The Event Type Manual
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-ADD-02: Create the event from Study to Other page with event auto
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: Create the event from Study to Other page
    ...
    ...
    ...     - The user is on the AI report processing screen
    ...     - The event has been closed and not marked "Include in report"
    ...     - The event validity is Valid
    ...
    ...     Test Steps:
    ...     1. Navigate to study "Events" page
    ...     2. Select the value "Invalid" -> Select event type "Brady/Tachy/AFib/Pause/Auto/Sinus" -> click on "Edit" button
    ...     3. Select the value "Valid" -> Observe the result -> click on "Save" button
    ...     4. Navigate to airp page
    ...     5. Click on the "Strips Management" button
    ...     6. Click on the "Other" link
    ...
    ...     Auto Create: 05/28/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-ADD-02    auto
    [Setup]     SUITE SETUP
    Create The Event On Other Page In The Device Event Tab With The Auto Event Type "Pause"
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
    Filter Strips Management    text_search=${event_id}
...
#    Run Keyword And Continue On Failure    Should Be Equal    ${strips_info}[0][DateTime] EDT       ${strips_box_info}[Trigger time]
    Run Keyword And Continue On Failure    Should Be Equal    ${strips_info}[0][Comment]       ${strips_box_info}[Technician comment]
    Run Keyword And Continue On Failure    Should Be Equal    ${strips_info}[0][Validity Status]       Valid
    Run Keyword And Continue On Failure    Should Be Equal    ${strips_info}[0][Type]      ${strips_box_info}[Event type]
    ${status_include}       Check Mark Include Toolbar Available
    Run Keyword And Continue On Failure    Should Not Be True       ${status_include}[Include event in report]
    Run Keyword And Continue On Failure    Should Not Be True       ${status_include}[Include strip]
    ${status_toolbar}       Check Toolbar Strips Management Available
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-01: Check the toolbar header in the "Other" page working properly
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: The filters in the "Other" page is: Valid/Invalid, Include event in report,
    ...
    ...
    ...     Expected Results:
    ...     4. - The check box "Include event in report" has been unmarked
    ...        - All the event strips not displayed the value on event "Incl. in report"
    ...        - The Valid is default
    ...        - The Size default is Small
    ...        - checkbox include strip disabled
    ...
    ...     **Others**
    ...     Create date: 05/15/2024 - Thang Tran
    ...     Auto Create: 05/28/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-01      auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-02: Verify the sort event by Event ID
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 05/28/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-02      auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-03: Verify the sort event by date time
    [Documentation]     Author: Thang Tran
    ...
    ...     Description:
    ...
    ...
    ...     Auto Create: 05/28/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-03      auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-04: View the validity status option and size option
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 05/28/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-04      auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-EDIT-01: Check the validity status when edit validity the event to Invalid
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     6. Select the "Invalid" value -> Observe the result
    ...     7. click on "Save" button -> Observe the result
#    ...     8. Navigate to study "Events" report -> Observe the result
    ...
    ...     Expected Results:
    ...     7. The event not displayed on page
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-EDIT-01      auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-EDIT-02: Check the validity status when edit validity the multiple event to Invalid
    [Documentation]     Author: Thang Tran
    ...
...
#    ...     8. Navigate to study "Events" report -> Observe the result
    ...
    ...     Auto Create: 05/29/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-EDIT-02    auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-ADD-03: Verify the event when change the event to marked "Include event in report"
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     7. The event change from "Other" page to "Included in report" page
    ...
    ...     Auto Create: 05/29/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-ADD-03      auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
    ...
    ${event_id}         Set Variable    ${strip_management}[0][Event ID]
    Filter Strips Management      text_search=${event_id}
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-ADD-04: Verify the events when change the multiple event to marked "Include event in report"
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 05/29/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-ADD-04      auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-ADD-05: Verify the event when change the event to marked "Include strip"
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 05/29/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-ADD-05      auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-ADD-06: Verify the events when change the multiple event to marked "Include strip"
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 05/29/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-ADD-06     auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-05: Verify the number event displayed on "Other" page with different sizes
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 05/29/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-05     auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-06: can view event with search by event ID
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 05/29/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-06     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-07: Verify filter event by Type and Validity
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Create date: 05/15/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-07     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-08: Check the toolbar on "Edit Strip" event page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 05/29/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-08     auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-09: Can view the zoom in and zoom out on "Edit Strip" page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 05/29/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-09      auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-10: View the toolbar options on "Edit Strip" page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 05/29/2024 - Thang Tran
    ...
    [Tags]     BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-10     auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-11: The filter back to default status after reset the filter
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 05/29/2024 - Thang Tran
    ...
    [Tags]     BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-11     auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-PAGINATION-01: Can next page by using Next/Previous button
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 05/29/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-PAGINATION-01    auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-PAGINATION-02: Can next page by using Next/Previous by hotkey
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 05/29/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-PAGINATION-02      auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-PAGINATION-03: Verify the pagination tool can manually input a number within the limit displayed on the page number
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 05/29/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-PAGINATION-03     auto
    [Setup]     SUITE SETUP
    Navigate To Aireport
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-01-1.12.0: Verify if the 'Strips Configuration' is displayed correctly when the user checks all Valid events include in the report and strip
    ...
    ...
    ...     Test Steps:
    ...     1. On Other tab, check Include event in report and Include strip for all Valid events
    ...     2. Click Generate report button
    ...
    ...     Expected Results:
    ...     1. Check for all valid events in the Other tab, including:
    ...     - Valid manual events that are closed (Baseline, Resume study, Evaluation strip)
    ...     - Auto events have been closed as valid: Tachy, Brady, Pause, AFib
    ...     - All above events are not marked ‘Include in report’
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-01-1.12.0       AIRP-1.12.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-02-1.12.0: Verify if the 'Strips Configuration' is displayed correctly when the user checks all events include in the report and strip as Invalid
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    ...     Test Steps:
    ...     1. On Other tab, check Include event in report and Include strip for all events as Invalid
    ...     2. Click Generate report button
    ...
    ...     Expected Results:
    ...     1. Check for all events in the Other tab, including:
    ...     - Valid manual events that are closed (Baseline, Resume study, Evaluation strip)
    ...     - Auto events have been closed as valid: Tachy, Brady, Pause, AFib
    ...     - All above events are not marked ‘Include in report’
    ...     2. The strips configuration in the 'Included in Report' tab matches the strips in the PDF report and corresponds to the ECG captured strips configuration
    ...
    ...     Create date: 09/25/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-VIEW-02-1.12.0       AIRP-1.12.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-RECAPTURE-02: Verify that manually captured Other event strips are retained after clicking Re-capture
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-OTHER-RECAPTURE-02       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
Create the event on other page in the device event tab with the event type manual
    ...
    ${events_id}     Evaluate    [item['Event ID'] for item in ${events} if item.get('Symptoms:') in ('Baseline', 'Resume Study', 'Evaluation Strip')]
...
Create the event on other page in the device event tab with the auto event type "${event_type}"
    Navigate To Events Page
    Filter Study Events     by_type=${event_type}       by_validity=Invalid
