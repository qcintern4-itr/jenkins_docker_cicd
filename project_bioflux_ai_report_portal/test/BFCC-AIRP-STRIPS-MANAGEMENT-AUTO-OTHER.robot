...
Metadata    sid     BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER
...
Force Tags      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER  web
Test Timeout    30m

*** Test Cases ***
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-ADD-01: Create the auto events with event type "Other"
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: Create the auto events with event type "Other"
    ...
    ...     Precondition:
    ...
    ...     2. Select the "Other" Rhythm events
    ...     3. Capture the event
    ...     4. Navigate to "Strips Management" page
    ...     5. Click on "Other" link
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-ADD-01      auto
    Navigate Airp Tab     tab=ECG Events
    Navigate To Ecg Events Subtab    Other
    ...
    Navigate To Tab Menu Strips Management      menu=Other
    ...
    Run Keyword And Continue On Failure    Should Be Equal      ${trigger_time}[Event type]         Other
    Delete Events Strips Management
    Filter Strips Management        is_save=${True}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-VIEW-01: Check the toolbar header in the "Other" page working properly
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: The filters in the "Other" page is: Delete, Include event in report, Include strip, Size, Hide excluded, Reload
    ...
    ...     Precondition:
    ...     - The user is on the AI report processing screen
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-VIEW-01     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-VIEW-02: View the size option
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-VIEW-02    auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-EDIT-01: Verify the event when change the event to not marked "Include event in report"
    [Documentation]     Author: Thang Tran
    ...
...
#    ...     6. The event not displayed on page
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-EDIT-01     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-EDIT-02:Verify the events when change the multiple event to not marked "Include event in report"
    [Documentation]     Author: Thang Tran
    ...
...
#    ...     6. The event not displayed on page
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-EDIT-02     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-EDIT-03: Verify the event when change the event to not marked "Include strip"
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-EDIT-03      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
    Select Strips Management On    row=2
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-EDIT-04: Verify the unmarked Include strip with the multiple events
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-EDIT-04      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
    View Strips Management On    1, 2
    Filter Strips Management      include_strip=${False}
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-VIEW-03: Verify the number event displayed on "Other" page with different sizes
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-VIEW-03     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-VIEW-04: Check the toolbar on "Edit Strip" event page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-VIEW-04     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-VIEW-05: Can view the zoom in and zoom out on "Edit Strip" page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-VIEW-05      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
#    ${include_reports}       Get Strips Management
#    Run Keyword And Continue On Failure    Should Not Be Empty    ${include_reports}
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-VIEW-06: View the toolbar options on "Edit Strip" page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]     BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-VIEW-06     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-PAGINATION-01: Can next page by using Next/Previous button
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-PAGINATION-01    auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-PAGINATION-02: Can next page by using Next/Previous by hotkey
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-PAGINATION-02      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-PAGINATION-03: Verify the pagination tool can manually input a number within the limit displayed on the page number
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-PAGINATION-03     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Other
#    ${strips_management}       Get Strips Management
#    Run Keyword And Continue On Failure    Should Not Be Empty    ${strips_management}
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-15: Check the highlight after updating beats on captured area
    ...
    ...
    ...     Expected Results:
    ...     - Highlight and beat will be updated and displayed properly
    ...     **Others**
    ...     Update date: 03/29/2024 - Hoang Nguyen

    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-15    manual    AIRP-1.9.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-16: Check the captured other event is displayed in strips management
     [Documentation]     Author: Hoang Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    ...     Expected Results:
    ...     - captured other events will display in the management strip after capture
    ...     **Others**
    ...     Update date: 03/29/2024 - Hoang Nguyen

    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-16    manual    AIRP-1.9.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-VIEW-48: Verify that Other event strip automatically checks 'Include event in report' and 'Include strip in report' after capturing from ECG event tab
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-VIEW-48      AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-ICON-01: Verify that hovering over the “Re-capture” button displays a tooltip
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-ICON-01       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-ICON-02: Verify that hovering on the icon of auto events displays a tooltip
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-ICON-02       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-ICON-03: Verify that the auto-icon disappears after the user updates the technician comment in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-ICON-03       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-ICON-04: Verify that the auto-icon disappears after the user recaptures the strip in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-ICON-04       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-ICON-05: Verify that the auto-icon does not disappear after the user unchecks "Include Strip" in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-ICON-05       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-ICON-06: Verify that the auto-icon does not disappear after the user unchecks "Include event in report" in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-ICON-06       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-ICON-07: Verify that the auto-icon disappears after the user updates the technician comment in the ECG Event tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-ICON-07       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-FILTER-01: Verify that the filter modal allows users to filter Auto Events by capture type
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-FILTER-01       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-FILTER-02: Verify that closing the filter modal without clicking “Apply” does not change the filter
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-FILTER-02       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-FILTER-03: Verify that “Show all events” is selected by default when opening the filter modal
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-FILTER-03       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-FILTER-04: Verify that “Show all events” is selected by default when opening the filter modal
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...    - This test case verifies that when the filter modal is opened, the default selected option is “Show all events”
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-FILTER-04       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-02: Verify that manually captured Other event strips are retained after clicking Re-capture
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...    - This test case verifies that strips of "Other" event types which were manually captured are not replaced or removed when the user clicks the "Re-capture" button
    ...    - Other event types may include: Single VE, Single SVE, Baseline, etc.
    ...
    ...     Precondition:
    ...    - A completed study containing at least one manually captured event of type Baseline, Single VE, or Single SVE
    ...
    ...     Test Steps:
    ...    1. Navigate to the Strip Management page
    ...    2. Confirm that a manual "Other" event (e.g. Single VE) is present
    ...    3. Click the "Re-capture" button
    ...    4. Wait for auto events to update
    ...
    ...     Expected Results:
    ...    1. The manually captured "Other" event remains unchanged in the list
    ...    2. No auto version of the same Event Type replaces or overrides the manual one
    ...    3. The strip content and captured timestamp of the manual event remain intact
    ...
    ...     **Others**
    ...     Create date: 6/18/2025 - Trinh Nguyen

    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-OTHER-RECAPTURE-02       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
