...
Metadata    sid     BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY
...
Force Tags      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY  web
Test Timeout    30m

*** Test Cases ***
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-05: Verify that the Brady strips captured by the system are displayed correctly
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-05       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-12: Verify that the list of events sorted by ascending time
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-12       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-13: Verify the first event will be selected after clicking on the Auto events tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-13       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-SIZE-01: Verify that the user can switch between Small, Medium, and Large sizes
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-SIZE-01       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-SIZE-02: Verify the size on thumbnail is displayed correctly after selecting Small size
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-SIZE-02       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-SIZE-03: Verify the size on thumbnail is displayed correctly after selecting Medium size
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-SIZE-03       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-SIZE-04: Verify the size on thumbnail is displayed correctly after selecting Large size
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-SIZE-04       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-EVENT-14: Verify that the user can check the checkbox for a Brady event to include it in the report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-EVENT-14       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-EVENT-19.1: Verify that the user can check the checkbox for multiple events to include it in the report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-EVENT-19.1       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-EVENT-20: Verify that the "Include strip" checkbox is enabled when the "Include in the report" checkbox is checked
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-EVENT-20       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-EVENT-34: Verify that the user can uncheck the checkbox for a Brady event to exclude it in the report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-EVENT-34       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-EVENT-39.1: Verify that the user can uncheck the checkbox for multiple events to exclude it in the report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-EVENT-39.1      AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-EVENT-40: Verify that the "Include strip" checkbox is disable when the "Include in the report" checkbox is unchecked
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-EVENT-40       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-STRIP-14: Verify that the user can check the checkbox for a Brady event to include strip in PDF report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-STRIP-14       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-STRIP-21: Verify that the user can check the checkbox for multiple events to include strip in PDF report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-STRIP-21       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-STRIP-22: Verify that the user can uncheck the checkbox for a Baseline event to exclude strip in PDF report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-STRIP-22       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-STRIP-35: Verify that the user can check the uncheckbox for a Brady event to exclude strip in PDF report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-STRIP-35       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-STRIP-42: Verify that the user can check the uncheckbox multiple events to exclude strip in PDF report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-INCLUDE-STRIP-42       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-01: Verify that the user cannot perform the 'Include event in report' action once the event is in the removing state
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-01       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-02: Verify that the user cannot perform the 'Include strip' action once the event is in the removing state
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-02       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-03: Verify that the user cannot perform the 'Update technician comment' action once the event is in the removing state
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-03       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-04: Verify that the user cannot perform the 'Update title' action once the event is in the removing state
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-04       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-05: Verify that the user cannot perform the 'Edit Strips (Capture)' action once the event is in the removing state
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-05       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-06: Verify that a tooltip appears when the user hovers over the delete button
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-06       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-19: Verify that the user can successfully delete a Brady event by using the Delete button
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-19       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-44: Verify that the user can successfully delete a Brady event by using the Delete button
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-44       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-52: Verify that the user can successfully delete multiple events by using Delete button
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-52       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-63: Verify that the user can successfully delete a Brady event by using the D hotkey
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-63       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-71: Verify that the user can successfully delete multiple events by using the D hotkey
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/4/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-DELETE-71       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-ADD-01: Create the auto events with event type "Brady"
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: Create the auto events with event type "Brady"
    ...
    ...     Precondition:
    ...
    ...     2. Select the "Brady" Rhythm events
    ...     3. Capture the event
    ...     4. Navigate to "Strips Management" page
    ...     5. Click on "Brady" link
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-ADD-01      auto
    ...
    Navigate To Tab Menu Strips Management      menu=Brady
    ...
    Run Keyword And Continue On Failure    Should Be Equal      ${trigger_time}[Event type]         Brady
    Delete Events Strips Management
    Filter Header        is_save=${True}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-01: Check the toolbar header in the "Brady" page working properly
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: The filters in the "Brady" page is: Delete, Include event in report, Include strip, Size, Hide excluded, Reload
    ...
    ...     Precondition:
    ...     - The user is on the AI report processing screen
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-01     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Brady
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-02: View the size option
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-02    auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Brady
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-EDIT-01: Verify the event when change the event to not marked "Include event in report"
    [Documentation]     Author: Thang Tran
    ...
...
#    ...     6. The event not displayed on page
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-EDIT-01     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Brady
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-EDIT-02:Verify the events when change the multiple event to not marked "Include event in report"
    [Documentation]     Author: Thang Tran
    ...
...
#    ...     6. The event not displayed on page
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-EDIT-02     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Brady
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-EDIT-03: Verify the event when change the event to not marked "Include strip"
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-EDIT-03      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Brady
    Select Strips Management On    row=2
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-EDIT-04: Verify the unmarked Include strip with the multiple events
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-EDIT-04      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Brady
    View Strips Management On    1, 2
    Filter Strips Management      include_strip=${False}
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-03: Verify the number event displayed on "Brady" page with different sizes
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-03     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Brady
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-04: Check the toolbar on "Edit Strip" event page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-04     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Brady
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-05.: Can view the zoom in and zoom out on "Edit Strip" page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-05.      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Brady
#    ${include_reports}       Get Strips Management
#    Run Keyword And Continue On Failure    Should Not Be Empty    ${include_reports}
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-06: View the toolbar options on "Edit Strip" page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]     BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-06     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Brady
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-PAGINATION-01: Can next page by using Next/Previous button
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-PAGINATION-01    auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Brady
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-PAGINATION-02: Can next page by using Next/Previous by hotkey
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-PAGINATION-02      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Brady
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-PAGINATION-03: Verify the pagination tool can manually input a number within the limit displayed on the page number
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-PAGINATION-03     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Brady
#    ${strips_management}       Get Strips Management
#    Run Keyword And Continue On Failure    Should Not Be Empty    ${strips_management}
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-15: Check captured channel in strip management after recaptured event
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-15      manual    AIRP-1.9.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-14-1.12.0: Verify that the 'Strips Configuration' is displayed correctly on the Brady strip after completing the study
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-14-1.12.0       AIRP-1.12.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-40: Verify that the Brady strip automatically checks 'Include event in report' and 'Include strip in report' after completing the study
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-40      AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-61: Verify that Brady event strip automatically checks 'Include event in report' and 'Include strip in report' after capturing from ECG event tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/01/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-VIEW-61      AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-CONFIG-17: Verify the 'Strips Configuration' is not updated when the user changes the capture and configuration in the Edit Strip modal for the Brady event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-CONFIG-17       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-CONFIG-38: Verify the 'Strips Configuration' is not updated when the user has captured and modifies configuration from ECG events tab for Brady event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-CONFIG-38       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-CONFIG-58: Verify the 'Strips Configuration' is not updated when the user has just captured a strip from ECG events tab for Brady event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-CONFIG-58       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-CONFIG-83: Verify the 'Strips Configuration' is updated when the user changes the capture and configuration in the Edit Strip modal for the Brady event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-CONFIG-83       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-CONFIG-104: Verify the 'Strips Configuration' is updated when the user has captured and modifies configuration from ECG events tab for Brady event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-CONFIG-104       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-CONFIG-124: Verify the 'Strips Configuration' is updated when the user has just captured a strip from ECG events tab for Brady event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-CONFIG-124       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}            

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-ICON-01: Verify that hovering over the “Re-capture” button displays a tooltip
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-ICON-01       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-ICON-02: Verify that hovering on the icon of auto events displays a tooltip
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-ICON-02       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-ICON-03: Verify that the auto-icon disappears after the user updates the technician comment in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-ICON-03       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-ICON-04: Verify that the auto-icon disappears after the user recaptures the strip in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-ICON-04       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-ICON-05: Verify that the auto-icon does not disappear after the user unchecks "Include Strip" in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-ICON-05       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-ICON-06: Verify that the auto-icon does not disappear after the user unchecks "Include event in report" in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-ICON-06       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-ICON-07: Verify that the auto-icon disappears after the user updates the technician comment in the ECG Event tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-ICON-07       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-FILTER-01: Verify that the filter modal allows users to filter Auto Events by capture type
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-FILTER-01       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-FILTER-02: Verify that closing the filter modal without clicking “Apply” does not change the filter
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-FILTER-02       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-FILTER-03: Verify that “Show all events” is selected by default when opening the filter modal
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-FILTER-03       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-FILTER-04: Verify that “Show all events” is selected by default when opening the filter modal
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...    - This test case verifies that when the filter modal is opened, the default selected option is “Show all events”
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-FILTER-04       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-01: Verify that system re-captures Brady event with slowest average HR
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-01       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-04: Verify that auto Brady is not displayed if an existing Brady with same Event ID was previously captured
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-BRADY-RECAPTURE-04       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
