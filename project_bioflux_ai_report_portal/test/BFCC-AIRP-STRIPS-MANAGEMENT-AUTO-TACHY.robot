...
Metadata    sid     BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY
...
Force Tags      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY  web
Test Timeout    30m

*** Test Cases ***
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-04: Verify that the Tachy strips captured by the system are displayed correctly
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-04       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-ADD-01: Create the auto events with event type "Tachy"
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: Create the auto events with event type "Tachy"
    ...
    ...     Precondition:
    ...
    ...     2. Select the "Tachy" Rhythm events
    ...     3. Capture the event
    ...     4. Navigate to "Strips Management" page
    ...     5. Click on "Tachy" link
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-ADD-01      auto
    ...
    Navigate To Tab Menu Strips Management      menu=Tachy
    ...
    Run Keyword And Continue On Failure    Should Be Equal      ${trigger_time}[Event type]         Tachy
    Delete Events Strips Management
    Filter Strips Management        is_save=${True}
    [Teardown]    Stop Ai Processing

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-01: Check the toolbar header in the "Tachy" page working properly
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: The filters in the "Tachy" page is: Delete, Include event in report, Include strip, Size, Hide excluded, Reload
    ...
    ...     Precondition:
    ...     - The user is on the AI report processing screen
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-01     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Tachy
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-02: View the size option
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-02    auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Tachy
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-EDIT-01: Verify the event when change the event to not marked "Include event in report"
    [Documentation]     Author: Thang Tran
    ...
...
#    ...     6. The event not displayed on page
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-EDIT-01     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Tachy
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-EDIT-02:Verify the events when change the multiple event to not marked "Include event in report"
    [Documentation]     Author: Thang Tran
    ...
...
#    ...     6. The event not displayed on page
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-EDIT-02     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Tachy
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-EDIT-03: Verify the event when change the event to not marked "Include strip"
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-EDIT-03      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Tachy
    Select Strips Management On    row=2
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-EDIT-04: Verify the unmarked Include strip with the multiple events
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-EDIT-04      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Tachy
    View Strips Management On    1, 2
    Filter Strips Management      include_strip=${False}
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-03: Verify the number event displayed on "Tachy" page with different sizes
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-03     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Tachy
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-04.: Check the toolbar on "Edit Strip" event page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-04.     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Tachy
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-05: Can view the zoom in and zoom out on "Edit Strip" page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-05      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Tachy
#    ${include_reports}       Get Strips Management
#    Run Keyword And Continue On Failure    Should Not Be Empty    ${include_reports}
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-06: View the toolbar options on "Edit Strip" page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]     BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-06     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Tachy
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-PAGINATION-01: Can next page by using Next/Previous button
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-PAGINATION-01    auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Tachy
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-PAGINATION-02: Can next page by using Next/Previous by hotkey
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-PAGINATION-02      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Tachy
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-PAGINATION-03: Verify the pagination tool can manually input a number within the limit displayed on the page number
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-PAGINATION-03     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Tachy
#    ${strips_management}       Get Strips Management
#    Run Keyword And Continue On Failure    Should Not Be Empty    ${strips_management}
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-15: Check captured channel in strip management after recaptured event
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-15      manual    AIRP-1.9.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-13-1.12.0: Verify that the 'Strips Configuration' is displayed correctly on the Tachy strip after completing the study
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-13-1.12.0       AIRP-1.12.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-39: Verify that the Tachy strip automatically checks 'Include event in report' and 'Include strip in report' after completing the study
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-39      AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-60: Verify that Tachy event strip automatically checks 'Include event in report' and 'Include strip in report' after capturing from ECG event tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/01/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-VIEW-60      AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-CONFIG-16: Verify the 'Strips Configuration' is not updated when the user changes the capture and configuration in the Edit Strip modal for the Tachy event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-CONFIG-16       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-CONFIG-37: Verify the 'Strips Configuration' is not updated when the user has captured and modifies configuration from ECG events tab for Tachy event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-CONFIG-37       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-CONFIG-57: Verify the 'Strips Configuration' is not updated when the user has just captured a strip from ECG events tab for Tachy event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-CONFIG-57       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-CONFIG-82: Verify the 'Strips Configuration' is updated when the user changes the capture and configuration in the Edit Strip modal for the Tachy event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-CONFIG-82       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-CONFIG-103: Verify the 'Strips Configuration' is updated when the user has captured and modifies configuration from ECG events tab for Tachy event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-CONFIG-103       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-CONFIG-123: Verify the 'Strips Configuration' is updated when the user has just captured a strip from ECG events tab for Tachy event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-CONFIG-123       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

 BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-ICON-01: Verify that hovering over the “Re-capture” button displays a tooltip
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-ICON-01       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-ICON-02: Verify that hovering on the icon of auto events displays a tooltip
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-ICON-02       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-ICON-03: Verify that the auto-icon disappears after the user updates the technician comment in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-ICON-03       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-ICON-04: Verify that the auto-icon disappears after the user recaptures the strip in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-ICON-04       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-ICON-05: Verify that the auto-icon does not disappear after the user unchecks "Include Strip" in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-ICON-05       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-ICON-06: Verify that the auto-icon does not disappear after the user unchecks "Include event in report" in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-ICON-06       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-ICON-07: Verify that the auto-icon disappears after the user updates the technician comment in the ECG Event tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-ICON-07       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-FILTER-01: Verify that the filter modal allows users to filter Auto Events by capture type
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-FILTER-01       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-FILTER-02: Verify that closing the filter modal without clicking “Apply” does not change the filter
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-FILTER-02       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-FILTER-03: Verify that “Show all events” is selected by default when opening the filter modal
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-FILTER-03       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-FILTER-04: Verify that “Show all events” is selected by default when opening the filter modal
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...    - This test case verifies that when the filter modal is opened, the default selected option is “Show all events”
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-FILTER-04       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-01: Verify that system re-captures Tachy event with highest average HR
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-01       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-TACHY-04: Verify that auto Tachy is not displayed if an existing Tachy with same Event ID was previously captured
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-TACHY-RECAPTURE-TACHY-04       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
