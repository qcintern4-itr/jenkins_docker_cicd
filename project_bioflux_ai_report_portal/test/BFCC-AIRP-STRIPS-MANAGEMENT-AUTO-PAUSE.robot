...
Metadata    sid     BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE
...
Force Tags      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE  web
Test Timeout    30m

*** Test Cases ***
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-06: Verify that the Pause strips captured by the system are displayed correctly
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-06       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-ADD-01: Create the auto events with event type "Pause"
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: Create the auto events with event type "Pause"
    ...
    ...     Precondition:
    ...
    ...     2. Select the "Pause" Rhythm events
    ...     3. Capture the event
    ...     4. Navigate to "Strips Management" page
    ...     5. Click on "Pause" link
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-ADD-01      auto
    ...
    Navigate To Tab Menu Strips Management      menu=Pause
    ...
    Run Keyword And Continue On Failure    Should Be Equal      ${trigger_time}[Event type]         Pause
    Delete Events Strips Management
    Filter Strips Management        is_save=${True}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-01: Check the toolbar header in the "Pause" page working properly
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: The filters in the "Pause" page is: Delete, Include event in report, Include strip, Size, Hide excluded, Reload
    ...
    ...     Precondition:
    ...     - The user is on the AI report processing screen
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-01     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Pause
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-02: View the size option
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-02    auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Pause
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-EDIT-01: Verify the event when change the event to not marked "Include event in report"
    [Documentation]     Author: Thang Tran
    ...
...
#    ...     6. The event not displayed on page
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-EDIT-01     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Pause
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-EDIT-02:Verify the events when change the multiple event to not marked "Include event in report"
    [Documentation]     Author: Thang Tran
    ...
...
#    ...     6. The event not displayed on page
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-EDIT-02     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Pause
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-EDIT-03: Verify the event when change the event to not marked "Include strip"
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-EDIT-03      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Pause
    Select Strips Management On    row=2
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-EDIT-04: Verify the unmarked Include strip with the multiple events
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-EDIT-04      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Pause
    View Strips Management On    1, 2
    Filter Strips Management      include_strip=${False}
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-03: Verify the number event displayed on "Pause" page with different sizes
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-03     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Pause
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-04: Check the toolbar on "Edit Strip" event page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-04     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Pause
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-05: Can view the zoom in and zoom out on "Edit Strip" page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-05      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Pause
#    ${include_reports}       Get Strips Management
#    Run Keyword And Continue On Failure    Should Not Be Empty    ${include_reports}
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-06.: View the toolbar options on "Edit Strip" page
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]     BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-06.     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Pause
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-PAGINATION-01: Can next page by using Next/Previous button
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-PAGINATION-01    auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Pause
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-PAGINATION-02: Can next page by using Next/Previous by hotkey
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-PAGINATION-02      auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Pause
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-PAGINATION-03: Verify the pagination tool can manually input a number within the limit displayed on the page number
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Auto Create: 06/03/2024 - Thang Tran
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-PAGINATION-03     auto
    Navigate Airp Tab     tab=Strips Management
    Navigate To Tab Menu Strips Management      menu=Pause
#    ${strips_management}       Get Strips Management
#    Run Keyword And Continue On Failure    Should Not Be Empty    ${strips_management}
...
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-15: Check captured channel in strip management after recaptured event
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-15      manual    AIRP-1.9.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-15-1.12.0: Verify that the 'Strips Configuration' is displayed correctly on the Pause strip after completing the study
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-15-1.12.0       AIRP-1.12.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-41: Verify that the Pause strip automatically checks 'Include event in report' and 'Include strip in report' after completing the study
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-41      AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-62: Verify that Pause event strip automatically checks 'Include event in report' and 'Include strip in report' after capturing from ECG event tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/01/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-VIEW-62      AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-CONFIG-18: Verify the 'Strips Configuration' is not updated when the user changes the capture and configuration in the Edit Strip modal for the Pause event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-CONFIG-18       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-CONFIG-39: Verify the 'Strips Configuration' is not updated when the user has captured and modifies configuration from ECG events tab for Pause event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-CONFIG-39       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-CONFIG-59: Verify the 'Strips Configuration' is not updated when the user has just captured a strip from ECG events tab for Pause event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-CONFIG-59       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-CONFIG-84: Verify the 'Strips Configuration' is updated when the user changes the capture and configuration in the Edit Strip modal for the Pause event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-CONFIG-84       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-CONFIG-105: Verify the 'Strips Configuration' is updated when the user has captured and modifies configuration from ECG events tab for Pause event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-CONFIG-105       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-CONFIG-125: Verify the 'Strips Configuration' is updated when the user has just captured a strip from ECG events tab for Pause event
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Create date: 10/2/2024 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-CONFIG-125       AIRP-1.8.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

 BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-ICON-01: Verify that hovering over the “Re-capture” button displays a tooltip
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-ICON-01       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-ICON-02: Verify that hovering on the icon of auto events displays a tooltip
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-ICON-02       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-ICON-03: Verify that the auto-icon disappears after the user updates the technician comment in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-ICON-03       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-ICON-04: Verify that the auto-icon disappears after the user recaptures the strip in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-ICON-04       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-ICON-05: Verify that the auto-icon does not disappear after the user unchecks "Include Strip" in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-ICON-05       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-ICON-06: Verify that the auto-icon does not disappear after the user unchecks "Include event in report" in the Strip Management tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-ICON-06       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-ICON-07: Verify that the auto-icon disappears after the user updates the technician comment in the ECG Event tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-ICON-07       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-FILTER-01: Verify that the filter modal allows users to filter Auto Events by capture type
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-FILTER-01       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-FILTER-02: Verify that closing the filter modal without clicking “Apply” does not change the filter
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-FILTER-02       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-FILTER-03: Verify that “Show all events” is selected by default when opening the filter modal
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-FILTER-03       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-FILTER-04: Verify that “Show all events” is selected by default when opening the filter modal
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...    - This test case verifies that when the filter modal is opened, the default selected option is “Show all events”
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-FILTER-04       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-01: Verify that system re-captures Pause event with the longest duration
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-01       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-04: Verify that auto Pause is not displayed if an existing Pause with same Event ID was previously captured
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    [Tags]      BFCC-AIRP-STRIPS-MANAGEMENT-AUTO-PAUSE-RECAPTURE-04       AIRP-1.16.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
