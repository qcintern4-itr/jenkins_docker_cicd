...
Metadata    sid     BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS
...
Force Tags      BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS  web
Test Timeout    30m

*** Test Cases ***

BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS-01: Verify the list of manual event is sorted by captured time
    ...
    ...
    [Tags]      BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS-01       AIRP-1.13.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS-02: Verify that manual events are sorted by capture time, not triggered time
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...     Create date: 6/5/2025 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS-02       AIRP-1.13.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS-03: Verify that auto device events are sorted by capture time, not triggered time
    [Documentation]     Author: Trinh Nguyen
    ...
 ...     Description:
    ...
    ...     Create date: 6/5/2025 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS-03       AIRP-1.13.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS-04: Verify that auto AI events (e.g., AFib) are sorted by capture time, not triggered time
    [Documentation]     Author: Trinh Nguyen
    ...
        ...     Description:
    ...
    ...     Create date: 6/5/2025 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS-04       AIRP-1.13.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS-05: Verify that auto AI events of different types (e.g., Tachy and Brady) are sorted by capture time, not triggered time
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...     Create date: 6/5/2025 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS-05       AIRP-1.13.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS-06: Verify that auto AI and auto device events of different types are sorted by capture time when captured times are close
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS-06       AIRP-1.13.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS-07: Verify that auto AI and manual device events are sorted by capture time when captured times are close
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...     Create date: 7/5/2025 - Trinh Nguyen
    ...
    [Tags]      BFCC-AIRP-PDF-REPORT-SAMPLE-STRIPS-07       AIRP-1.13.0       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
