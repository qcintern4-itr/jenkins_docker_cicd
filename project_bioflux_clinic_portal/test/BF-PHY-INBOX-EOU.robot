*** Settings ***
Documentation   Test Suite - Clinic Portal - EOU Inbox page
Metadata    sid     BF-PHY-INBOX-EOU
...
Force Tags      BF-PHY-INBOX-EOU        web
Test Timeout    15m

*** Test Cases ***
BF-PHY-INBOX-EOU-VIEW-01: View the EOU reports screen
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     Description: The user can view the EOU reports screen in the Inbox list
    ...
    ...     Precondition:
    ...     - The user is on the INBOX page in the Clinic Portal
    ...
    ...     Test Steps:
    ...     1. Click the EOU reports tab of the INBOX page
    ...     2. Observe the EOU report screen
    ...
    ...     Expected Results:
    ...     1. On the side navigation menu, the EOU reports tab shall have a label indicating the number
    ...     of unread reports
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-01        auto    R1
    Navigate To Inbox
...
BF-PHY-INBOX-EOU-VIEW-02: Quick access Patient ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-02       auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=End of Use reports
...
BF-PHY-INBOX-EOU-VIEW-03: Quick access Study ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-03       auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=End of Use reports
    ${reports}      Get Reports On Page
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BF-PHY-INBOX-EOU-VIEW-04: EOU - Check case the recently sent EOU report has been marked as an Artifact report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-04       auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=End of Use reports      status_report=All
    ${reports}      Get All Reports On Page
    ${study_ids}     Evaluate    [item['Study ID'] for item in ${reports} if item['Artifact'] == ${True}]
...
BF-PHY-INBOX-EOU-VIEW-05: Check case there is a green lable with the Biodirect label title on studies if running the Biodirect service
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-05       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-VIEW-06: Check case there is no report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-06       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-VIEW-07: Check case a study is deleted by a clinic user
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-07       auto       R1
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
...
BF-PHY-INBOX-EOU-VIEW-08: Check case a study is aborted by a Call Center user
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-08       auto       R1
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
    Filter Inbox    search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[aborted_study_id]
    ${eou_report}       Get All Reports On Page
    Run Keyword And Continue On Failure    Should Be Empty    ${eou_report}
BF-PHY-INBOX-EOU-VIEW-09: The message is displayed for studies with a duration of less than 10 days
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...     The message is displayed for studies with a duration of less than 10 days in End of Use report
    ...
    ...     Precondition:
    ...     Study with a duration of less than 10
    ...
    ...     Test Steps:
    ...     1. User on EOU report in this study
    ...
    ...     Expected Results:
    ...     1. The message is displayed for studies with a duration of less than 10 days in the End of Use Report.
    ...


    [Tags]  BF-PHY-INBOX-EOU-VIEW-09       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-FILTER-FACILITY-01: View the name of the facility in case the user only associates with one facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    ...
    ...     Test Steps:
    ...     1. Click the End of Use reports reports tab of the INBOX page
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-FACILITY-01    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Inbox
#    Navigate To Report Type    End of Use reports
...
BF-PHY-INBOX-EOU-FILTER-FACILITY-02: Filter by facility in case the user associates with multiples facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    ...     Test Steps:
    ...     1. Click the End of Use reports tab of the INBOX page
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-FACILITY-02     auto    R1
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
...
BF-PHY-INBOX-EOU-PAGINATION-01: Navigate to the next page
    [Documentation]      Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-PAGINATION-01      auto    R1
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
...
BF-PHY-INBOX-EOU-PAGINATION-02: Navigate to the previous page
    [Documentation]      Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-PAGINATION-02      auto    R1
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
    Filter Inbox        status_report=All
...
BF-PHY-INBOX-EOU-SORT-01: Sort the report lists on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-INBOX-EOU-SORT-01       auto
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
...
BF-PHY-INBOX-EOU-FILTER-PRIORITY-01: Filter the report lists by priority on the Inbox page
    [Documentation]  Author: Trinh Nguyen
...
#    ...     4. If there is no report, a message will be displayed: “There is no data to display”
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-PRIORITY-01     auto       R1
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
    Filter Inbox    status_report=All
...
BF-PHY-INBOX-EOU-SEARCH-01: View all search attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-INBOX-EOU-SEARCH-01      auto
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
...
BF-PHY-INBOX-EOU-SEARCH-04: Search by Patient ID attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-INBOX-EOU-SEARCH-04      auto       R1
    [Template]    Search Reports
    End of Use reports    Patient ID
    
BF-PHY-INBOX-EOU-SEARCH-06: Search for report with existing study ID
    ...
    ...     4. Enter a valid study ID that has EOU report
    ...
    ...     Expected Results:
    ...     The report list shall be filtered and displayed accordingly with the entered Study ID
    ...
    ...    **Others**
    ...    Update date: 03/28/2025-Nhan Nguyen (auto)

    [Tags]  BF-PHY-INBOX-EOU-SEARCH-06     auto
    [Template]    Search Reports    
    End of Use reports    Study ID

BF-PHY-INBOX-EOU-SEARCH-08: Search by Patient Name with existing Patient on system
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    ...     **Others**
    ...     - Update date: 05/15/2025-Nhan Nguyen (auto)

    [Tags]  BF-PHY-INBOX-EOU-SEARCH-08      auto       CP-2.16.7
    [Template]    Search Reports
    End of Use reports    Patient name

BF-PHY-INBOX-EOU-SEARCH-09: Check message displayed with non-existent reports when Search by Patient Name/Study ID/Patient ID
    [Documentation]  Author: Nhan Nguyen
    ...     Description: The user can search by Patient attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    ...     1. Click the EOU reports tab of the INBOX page
    ...     2. Click the search option icon
    ...     3. Select search option (Patient Name/Study ID/Patient ID)
    ...     4. Enter the search input in the search field
    ...
    ...     Expected Results:
    ...
    [Tags]  BF-PHY-INBOX-EOU-SEARCH-09     auto
    [Template]    Search Reports With Non-Existent
    End of Use reports    Patient name    No name
    End of Use reports    Study ID    123
    End of Use reports    Patient ID    Nonexistent

BF-PHY-INBOX-EOU-VIEW-DETAILS-01: View details of EOU report in the list
    [Documentation]     Author: Trinh Nguyen
...
#    ...     - An artifact tag
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-DETAILS-01        auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=End of Use reports      status_report=All
    ${reports}      Get All Reports On Page
...
#    Run Keyword And Continue On Failure     Should Be True     ${items}[save button]
    Run Keyword And Continue On Failure     Should Be True     ${items}[add signature button]       # This button is not showed for technician

BF-PHY-INBOX-EOU-VIEW-DETAILS-02-CP2.24.2: View EOU details-Display text notify about Diagnostics Yield in case of study duration less than 10d
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-DETAILS-02-CP2.24.2       manual     R1       CP-2.24.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-VIEW-DETAILS-02: MCT study/EOU old report format-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-DETAILS-02       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-VIEW-DETAILS-03: MCT study/EOU new report format-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-DETAILS-03       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-VIEW-DETAILS-04: MCT Peek study/EOU old report format-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-DETAILS-04       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-VIEW-DETAILS-05: MCT Peek study/EOU new report format-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-DETAILS-05       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-VIEW-DETAILS-06: Holter/Ext.Holter study/EOU old report format-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-DETAILS-06       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-VIEW-DETAILS-08: Holter/Ext.Holter study/EOU new report format-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-DETAILS-08       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-VIEW-DETAILS-09: Cardiac Event study/EOU old report format-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-EOU-VIEW-DETAILS-09       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-REVIEWED-01: Mark a report sent by the Call center as reviewed
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-REVIEWED-01        auto
    Navigate To Inbox
    Filter Inbox    report_type=End of Use reports     priority=All priority
    ${reports}      Get Reports On Page
    ${study_ids}     Evaluate    [item['Study ID'] for item in ${reports} if item['Artifact'] == ${False}]
    ${random_study_id}     Evaluate    random.choice(${study_ids})    random
    Filter Inbox    search_by=Study ID      text_search=${random_study_id}
...
BF-PHY-INBOX-EOU-REVIEWED-02: Mark a report sent by the Call center as not reviewed
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-REVIEWED-02       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-DOWNLOAD-01: Download PDF file
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-DOWNLOAD-01       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-COMMENT-01: Input physician interpretation to PDF reports in case report has not physician interpretation before
    [Documentation]   Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-COMMENT-01       manual    R1    CP-2.28.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    # verify comment at input field, PDF: TDB
#    Navigate To Inbox
#    Filter Inbox     report_type=End of Use reports     priority=Urgent
#    Select Report    row=1
...
#    [Teardown]      Clear Comment Text     End of Use reports     Urgent

BF-PHY-INBOX-EOU-COMMENT-02: Input physician interpretation to PDF reports in case report already has physician interpretation
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The user can Input physician interpretation to PDF reports
    ...
    ...
    ...     **Others
    ...     Update date: 2/11/2025 - Tam Ho
    [Tags]  BF-PHY-INBOX-EOU-COMMENT-02       manual    R1    CP-2.28.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Inbox
#    Filter Inbox     report_type=End of Use reports    priority=High
#    ${reports}      Get Reports On Page
#    ${text}         Evaluate    '${reports}[0][Study ID]'.split()[0].strip()
#    Filter Inbox     report_type=End of Use reports    priority=High      search_by=Study ID      text_search=${text}
#    Select Report    row=1
#    Open Add Interpretation Dialog
...
#    [Teardown]    Clear Comment Text    End of Use reports    High   Study ID    ${text}

BF-PHY-INBOX-EOU-SIGN-01: Add a signature to a PDF report
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    ...     **Others
    ...     Update date: 2/11/2025 - Tam Ho
   [Tags]  BF-PHY-INBOX-EOU-SIGN-01       manual       R1    CP-2.28.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-FILTER-STATUS-01: Check default report status is New, Downloaded, Reviewed, Interpreted
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-STATUS-01       manual      CP-2.22.0   R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BF-PHY-INBOX-EOU-FILTER-STATUS-02: Filter by Report status is New
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-STATUS-02       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-FILTER-STATUS-03: Filter by Report status is Downloaded
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-STATUS-03       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-FILTER-STATUS-04: Filter by Report status is Reviewed
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-STATUS-04       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-FILTER-STATUS-05: Filter by Report status is Interpreted
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-STATUS-05       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-FILTER-STATUS-06: Filter by Report status is Interpreted
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-STATUS-06       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-FILTER-STATUS-07: Filter by Report status is Signed
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-STATUS-07       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BF-PHY-INBOX-EOU-FILTER-STATUS-08: Filter by Report status is Completed
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-STATUS-08       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-FILTER-STATUS-09: Filter by Report status will be applied for other tabs (except All reports)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-STATUS-09       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-EOU-FILTER-STATUS-10: Filter by multiple Report statuses
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-STATUS-10       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BF-PHY-INBOX-EOU-FILTER-STUDIES-01: Check default study filter status is Your studies
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-STUDIES-01       manual      CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BF-PHY-INBOX-EOU-FILTER-STUDIES-02: Filter reports by All studies
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-STUDIES-02      manual      CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BF-PHY-INBOX-EOU-FILTER-STUDIES-03: Switch studies filter between Your studies and All studies
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-EOU-FILTER-STUDIES-03      manual      CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
Filter EOU Reports
    ...
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
    Filter Inbox    report_type=End of Use reports      priority=${priority}        search_by=${search_by}
    ${reports}       Get Reports On Page
    ${text}          Set Variable If
    ...  '${search_by}' != '${EMPTY}' and '${search_by.lower()}' == 'patient name'       Patient API Test
    ...
    Filter Inbox    report_type=End of Use reports      priority=${priority}        search_by=${search_by}      text_search=${text}
    ${reports}       Get All Reports On Page
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}     No reports found - with text search ${search_by} `${text}`
    Run Keyword If   '${priority.lower()}' != 'all priority'
...
Filter Priority All Reports with priority "${priority}"
    Filter Inbox    report_type=End of Use reports      priority=${priority}
    ${reports}       Get All Reports On Page
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
