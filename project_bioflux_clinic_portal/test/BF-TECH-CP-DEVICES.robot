...
Metadata    sid     BF-TECH-CP-DEVICES
...
Force Tags      BF-TECH-CP-DEVICES      web
Test Timeout    1h

*** Test Cases ***

BF-TECH-CP-DEVICES-VIEW-ALL-01: View all subtabs in All Devices page
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-01      auto    R1
    Navigate To Devices
    Navigate To Devices Tab    All Devices
    ${sub_tab}      Get Devices Subtabs
    Run Keyword And Continue On Failure    Should Be Equal    ${sub_tab}[0]     In Study
    Run Keyword And Continue On Failure    Should Be Equal    ${sub_tab}[1]     Awaiting upload
    Run Keyword And Continue On Failure    Should Be Equal    ${sub_tab}[2]     Not in study
    Run Keyword And Continue On Failure    Should Be Equal    ${sub_tab}[3]     RMA
    Run Keyword And Continue On Failure    Should Be Equal    ${sub_tab}[4]     All devices

BF-TECH-CP-DEVICES-VIEW-ALL-02: View In study subtab in All Devices page
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-02      auto
...
BF-TECH-CP-DEVICES-VIEW-ALL-03: Sort the In study devices running studies by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-03       auto
    Navigate To Devices
    Filter Devices    devices_tab=All Devices       devices_subtab=In Study
    Select Facility    All facilities
    ${devices}        Get All Devices
...
BF-TECH-CP-DEVICES-VIEW-ALL-04: Check pagination tool works properly in In Study tab
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-04       manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-DEVICES-VIEW-ALL-05: View Awaiting Upload subtab in All Devices page
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-05       manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-DEVICES-VIEW-ALL-06: Sort the Awaiting Upload devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-06       auto
    Navigate To Devices
...
BF-TECH-CP-DEVICES-VIEW-ALL-07: Check pagination tool works properly in Awaiting Upload tab
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-07       manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-DEVICES-VIEW-ALL-08: View Not In Study subtab in All Devices page
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-08       auto    R1
    Navigate To Devices
...
BF-TECH-CP-DEVICES-VIEW-ALL-09: Sort the Not In Study devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-09      auto
    Navigate To Devices
    Filter Devices    devices_tab=All Devices       devices_subtab=Not In Study
    Select Facility    All facilities
    # sort descending
...
BF-TECH-CP-DEVICES-VIEW-ALL-10: Check pagination tool works properly in Not In Study tab
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-10       manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-DEVICES-VIEW-ALL-11: View RMA subtab in All Devices page
    [Documentation]     Author: Nhan Nguyen
    ...
...
#    ...     the device will be removed from the list (as it is no longer assigned to the clinic)
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-11      auto    R1
    Navigate To Devices
...
BF-TECH-CP-DEVICES-VIEW-ALL-12: Sort the RMA devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-12       auto
    Navigate To Devices
    Filter Devices    devices_tab=All Devices       devices_subtab=RMA
    Select Facility    All facilities
    # sort descending
...
BF-TECH-CP-DEVICES-VIEW-ALL-13: Check pagination tool works properly in RMA tab
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-13       manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-DEVICES-VIEW-ALL-14: View All subtab in All Devices page
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-14      auto    R1
    Navigate To Devices
...
BF-TECH-CP-DEVICES-VIEW-ALL-15: Sort the All devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-15       auto
    Navigate To Devices
    Filter Devices    devices_tab=All Devices       devices_subtab=All devices
    # sort descending
    ${devices}        Get All Devices
...
BF-TECH-CP-DEVICES-VIEW-ALL-16: Check pagination tool works properly in All tab
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-ALL-16       auto    R1
    Navigate To Devices
    Filter Devices    devices_tab=All devices       devices_subtab=All devices
    ${devices}        Get Devices On Page
    Run Keyword And Continue On Failure    Should Not Be Empty    ${devices}       No Devices found
    ${default_size}     Get Devices Current Pagination
    Run Keyword And Continue On Failure    Should Be Equal    ${default_size}[Rows]     10 per page
    Run Keyword And Continue On Failure    Should Be Equal    ${default_size}[Page]     1
    Run Keyword And Continue On Failure    Length Should Be   ${devices}                10
    Pagination Devices    next_or_previous=next
    ${default_size}     Get Devices Current Pagination
    Run Keyword And Continue On Failure    Should Be Equal    ${default_size}[Page]     2
    ...
    ${default_size}     Get Devices Current Pagination
    ${devices}        Get Devices On Page
    Run Keyword And Continue On Failure    Should Be Equal    ${default_size}[Rows]     30 per page
    Run Keyword And Continue On Failure    Should Be Equal    ${default_size}[Page]     1
    Run Keyword And Continue On Failure    Length Should Be   ${devices}                30
    Custom Devices Size Per Page    rows=50 per page
    ${default_size}     Get Devices Current Pagination
    Run Keyword And Continue On Failure    Should Be Equal    ${default_size}[Rows]     50 per page
    Run Keyword And Continue On Failure    Should Be Equal    ${default_size}[Page]     1

BF-TECH-CP-DEVICES-VIEW-INACTIVE-01: View Lost/Inactive devices page
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-INACTIVE-01       auto
    Navigate To Devices
...
BF-TECH-CP-DEVICES-VIEW-INACTIVE-02: Sort the Lost/Inactive devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-INACTIVE-02       auto
    Navigate To Devices
...
BF-TECH-CP-DEVICES-VIEW-INACTIVE-03: Check pagination tool works properly in Lost/Inactive tab
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-INACTIVE-03      auto    R1
    Navigate To Devices
    Filter Devices    devices_tab=Lost/Inactive
    Select Facility    All facilities
    ${devices}        Get Devices On Page
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-01: View All/Unused devices page
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-01       auto    R1
    Navigate To Devices
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-02: Sort the All/Unused devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-02       auto
    Navigate To Devices
    Filter Devices    devices_tab=Unused     devices_subtab=All time
    Select Facility    All facilities
    # sort descending
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-03: Check pagination tool works properly in All/Unused tab
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-03     auto    R1
    Navigate To Devices
    Filter Devices    devices_tab=Unused       devices_subtab=All time
    ${devices}        Get Devices On Page
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-04: View 1month/Unused devices page
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-04       auto    R1
    Navigate To Devices
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-05: Sort the 1month/Unused devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-05       auto
    Navigate To Devices
    Filter Devices    devices_tab=Unused     devices_subtab=1 month
    Select Facility    All facilities
    # sort descending
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-06: Check pagination tool works properly in 1month/Unused tab
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-06       auto
    Navigate To Devices
    Filter Devices    devices_tab=Unused     devices_subtab=1 month
    Select Facility    All facilities
    ${devices}        Get Devices On Page
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-07: View 2months/Unused devices page
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-07       auto
    Navigate To Devices
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-08: Sort the 2months/Unused devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-08       auto
    Navigate To Devices
    Filter Devices    devices_tab=Unused     devices_subtab=2 months
    Select Facility    All facilities
    # sort descending
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-09: Check pagination tool works properly in 2months/Unused tab
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-09       auto
    Navigate To Devices
    Filter Devices    devices_tab=Unused     devices_subtab=2 months
    Select Facility    All facilities
    ${devices}        Get Devices On Page
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-10: View 3months/Unused devices page
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-10       auto
    Navigate To Devices
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-11: Sort the 3months/Unused devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-11        auto
    Navigate To Devices
    Filter Devices    devices_tab=Unused     devices_subtab=3 months
    Select Facility    All facilities
    # sort descending
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-12: Check pagination tool works properly in 3months/Unused tab
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-12       auto    R1
    Navigate To Devices
    Filter Devices    devices_tab=Unused       devices_subtab=3 months
    ${devices}        Get Devices On Page
    Run Keyword And Continue On Failure    Should Not Be Empty    ${devices}       No Unused Devices found
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-13: View 6months/Unused devices page
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-13       auto
    Navigate To Devices
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-14: Sort the 6months/Unused devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-14      auto
    Navigate To Devices
    Filter Devices    devices_tab=Unused     devices_subtab=3 months
    Select Facility    All facilities
    # sort descending
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-15: Check pagination tool works properly in 6months/Unused tab
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-15       auto    R1
    Navigate To Devices
    Filter Devices    devices_tab=Unused       devices_subtab=6 months
    ${devices}        Get Devices On Page
    Run Keyword And Continue On Failure    Should Not Be Empty    ${devices}       No Unused Devices found
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-16: View 1year/Unused devices page
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-16       auto
    Navigate To Devices
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-17: Sort the 1year/Unused devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-17       auto
    Navigate To Devices
    Filter Devices    devices_tab=Unused     devices_subtab=1 year
    Select Facility    All facilities
    # sort descending
...
BF-TECH-CP-DEVICES-VIEW-UNUSED-18: Check pagination tool works properly in 1year/Unused tab
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-VIEW-UNUSED-18      auto    R1
    Navigate To Devices
    Filter Devices    devices_tab=Unused       devices_subtab=1 year
    ${devices}        Get Devices On Page
    Run Keyword And Continue On Failure    Should Not Be Empty    ${devices}       No Unused Devices found
...
BF-TECH-CP-DEVICES-SEARCH-01: Search on device list
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-SEARCH-01        auto    R1
    Navigate To Devices
    Filter Devices    devices_tab=All devices    devices_subtab=All devices
    ${current_filter}       Get Devices Current Filter
...
BF-TECH-CP-DEVICES-SEARCH-02: No result found on device list
    ...
    [Tags]      BF-TECH-CP-DEVICES-SEARCH-02         auto
    Navigate To Devices
    Filter Devices    devices_tab=All devices    devices_subtab=All devices
    ${current_filter}       Get Devices Current Filter
    Run Keyword And Continue On Failure    Should Be Equal    Search by ${current_filter}[Search By]      Search by Device ID  # Verify placehoder at search field
...
BF-TECH-CP-DEVICES-FILTER-FACILITY-01: Filter by facility
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-FILTER-FACILITY-01       auto
    Navigate To Devices
    Filter Devices    devices_tab=All devices    devices_subtab=All devices
    # Default
    ${current_filter}       Get Devices Current Filter
...
BF-TECH-CP-DEVICES-FILTER-MODEL-01: Filter by model
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-FILTER-MODEL-01      auto    R1
    Navigate To Devices
    Filter Devices    devices_tab=All devices    devices_subtab=All devices
    ...
    ${filter_options}           Get Devices Filter Options
    Run Keyword And Continue On Failure    Should Be Equal        ${filter_options}[Model][0]       All models
    Run Keyword And Continue On Failure    Should Be Equal        ${filter_options}[Model][1]       Bioflux
    Run Keyword And Continue On Failure    Should Be Equal        ${filter_options}[Model][2]       Biocore/Biotres
    # filter
...
BF-TECH-CP-DEVICES-QUICKACCESS-01: Quick access to device information
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-QUICKACCESS-01      auto   CP-2.23.0    R1
    Navigate To Devices
    Filter Devices    devices_tab=All devices       devices_subtab=All devices
    ${devices}      Get Devices On Page
...
BF-TECH-CP-DEVICES-QUICKACCESS-02: Quick access to device information for Biocore/Biocore Pro with FW HSR
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BF-TECH-CP-DEVICES-QUICKACCESS-02       manual    R1     CP-2.23.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
