...
Metadata    sid     BF-PHY-INBOX-NOTIFICATION
...
Force Tags      BF-PHY-INBOX-NOTIFICATION       web
Test Timeout    1h

*** Test Cases ***
BF-PHY-INBOX-NOTIFICATION-VIEW-01: View the Notification reports screen
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-VIEW-01       auto       R1
    Navigate To Inbox
...
BF-PHY-INBOX-NOTIFICATION-VIEW-02: Quick access Patient ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-VIEW-02       auto       R1
    Navigate To Inbox
...
BF-PHY-INBOX-NOTIFICATION-VIEW-03: Quick access Study ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-VIEW-03       auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=Notification reports
    ${reports}      Get Reports On Page 2
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BF-PHY-INBOX-NOTIFICATION-VIEW-04: Check case there is a green lable with the Biodirect label title on studies if running the Biodirect service
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-VIEW-04       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-VIEW-05: Check case there is no report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-VIEW-05       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-VIEW-06: Check case a study is deleted by a clinic user
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-VIEW-06       auto       R1
    Navigate To Inbox
    Navigate To Report Type    Notification reports
...
BF-PHY-INBOX-NOTIFICATION-VIEW-07: Check case a study is aborted by a Call Center user
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-VIEW-07       auto       R1
    Navigate To Inbox
    Navigate To Report Type    Notification reports
...
BF-PHY-INBOX-NOTIFICATION-FILTER-FACILITY-01: View the name of the facility in case the user only associates with one facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-FACILITY-01        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Inbox
#    Navigate To Report Type    Notification reports
...
BF-PHY-INBOX-NOTIFICATION-FILTER-FACILITY-02: Filter by facility in case the user associates with multiples facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-FACILITY-02        auto       R1
    Navigate To Inbox
    Navigate To Report Type    Notification reports
...
BF-PHY-INBOX-NOTIFICATION-PAGINATION-01: Navigate to the next page
    [Documentation]      Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-PAGINATION-01     auto       R1
    Navigate To Inbox
    Navigate To Report Type    Notification reports
    Filter Inbox        status_report=All
...
BF-PHY-INBOX-NOTIFICATION-PAGINATION-02: Navigate to the previous page
    [Documentation]      Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-PAGINATION-02     auto       R1
    Navigate To Inbox
    Navigate To Report Type    Notification reports
    Filter Inbox        status_report=All
...
BF-PHY-INBOX-NOTIFICATION-SORT-01: Sort the report lists on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-SORT-01       auto
    Navigate To Inbox
    Navigate To Report Type    Notification reports
...
BF-PHY-INBOX-NOTIFICATION-FILTER-PRIORITY-01: Filter the report lists by priority on the Inbox page
    [Documentation]  Author: Trinh Nguyen
...
#    ...     4. If there is no report, a message will be displayed: “There is no data to display”
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-PRIORITY-01        auto       R1
    Navigate To Inbox
    Navigate To Report Type    Notification reports
    Filter Inbox    status_report=All
...
BF-PHY-INBOX-NOTIFICATION-SEARCH-01: View all search attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-SEARCH-01     auto
    Navigate To Inbox
    Navigate To Report Type    Notification reports
...
BF-PHY-INBOX-NOTIFICATION-SEARCH-02: Search by Patient Name attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
...
#    ...     4. A message will be displayed: “No result found”
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-SEARCH-02     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    [Template]    Filter Notification Reports  # Facing bug
#    All priority     Patient name

BF-PHY-INBOX-NOTIFICATION-SEARCH-03: Search by Study ID attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
...
#    ...     4. A message will be displayed: “No result found”
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-SEARCH-03     auto       R1
    [Template]    Search Reports
    Notification reports     Study ID

BF-PHY-INBOX-NOTIFICATION-SEARCH-04: Search by Patient ID attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The user can search by Study ID attributes on the Inbox page
    ...
    ...     Precondition:
...
#    ...     4. A message will be displayed: “No result found”
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-SEARCH-04     auto       R1
    [Template]    Search Reports
    Notification reports     Patient ID

BF-PHY-INBOX-NOTIFICATION-SEARCH-05: Search by Patient Name with existing Patient on system
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-SEARCH-05     auto
    [Template]    Search Reports
    Notification reports    Patient name

BF-PHY-INBOX-NOTIFICATION-SEARCH-06: Check message displayed with non-existent reports when Search by Patient Name/Study ID/Patient ID
    [Documentation]  Author: Nhan Nguyen
    ...     Description: The user can search by Patient attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-SEARCH-06     auto
    [Template]    Search Reports With Non-Existent
    Notification reports    Patient name    No name
    Notification reports    Study ID    123
    Notification reports    Patient ID    Nonexistent

BF-PHY-INBOX-NOTIFICATION-VIEW-DETAILS-01: View details of Notification report in the list
    [Documentation]     Author: Trinh Nguyen
...
#    ...     - An artifact tag
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-VIEW-DETAILS-01       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Inbox
#    Filter Inbox    report_type=Notification reports
#    ${reports}      Get Reports On Page
...
BF-PHY-INBOX-NOTIFICATION-VIEW-DETAILS-02: Notification-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-VIEW-DETAILS-02       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-VIEW-DETAILS-03: Notification-Download report
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-VIEW-DETAILS-03       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-VIEW-DETAILS-04: Event-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-VIEW-DETAILS-04       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-VIEW-DETAILS-05: Event-Download report
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-VIEW-DETAILS-05       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-REVIEWED-01: Mark a report sent by the Call center as reviewed
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-REVIEWED-01       auto       R1
    Navigate To Inbox
...
BF-PHY-INBOX-NOTIFICATION-REVIEWED-02: Mark a report sent by the Call center as not reviewed
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-REVIEWED-02       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-DOWNLOAD-01: Download PDF file
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-DOWNLOAD-01       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-COMMENT-01: Input physician interpretation to PDF reports in case report has not physician interpretation before
    [Documentation]   Author: Trinh Nguyen
    ...
   ...
   [Tags]  BF-PHY-INBOX-NOTIFICATION-COMMENT-01       manual    R1    CP-2.28.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
#    # Clear Text
#    [Teardown]    Clear Comment Text    Notification reports      Urgent

BF-PHY-INBOX-NOTIFICATION-COMMENT-02: Input physician interpretation to PDF reports in case report already has physician interpretation
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The user can Input physician interpretation to PDF reports
    ...
    ...
    ...     **Others
    ...     Update date: 2/11/2025 - Tam Ho
    [Tags]  BF-PHY-INBOX-NOTIFICATION-COMMENT-02       manual    R1    CP-2.28.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Inbox
...
BF-PHY-INBOX-NOTIFICATION-SIGN-01: Add a signature to a PDF report
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    ...     **Others
    ...     Update date: 2/11/2025 - Tam Ho
    [Tags]  BF-PHY-INBOX-NOTIFICATION-SIGN-01       manual       R1    CP-2.28.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-01: Check default report status is New, Downloaded, Reviewed, Interpreted
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-01       manual      CP-2.22.0   R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-02: Filter by Report status is New
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-02       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-03: Filter by Report status is Downloaded
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-03       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-04: Filter by Report status is Reviewed
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-04       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-05: Filter by Report status is Interpreted
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-05       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-06: Filter by Report status is Interpreted
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-06       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-07: Filter by Report status is Signed
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-07       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-08: Filter by Report status is Completed
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-08       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-09: Filter by Report status will be applied for other tabs (except All reports)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-09       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-10: Filter by multiple Report statused
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-STATUS-10       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-FILTER-STUDIES-01: Check default study filter status is Your studies
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-STUDIES-01       manual      CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-FILTER-STUDIES-02: Filter reports by All studies
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-STUDIES-02      manual      CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-NOTIFICATION-FILTER-STUDIES-03: Switch studies filter between Your studies and All studies
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-NOTIFICATION-FILTER-STUDIES-03      manual      CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
Filter Notification Reports
    ...
    ...  Run Keyword And Continue On Failure    Should Be True    all('${priority}' == r['Priority'] for r in ${reports})       Invalid results are showing - with textsearch `${priority}`
