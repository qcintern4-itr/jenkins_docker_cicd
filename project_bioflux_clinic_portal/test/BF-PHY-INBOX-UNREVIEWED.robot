...
Metadata    sid     BF-PHY-INBOX-UNREVIEWED
...
Force Tags      BF-PHY-INBOX-UNREVIEWED       web
Test Timeout    1h

*** Test Cases ***
BF-PHY-INBOX-UNREVIEWED-VIEW-01: View the Unreviewed reports screen
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-VIEW-01       manual       R1       CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-VIEW-02: Quick access Patient ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-VIEW-02       manual       R1       CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-VIEW-03: Quick access Study ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-VIEW-03       manual       R1       CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-VIEW-04: Check case there is a green lable with the Biodirect label title on studies if running the Biodirect service
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-VIEW-04       manual       R1       CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-VIEW-05: Check case there is no report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-VIEW-05       manual       R3       CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-VIEW-06: Check case a study is aborted by a Call Center user
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-VIEW-06       manual       R2       CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-VIEW-07: Check report is auto-generated and displayed if available and not artifact
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-VIEW-07       manual       R1       CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-VIEW-08: Check report not displayed if available and artifact
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-VIEW-08       manual       R1       CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-VIEW-09: Check report not displayed if not available
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-VIEW-09       manual       R1       CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-FILTER-FACILITY-01: View the name of the facility in case the user only associates with one facility
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-FILTER-FACILITY-01       manual     R2      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-FILTER-FACILITY-02: Filter by facility in case the user associates with multiple facilities
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-FILTER-FACILITY-02       manual     R2      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-PAGINATION-01: Navigate to the next page
    [Documentation]      Author: Nhan Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-PAGINATION-01       manual     R1      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-PAGINATION-02: Navigate to the previous page
    [Documentation]      Author: Nhan Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-PAGINATION-02       manual     R1      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-SORT-01: Sort the report lists on the Inbox page
    [Documentation]  Author: Nhan Nguyen
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-SORT-01       manual     R1      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-SEARCH-01: View all search attributes on the Inbox page
    [Documentation]  Author: Nhan Nguyen
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-SEARCH-01      manual     R1      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-SEARCH-02: Search by Patient Name attributes on the Inbox page
    [Documentation]  Author: Nhan Nguyen
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-SEARCH-02       manual     R1      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-SEARCH-03: Search by Study ID attributes on the Inbox page
    [Documentation]  Author: Nhan Nguyen
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-SEARCH-03       manual     R1      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-SEARCH-04: Search by Patient ID attributes on the Inbox page
    [Documentation]  Author: Nhan Nguyen
    ...     Description: The user can search by Study ID attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-SEARCH-04       manual     R1      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-VIEW-DETAILS-01: View details of Unreviewed report in the list
    [Documentation]     Author: Nhan Nguyen
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-VIEW-DETAILS-01      manual      R1      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-VIEW-DETAILS-02: View details of Unreviewed report-Open Study Management
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...     Precondition:
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-VIEW-DETAILS-02      manual      R1      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-DOWNLOAD-01: Download PDF file
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-DOWNLOAD-01       manual    R1      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-COMMENT-01: Input physician interpretation to PDF reports in case report has not physician interpretation before
    [Documentation]   Author: Nhan Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-COMMENT-01       manual    R1      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-COMMENT-02: Edit physician interpretation to PDF reports in case report already has physician interpretation
    [Documentation]   Author: Nhan Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-COMMENT-02       manual    R1      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-UNREVIEWED-SIGN-01: Add a signature to a PDF report
    [Documentation]  Author: Nhan Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-UNREVIEWED-SIGN-01       manual    R1      CP-2.24.0    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
