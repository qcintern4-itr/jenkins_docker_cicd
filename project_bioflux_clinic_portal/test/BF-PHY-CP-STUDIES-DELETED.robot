...
Metadata    sid     BF-PHY-CP-STUDIES-DELETED
...
Force Tags      BF-PHY-CP-STUDIES-DELETED       web
Test Timeout    1h

# Facing bug: https://itrvn.atlassian.net/browse/BF-3368
*** Test Cases ***
BF-PHY-CP-STUDIES-DELETED-VIEW-01: View a list of deleted studies
...
#    ...     - The user shall be able to navigate between loaded pages by pressing the [Next] button to load more reports
    ...
    [Tags]  BF-PHY-CP-STUDIES-DELETED-VIEW-01       auto    R1
...
BF-PHY-CP-STUDIES-DELETED-FILTER-FACILITY-01: View the name of the facility in case the user only associates with one facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-DELETED-FILTER-FACILITY-01       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-DELETED-FILTER-FACILITY-02: Select a specific facility in case the user associates with multiples facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-DELETED-FILTER-FACILITY-02        auto
    Navigate To Studies Page
    Filter Studies    study_state=Deleted
...
BF-PHY-CP-STUDIES-DELETED-SEARCH-01: View all search attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-DELETED-SEARCH-01     auto
    Navigate To Studies Page
    Filter Studies    study_state=Deleted
...
BF-PHY-CP-STUDIES-DELETED-SEARCH-02: Search by Patient Name attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     4. All entered text will be deleted
     ...
     [Tags]  BF-PHY-CP-STUDIES-DELETED-SEARCH-02        manual
     Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    [Template]    Filter Deleted - Studies
#    Patient Name

BF-PHY-CP-STUDIES-DELETED-SEARCH-03: Search by Study ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-DELETED-SEARCH-03     auto
    [Template]    Filter Deleted - Studies
    Study ID

BF-PHY-CP-STUDIES-DELETED-SEARCH-04: Search by Patient ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The user can search by Study ID attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-DELETED-SEARCH-04     auto
    [Template]    Filter Deleted - Studies
    Patient ID

BF-PHY-CP-STUDIES-DELETED-SEARCH-05: Search by Device ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-DELETED-SEARCH-05     auto
    [Template]    Filter Deleted - Studies
    Device ID

BF-PHY-CP-STUDIES-DELETED-RESTORE-01: Restore deleted studies
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-DELETED-RESTORE-01        auto    R1
    Navigate To Studies Page
    Filter Studies      study_state=Deleted
    ...
    Run Keyword And Continue On Failure    Should Be Equal    ${message}       Study ${study_id} is restored  # FACING BUG: study id (Study 6632 is restored != Study 06632 is restored)
...
BF-PHY-CP-STUDIES-DELETED-QUICK-ACCESS-01: Quick access to patient info
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Expected Results:
    ...
    [Tags]  BF-PHY-CP-STUDIES-DELETED-QUICK-ACCESS-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-DELETED-QUICK-ACCESS-02: Quick access to device info
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-DELETED-QUICK-ACCESS-02     manual      CP-2.23.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
Filter Deleted - Studies        # Incase of relative check device ID -> Can not handle data before test
    ...
    ...  Run Keyword And Continue On Failure    Should Be True    all('${text_search}'.lower() in f['Patient ID'].lower() for f in ${studies})      Invalid results are showing - with text search ${text_search}
    Run Keyword If    '${search_by}'.lower() == 'device id'
    ...  Run Keyword And Continue On Failure    Should Be True    all('${text_search}'.lower() in f['Device ID'] for f in ${studies})       Invalid results are showing - with text search ${text_search}
...
Delete Study
    ...
    Filter Studies      search_by=Study ID     text_search=${study_id}
    ${studies}        Get Completed Studies
    Run Keyword And Continue On Failure    Should Be Empty    ${studies}      No study matching ${study_id}
    Filter Studies      study_state=Deleted
    ${del_studies}      Get Deleted Studies
