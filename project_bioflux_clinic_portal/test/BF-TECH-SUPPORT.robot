...
Force Tags      BF-TECH-SUPPORT     web
Test Timeout    1h

*** Test Cases ***
BF-TECH-SUPPORT-VIEW-01: View a Customer Support page
    ...
    [Tags]  BF-TECH-SUPPORT-VIEW-01  CP-2.12.0      auto
    Navigate To Support
...
BF-TECH-SUPPORT-VIEW-02: View list of support requests
    [Documentation]   Author: Trinh Nguyen
    ...
    ...
    ...
    ...     Expected Results:
    ...     1. The user shal be able to view a list of support request. The list contains the following attributes:
    ...     - Request ID
    ...     - Status:
    ...     + Open
    ...     + Resolved
    ...
    ...     3. There shall be filters for the user to filter the list by desired value:
    ...     - Status filter - the user can selecr 1 among:
    ...     + All statused
    ...     + Open
    ...     + Resolved
    ...     - Category filter:
    ...
    [Tags]  BF-TECH-SUPPORT-VIEW-02  CP-2.12.0      auto
    Navigate To Support
...
BF-TECH-SUPPORT-SEARCH-01: Search in Support Request list by Request ID
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-SUPPORT-SEARCH-01  CP-2.12.0        auto
    Navigate To Support
    Navigate To Support Menu    Support request
...
BF-TECH-SUPPORT-FILTER-01: Filter the request list by the Status filter
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-SUPPORT-FILTER-01  CP-2.12.0        auto
    [Template]    Filter Support - Request
    Resolved
    Open
    All statuses

BF-TECH-SUPPORT-FILTER-02: Filter the request list by the Category filter
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-SUPPORT-FILTER-02       CP-2.12.0        auto
    [Template]    Filter Support - Request
    ...
    ${EMPTY}      Others                ${EMPTY}
    ${EMPTY}      All categories        ${EMPTY}
    ${EMPTY}      Abort study           ${EMPTY}

BF-TECH-SUPPORT-PAGINATION-01: Check pagination tool works properly in Support request
    ...
    [Tags]     BF-TECH-SUPPORT-PAGINATION-01     manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-SUPPORT-MATERIALS-VIEW-01: View list of sub-tabs on the Support Materials page
    [Documentation]   Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-VIEW-01  CP-2.11.0        manual      R1    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Support
...
BF-TECH-SUPPORT-MATERIALS-VIEW-DETAILS-01: View details of the Onboarding guide sub-tab
    [Documentation]   Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-VIEW-DETAILS-01  CP-2.11.0     manual      R1    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Support
#    Navigate To Support Menu    Support modules
...
BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-01: Download PDF file-Onboarding guide of Bioflux
    [Documentation]   Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-01     manual    deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-02: Download PDF file-Onboarding guide of Bioflux
    [Documentation]   Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-02  CP-2.11.0     manual    deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-SUPPORT-MATERIALS-VIEW-DETAILS-02: View details of the Features Manual sub-tab
    [Documentation]   Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-VIEW-DETAILS-02  CP-2.11.0   manual      R1    deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Support
#    Navigate To Support Menu    Support modules
#    ${subtabs}      Get Support Materials Filter Options
...
BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-03: Download PDF file-Features manual
    [Documentation]   Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-03  CP-2.11.0     manual    deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-SUPPORT-MATERIALS-VIEW-DETAILS-03: View details of the Instructions For Use sub-tab
    [Documentation]   Author: Trinh Nguyen
    ...
    ...
    ...     Test Steps:
    ...     1. Click on the Instruction For Use sub-tab
    ...     2. Observe the screen
    ...
    ...     Expected Results:
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-VIEW-DETAILS-03  CP-2.11.0    manual      R1    deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Support
#    Navigate To Support Menu    Support modules
#    ${subtabs}      Get Support Materials Filter Options
...
BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-04: Download PDF file-Instruction for use of Bioflux
    [Documentation]   Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-04  CP-2.11.0     manual    deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-05: Download PDF file-Instruction for use of Biocore/Biotres
    [Documentation]   Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-05  CP-2.11.0     manual    deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-SUPPORT-MATERIALS-VIEW-DETAILS-04: View details of the Patient Manual sub-tab
    [Documentation]   Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-VIEW-DETAILS-04  CP-2.11.0    manual      R1    deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Support
#    Navigate To Support Menu    Support modules
#    ${subtabs}      Get Support Materials Filter Options
...
BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-06: Download PDF file-Patien manual of Bioflux
    [Documentation]   Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-06  CP-2.11.0     manual    deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-07: Download PDF file-Patien manual of Biocore/Biotres
    [Documentation]   Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-07  CP-2.11.0     manual    deactive    
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-SUPPORT-MATERIALS-VIEW-DETAILS-05: View details of the Patient Quick Guide sub-tab
    [Documentation]   Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-VIEW-DETAILS-05  CP-2.11.0    manual      R1    deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Support
#    Navigate To Support Menu    Support modules
#    ${subtabs}      Get Support Materials Filter Options
...
BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-08: Download PDF file-Patient Quick Guide of Bioflux
    [Documentation]   Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-08  CP-2.11.0     manual    deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-09: Download PDF file-Patient Quick Guide of Biocore/Biotres
    [Documentation]   Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-MATERIALS-DOWNLOAD-09  CP-2.11.0     manual    deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-MODULES-01-CP-2.25.0: Menu Item Display Updated to "Support Modules"
    ...
    [Tags]  BF-TECH-SUPPORT-MODULES-01-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-MODULES-02-CP-2.25.0: The List of Support Modules is Sorted by Index in Ascending Order
    [Documentation]   Author: Tam Ho
    ...     Description:
    ...
    [Tags]  BF-TECH-SUPPORT-MODULES-02-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-MODULES-03-CP-2.25.0: Each Module Displays an Image, Title, and Description
    [Documentation]   Author: Tam Ho
    ...     Description:
    ...
    [Tags]  BF-TECH-SUPPORT-MODULES-03-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-MODULES-04-CP-2.25.0: Clicking "View" Opens the PDF in a Viewer
    [Documentation]   Author: Tam Ho
    ...     Description:
    ...
    [Tags]  BF-TECH-SUPPORT-MODULES-04-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-MODULES-05-CP-2.25.0: Users Can Download the PDF
    [Documentation]   Author: Tam Ho
    ...     Description:
    ...
    [Tags]  BF-TECH-SUPPORT-MODULES-05-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-MODULES-06-CP-2.25.0: The First Page of the PDF Is Displayed as an Image
    [Documentation]   Author: Tam Ho
    ...     Description:
    ...
    [Tags]  BF-TECH-SUPPORT-MODULES-06-CP-2.25.0  CP-2.25.0     manual    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-DEVICE-MANUALS-01-CP-2.25.0: The First Page of the PDF Is Displayed as an Image
    [Documentation]   Author: Tam Ho
    ...
    [Tags]  BF-TECH-SUPPORT-DEVICE-MANUALS-01-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-DEVICE-MANUALS-02-CP-2.25.0: View details of the Instructions For Use sub-tab
    [Documentation]   Author: Tam Ho
    ...
    [Tags]  BF-TECH-SUPPORT-DEVICE-MANUALS-02-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-DEVICE-MANUALS-03-CP-2.25.0: Download PDF file-Instruction for use of Bioflux
    [Documentation]   Author: Tam Ho
    ...     Description: The user can download the Bioflux PDF file on the Instruction For Use sub-tab
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-SUPPORT-DEVICE-MANUALS-03-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-DEVICE-MANUALS-04-CP-2.25.0: Download PDF file-Instruction for use of Biocore/Biotres
    [Documentation]   Author: Tam Ho
    ...     Description: The user can download the Biocore/Biotres PDF file on the Instruction For Use sub-tab
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-SUPPORT-DEVICE-MANUALS-04-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-DEVICE-MANUALS-05-CP-2.25.0: View details of the Patient Manual sub-tab
    [Documentation]   Author: Tam Ho
    ...
    [Tags]  BF-TECH-SUPPORT-DEVICE-MANUALS-05-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-DEVICE-MANUALS-06-CP-2.25.0: Download PDF file-Patient Manual of Bioflux
    [Documentation]   Author: Tam Ho
    ...     Description: The user can download the Bioflux PDF file on the Patient Manual sub-tab
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-SUPPORT-DEVICE-MANUALS-06-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-DEVICE-MANUALS-07-CP-2.25.0: Download PDF file-Patien manual of Biocore/Biotres
    [Documentation]   Author: Tam Ho
    ...     Description: The user can download the Biocore/Biotres PDF file on the Patient Manual sub-tab
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-SUPPORT-DEVICE-MANUALS-07-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-DEVICE-MANUALS-08-CP-2.25.0: View details of the Patient Quick Guide sub-tab
    [Documentation]   Author: Tam Ho
    ...     Description: The user can view details of the Patient Quick Guide sub-tab of the Support page
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-SUPPORT-DEVICE-MANUALS-08-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-DEVICE-MANUALS-09-CP-2.25.0: Download PDF file-Patient Quick Guide of Bioflux
    [Documentation]   Author: Tam Ho
    ...     Description: The user can download the Bioflux PDF file on the Patient Quick Guide sub-tab
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-SUPPORT-DEVICE-MANUALS-09-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-SUPPORT-DEVICE-MANUALS-10-CP-2.25.0: Download PDF file-Patient Quick Guide of Biocore/Biotres
    [Documentation]   Author: Tam Ho
    ...     Description: The user can download the Biocore/Biotres PDF file on the Patient Quick Guide sub-tab
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-SUPPORT-DEVICE-MANUALS-10-CP-2.25.0  CP-2.25.0     manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


# Facing bug relative to search by Patient name
BF-TECH-SUPPORT-SUBMIT-REQUEST-01: Submit a request with Change study type category
    [Documentation]   Author: Trinh Nguyen
    ...
...
#    ...     displayed under the New study type field
    ...
    [Tags]  BF-TECH-SUPPORT-SUBMIT-REQUEST-01  CP-2.12.0      auto
...
BF-TECH-SUPPORT-SUBMIT-REQUEST-02: Submit a request with Abort study category
    [Documentation]   Author: Nhan Nguyen
    ...
...
#    ...     - This study currently has an open request
    ...
    [Tags]  BF-TECH-SUPPORT-SUBMIT-REQUEST-02   CP-2.12.0    auto
    ...
    [Teardown]      Resolve Request     ${request_id}

BF-TECH-SUPPORT-SUBMIT-REQUEST-03: Submit a request with Report request category
    [Documentation]   Author: Nhan Nguyen
    ...
...
#    ...     - This study currently has an open request
    ...
    [Tags]  BF-TECH-SUPPORT-SUBMIT-REQUEST-03     CP-2.12.0    auto
    ${studies}        Get Studies - Completed On       ${FACILITIES}[0][name]
    ${study_id}       Set Variable      ${studies}[0][Study ID]
    Navigate To Support
    Navigate To Support Menu   Support request
...
BF-TECH-SUPPORT-SUBMIT-REQUEST-04: Submit a request with Web portal issues category
    [Documentation]   Author: Nhan Nguyen
    ...
    ...
    ...     5. At step 5, a success message stating: “We have received your request and will reach out to you to let you know
    ...     when the issue has been resolved”shall be appeared on the screen after the user has submitted/sent the request to cs@biotricity.com

    [Tags]  BF-TECH-SUPPORT-SUBMIT-REQUEST-04     CP-2.12.0     auto
    Navigate To Support
    Navigate To Support Menu    Support request
...
BF-TECH-SUPPORT-SUBMIT-REQUEST-05: Submit a request with Others category
    [Documentation]   Author: Nhan Nguyen
    ...
    ...
    ...     3. At step 3, the entered messaged shall be displayed
    ...     4. At step 4, the entered email shall be displayed
    ...     5. At step 5, a success message stating: “We have received your request and will get back to you as soon as possible”
    ...     shall be appeared on the screen after the user has submitted/sent the request to cs@biotricity.com

    [Tags]  BF-TECH-SUPPORT-SUBMIT-REQUEST-05     CP-2.12.0     auto
    Navigate To Support
    Navigate To Support Menu    Support request
    Navigate To New Support Request
    ${request_options}      Get New Support Request Options
...
BF-TECH-SUPPORT-SUBMIT-REQUEST-06: Submit a request with Billing questions category
    [Documentation]   Author: Nhan Nguyen
    ...
    ...
    ...     6. At step 6, a success message stating: “We have received your request and someone from our billing department
    ...     will be reaching out to you shortly”shall be appeared on the screen after the user has submitted/sent the request to cs@biotricity.com

    [Tags]  BF-TECH-SUPPORT-SUBMIT-REQUEST-06    CP-2.12.0      auto
    Navigate To Support
    Navigate To Support Menu    Support request
    Navigate To New Support Request
    ${request_options}      Get New Support Request Options
...
BF-TECH-SUPPORT-SEND-FEEDBACK-01: Send feedback to Biotricity
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-SEND-FEEDBACK-01    CP-2.12.0       auto    R1
...
BF-TECH-SUPPORT-SEND-FEEDBACK-02: Send feature request to Biotricity
    ...
    [Tags]  BF-TECH-SUPPORT-SEND-FEEDBACK-02       auto    R1
    Navigate To Top Menu    Support
...
BF-TECH-SUPPORT-SEND-FEEDBACK-03: Cannot send feedback with empty all required fields
    [Documentation]  Author: Nhan Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-SEND-FEEDBACK-03       auto
    Navigate To Top Menu    Support
...
BF-TECH-SUPPORT-SEND-FEEDBACK-04: Cannot send feature request with empty all required fields
    ...
    [Tags]  BF-TECH-SUPPORT-SEND-FEEDBACK-04       auto
...
BF-TECH-SUPPORT-FILTER-FACILITY-01: Filter the facility
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-SUPPORT-FILTER-FACILITY-01   CP-2.12.0      auto
    # From inbox
    Navigate To Inbox
