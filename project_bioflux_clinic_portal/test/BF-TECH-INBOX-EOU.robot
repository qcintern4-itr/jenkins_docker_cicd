...
Metadata    sid     BF-TECH-INBOX-EOU
...
Force Tags      BF-TECH-INBOX-EOU       web
Test Timeout    1h

*** Test Cases ***
BF-TECH-INBOX-EOU-VIEW-01: View the EOU reports screen
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-01       auto
    Navigate To Inbox
...
BF-TECH-INBOX-EOU-VIEW-02: Quick access Patient ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-02       auto       R1
    Navigate To Inbox
...
BF-TECH-INBOX-EOU-VIEW-03: Quick access Study ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-03       auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=End of Use reports
    ${reports}      Get Reports On Page
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BF-TECH-INBOX-EOU-VIEW-04: EOU - Check case the recently sent EOU report has been marked as an Artifact report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-04       auto       R1
    Navigate To Inbox
...
BF-TECH-INBOX-EOU-VIEW-05: Check case there is a green lable with the Biodirect label title on studies if running the Biodirect service
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-05       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-EOU-VIEW-06: Check case there is no report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-06       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-EOU-VIEW-07: Check case a study is deleted by a clinic user
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-07       auto       R1
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
...
BF-TECH-INBOX-EOU-VIEW-08: Check case a study is aborted by a Call Center user
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-08       auto       R1
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
...
BF-TECH-INBOX-EOU-FILTER-FACILITY-01: View the name of the facility in case the user only associates with one facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-FILTER-FACILITY-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Inbox
#    Navigate To Report Type    End of Use reports
...
BF-TECH-INBOX-EOU-FILTER-FACILITY-02: Select a specific facility in case the user associates with multiples facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-FILTER-FACILITY-02        auto
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
...
BF-TECH-INBOX-EOU-PAGINATION-01: Navigate to the next page
    [Documentation]      Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-PAGINATION-01     auto
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
    Filter Inbox        status_report=All
...
BF-TECH-INBOX-EOU-PAGINATION-02: Navigate to the previous page
    [Documentation]      Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-PAGINATION-02     auto
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
    Filter Inbox        status_report=All
...
BF-TECH-INBOX-EOU-SORT-01: Sort the report lists on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-INBOX-EOU-SORT-01     auto
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
...
BF-TECH-INBOX-EOU-FILTER-PRIORITY-01: Filter the report lists by priority on the Inbox page
    [Documentation]  Author: Trinh Nguyen
...
#    ...     4. If there is no report, a message will be displayed: “There is no data to display”
    ...
    [Tags]  BF-TECH-INBOX-EOU-FILTER-PRIORITY-01        auto
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
    Filter Inbox    status_report=All
...
BF-TECH-INBOX-EOU-SEARCH-01: View all search attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-INBOX-EOU-SEARCH-01     auto
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
...
BF-TECH-INBOX-EOU-SEARCH-02: Search by Patient Name attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     4. All entered text will be deleted
     ...
     [Tags]  BF-TECH-INBOX-EOU-SEARCH-02         auto        CP-2.16.7
     [Template]    Filter EOU Reports         # Facing bug
     All priority    Patient name

BF-TECH-INBOX-EOU-SEARCH-03: Search by Study ID attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-INBOX-EOU-SEARCH-03     auto
    [Template]    Filter EOU Reports
    All priority    Study ID

BF-TECH-INBOX-EOU-SEARCH-04: Search by Patient ID attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The user can search by Study ID attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-EOU-SEARCH-04     auto
    [Template]    Filter EOU Reports
    All priority    Patient ID

BF-TECH-INBOX-EOU-SEARCH-05: Search by Physician attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-INBOX-EOU-SEARCH-05     auto
    [Template]    Filter EOU Reports
    All priority    Physician

BF-TECH-INBOX-EOU-SEARCH-06: Search for report with existing study ID
    ...
    [Tags]  BF-TECH-INBOX-EOU-SEARCH-06     auto
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
    ${reports_list}    Get Eou Reports On Inbox
    Filter Inbox    search_by=Study ID   text_search=${reports_list}[0][Study ID]
    ${reports}    Get Eou Reports On Inbox
    Run Keyword And Continue On Failure    Should Be Equal    ${reports}[0][Study ID]    ${reports_list}[0][Study ID]

BF-TECH-INBOX-EOU-SEARCH-07: Check message displayed in case of searching with no result found
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     2. Click the search option icon
    ...     3. Select the Study ID option
    ...     4. Enter an invalid study ID that has no exist in the system
    ...
    ...     Expected Results:
    ...
    [Tags]  BF-TECH-INBOX-EOU-SEARCH-07     auto
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
    Filter Inbox    search_by=Study ID   text_search=123
    ${reports}    ${message}    Get Eou Reports On Inbox
    Run Keyword And Continue On Failure    Should Be Equal    ${message}    No result found
    
BF-TECH-INBOX-EOU-SEARCH-08: Search by Patient Name with existing Patient on system
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The user can search by Patient attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-EOU-SEARCH-08      auto       CP-2.16.7
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
    ${all_reports}    Get Eou Reports On Inbox
...
BF-TECH-INBOX-EOU-SEARCH-09: Search by Patient Name-Check message displayed in case of searching with no result found
    [Documentation]  Author: Nhan Nguyen
    ...     Description: The user can search by Patient attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-EOU-SEARCH-09     auto
    Navigate To Inbox
    Navigate To Report Type    End of Use reports
...
BF-TECH-INBOX-EOU-VIEW-DETAILS-01: View details of EOU report in the list
    [Documentation]     Author: Trinh Nguyen
...
#    ...     - An artifact tag
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-DETAILS-01     auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=End of Use reports
    ${reports}      Get All Reports On Page
...
BF-TECH-INBOX-EOU-VIEW-DETAILS-03: View EOU report details in case the report has been marked as artifact
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-DETAILS-03      auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=End of Use reports      status_report=All
    ${reports}      Get All Reports On Page
    ${study_ids}     Evaluate    [item['Study ID'] for item in ${reports} if item['Artifact'] == ${True}]
...
BF-TECH-INBOX-EOU-VIEW-DETAILS-04: MCT study/EOU old report format-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-DETAILS-04       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-EOU-VIEW-DETAILS-05: MCT study/EOU new report format-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-DETAILS-05       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-EOU-VIEW-DETAILS-06: MCT Peek study/EOU old report format-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-DETAILS-06       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-EOU-VIEW-DETAILS-07: MCT Peek study/EOU new report format-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-DETAILS-07       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-EOU-VIEW-DETAILS-08: Holter/Ext.Holter study/EOU old report format-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-DETAILS-08       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-EOU-VIEW-DETAILS-09: Holter/Ext.Holter study/EOU new report format-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-DETAILS-09       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-EOU-VIEW-DETAILS-10: Cardiac Event study/EOU old report format-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-DETAILS-10       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-EOU-VIEW-DETAILS-11: EOU-Download report
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-DETAILS-11       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-EOU-VIEW-DETAILS-12: View report details in case the Financial hold of the facility is "80 days" or "90 days"
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-DETAILS-12       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-EOU-VIEW-DETAILS-13: Quick access Study ID from report details page
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-DETAILS-13       auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=End of Use reports
    ${reports}      Get Reports On Page
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BF-TECH-INBOX-EOU-VIEW-DETAILS-14: Quick access Patient ID from report details page
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-EOU-VIEW-DETAILS-14       auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=End of Use reports
    ${reports}      Get Reports On Page
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BF-TECH-INBOX-EOU-REVIEWED-01: Mark a report sent by the Call center as reviewed
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-REVIEWED-01       auto
    Navigate To Inbox
...
BF-TECH-INBOX-EOU-REVIEWED-02: Mark a report sent by the Call center as not reviewed
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-REVIEWED-02       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-EOU-DOWNLOAD-01: Download PDF file
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-DOWNLOAD-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-EOU-COMMENT-01: Input physician interpretation to PDF reports in case report has not physician interpretation before
    [Documentation]   Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-EOU-COMMENT-01    manual    R1    CP-2.28.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
#    # Clear Text
#    [Teardown]    Clear Comment Text     End of Use reports    Urgent      ${EMPTY}     ${EMPTY}

BF-TECH-INBOX-EOU-COMMENT-02: Input physician interpretation to PDF reports in case report already has physician interpretation
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The user can Input physician interpretation to PDF reports
    ...
    ...
    ...     **Others
    ...     Update date: 2/11/2025 - Tam Ho
    [Tags]  BF-TECH-INBOX-EOU-COMMENT-02     manual    R1    CP-2.28.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Inbox
...
Filter EOU Reports
    ...
    ...  Run Keyword And Continue On Failure    Should Be True    all('${text}'.lower() in r['Physician'].lower() for r in ${reports})      Invalid results are showing - with ${search_by} text search `${text}`
