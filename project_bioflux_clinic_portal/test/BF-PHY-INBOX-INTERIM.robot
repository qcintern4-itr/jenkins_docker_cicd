*** Settings ***
Documentation   Test Suite - Clinic Portal - Interim Inbox page
Metadata    sid     BF-PHY-INBOX-INTERIM
...
Force Tags      BF-PHY-INBOX-INTERIM        web
Test Timeout    1h

*** Test Cases ***
BF-PHY-INBOX-INTERIM-VIEW-01: View the Interim reports screen
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     Description: The user can view the Interim reports screen in the Inbox list
    ...
    ...     Precondition:
    ...     - The user is on the INBOX page in the Clinic Portal
    ...
    ...     Test Steps:
    ...     1. Click the Interim reports tab of the INBOX page
    ...     2. Observe the Interim report screen
    ...
    ...     Expected Results:
    ...     1. On the side navigation menu, the Interim reports tab shall have a label indicating the number
    ...     of unread reports
    ...
    ...     6. Search bar
    ...     7. Search option
    [Tags]  BF-PHY-INBOX-INTERIM-VIEW-01        auto    R1
    Navigate To Inbox
    Navigate To Report Type    Interim reports
...
BF-PHY-INBOX-INTERIM-VIEW-02: Quick access Patient ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-VIEW-02      auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=Interim reports
...
BF-PHY-INBOX-INTERIM-VIEW-03: Quick access Study ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-VIEW-03      auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=Interim reports
    ${reports}      Get Reports On Page
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BF-PHY-INBOX-INTERIM-VIEW-04: Interim - Check case the recently sent Interim report has been marked as an Artifact report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-VIEW-04       auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=Interim reports     status_report=All
...
BF-PHY-INBOX-INTERIM-VIEW-05: Check case there is a green lable with the Biodirect label title on studies if running the Biodirect service
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-VIEW-05       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-VIEW-06: Check case there is no report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-VIEW-06       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-VIEW-07: Check case a study is deleted by a clinic user
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-VIEW-07       auto       R1
    Navigate To Inbox
    Navigate To Report Type    Interim reports
...
BF-PHY-INBOX-INTERIM-VIEW-08: Check case a study is aborted by a Call Center user
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-VIEW-08      auto       R1
    Navigate To Inbox
...
BF-PHY-INBOX-INTERIM-FILTER-FACILITY-01: View the name of the facility in case the user only associates with one facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-FACILITY-01       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Inbox
#    Navigate To Report Type    Interim reports
...
BF-PHY-INBOX-INTERIM-FILTER-FACILITY-02: Filter by facility in case the user associates with multiples facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-FACILITY-02     auto    R1
    Navigate To Inbox
    Navigate To Report Type    Interim reports
...
BF-PHY-INBOX-INTERIM-PAGINATION-01: Navigate to the next page
    [Documentation]      Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-PAGINATION-01      auto    R1
    Navigate To Inbox
    Navigate To Report Type    Interim reports
...
BF-PHY-INBOX-INTERIM-PAGINATION-02: Navigate to the previous page
    [Documentation]      Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-PAGINATION-02      auto    R1
    Navigate To Inbox
    Navigate To Report Type    Interim reports
    Filter Inbox        status_report=All
...
BF-PHY-INBOX-INTERIM-SORT-01: Sort the report lists on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-SORT-01       auto
    Navigate To Inbox
    Navigate To Report Type    Interim reports
...
BF-PHY-INBOX-INTERIM-FILTER-PRIORITY-01: Filter the report lists by priority on the Inbox page
    [Documentation]  Author: Trinh Nguyen
...
#    ...     4. If there is no report, a message will be displayed: “There is no data to display”
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-PRIORITY-01     auto    R1
    Navigate To Inbox
    Navigate To Report Type    Interim reports
    Filter Inbox    status_report=All
...
BF-PHY-INBOX-INTERIM-SEARCH-01: View all search attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-SEARCH-01      auto
    Navigate To Inbox
    Navigate To Report Type    Interim reports
...
BF-PHY-INBOX-INTERIM-SEARCH-02: Search by Patient Name attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-SEARCH-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    [Template]    Filter Interim Reports    # facing bug
#    All priority      Patient name

BF-PHY-INBOX-INTERIM-SEARCH-03: Search by Study ID attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-SEARCH-03     auto    R1
    [Template]    Search Reports
    Interim reports      Study ID

BF-PHY-INBOX-INTERIM-SEARCH-04: Search by Patient ID attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The user can search by Study ID attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-SEARCH-04      auto    R1
    [Template]    Search Reports
    Interim reports      Patient ID

BF-PHY-INBOX-INTERIM-SEARCH-05: Search by Patient Name with existing Patient
    ...
    ...
    ...    **Others
    ...    - Update date: 04/11/2025-Nhan Nguyen (auto)

    [Tags]  BF-PHY-INBOX-INTERIM-SEARCH-05     auto
    [Template]    Search Reports
    Interim reports    Patient name

BF-PHY-INBOX-INTERIM-SEARCH-06: Check message displayed with non-existent reports when Search by Patient Name/Study ID/Patient ID
    [Documentation]  Author: Nhan Nguyen
    ...     Description: The user can search by Patient attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-SEARCH-06     auto
    [Template]    Search Reports With Non-Existent
    Interim reports    Patient name    No name
    Interim reports    Study ID    123
    Interim reports    Patient ID    Nonexistent

BF-PHY-INBOX-INTERIM-VIEW-DETAILS-01: View details of Interim report in the list
    [Documentation]     Author: Trinh Nguyen
...
#    ...     - An artifact tag
    [Tags]  BF-PHY-INBOX-INTERIM-VIEW-DETAILS-01       auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=Interim reports     status_report=All
    ${reports}      Get All Reports On Page
...
BF-PHY-INBOX-INTERIM-REVIEWED-01: Mark a report sent by the Call center as reviewed
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-REVIEWED-01        auto    R1
    Navigate To Inbox
    Filter Inbox    report_type=Interim reports     priority=All priority
    ${reports}      Get Reports On Page
    ${study_ids}     Evaluate    [item['Study ID'] for item in ${reports} if item['Artifact'] == ${False}]
    ${random_study_id}     Evaluate    random.choice(${study_ids})    random
    Filter Inbox    search_by=Study ID      text_search=${random_study_id}
...
BF-PHY-INBOX-INTERIM-REVIEWED-02: Mark a report sent by the Call center as not reviewed
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-REVIEWED-02       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-DOWNLOAD-01: Download PDF file
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-DOWNLOAD-01       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-COMMENT-01: Input physician interpretation to PDF reports in case report has not physician interpretation before
    [Documentation]   Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-COMMENT-01      manual    R1    CP-2.28.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    # verify comment at input field, PDF: TDB
#    Navigate To Inbox
#    Filter Inbox     report_type=Interim reports     priority=Urgent
#    Select Report    row=1
...
#    # Clear Text
#    [Teardown]    Clear Comment Text    Interim reports     Urgent

BF-PHY-INBOX-INTERIM-COMMENT-02: Input physician interpretation to PDF reports in case report already has physician interpretation
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The user can Input physician interpretation to PDF reports
    ...
    ...
    ...     **Others
    ...     Update date: 2/11/2025 - Tam Ho
    [Tags]  BF-PHY-INBOX-INTERIM-COMMENT-02       manual    R1    CP-2.28.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Inbox
#    Filter Inbox     report_type=Interim reports    priority=High
#    ${reports}      Get Reports On Page
#    ${text}         Evaluate    '${reports}[0][Study ID]'.split()[0].strip()
#    Filter Inbox     report_type=Interim reports    priority=High      search_by=Study ID      text_search=${text}
#    Select Report    row=1
#    Open Add Interpretation Dialog
...
#    # Clear comment
#    [Teardown]    Clear Comment Text    Interim reports    High     Study ID    ${text}

BF-PHY-INBOX-INTERIM-SIGN-01: Add a signature to a PDF report
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    ...     **Others
    ...     Update date: 2/11/2025 - Tam Ho
    [Tags]  BF-PHY-INBOX-INTERIM-SIGN-01       manual       R1    CP-2.28.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-FILTER-STATUS-01: Check default report status is New, Downloaded, Reviewed, Interpreted
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-STATUS-01       manual      CP-2.22.0   R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-FILTER-STATUS-02: Filter by Report status is New
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-STATUS-02       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-FILTER-STATUS-03: Filter by Report status is Downloaded
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-STATUS-03       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-FILTER-STATUS-04: Filter by Report status is Reviewed
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-STATUS-04       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-FILTER-STATUS-05: Filter by Report status is Interpreted
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-STATUS-05       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-FILTER-STATUS-06: Filter by Report status is Interpreted
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-STATUS-06       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-FILTER-STATUS-07: Filter by Report status is Signed
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-STATUS-07       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-FILTER-STATUS-08: Filter by Report status is Completed
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-STATUS-08       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-FILTER-STATUS-09: Filter by Report status will be applied for other tabs (except All reports)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-STATUS-09       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-FILTER-STATUS-10: Filter by multiple Report statuses
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-STATUS-10       manual      CP-2.22.0   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-FILTER-STUDIES-01: Check default study filter status is Your studies
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-STUDIES-01       manual      CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-FILTER-STUDIES-02: Filter reports by All studies
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-STUDIES-02      manual      CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-INBOX-INTERIM-FILTER-STUDIES-03: Switch studies filter between Your studies and All studies
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-INBOX-INTERIM-FILTER-STUDIES-03      manual      CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
Filter Interim Reports
    [Arguments]       ${priority}=${EMPTY}     ${search_by}=${EMPTY}
    Navigate To Inbox
    Navigate To Report Type    Interim reports
    Filter Inbox    status_report=All
    Filter Inbox    report_type=Interim reports      priority=${priority}        search_by=${search_by}
    ${reports}       Get Reports On Page
    ...
    Filter Inbox    report_type=Interim reports      priority=${priority}        search_by=${search_by}      text_search=${text}
    ${reports}       Get All Reports On Page
