...
Metadata    sid     BF-TECH-INBOX-INSTANT
...
Force Tags      BF-TECH-INBOX-INSTANT       web
Test Timeout    1h

*** Test Cases ***
BF-TECH-INBOX-INSTANT-VIEW-01: View the Instant reports screen
    ...
    ...     5. Search bar
    ...     6. Search option
    [Tags]  BF-TECH-INBOX-INSTANT-VIEW-01       auto
    Navigate To Inbox
    ...
    ${expected_facilities}       Create List    All facilities     Facility_QA_01      Facility_QA_02
    ...
    Run Keyword And Continue On Failure    Lists Should Be Equal    ${expected_facilities}       ${search_by}[Facility]
    # Step 1, 3 TBD

BF-TECH-INBOX-INSTANT-VIEW-02: Quick access Patient ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-VIEW-02       auto       R1
    Navigate To Inbox
...
BF-TECH-INBOX-INSTANT-VIEW-03: Quick access Study ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-VIEW-03       auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=Instant reports
    ${reports}      Get Reports On Page 2
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BF-TECH-INBOX-INSTANT-VIEW-04: Check case there is a green lable with the Biodirect label title on studies if running the Biodirect service
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-VIEW-04       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INSTANT-VIEW-05: Check case there is no report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-VIEW-05       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INSTANT-VIEW-06: Check case a study is deleted by a clinic user
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-VIEW-06       auto       R1
    Navigate To Inbox
    Navigate To Report Type    Instant reports
    ${instant_report}       Get Reports On Page 2
    ${study_ids}         Evaluate    [item['Study ID'] for item in ${instant_report}]
    ...
    ${instant_report}       Get Reports On Page 2
    Run Keyword And Continue On Failure    Should Be Empty    ${instant_report}
    [Teardown]    Run Keyword    Restore Deleted Study With Study Id "${study_id}"

BF-TECH-INBOX-INSTANT-VIEW-07: Check case a study is aborted by a Call Center user
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-VIEW-07      auto       R1
    Navigate To Inbox
...
BF-TECH-INBOX-INSTANT-FILTER-FACILITY-01: View the name of the facility in case the user only associates with one facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-FILTER-FACILITY-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Inbox
#    Navigate To Report Type    Instant reports
...
BF-TECH-INBOX-INSTANT-FILTER-FACILITY-02: Select a specific facility in case the user associates with multiples facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-FILTER-FACILITY-02        auto
    Navigate To Inbox
    Navigate To Report Type    Instant reports
...
BF-TECH-INBOX-INSTANT-PAGINATION-01: Navigate to the next page
    [Documentation]      Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-PAGINATION-01    auto
    Navigate To Inbox
    Navigate To Report Type    Instant reports
...
BF-TECH-INBOX-INSTANT-PAGINATION-02: Navigate to the previous page
    [Documentation]      Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-PAGINATION-02     auto
    Navigate To Inbox
    Navigate To Report Type    Instant reports
...
BF-TECH-INBOX-INSTANT-SORT-01: Sort the report lists on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-SORT-01     auto
    Navigate To Inbox
    Navigate To Report Type    Instant reports
...
BF-TECH-INBOX-INSTANT-SEARCH-01: View all search attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-SEARCH-01     auto
    Navigate To Inbox
    Navigate To Report Type    Instant reports
...
BF-TECH-INBOX-INSTANT-SEARCH-02: Search by Patient Name attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     4. All entered text will be deleted
     ...
     [Tags]  BF-TECH-INBOX-INSTANT-SEARCH-02        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    [Template]    Filter Instant Reports
#    Patient name   # facing bug

BF-TECH-INBOX-INSTANT-SEARCH-03: Search by Study ID attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-SEARCH-03     auto
    [Template]    Filter Instant Reports
    Study ID

BF-TECH-INBOX-INSTANT-SEARCH-04: Search by Patient ID attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The user can search by Study ID attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-SEARCH-04     auto
    [Template]    Filter Instant Reports
    Patient ID

BF-TECH-INBOX-INSTANT-SEARCH-05: Search by Physician attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-SEARCH-05     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    [Template]    Filter Instant Reports
#    Physician

BF-TECH-INBOX-INSTANT-VIEW-DETAILS-01: View details of Instant report in the list
    [Documentation]     Author: Trinh Nguyen
...
#    ...        "Something went wrong, please try again!"
    [Tags]  BF-TECH-INBOX-INSTANT-VIEW-DETAILS-01       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Inbox
#    Navigate To Report Type    Instant reports
#    ${reports}      Get Reports On Page 2
...
#    Run Keyword And Continue On Failure    Should Be Equal    ${are_items_displayed}[Add signature button]             ${False}
...
BF-TECH-INBOX-INSTANT-VIEW-DETAILS-02: Add Interpretation
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-VIEW-DETAILS-02       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INSTANT-VIEW-DETAILS-03: Download report
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-VIEW-DETAILS-03       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INSTANT-VIEW-DETAILS-04: View report details in case the Financial hold of the facility is "80 days" or "90 days"
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-VIEW-DETAILS-04       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INSTANT-VIEW-DETAILS-05: Quick access Study ID from report details page
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-VIEW-DETAILS-05       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INSTANT-VIEW-DETAILS-06: Quick access Patient ID from report details page
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-VIEW-DETAILS-06       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INSTANT-DOWNLOAD-01: Download PDF file
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-DOWNLOAD-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INSTANT-COMMENT-01: Input physician interpretation to PDF reports in case report has not physician interpretation before
    [Documentation]   Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-COMMENT-01     manual    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
#    # Clear Text
#    [Teardown]    Clear Comment Text     Instant reports       ${EMPTY}      ${EMPTY}      ${EMPTY}

BF-TECH-INBOX-INSTANT-COMMENT-02: Input physician interpretation to PDF reports in case report already has physician interpretation
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The user can Input physician interpretation to PDF reports
    ...
    ...
    [Tags]  BF-TECH-INBOX-INSTANT-COMMENT-02     manual    inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Inbox
#    Filter Inbox     report_type=Instant reports
#    ${reports}      Get Reports On Page 2
...
#    # Clear comment
#    [Teardown]    Clear Comment Text     Instant reports        ${EMPTY}      Study ID        ${text}
...
Filter Instant Reports
    ...
    ...  '${search_by.lower()}' == 'physician'          ${reports}[0][Physician]
    ...
    Run Keyword If     '${search_by.lower()}' == 'physician'
