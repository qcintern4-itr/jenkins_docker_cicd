...
Metadata    sid     BF-TECH-INBOX-INTERIM
...
Force Tags      BF-TECH-INBOX-INTERIM       web
Test Timeout    1h

*** Test Cases ***
BF-TECH-INBOX-INTERIM-VIEW-01:View the Interim reports screen
    ...
    ...     6. Search bar
    ...     7. Search option
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-01       auto
    Navigate To Inbox
...
BF-TECH-INBOX-INTERIM-VIEW-02: Quick access Patient ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-02       auto       R1
    Navigate To Inbox
...
BF-TECH-INBOX-INTERIM-VIEW-03: Quick access Study ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-03      auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=Interim reports
    ${reports}      Get Reports On Page
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BF-TECH-INBOX-INTERIM-VIEW-04: Interim - Check case the recently sent Interim report has been marked as an Artifact report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-04       auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=Interim reports
    Filter Inbox    status_report=All
...
BF-TECH-INBOX-INTERIM-VIEW-05: Check case there is a green lable with the Biodirect label title on studies if running the Biodirect service
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-05       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INTERIM-VIEW-06: Check case there is no report
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-06       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INTERIM-VIEW-07: Check case a study is deleted by a clinic user
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-07       auto       R1
    Navigate To Inbox
    Navigate To Report Type    Interim reports
...
BF-TECH-INBOX-INTERIM-VIEW-08: Check case a study is aborted by a Call Center user
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-08      auto       R1
    Navigate To Inbox
...
BF-TECH-INBOX-INTERIM-FILTER-FACILITY-01: View the name of the facility in case the user only associates with one facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-FILTER-FACILITY-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Inbox
#    Navigate To Report Type    Interim reports
...
BF-TECH-INBOX-INTERIM-FILTER-FACILITY-02: Select a specific facility in case the user associates with multiples facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-FILTER-FACILITY-02        auto
    Navigate To Inbox
    Navigate To Report Type    Interim reports
...
BF-TECH-INBOX-INTERIM-PAGINATION-01: Navigate to the next page
    [Documentation]      Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-PAGINATION-01     auto
    Navigate To Inbox
    Navigate To Report Type    Interim reports
    Filter Inbox        status_report=All
...
BF-TECH-INBOX-INTERIM-PAGINATION-02: Navigate to the previous page
    [Documentation]      Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-PAGINATION-02     auto
    Navigate To Inbox
    Navigate To Report Type    Interim reports
    Filter Inbox        status_report=All
...
BF-TECH-INBOX-INTERIM-SORT-01: Sort the report lists on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-SORT-01     auto
    Navigate To Inbox
    Navigate To Report Type    Interim reports
    Filter Inbox        status_report=All
...
BF-TECH-INBOX-INTERIM-FILTER-PRIORITY-01: Filter the report lists by priority on the Inbox page
    [Documentation]  Author: Trinh Nguyen
...
#    ...     4. If there is no report, a message will be displayed: “There is no data to display”
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-FILTER-PRIORITY-01        auto
    Navigate To Inbox
    Navigate To Report Type    Interim reports
    Filter Inbox    status_report=All
...
BF-TECH-INBOX-INTERIM-SEARCH-01: View all search attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-SEARCH-01     auto
    Navigate To Inbox
    Navigate To Report Type    Interim reports
    Filter Inbox        status_report=All
...
BF-TECH-INBOX-INTERIM-SEARCH-02: Search by Patient Name attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     4. All entered text will be deleted
     ...
     [Tags]  BF-TECH-INBOX-INTERIM-SEARCH-02        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    [Template]    Filter Interim Reports
#    All priority    Patient name   # Facing bug

BF-TECH-INBOX-INTERIM-SEARCH-03: Search by Study ID attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-SEARCH-03     auto
    [Template]    Filter Interim Reports
    All priority    Study ID

BF-TECH-INBOX-INTERIM-SEARCH-04: Search by Patient ID attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The user can search by Study ID attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-SEARCH-04     auto
    [Template]    Filter Interim Reports
    All priority    Patient ID

BF-TECH-INBOX-INTERIM-SEARCH-05: Search by Physician attributes on the Inbox page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-SEARCH-05     auto
    [Template]    Filter Interim Reports
    All priority    Physician
    
BF-TECH-INBOX-INTERIM-SEARCH-06: Search by Patient Name with existing Patient
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-SEARCH-06     auto
    Navigate To Inbox
    Navigate To Report Type    Interim reports
    Filter Inbox   search_by=Patient name   text_search=Patient API Test
    ${reports}    Get Interim Reports On Inbox
    Run Keyword And Continue On Failure    Should Be Equal    ${reports}[0][Patient Name]    Patient API Test

BF-TECH-INBOX-INTERIM-SEARCH-07: Search by Patient Name-Check message displayed in case of searching with no result found
    [Documentation]  Author: Nhan Nguyen
    ...     Description: The user can search by Patient attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-SEARCH-07     auto
    Navigate To Inbox
    Navigate To Report Type    Interim reports
    Filter Inbox   search_by=Patient name   text_search=No name
    ${reports}    ${message}    Get Interim Reports On Inbox
    Run Keyword And Continue On Failure    Should Be Equal    ${message}    No result found

BF-TECH-INBOX-INTERIM-VIEW-DETAILS-01: View details of Interim report in the list
    [Documentation]     Author: Trinh Nguyen
...
#    ...     - An artifact tag
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-DETAILS-01     auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=Interim reports
    ${reports}      Get All Reports On Page
...
BF-TECH-INBOX-INTERIM-VIEW-DETAILS-03: View Interim report details in case the report has been marked as artifact
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-DETAILS-03       auto       R1
    Navigate To Inbox
...
BF-TECH-INBOX-INTERIM-VIEW-DETAILS-04: Interim-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-DETAILS-04       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INTERIM-VIEW-DETAILS-05: Interim-Download report
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-DETAILS-05       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INTERIM-VIEW-DETAILS-06: View report details in case the Financial hold of the facility is "80 days" or "90 days"
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-DETAILS-06       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INTERIM-VIEW-DETAILS-07: Quick access Study ID from report details page
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-DETAILS-07      auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=Interim reports
    ${reports}      Get Reports On Page
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BF-TECH-INBOX-INTERIM-VIEW-DETAILS-08: Quick access Patient ID from report details page
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-VIEW-DETAILS-08      auto       R1
    Navigate To Inbox
    Filter Inbox    report_type=Interim reports
#    Filter Inbox    status_report=All
    ${reports}      Get Reports On Page
...
BF-TECH-INBOX-INTERIM-REVIEWED-01: Mark a report sent by the Call center as reviewed
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-REVIEWED-01       auto
    Navigate To Inbox
...
BF-TECH-INBOX-INTERIM-REVIEWED-02: Mark a report sent by the Call center as not reviewed
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-REVIEWED-02       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INTERIM-DOWNLOAD-01: Download PDF file
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-DOWNLOAD-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-INBOX-INTERIM-COMMENT-01: Input physician interpretation to PDF reports in case report has not physician interpretation before
    [Documentation]   Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-INBOX-INTERIM-COMMENT-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
#    # Clear Text
#    [Teardown]     Clear Comment Text    Interim reports      Urgent        ${EMPTY}        ${EMPTY}

BF-TECH-INBOX-INTERIM-COMMENT-02: Input physician interpretation to PDF reports in case report already has physician interpretation
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The user can Input physician interpretation to PDF reports
    ...
    ...
    ...     **Others
    ...     Update date: 2/11/2025 - Tam Ho
    [Tags]  BF-TECH-INBOX-INTERIM-COMMENT-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    [Setup]    Clear Comment Text     Interim reports      High     ${EMPTY}        ${EMPTY}
#    Navigate To Inbox
