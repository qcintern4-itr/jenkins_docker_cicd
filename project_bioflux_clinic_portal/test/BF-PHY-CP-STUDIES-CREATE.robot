...
Metadata    sid     BF-PHY-CP-STUDIES-CREATE
...
Force Tags          BF-PHY-CP-STUDIES-CREATE       web
Test Timeout        1h

*** Test Cases ***
BF-PHY-CP-STUDIES-CREATE-STEP1-01: Fill information in step 1-Patient information
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 1- Patient information
    ...
    ...     Precondition:
    ...     1. The Clinic Physician user is on Create new study screen – step 1 (Patient information)
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP1-01       auto
...
BF-PHY-CP-STUDIES-CREATE-STEP1-02: Verify the message when the all filed are blank in step 1
    [Documentation]
    ...     Description: The clinic Physician all filed are blank in step 1- Patient information
    ...
    ...     Precondition:
    ...     1. The Clinic Physician user is on Create new study screen – step 1 (Patient information)
    ...     2. There is a bioflux device that is on Ready for new study status
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP1-02       auto
    Navigate To Studies Page
    Open New Study
    Create New Study Page 1    is_next=${True}
...
BF-PHY-CP-STUDIES-CREATE-STEP2-02: Verify the message when the all filed are blank in step 2
    [Documentation]
    ...     Description: The clinic Physician all filed are blank in step 2- Patient contact
    ...
    ...     Precondition:
    ...     1. The Clinic Physician user is on Create new study screen – step 2 (Patient contact)
    ...     2. There is a bioflux device that is on Ready for new study status
    ...     3. There is a biotres device that is on Ready for new study status
    ...
    ...     Test Steps:
    ...
    ...     Create Date: 10/24/2023
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP2-02       auto
    Navigate To Studies Page
    Open New Study
...
BF-PHY-CP-STUDIES-CREATE-STEP3-09: Verify the message when the all filed are blank in step 3
    [Documentation]
    ...     Description: The clinic Physician all filed are blank in step 3 - Study information
    ...
    ...     Precondition:
    ...
    ...     Create Date: 10/24/2023
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-09       auto
    Navigate To Studies Page
    Open New Study
    Create New Study Page 1    patient_id=PT103     first_name=Patient     middle_name=Test      last_name=01     dob=11/11/2000      height=4ft, 3in     weight=50lb     ethnicity=Asian      pacemaker=${True}     icd=${True}
...
BF-PHY-CP-STUDIES-CREATE-STEP4-04: Verify the message when the all filed are blank in step 4
    [Documentation]
    ...
    ...     Create Date: 10/24/2023
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP4-04       auto
    Navigate To Studies Page
    Open New Study
    Create New Study Page 1    patient_id=PT103     first_name=Patient     middle_name=Test      last_name=01     dob=11/11/2000      height=4ft, 3in     weight=50lb     ethnicity=Asian      pacemaker=${True}     icd=${True}
    ${second_contact}   Create Dictionary    name=Jonh     relationship=brother     phone_number=049-586-7594     email=jonh@yopmail.com
...
BF-PHY-CP-STUDIES-CREATE-STEP3-01: Can Fill information in step 3-Study information
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 3- Study information with device ready
    ...     for Protect+ program
    ...
    ...     Precondition:
    ...     1. The Clinic Physician user is on Create new study screen – step 3 (Study information)
    ...
    ...
    ...     Test Steps:
    ...     1. On Device section, select Bioflux model button and click on the Device ID dropdown list
    ...
    ...     6. Select a type on the Study type dropdown list
    ...
    ...     5. At step 5,6,7,8,9 the selected/entered data shall be displayed
    ...     6. At step 10, the user will navigate back to step 2 (Patient contact)
    ...     7. At step 11, the user should be navigated to step 4 (Diagnosis)
    ...
    ...     **Others**
    ...     Update Date: 8/21/2023 - Trinh Nguyen

    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-02: Can Fill information in step 3-Study information
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 3- Study information with Bioflux device
    ...
    ...     Precondition:
    ...     1. The Clinic Physician user is on Create new study screen – step 3 (Study information)
    ...
    ...
    ...     4. Select a specific study type on the Study type dropdown list
    ...
    ...     3. At step 3, 4, 5, 6, 7 the selected/entered data shall be displayed
    ...     4. At step 8, the user will navigate back to step 2 (Patient contact)
    ...     5. At step 9, the user should be navigated to step 4 (Diagnosis)
    ...
    ...     **Others**
    ...     Update Date: 8/21/2023 - Trinh Nguyen

    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-02     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-03: Can Fill information in step 3-Study information
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 3 with Biocore/Biotres device does not have
    ...
    ...     3. Select a physician on the Referring physician dropdown list
    ...     4. Select a HOLTER/EXTENDED HOLTER on the Study type dropdown list
    ...     5. Enter valid value on the Study duration field
    ...     6. Select a valid date on the Patient return visit datepicker
    ...     7. Enter valid value on the Clinic Initials field
    ...     8. Click the Previous button
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-03     manual       CP-2.14.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-04: Can Fill information in step 3-Study information
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill all information in step 3 with Biocore/Biotres device does not have
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-04     manual       CP-2.14.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-05: Can Fill information in step 3-Study information
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill all information in step 3 with Biocore/Biotres device has the auto-events
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-05     manual       CP-2.14.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-06: Cannot Fill information in step 3-Study information
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician cannot fill all information in step 3 with Biocore/Biotres device does not have
    ...     the auto-events detection enabled and firmware version has not been updated to the latest
    ...
    ...     Precondition:
    ...     1. The Clinic Physician user is on Create new study screen – step 3 (Study information)
    ...
    ...     2. On Device section, select Biocore/Biotres button and select a Device ID on dropdown list
    ...     3. Select a physician on the Referring physician dropdown list
    ...     4. Select a MCT/MCT Peek/CARDIAC EVENT/HOLTER AND FOLLOW ON STUDY on the Study type dropdown list
    ...     5. Click the Okay button on pop-up
    ...     6. Enter valid value on the Study duration field
    ...     7. Select a valid date on the Patient return visit datepicker
    ...     8. Enter valid value on the Clinic Initials field
    ...     9. Click the Previous button
    ...     10. Observe the Next button
    ...
    ...     Expected Results:
    ...     1. At step 1, There shall be a drop-down list of facilities in case the user has more than one assigned
    ...     facility. Otherwise, the Facility Name attribute shall be hidden
    ...
    ...     be displayed to the user. The [Next] button of the Study Information page shall be disabled
    ...     2. At step 2, the selected device ID shall be displayed
    ...     3. At step 3 the selected Referring physician shall be displayed
    ...     4. At step 4, a pop-up shall be displayed with the following information:
    ...     - Title: Feature not available
    ...     - Content: Please contact your sales representative to enable this feature.
    ...     - Button: Okay
    ...     5. At step 5, clicking the Okay button shall dismiss the modal and clear the current study type
    ...     6. At step 6,7,8 the entered/selected data shall be displayed
    ...     7. At step 9, the user will navigate back to step 2 (Patient contact)
    ...     8. At step 10, the Next button is disabled
    ...
    ...     **Others**
    ...     Update Date: 8/21/2023 - Trinh Nguyen

    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-06     manual       CP-2.14.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-07: Cannot Fill all information in step 3-Study information
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician cannot fill all information in step 3 with Biocore/Biotres device does not have
    ...     the auto-events detection enabled and firmware version has been updated to the latest
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-07     manual       CP-2.14.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-08: Cannot Fill information in step 3-Study information
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician cannot fill all information in step 3 with Biocore/Biotres device has
    ...     the auto-events detection enabled and firmware version has not been updated to the latest
    ...
    ...     Precondition:
    ...     1. The Clinic Physician user is on Create new study screen – step 3 (Study information)
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-08     manual       CP-2.14.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-09-CP2.24.2: Step 3-Allow physician to select Interpreting physician while start a new study
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-09-CP2.24.2     manual       CP-2.24.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-10-CP2.24.2: Step 3-Display text notify about Diagnostics Yield in case of study duration less than 10d
    [Documentation]   Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-10-CP2.24.2     manual       CP-2.24.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-11-CP2.24.2: Step 3-Diagnostic Yield page: open in new tab when user click “Click to learn more”
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-11-CP2.24.2     manual       CP-2.24.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-CREATE-STEP3-12-CP2.24.2: Step 3-Diagnostic Yield: text notify does not close automatically
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-12-CP2.24.2     manual       CP-2.24.2    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-CREATE-STEP3-13-CP2.24.2: Step 3-Diagnostic Yield: text notify can be closed manually
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-13-CP2.24.2     manual       CP-2.24.2    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-CREATE-STEP3-14-CP2.24.2: Step 3- The modal is displayed when a selected device is not returned
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...     The system displays a modal to inform the user when selected device is not marked as returned
    ...
    ...     Precondition:
    ...     1. User at step 3 during study creation
    ...
    ...     Test Steps:
    ...     1. User selected Device Not Return
    ...
    ...     Expected Results:
    ...     A modal appears, informing the user that the selected device is not marked as returned


    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-14-CP2.24.2     manual       CP-2.24.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-CREATE-STEP3-15-CP2.24.2: Step 3- The modal contains a hyperlink to the study details page
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...     The modal includes a hyperlink to the study details page that opens in a new tab
    ...
    ...     Precondition:
    ...     1. User at step 3 during study creation
    ...     2. User selected Device Not Return
    ...
    ...     Test Steps:
    ...
    ...     Expected Results:
    ...     1. The modal closes
    ...     2. The Device ID field is cleared
    ...     3. Opens the study details page


    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-15-CP2.24.2     manual       CP-2.24.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-CREATE-STEP3-16-CP2.24.2: Step 3- Clicking "Cancel" clears the Device ID field and closes the modal
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...     Ensure that when the user clicks "Cancel" in the modal, the modal closes, and the Device ID field is cleared
    ...
    ...     Precondition:
    ...     1. User at step 3 during study creation
    ...     2. User selected Device Not Return
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-16-CP2.24.2     manual       CP-2.24.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-CREATE-STEP3-17-CP2.24.2: Step 3- Clicking "Continue" marks the device as returned and keeps the Device ID in the field
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...     Ensure that when the user clicks "Continue," the system marks the device as returned and retains the Device ID in the field
    ...
    ...     Precondition:
    ...     1. User at step 3 during study creation
    ...     2. User selected Device Not Return
    ...
    ...
    ...     Expected Results:
    ...     1. The selected device is marked as returned in the system
    ...     2. The Device ID remains in the field
    ...     3. The modal closes


    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-17-CP2.24.2     manual       CP-2.24.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-18-CP2.26.0: UI Select Device: Auto-Suggests Devices with 'Online'+ 'Ready for New Study' (+Maintenance needed)
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-18-CP2.26.0     manual       CP-2.26.0    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-19-CP2.26.0: UI Select Device: Search for All Device IDs Regardless of Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-19-CP2.26.0     manual       CP-2.26.0    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-20-CP2.26.0: UI Select Device: Prioritize 'Online & Ready for New Study' Devices in Search Results
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-20-CP2.26.0     manual       CP-2.26.0    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-21-CP2.26.0: UI Select Device: Display "High Sample Rate" Tag for Devices with 'Online' and 'Ready for New Study' Status and High Sample Rate
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-21-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-22-CP2.26.0: UI Select Device: Display "RMA" Tag for Devices with "Online - Ready for New Study" and "RMA" Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-22-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-23-CP2.26.0: UI Select Device: Display "RMA" Tag for Devices with "High Sample Rate" and "RMA" Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-23-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-24-CP2.26.0: UI Select Device: Display "Renewal" Tag for Devices with "High Sample Rate" and "Renewal" Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-24-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-25-CP2.26.0: UI Select Device: Display "Offline" Tag for Devices with "High Sample Rate" and "Offline" Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-25-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-26-CP2.26.0: UI Select Device: Display "In Study" Tag for Devices with "High Sample Rate" and "In Study" Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-26-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-27-CP2.26.0: UI Select Device: Display "Offline" Tag for Devices with "Maintenance Needed" and "Offline" Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-27-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-28-CP2.26.0: UI Select Device: Display "In study" Tag for Devices with "Maintenance Needed" and "In study" Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-28-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-29-CP2.26.0: UI Select Device: Display "RMA" Tag for Devices with "RMA " and "Offline" Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-29-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-30-CP2.26.0: UI Select Device: Display "Renewal" Tag for Devices with "Renewal " and Offline" Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-30-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-31-CP2.26.0: UI Select Device: Display "In study" Tag for Devices with "In study" and Offline" Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-31-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-32-CP2.26.0: UI Select Device: Display Error Modal for RMA Device When Selecting Device with RMA Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-32-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-33-CP2.26.0: UI Select Device: Display Error Modal for "In Study" Device When Selecting Device with "In Study" Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-33-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-34-CP2.26.0: UI Select Device: Display Error Modal for "Offline" Device When Selecting Device with "Offline" Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-34-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-35-CP2.26.0: UI Select Device: Display Error Modal for "Renewal" Device When Selecting Device with "Renewal" Status
    [Documentation]   Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-35-CP2.26.0     manual       CP-2.26.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-36-CP2.28.0: User Can Add a Physician via NPI Search
    [Documentation]   Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-36-CP2.28.0     manual       CP-2.28.0    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-37-CP2.28.0: NPI Search Input is Focused by Default
    [Documentation]   Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-37-CP2.28.0     manual       CP-2.28.0    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-38-CP2.28.0: NPI Search Input is Focused by Default
    [Documentation]   Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-38-CP2.28.0     manual       CP-2.28.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-39-CP2.28.0: Invalid NPI Input Shows Error
    [Documentation]   Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-39-CP2.28.0     manual       CP-2.28.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-40-CP2.28.0: Valid NPI with No Data Shows Message
    [Documentation]   Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-40-CP2.28.0     manual       CP-2.28.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-41-CP2.28.0: "Searching for Physician..." Screen Appears When Searching by NPI
    [Documentation]   Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-41-CP2.28.0     manual       CP-2.28.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-42-CP2.28.0: Valid NPI Auto-Fills Fields
    [Documentation]   Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-42-CP2.28.0     manual       CP-2.28.0    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-43-CP2.28.0: Allow Editing of Auto-Filled Fields
    [Documentation]   Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-43-CP2.28.0     manual       CP-2.28.0    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP3-44-CP2.29.1: Can Be Initiated study Without a Device ID
    [Documentation]   Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP3-44-CP2.29.1     manual       CP-2.29.1    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP4-01: Fill information in step 4-Diagnosis
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 4-Diagnosis
    ...
    ...     Precondition:
    ...     1. The Clinic Physician user is on Create new study screen – step 4 (Diagnosis)
    ...
    ...     - The Biolfux device assigned to this study will display the study setup screen with the patient’s name,
    ...     patient ID, and study duration information inputted from the above steps
    ...
    ...     **Others**
    ...     Update Date: 8/21/2023 - Trinh Nguyen

    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP4-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP4-02-CP2.16.2: Fill information in step 4-Diagnosis
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 4-Diagnosis
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP4-02-CP2.16.2     manual       CP-2.14.0      CP-2.16.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP4-03-CP2.16.6: Add new primary and secondary diagnosis code in step 4-Diagnosis
    [Documentation]   Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP4-03-CP2.16.6     manual       CP-2.14.0      CP-2.16.6
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-STEP5-01: View information in step 5-Verify ECG signal
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can view information in step 5-Verify ECG signal
    ...
    ...     Precondition:
    ...     1. The Clinic Physician user is on Create new study screen – step 4 (Verify ECG signal)
    ...
    ...     Test Steps:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-STEP5-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-DONE-01-CP2.29.1: Verify Study Redirection to Active Tab When Device Is Assigned
    [Documentation]   Author: Tam Ho
    ...
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-DONE-01-CP2.29.1     manual    CP-2.29.1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-DONE-02-CP2.29.1: Verify Study Redirection to Unassigned Tab When No Device Is Assigned
    [Documentation]   Author: Tam Ho
    ...
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-DONE-02-CP2.29.1     manual    CP-2.29.1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-BIODIRECT-STEP1-01: Fill information in step 1-Patient information
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 1- Patient information
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-BIODIRECT-STEP1-01     auto
    Navigate To Studies Page
    Open New Study
    ${current_page}     Get Current New Study Page
...
BF-PHY-CP-STUDIES-CREATE-BIODIRECT-STEP2-01: Fill information in step 2-Patient contact
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 2- Patient contact
    ...
    ...     Precondition:
    ...     1. The Clinic Physician user is on Create new study screen – step 2 (Patient contact)
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-BIODIRECT-STEP2-01     auto
    Navigate To Studies Page
    Open New Study
    ${current_page}     Get Current New Study Page
    Run Keyword And Continue On Failure    Should Be Equal    ${current_page}       Patient information        # PAGE 1
...
BF-PHY-CP-STUDIES-CREATE-BIODIRECT-STEP3-01: Fill information in step 3-Study information
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 3- Study information
    ...
    ...     Precondition:
    ...     1. The Clinic Physician user is on Create new study screen – step 3 (Study information)
    ...     2. Bioflux Admin has enabled the Biolfux Direct to the facility
    ...
    ...     3. Select a type on the Study type dropdown list
    ...     4. Enter valid value on the Study duration field
    ...     5. Select a valid date on the Patient return visit datepicker
    ...     6. Enter valid value on the Clinic Initials field
    ...
    ...     2. In the Interpreting physician field, the physician name shall be disabled
    ...     3. At step 3,4,5,6, the selected/entered data shall be displayed
    ...     4. At step 8, the user will navigate back to step 2 (Patient contact)
    ...     5. At step 9, the user should be navigated to step 4 (Diagnosis)

    [Tags]  BF-PHY-CP-STUDIES-CREATE-BIODIRECT-STEP3-01     auto
    Navigate To Studies Page
    Open New Study
    ${current_page}     Get Current New Study Page
    Run Keyword And Continue On Failure    Should Be Equal    ${current_page}       Patient information       # PAGE 1
    ...
    Run Keyword And Continue On Failure    Should Be Equal    ${values_page_3}[Interpreting physician]  ${PHY_USER}[0][name]   # Auto assign current phy user
    ...
    Create New Study Page 3    is_next=${True}
    ${current_page}     Get Current New Study Page
    Run Keyword And Continue On Failure    Should Be Equal    ${current_page}       Diagnosis                # PAGE 4

BF-PHY-CP-STUDIES-CREATE-BIODIRECT-STEP4-01: Fill information in step 4-Diagnosis
    [Documentation]     Author:  Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 4-Diagnosis
    ...
    ...
    [Tags]      BF-PHY-CP-STUDIES-CREATE-BIODIRECT-STEP4-01     auto
    Navigate To Studies Page
    Open New Study
    ${current_page}     Get Current New Study Page
    Run Keyword And Continue On Failure    Should Be Equal    ${current_page}       Patient information       # PAGE 1
    ...
    Create New Study Page 2     country=Canada      address=AAR Plumbing and Heating Supply, Steeles Avenue East, Brampton, ON, Canada       primary_phone_number=084-657-4637        email=patient@yopmail.com
    ...  secondary_phone_number=0293757473      secondary_contact=${second_contact}
    Create New Study Page 3     facility=${FACILITIES}[0][name]      device_type=Bioflux   device_id=${DEVICES}[0][id]     referring_physician=Physician Qa Team 01    study_type=MCT – 93228-93229        study_duration=3      patient_return_visit=${date}
    ...  clinician_initials=Initials
    ${current_page}     Get Current New Study Page
...
BF-PHY-CP-STUDIES-CREATE-TEST-STEP1-01: Fill information in step 1-Patient information
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 1- Patient information
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-STEP1-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-TEST-STEP2-01: Fill information in step 2-Patient contact
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 2- Patient contact
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-STEP2-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-TEST-STEP3-01: Fill information in step 3-Study information - with device currently in Maintenance tab
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 3- Study information
    ...
    ...
    ...      + Use anyway
    ...     3. At step 3, the confirmation dialog shall be removed
    ...     4. In the Interpreting physician field, the physician name shall be disabled
    ...     5. At step 4, confirm the use of that device and the selected device shall be displayed
    ...     6. At step 5,6,7,8,9,10 the selected/entered data shall be displayed
    ...     7. At step 11, the user will navigate back to step 2 (Patient contact)
    ...     8. At step 12, the user should be navigated to step 4 (Diagnosis)
    ...
    ...     **Others**
    ...     Update Date: 8/21/2023 - Trinh Nguyen

    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-STEP3-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-TEST-STEP3-02: Fill information in step 3 - with Biocore/Biotres device - Functional test
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 3- Study information
    ...
    ...
    ...     5. Select a MCT/Cardiac event type on the Study type dropdown list
    ...     6. Enter valid value on the Study duration field
    ...     7. Select a valid date on the Patient return visit datepicker
    ...     8. Enter valid value on the Clinic Initials field
    ...     9. Click the Previous button
    ...
    ...     4. In the Interpreting physician field, the physician name shall be disabled
    ...     4. At step 4,5,6,7,8 the selected/entered data shall be displayed
    ...     5. At step 9, the user will navigate back to step 2 (Patient contact)
    ...     6. At step 10, the user should be navigated to step 4 (Diagnosis)
    ...
    ...     **Others**
    ...     Update Date: 8/21/2023 - Trinh Nguyen

    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-STEP3-02     manual    CP-2.13.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-TEST-STEP3-03: Cannot fill information in step 3 - with Biocore/Biotres device - Functional test
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician cannot fill information in step 3- Study information
    ...
    ...     Precondition:
    ...     1. The Clinic Physician user is on Create new study screen – step 3 (Study information)
    ...     2. There is a test facility
    ...
    ...     3. On Device section, select Biocore/Biotres button and select a Device ID on dropdown list
    ...     4. Select a physician on the Referring physician dropdown list
    ...     5. Select a MCT Peek/Holter/Extended Holter event type on the Study type dropdown list
    ...     6. Enter valid value on the Study duration field
    ...     7. Select a valid date on the Patient return visit datepicker
    ...     8. Enter valid value on the Clinic Initials field
    ...     9. Click the Previous button
    ...
    ...     4. At step 4,5,6,7,8 the selected/entered data shall be displayed
    ...     5. At step 9, the user will navigate back to step 2 (Patient contact)
    ...     6. At step 10, a modal with the following error message shall be displayed: "You can only create an MCT
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-STEP3-03     manual    CP-2.13.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-TEST-STEP3-04: Fill information in step 3 - with Biocore/Biotres device
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 3 with Biocore/Biotres device have a FW version has been
    ...
    ...     2. On Device section, select Biocore/Biotres button and select a Device ID on dropdown list
    ...     3. Select a physician on the Referring physician dropdown list
    ...     4. Select a MCT/MCT PEEK/CARDIAC EVENT/HOLTER/EXTENDED HOLTER/HOLTER AND FOLLOW ON STUDY type on the
    ...     Study type dropdown list
    ...     5. Enter valid value on the Study duration field
    ...     6. Select a valid date on the Patient return visit datepicker
    ...     7. Enter valid value on the Clinic Initials field
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-STEP3-04     manual    CP-2.14.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-TEST-STEP3-05: Fill information in step 3 - with Bioflux device
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 3- Study information
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-STEP3-05     manual    CP-2.13.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-TEST-STEP3-06-CP2.24.2: Confirm returned device if the selected device is not returned for any studies - For Active facility
    [Documentation]   Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-STEP3-06-CP2.24.2    manual    CP-2.24.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-TEST-STEP3-05-CP2.16.8: Confirm returned device if the selected device is not returned - For Active facility
    [Documentation]   Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-STEP3-05-CP2.16.8     manual    CP-2.16.8     deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-TEST-STEP4-01: Fill information in step 4-Diagnosis
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 4-Diagnosis
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-STEP4-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-TEST-STEP4-02-CP2.16.2: Fill information in step 4-Diagnosis
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 4-Diagnosis
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-STEP4-02-CP2.16.2     manual       CP-2.14.0      CP-2.16.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-TEST-STEP5-01: View information in step 5-Verify ECG signal
    [Documentation]   Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can view information in step 5-Verify ECG signal
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-STEP5-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-TEST-STEP5-01-CP2.16.8: Check "Create Return Shipping Label" function for Active facility
    [Documentation]   Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-STEP5-01-CP2.16.8     manual      CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-TEST-01: Automatically stop study of Functional test study
    [Documentation]   Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-01     manual  CP-2.13.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-TEST-02: Automatically generate EOU report
    [Documentation]   Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-TEST-02     manual  CP-2.13.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-COPY-01: Create a new study from an existing study (MCT/Cardiac/Holter/Extended Holter/MCT Peek
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     Description: The clinic Physician can fill information in step 1- Patient information
    ...
    ...     Precondition:
    ...     1. The Clinic Physician is on the STUDIES page
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-COPY-01        auto
#     Update Financial hold of the facility is “None”
    ...
    Create New Study Page 1   is_next=${True}
    Create New Study Page 2   is_next=${True}
#    Create New Study Page 3   facility=${FACILITIES}[0][name]     is_next=${False}
    ...
    ...           AND             Api Delete Studies      ${AWS_TOKEN}   studyIds=${study_friendlyid}

BF-PHY-CP-STUDIES-CREATE-01: Bioflux-Create new study with a single study type (MCT/MCT Peek/Cardiac event/Holter/Ext.Holter)
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-01     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-02: Bioflux-Create new study with a Holter and FO study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-02     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-02-CP2.25.3: Bioflux-Create new study with a Holter and FO study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-02-CP2.25.3     manual   R1    CP-2.25.3
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-03-CP2.25.3: Bioflux-Create new study with an Ext.Holter and FO study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-03-CP2.25.3     manual   R1    CP-2.25.3
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-04-CP2.25.3: Biocore (FW>=1.5.0 and enabled Auto event detection)-Create new study with a Holter and FO study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-04-CP2.25.3     manual   R1    CP-2.25.3
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-05-CP2.25.3: Biocore (FW>=1.5.0 and enabled Auto event detection)-Create new study with a Ext.Holter and FO study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-05-CP2.25.3     manual   R1    CP-2.25.3
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-06-CP2.25.3: Biocore Pro-Create new study with an Holter and FO study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-06-CP2.25.3     manual   R1    CP-2.25.3
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-07-CP2.25.3: Biocore Pro-Create new study with an Ext.Holter and FO study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-07-CP2.25.3     manual   R1    CP-2.25.3
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-08-CP2.25.3: Biocore-Create new study with a Holter and FO study using Biodirect service
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-08-CP2.25.3     manual   R1    CP-2.25.3
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-09-CP2.25.3: Biocore-Create new study with an Ext.Holter and FO study using Biodirect service
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-09-CP2.25.3     manual   R1    CP-2.25.3
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-10-CP2.25.3: Biocore Pro-Create new study with a Holter and FO study using Biodirect service
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-10-CP2.25.3     manual   R1    CP-2.25.3
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-11-CP2.25.3: Biocore Pro-Create new study with an Ext.Holter and FO study using Biodirect service
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-11-CP2.25.3     manual   R1    CP-2.25.3
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-03: Bioflux-Create new study with a single study type (MCT/MCT Peek/Cardiac event/Holter/Ext.Holter) using Biodirect service
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-03     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-04: Bioflux-Create new study with a Holter and FO study using Biodirect service
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-04     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-05: Biocore/Biotres (No Auto tag + FW <1.5.0)-Can create new study with Holter/Ext.Holter study type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-05     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-06: Biocore/Biotres (No Auto tag + FW <1.5.0)-Cannot create new study with MCT/MCT Peek/Cardiac Event/HnFO study type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-06     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-07: Biocore/Biotres (No Auto tag + FW >=1.5.0)-Can create new study with Holter/Ext.Holter study type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-07     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-08: Biocore/Biotres (No Auto tag + FW >=1.5.0)-Cannot create new study with MCT/MCT Peek/Cardiac Event/HnFO study type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-08     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-09: Biocore/Biotres (Auto tag + FW <1.5.0)-Can create new study with Holter/Ext.Holter study type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-09     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-10: Biocore/Biotres (Auto tag + FW <1.5.0)-Cannot create new study with MCT/MCT Peek/Cardiac Event/HnFO study type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-10     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-11: Biocore/Biotres (Auto tag + FW >=1.5.0)-Can create new study with any study type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-11     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-12: Biocore/Biotres-Cannot create new study using Biodirect service
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-12     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-13: Bioflux-Copy an existing study to create new study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-13     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-14: Bioflux-Copy an existing study using Biodirect service to create new study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-14     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-15: Biocore/Biotres-Copy an existing study to create new study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-15     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-16: Bioflux-Can create new Test Study with MCT/Cardiac even type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-16     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-17: Bioflux-Cannot create new Test Study with Holter/Ext.Holter/MCT Peek/HnFO type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-17     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-18: Biocore/Biotres (FW <1.5.0)-Can create new Test Study with Holter/Ext.Holter type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-18     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-19: Biocore/Biotres (FW <1.5.0)-Cannot create new Test Study with MCT/MCT Peek/Cardiac event type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-19     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-20: Biocore/Biotres (FW >=1.5.0)-Can create new Test Study with MCT/Cardiac event type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-20     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-21: Biocore/Biotres (FW >=1.5.0)-Cannot create new Test Study with MCT Peek/Holter/Ext.Holter/HnFO type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-21     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-22: Bioflux-Copy an existing Test study to create new study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-22     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-23: Biocore/Biotres-Copy an existing Test study to create new study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-23     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-23-CP2.25.3: Biocore Pro-Copy an existing Test study to create new study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-23-CP2.25.3     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-24: Cannot create a new study if financial hold is 90 days
    [Documentation]     Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-24    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-25: Cannot create a new study if financial hold is 90 days
    [Documentation]     Author: Trinh Nguyen
    ...     Description: User cannot create a new study if financial hold is 90 days
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-25    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-26: Active Facility-Can create Holter study with duration is in hours unit (from 1h to 72h)
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-26    manual    CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-27: Active Facility-Can create Holter and FO study with duration is in hours unit (from 1h to 72h) for Holter type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-27    manual    CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-28: Test Facility-Can create Holter study with duration is in hours unit (from 1h to 72h)
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-28    manual    CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-29: Test Facility-Can create Holter and FO study with duration is in hours unit (from 1h to 72h) for Holter type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-29    manual    CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-30: Create Biodirect study for Biocore device
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-30    manual    CP-2.22.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-31: Create Biodirect study for Biocore Pro device
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-31   manual    CP-2.22.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-32: Create Biodirect study for Biocore from Bioheart shop
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-32   manual    CP-2.22.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-33: Create study for Biocore using FW High sampling rate
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-33   manual    CP-2.23.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-CREATE-34: Create study for Biocore Pro using FW High sampling rate
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-CREATE-34   manual    CP-2.23.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
SUITE SETUP
    ...
    ${CLINIC_TOKEN}       Sign In Bioflux       username=${PHY_USER}[0][username]       password=${PHY_USER}[0][password]
...
Api Study - Create
    Api Create Study On    token=${AWS_TOKEN}    facility=${FACILITIES}[1][id]   device_id=${DEVICES}[bioflux_device][1][id]   study_type=CARDIAC EVENT   device_type=Bioflux
    ${filter}          Create Dictionary     status=Ongoing        deviceId=${DEVICES}[bioflux_device][1][id]
    ${filter}          Create Dictionary     filter=${filter}
