*** Settings ***
Documentation   Test Suite - Clinic Portal - Archived studies
Metadata    sid     BF-PHY-ARCHIVED-STUDY
...
Force Tags      BF-PHY-ARCHIVED-STUDY    web
Test Timeout    1h

*** Test Cases ***
BF-PHY-ARCHIVED-STUDY-01: Study management page >> Events tab-Cannot view event list
    ...
    ...     Last Update: 03/11/2023, 11/22/2023
    ...
    [Tags]  BF-PHY-ARCHIVED-STUDY-01       auto        CP-2.16.7
...
BF-PHY-ARCHIVED-STUDY-02: Study management page >> ECG Viewer tab-Cannot view HR chart and events
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description: Events tab-Cannot view event list
    ...
    ...
    ...     **Others**:
    ...     Author Update: Thang Tran
    ...     Last Update: 11/03/2023, 11/22/2023
    ...
    [Tags]  BF-PHY-ARCHIVED-STUDY-02        auto        CP-2.16.7
    Navigate To Studies Page
    Filter Studies    study_state=Completed
    ${studies}      Get Completed Studies
    Run Keyword And Continue On Failure    Should Not Be Empty    ${studies}
...
BF-PHY-ARCHIVED-STUDY-03: Study management page >> Instant Reports-View tab if the study has never had reports created previously
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description: Events tab-Cannot view event list
    ...
    ...
    ...     **Others**:
    ...     Author Update: Thang Tran
    ...     Last Update: 11/03/2023, 11/22/2023, 07/24/2024(Nhan Nguyen)
    ...
    [Tags]  BF-PHY-ARCHIVED-STUDY-03       manual       CP-2.16.7       inactive
...
#    ${page_header}      Get Page Header Detail
#    Run Keyword And Continue On Failure    Should Be Equal    ${page_header}      STUDY
#    Navigate To Study Details Tab       Instant report
...
BF-PHY-ARCHIVED-STUDY-04: Study management page >> Instant Reports-View tab if the study has had reports created previously
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-ARCHIVED-STUDY-04       manual        CP-2.16.7      inactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
