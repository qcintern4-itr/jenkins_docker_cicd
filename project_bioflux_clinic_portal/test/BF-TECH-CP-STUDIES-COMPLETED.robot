...
Metadata    sid     BF-TECH-CP-STUDIES-COMPLETED
...
Force Tags          BF-TECH-CP-STUDIES-COMPLETED        web
Test Timeout        1h

# Facing bug: https://itrvn.atlassian.net/browse/BF-3368
*** Test Cases ***
BF-TECH-CP-STUDIES-COMPLETED-VIEW-01: View a list of completed studies
    ...
    ...     2. This tab shall also include aborted studies (studies canceled by Call center users) but they won’t be
    ...     displayed until the user searches for a study and selects the “Include aborted study” checkbox
    ...     3. The tab includes the following information
    ...
    ...     - Delete: (button). It is used to delete the study. This button only displays for Clinic Technician and
    ...     will not be displayed for aborted studies
    ...     - Copy to a new study: (button). It is used to copy the information to the new study. This button only
    ...     displays for Clinic Technician
    ...     - Action: the user shall be able to access the STUDY MANAGEMENT page of the study by hovering over the
    ...     row of the study list

    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-VIEW-01     auto
...
BF-TECH-CP-STUDIES-COMPLETED-SORT-STUDY-01: Sort the Completed study by Study ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-STUDIES-COMPLETED-SORT-STUDY-01       auto
    Navigate To Studies Page
    Filter Studies    study_state=Completed
    Select Facility    All facilities
    # sort descending
...
BF-TECH-CP-STUDIES-COMPLETED-PAGINATION-01: Check pagination tool works properly in Completed tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]      BF-TECH-CP-STUDIES-COMPLETED-PAGINATION-01       auto
    Navigate To Studies Page
    Filter Studies    study_state=Completed
...
BF-TECH-CP-STUDIES-COMPLETED-FILTER-FACILITY-01: View the name of the facility in case the user only associates with one facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-FILTER-FACILITY-01     auto
    Navigate To Studies Page
    Filter Studies    study_state=Completed
...
BF-TECH-CP-STUDIES-COMPLETED-FILTER-FACILITY-02: Select a specific facility in case the user associates with multiples facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-FILTER-FACILITY-02     auto
    Navigate To Studies Page
    Filter Studies    study_state=Completed
    ...
    Select Facility     All facilities
    ${studies}          Get Completed Studies
    Run Keyword And Continue On Failure    Should Not Be Empty    ${studies}      No completed studies found - with facility 'All facilities'

BF-TECH-CP-STUDIES-COMPLETED-SEARCH-01: View all search attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-SEARCH-01      auto
    Navigate To Studies Page
    Filter Studies    study_state=Completed
    ...
    Run Keyword And Continue On Failure    Should Be Equal    ${current_filter}[Study state]    Completed
    Run Keyword And Continue On Failure    Should Be Equal    ${current_filter}[Search by]      Search...

BF-TECH-CP-STUDIES-COMPLETED-SEARCH-02: Search by Patient Name attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-SEARCH-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    [Template]    Filter Completed - Studies
#    Patient Name

BF-TECH-CP-STUDIES-COMPLETED-SEARCH-03: Search by Study ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-SEARCH-03      auto
    [Template]    Filter Completed - Studies
    Study ID

BF-TECH-CP-STUDIES-COMPLETED-SEARCH-04: Search by Patient ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-SEARCH-04      auto
    [Template]    Filter Completed - Studies
    Patient ID

BF-TECH-CP-STUDIES-COMPLETED-SEARCH-05: Search by Device ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-SEARCH-05      auto
    [Template]    Filter Completed - Studies
    Device ID

BF-TECH-CP-STUDIES-COMPLETED-SEARCH-06: Search a study aborted by Call center supervisor
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-SEARCH-06       auto       R1
    Navigate To Studies Page
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-01: View details information for MCT/MCT PEEK/CARDIAC EVENT/HOLTER/EXT HOLTER studies
    [Documentation]    Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-01       auto
    Navigate To Studies Page
    Filter Studies    study_state=Completed
    ${studies}      Get Completed Studies
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-02: View details information for For studies running 'Holter & Follow-on' study
    [Documentation]    Author: Trinh Nguyen
    ...     Description: The user can view the detailed information of the study
    ...
    ...     Precondition:
...
#    ...     “This study has been aborted and will not be counted toward your billing.”
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-02    auto
    Navigate To Studies Page
    Filter Studies    study_state=Completed
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-05-CP-2.16.6: Can view the new primary and secondary diagnosis code
    [Documentation]    Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-05-CP-2.16.6      manual       CP-2.16.6
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-06-CP-2.16.6: Can edit to the new primary and secondary diagnosis code
    [Documentation]    Author: Trinh Nguyen
    ...     Description: The user can view the new primary and secondary diagnosis code in study details of a study
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-06-CP-2.16.6      auto
    Navigate To Studies Page
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-PATIENT-01: View the detailed information of the patient
    [Documentation]  Author: Trinh Nguyen
...
#    ...     “This study has been aborted and will not be counted toward your billing.”
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-PATIENT-01     auto
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-01: View list of reports sent by the Call center of a study
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-01       auto     R1
    Navigate To Studies Page
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-02: Search Interim/EOU report by Report ID
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-02       auto        R1
    Navigate To Studies Page
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
    Navigate To Study Details Tab    Reports
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-03: Search Notification/Event report by Report ID
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-03      auto     R1
    Navigate To Studies Page
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
    Navigate To Study Details Tab    Reports
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-04: Check a tooltip shall displayed when user hovers over the error tag
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-04       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-05: Can sort report by Report ID/Last Modified/Type/Reviewed
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-05       auto     R1
    Navigate To Studies Page
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
    Navigate To Study Details Tab    Reports
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-06: Check the pagination tool is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-06        auto      R1
    Navigate To Studies Page
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
    Navigate To Study Details Tab    Reports
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-07: Check user can go to the Report View page by clicking the Edit report button
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-07       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-08: View Interim/EOU report details in study management page
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-08       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-09: View Notification/Event report details in study management page
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-09       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-10: Can mark the reports as reviewed/unreviewed
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-10      auto     R1
    Navigate To Studies Page
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
    Navigate To Study Details Tab    Reports
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-11: Can navigate to the report screen of the study management page by clicking the close button
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-11       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-12: MCT study/EOU old report format-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-12       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-13: MCT study/EOU new report format-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-13       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-14: MCT Peek study/EOU old report format-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-14       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-15: MCT Peek study/EOU new report format-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-15       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-16: Holter/Ext.Holter study/EOU old report format-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-16       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-17: Holter/Ext.Holter study/EOU new report format-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-17       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-18: Cardiac Event study/EOU old report format-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-18       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-19: EOU-Download report
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-19       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-20: Interim-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-20       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-21: Interim-Download report
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-21       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-22: Notification-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-22       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-23: Notification-Download report
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-23       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-24: Event-Add Interpretation
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-24       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-25: Event-Download report
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-25       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-26: Event-View ECG strip
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-26       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-27: Cannot view Event/Notification report in case the financial hold of facility is 80 or 90 days
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-27       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-28: Cannot view Interim/EOU report in case the financial hold of facility is 80 or 90 days
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-28       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-29: The report tab shall not be displayed for aborted studies
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-REPORT-29      auto     R1
    Navigate To Studies Page
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-01: View components displayed on Events list
    [Documentation]  Author: Trinh Nguyen
...
#    ...     10. For aborted studies, this Events tab shall not be displayed
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-01-CP2.21.0: Display patient manual events, regardless of symptom, validitity, open or closed
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-01-CP2.21.0       manual      R1     CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-02-CP2.21.0: Display auto events with status valid and closed
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-02-CP2.21.0       manual      R1     CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-03-CP2.21.0: Not display manual events (Evaluation trips, baseline, resumed) unless status valid and closed
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-03-CP2.21.0       manual      R1     CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-04-CP2.21.0: Check if an event is annotated with a section of ECG strip marked that strip shall be shown as annotated
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-04-CP2.21.0       manual      R1     CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-02: Filter event list by range date of study duration
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-02       auto      R1
    Navigate To Studies Page
    # check list summary reports
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-03: Sort event list by descending/escending order
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-03       auto      R1
    Navigate To Studies Page
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
    Navigate To Study Details Tab    Events
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-04: Filter event list by event type
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-04       auto      R1
    ...
    Pause
    Manual
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-05: Reload the event list by "Manual reload" button
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-05       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-06: Search for an event by Event ID
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-06      auto      R1
    Navigate To Studies Page
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
    Navigate To Study Details Tab    Events
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-07: View ECG details of an event
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-07      auto      R1
    Navigate To Studies Page
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
    Navigate To Study Details Tab    Events
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-08: For aborted studies, this Events tab shall not be displayed
    [Documentation]  Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-EVENT-08       auto      R1
    Navigate To Studies Page
    # check list summary reports
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[aborted_study_id]
    Select Aborted Study
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-01:View details of the ECG Viewer tab
    [Documentation]     Author: Trinh Nguyen
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-02: Check there is message displayed in case study running on Biodirect service has not been started by the patient
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-02     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-03: Check there is message displayed in case the event data of the selected date has not been uploaded to the system yet
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-03     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-04: The user can view the HR chart of a specific date by selecting the date from the drop-down selection
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-04     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-05: Check there is a message displayed in case the event data of the selected date has not been uploaded to the system yet
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-05     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-06: Check the Refresh button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-06     auto
    Navigate To Studies Page
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-07: Check the Show event indicators checkbox is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-07     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-08: Check the Show event indicators checkbox is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-08     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-09: Check case there shall be highlighted blank spaces between the heartbeat lines in case there is no heart rate data at any time period in the HR chart
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-09     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-10: Check there shall be a vertical line indicating the time and the heart rate at that time when the user hovers over the HR chart
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-10     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-11: Check the label shall displayed the time and NA for HR at that time in case the user hovers over the period of time on the HR chart that does not have data
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-11     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-12: Check details of the ECG chart when the user clicks on the HR chart
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-12     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-13: Check the user cannot click on the HR chart of the time periods that do not have any data
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-13     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-14: Check details of the Event information bar under the HR chart when user clicks on the HR chart
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-14     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-15: Check behavior when the user clicks on the HR chart and drags
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-15     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-16: Check the Reset zoom button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-16     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-17: Check case the user selects the vertical line and then zooms in the HR chart
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-17     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-18: Check the user can only zoom in and zoom out one time
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-18     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-19: Check case the user clicks on an event in the event list while zooming in
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-19     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-20: Check details of the ECG chart
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-20     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-21: Check case the user clicks on an event in the event list while zooming in
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-21     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-22: Check Speed filter on ECG chart is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-22     auto
    Navigate To Studies Page
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
    Navigate To Study Details Tab    ECG viewer
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-23: Check Gain filter on ECG chart is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-23     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-24: Check High Pass filter tool on ECG chart is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-24     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-25: Check Low Pass filter tool on ECG chart is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-25     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-26: Check Show/Hide Channels button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-26     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-27: Check the Beat marker tool is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-27     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-28: Check the View all strip button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-28     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-29: Check user can Add beat marker
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-29     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-30: Check user can Remove beat marker
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-30     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-31: Check Horizontal Caliper button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-31     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-32: Check Vertical Caliper button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-32     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-33: Check Beat Calipers button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-33     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-34: Check Text Annotation button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-34     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-35: Check Mark 10 Sec button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-35     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-36: Check Mark 20 Sec button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-36     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-37: Check Mark a Pattern button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-37     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-38: Check Hide Beat Markers button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-38     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-39: Check details of the Event section
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-39    auto
    Navigate To Studies Page
    # check list summary reports
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-40: Check result when user clicks on the row of an event
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-40     auto
    Navigate To Studies Page
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
    Navigate To Study Details Tab    ECG viewer
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-41: Check the event type filter is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-41     auto
    Navigate To Studies Page
    # check list summary reports
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-42: Check the user can access the ECG Viewer Guideline
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-42     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-43: Check the Do not show this again checkbox is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-43     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-44: Check the Pagination tool below the Event lists is working prorerly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-44     auto
    Navigate To Studies Page
    # check list summary reports
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[study_id_report]
    Manage Completed Study On    row=1
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-45: The ECG Viewer tab shall not be dislayed for aborted studies
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-ECG-VIEWER-45     auto      R1
    Navigate To Studies Page
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[aborted_study_id]
    Select Aborted Study
    Manage Completed Study On    row=1
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-01: Create an manual Instant report
    [Documentation]  Author: Nhan Nguyen
    ...
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-01       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-02: Auto-Generate Instant Report When Study Concludes and All Data Is Uploaded
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/25/2025-TamHo
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-02       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-03: Create an Instant Report With Overlapping Time Frame (No New Data Uploaded) and The previous report is generated
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/25/2025-TamHo
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-03       manual    R2      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-04: Create an Instant Report With Overlapping Time Frame (No New Data Uploaded) and The previous report is generating
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/25/2025-TamHo
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-04       manual    R2      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-05: Create an Instant Report With Overlapping Time Frame (New Data Uploaded)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/25/2025-TamHo
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-05       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-06: Create an Instant Report With Overlapping Time Frame (No New Data Uploaded) and The previous report is generated + Artifact
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/25/2025-TamHo
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-06       manual    R2      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-07: View the List of Instant Reports
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/25/2025-TamHo
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-07       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-08: View a Generated Instant Report when EOU report not ready
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/25/2025-TamHo
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-08       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-09: Verify Pop-up Notification When Accessing an Auto-Generated Instant Report While the EOU Report is Ready
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/25/2025-TamHo
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-09       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-10: Verify Navigation to EOU Report from the Pop-up
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/25/2025-TamHo
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-10       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-11: Verify Navigation to Instant Report from the Pop-up
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/25/2025-TamHo
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-11       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-12: Verify Alert Banner and Navigation Link to EOU Report After Selecting View Instant Report
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/25/2025-TamHo
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-12       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-13: Check the pagniation tool is working
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/25/2025-TamHo
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-13       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-14: Instant-Download report
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/25/2025-TamHo
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-14       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-15: Verify Instant Report Tab is Not Displayed for Aborted Studies
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Last updated: 03/25/2025- TamHo
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-INSTANT-15       auto      R1
    Navigate To Studies Page
    Filter Studies    study_state=Completed     search_by=Study ID      text_search=${STUDY_ID_COMPLETED}[aborted_study_id]
    Select Aborted Study
    Manage Completed Study On    row=1
    ${tab}      Get Study Details Tab
    Run Keyword And Continue On Failure    List Should Not Contain Value    ${tab}      Instant report

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-RETURN-01: Return Status tab not available for Test facility
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-RETURN-01      manual     R1     CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-RETURN-02: For Active facility - Edit Return status
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-RETURN-02       auto      R1
    Navigate To Studies Page
    Filter Studies    study_state=Completed
    Manage Completed Study On    row=1
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-RETURN-03: For Active facility - Edit Notes
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-RETURN-03      auto      R1
    Navigate To Studies Page
    Filter Studies    study_state=Completed
    Manage Completed Study On    row=1
    Navigate To Study Details Tab    Return status
...
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-RETURN-04: For Active facility - Create a return shipping label
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-RETURN-04       manual     R1     CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-RETURN-05: For Active facility - Check "Device returned" toggle disabled
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-RETURN-05      manual     R1     CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-TECH-CP-STUDIES-COMPLETED-DETAILS-BIODIRECT-STATUS-01:Display Shipping Label Details for Sending Device Status
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-BIODIRECT-STATUS-01       manual     R1     CP-2.25.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-BIODIRECT-STATUS-02:Display Shipping Label Details for Returning Device Status
    [Documentation]     Author: Tam Ho
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-BIODIRECT-STATUS-02       manual     R1     CP-2.25.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-CP-STUDIES-COMPLETED-DETAILS-BIODIRECT-STATUS-03: Display message "No shipping label created yet" when Study Biodirect has not shipment label
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-DETAILS-BIODIRECT-STATUS-03      manual    CP-2.25.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-TECH-CP-STUDIES-COMPLETED-EDIT-STUDY-INFO-01: Edit Patient return visit
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-EDIT-STUDY-INFO-01      auto
    Navigate To Studies Page
    Filter Studies  study_state=Completed
    Manage Completed Study On    row=1
    # Verify page header
...
BF-TECH-CP-STUDIES-COMPLETED-EDIT-STUDY-INFO-02: Change Referring physician
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-EDIT-STUDY-INFO-02       auto
    Navigate To Studies Page
    Filter Studies  study_state=Completed
    Manage Completed Study On    row=1
    ${page_header}      Get Study Details Overview
...
BF-TECH-CP-STUDIES-COMPLETED-EDIT-STUDY-INFO-03: Change Interpreting physician
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-EDIT-STUDY-INFO-03     auto
    Navigate To Studies Page
    Filter Studies  study_state=Completed
    Manage Completed Study On    row=1
    ${page_header}      Get Study Details Overview
    ...
    ${tab}      Get Current Study Details Tab
    Run Keyword And Continue On Failure    Should Be Equal    ${tab}      Study details
    ${interpreting_physician}      Create Dictionary    interpreting_physician=${REFERRING_PHYSICIAN}     is_change=${False}
...
BF-TECH-CP-STUDIES-COMPLETED-EDIT-STUDY-INFO-04: Edit Diagnosis info and Patient medication
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-EDIT-STUDY-INFO-04      auto
    Navigate To Studies Page
    Filter Studies  study_state=Completed
    Manage Completed Study On    row=1
    ${page_header}      Get Study Details Overview
...
BF-TECH-CP-STUDIES-COMPLETED-EDIT-STUDY-INFO-05: The Edit Physician admendments notes session is not displayed
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-EDIT-STUDY-INFO-05     auto
    Navigate To Studies Page
    Filter Studies  study_state=Completed
    Manage Completed Study On    row=1
    ${page_header}      Get Study Details Overview
...
BF-TECH-CP-STUDIES-COMPLETED-01: Can delete a Biocore/Biotres study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-01     auto
    Navigate To Studies Page
    Filter Studies    study_state=Completed
    ${studies}      Get Completed Studies
...
BF-TECH-CP-STUDIES-COMPLETED-02: Can delete multiple Biocore/Biotres studies
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-02     auto
    Navigate To Studies Page
    Filter Studies    study_state=Completed
...
BF-TECH-CP-STUDIES-COMPLETED-03: Cannot delete a Bioflux study using Biodirect service
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-03      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Filter Studies    study_state=Completed
#    ${completed}      Get Completed Studies
#    Run Keyword And Continue On Failure    Should Not Be Empty    ${completed}
...
BF-TECH-CP-STUDIES-COMPLETED-EDIT-PATIENT-INFO-01: Edit Patient info
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-EDIT-PATIENT-INFO-01     auto
    Navigate To Studies Page
    Filter Studies  study_state=Completed
    Manage Completed Study On    row=1
    ${page_header}      Get Study Details Overview
...
BF-TECH-CP-STUDIES-COMPLETED-EDIT-PATIENT-INFO-02: Edit Patient contact
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-EDIT-PATIENT-INFO-02     auto
    Navigate To Studies Page
    Filter Studies  study_state=Completed
    Manage Completed Study On    row=1
    ${page_header}      Get Study Details Overview
...
BF-TECH-CP-STUDIES-COMPLETED-EDIT-PATIENT-INFO-03: Edit Patient's secondary contact
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-EDIT-PATIENT-INFO-03     auto
    Navigate To Studies Page
    Filter Studies  study_state=Completed
    Manage Completed Study On    row=1
    ${page_header}      Get Study Details Overview
...
BF-TECH-CP-STUDIES-COMPLETED-EDIT-PATIENT-INFO-04: Edit Patient's insurance
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-EDIT-PATIENT-INFO-04    auto
    Navigate To Studies Page
    Filter Studies  study_state=Completed
    Manage Completed Study On    row=1
    ${page_header}      Get Study Details Overview
...
BF-TECH-CP-STUDIES-COMPLETED-EDIT-PATIENT-INFO-05: Edit Patient's medical history
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-EDIT-PATIENT-INFO-05     auto
    Navigate To Studies Page
    Filter Studies  study_state=Completed
    Manage Completed Study On    row=1
    ${page_header}      Get Study Details Overview
...
BF-TECH-CP-STUDIES-COMPLETED-QUICK-ACCESS-01: Quick access to study info and can go to study management page here
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-QUICK-ACCESS-01     auto
    Navigate To Studies Page
    Filter Studies  study_state=Completed
    ${completed_studies}       Get Completed Studies
...
BF-TECH-CP-STUDIES-COMPLETED-QUICK-ACCESS-02: Quick access to patient info
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-QUICK-ACCESS-02     auto
    Navigate To Studies Page
    Filter Studies  study_state=Completed
    ${completed_studies}       Get Completed Studies
    ${studies_id}              Evaluate    [item['Study ID'] for item in ${completed_studies}]
...
BF-TECH-CP-STUDIES-COMPLETED-QUICK-ACCESS-03: Quick access to device info
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Auto create: 03/08/2024 - Thang Tran
    ...
    [Tags]  BF-TECH-CP-STUDIES-COMPLETED-QUICK-ACCESS-03     auto     CP-2.23.0
    Navigate To Studies Page
    Filter Studies  study_state=Completed
    ${completed_studies}       Get Completed Studies
    ${studies_id}              Evaluate    [item['Study ID'] for item in ${completed_studies}]
...
Filter Completed - Studies
    ...
    ...  Run Keyword And Continue On Failure    Should Be True    all('${text_search}' in f['Patient ID'] for f in ${studies})      Invalid results are showing - with ${search_by} text search `${text_search}`
    Run Keyword If    '${search_by}'.lower() == 'device id'
    ...  Run Keyword And Continue On Failure    Should Be True    all('${text_search}' in f['Device ID'] for f in ${studies})       Invalid results are showing - with ${search_by} text search `${text_search}`
