...
Force Tags      BF-PHY-FLEET      web
Test Timeout    1h

*** Test Cases ***
BF-PHY-FLEET-RMA-CREATE-01: Submit an RMA ticket to Biotricity in case user only associates with more than one facility
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-01       auto
    Navigate To Fleet
    Navigate To Fleet Tab    RMA Request
    ${rma_device_info}      Create Dictionary    device_id=${DEVICE}[device_id_1]       reasons=Charging Issue      add_more=${True}
    ${rma_shipping_address}     Create Dictionary    contact_email=test@yopmail.com       contact_phone=484-351-2215
    Add New Rma Request     facility=Facility_QA_01     rma_device_info=${rma_device_info}      notification_email=test@yopmail.com       shipping_address=${rma_shipping_address}
    Navigate To Other Page    page=Devices
    Filter Devices    devices_tab=Devices       devices_subtab=RMA      text_search=${DEVICE}[device_id_1]
    ${devices}      Get Devices On Page
    Run Keyword And Continue On Failure    Should Be Equal    ${devices}[0][Device ID]         ${DEVICE}[device_id_1] | RMA
    Filter Devices    devices_subtab=All devices
    ${devices}      Get Devices On Page
    Run Keyword And Continue On Failure    Should Be Equal    ${devices}[0][Device ID]         ${DEVICE}[device_id_1] | RMA
    Clear RMA Request
    Navigate To Other Page    page=Devices
    Filter Devices    devices_tab=Devices       devices_subtab=All devices      text_search=${DEVICE}[device_id_1]
    ${devices}      Get Devices On Page
    Run Keyword And Continue On Failure    Should Be Equal    ${devices}[0][Device ID]         ${DEVICE}[device_id_1]

BF-PHY-FLEET-RMA-CREATE-02: View list of Reason for RMA of Bioflux
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-02       manual       R1    CP-2.18.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-03: View list of Reason for RMA of Biocore/Biotres
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-03       manual       R1    CP-2.18.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-03-CP2.18.0: View list of Reason for RMA of Biocore/Biotres Pro
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-03-CP2.18.0       manual       R1   CP-2.18.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-04: View list of Patient impact
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-04       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-05: Cannot add a RMA devices if the number of devices in the device list with the reason "Device issues" reaches 5
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-05       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-MAINTENANCE-01: Facility has not subscibed Protect+ program-Iinitiate an RMA request with reason "Return for Maintenance" for a device
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-MAINTENANCE-01       manual    CP-2.26.0       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-MAINTENANCE-02: Facility has subscibed Protect+ program-Iinitiate an RMA request with reason "Protect+ Program" for a device
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-MAINTENANCE-02       manual    CP-2.26.0       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-MAINTENANCE-03: Facility has not subscibed Protect+ program-Iinitiate an RMA request with reason "Return for Maintenance" for multiple devices
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-MAINTENANCE-03       manual    CP-2.26.0       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-MAINTENANCE-04: Facility has subscibed Protect+ program-Iinitiate an RMA request with reason "Protect+ Program" for multiple devices
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-MAINTENANCE-04       manual    CP-2.26.0       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-MAINTENANCE-05: Cannot initiate an RMA request with reason "Return for Maintenance" for multiple devices exceeded max RMA devices
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-MAINTENANCE-05       manual    CP-2.26.0       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-MAINTENANCE-06: Cannot initiate an RMA request with reason "Protect+ Program" for multiple devices exceeded max RMA devices
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-MAINTENANCE-06       manual    CP-2.26.0       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-VIEW-01 : View list of RMA tickets
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-VIEW-01        auto    R1
    ...
    Run Keyword And Continue On Failure    Should Be Equal    ${current_filter}[RMA State]    All statuses       # All statuses by default
...
BF-PHY-FLEET-RMA-VIEW-02: View details of a Pending RMA
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-VIEW-02        auto        R1
    Navigate To Fleet
...
BF-PHY-FLEET-RMA-VIEW-03: View details of an Approved RMA
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can view the detail of an Approved RMA ticket in the RMA list
    ...
    ...     Precondition: The user is on the RMA tab of Fleet page
    ...
    ...     Test Steps:
    ...
    [Tags]  BF-PHY-FLEET-RMA-VIEW-03        auto        R1
    [Template]    Check RMA Request Details
    Approved

BF-PHY-FLEET-RMA-VIEW-04: View details of a Completed RMA
    [Documentation]     Author: Trinh Nguyen
    ...
...
#    ...      + After 120 days from the date of order creation, the timeline will no longer be visible
    ...
    [Tags]  BF-PHY-FLEET-RMA-VIEW-04        auto        R1
    [Template]    Check RMA Request Details
    Completed

BF-PHY-FLEET-RMA-VIEW-05: View details of a Canceled RMA
    [Documentation]     Author: Trinh Nguyen
    ...
...
#    ...      + After 120 days from the date of order creation, the timeline will no longer be visible
    ...
    [Tags]  BF-PHY-FLEET-RMA-VIEW-05        auto       R1
    [Template]    Check RMA Request Details
    Canceled

BF-PHY-FLEET-RMA-EDIT-01: Edit device ID of a pending RMA ticket
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-EDIT-01       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-EDIT-02: Add replacement device ID of a pending RMA ticket
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-EDIT-02       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-EDIT-03: Edit Reason for RMA of a pending RMA ticket (Bioflux)
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-EDIT-03       manual       R1      CP-2.18.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-EDIT-04: Edit Reason for RMA of a pending RMA ticket (Biocore/Biotres)
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-EDIT-04       manual       R1      CP-2.18.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-EDIT-04-CP2.18.0: Edit Reason for RMA of a pending RMA ticket (Biocore/Biotres Pro)
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-EDIT-04-CP2.18.0       manual       R1      CP-2.18.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-EDIT-05: Edit Paient impact of a pending RMA ticket
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-EDIT-05       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-EDIT-06: Edit Date of Event of a pending RMA ticket
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-EDIT-06       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-EDIT-07: Remove device from a pending RMA ticket
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-EDIT-07       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-EDIT-08: Edit pending RMA ticket with reason "Return for Maintenance"
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-EDIT-08       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-EDIT-09: Edit pending RMA ticket with reason "Protect+ program"
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-EDIT-09       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-EDIT-10: Cancel a pending RMA ticket
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-EDIT-10       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-PAGINATION-01: Check pagination tool works properly in RMA Request tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]     BF-PHY-FLEET-RMA-PAGINATION-01   auto      R1
    Navigate To Fleet
    Navigate To Fleet Tab    RMA Request
    Filter Fleet Rma Request        by_status=All statuses
...
BF-PHY-FLEET-RMA-FILTER-01: View the name of the facility in case the user only associates with one facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-FILTER-01       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-FILTER-02: Filter RMA list by facility in case the user only associates with multiple facilities
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-FILTER-02        auto      R1
    Navigate To Fleet
    Navigate To Fleet Tab    RMA Request
...
BF-PHY-FLEET-RMA-FILTER-03: Filter RMA list by RMA status (All/Pending/Approved/Completed/Canceled)
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-FILTER-03        auto      R1
...
BF-PHY-FLEET-RMA-SEARCH-01: Search RMA list by RMA ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]      BF-PHY-FLEET-RMA-SEARCH-01       auto     R1
    Navigate To Fleet
    Navigate To Fleet Tab    RMA Request
    ...
    Run Keyword And Continue On Failure    Should Be Equal    ${current_values}[RMA State]      All statuses
...
BF-PHY-FLEET-RMA-SEARCH-02: Search RMA list by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-SEARCH-02       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-SORT-01: Sort the RMA ticket by RMA ID
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-SORT-01        auto      R1
    Navigate To Fleet
    Navigate To Fleet Tab    RMA Request
    Filter Fleet Rma Request    by_status=All statuses
    ...
    ${expected_asc}     Evaluate    sorted(${actual_rma_ids}, key=int, reverse=${False})
...
BF-PHY-FLEET-RMA-SORT-02: Sort the RMA ticket by Request Date
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-SORT-02        auto      R1
    Navigate To Fleet
    Navigate To Fleet Tab    RMA Request
    Filter Fleet Rma Request    by_status=All statuses
...
BF-PHY-FLEET-RMA-SORT-03: Sort the RMA ticket by Returned Date
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-SORT-03        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-01: Notification Sent to Clinic Notification Center After Service Staff Presses “Request Device Return”
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-01        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-02: Email Sent to All Notification Emails Listed in the RMA Ticket After Service Staff Presses “Request Device Return”
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-02        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-03: Icon Displayed Next to RMA Ticket ID in Clinic Portal When S&D Requests Clinic to Initiate a Shipping Label
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-03        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-04: Icon Disappears After a Shipping Label is Created for the RMA Ticket
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-04        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-05: Count and Display Pending Shipping Labels on RMA Request Tab
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-05        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-06: Dot on the Fleet Page Appears When There Are Pending RMA Labels
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-06        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-07: Dot on the Fleet Page Disappears When All Shipping Labels Are Created
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-07        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-08: Number on the RMA Request Tab Updates After Creating a Shipping Label
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-08        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-09: Display Instructional Message for Shipping Label Creation on Approved RMA Ticket
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-09        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-10: Instructional Message Disappears When RMA Ticket is Completed
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-10        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-11: Clicking the "Create Shipping Label" button navigates the user to the shipping label creation process
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-11        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-12:Package_Default Package Selection "Custom Dimensions"
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-12        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-13:Shipping rate_Auto get the cheapest one and show for the user when they check shipping rate
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-13        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-14:Sender_Pre-filled with facility information and can edit
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-14        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-15:Receiver_Pre-filled with BTCY information (Cannot edit)
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-15        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-16:Receiver_Pre-filled with BTCY information (Cannot edit)
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-16        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-17:Multiple Shipping Labels Creation for Approved RMA Ticket
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-17        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-18: No notification sent to the notification center of clinic when the clinic creates a shipment
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RMA-CREATE-SHIPPING-LABEL-18        manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-MAINTENANCE-VIEW-01: View list of Maintenance devices
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-MAINTENANCE-VIEW-01       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    ${expected_attribute}   Create List    Device ID       Model      Firmware Version     Status     Network     Charging State     Device Lifetime     Facility
#    Navigate To Fleet
#    Navigate To Fleet Tab    Maintenance
#    ${current_filter}        Get Fleet Current Filter Values
#    Run Keyword And Continue On Failure    Should Be Equal    ${current_filter}[RMA Type]     Maintenance
#    Run Keyword And Continue On Failure    Should Be Empty    ${current_filter}[Text Search]
#    ${maintenance}     Get Fleet Maintenance Items
#    Run Keyword And Continue On Failure    Should Not Be Empty    ${maintenance}       No RMA Request found
#    ${actual_attribute}     Evaluate       [k for k, v in ${maintenance}[0].items()]
#    Run Keyword And Continue On Failure    Lists Should Be Equal    ${expected_attribute}       ${actual_attribute}

BF-PHY-FLEET-MAINTENANCE-VIEW-02: Device Listed in Maintenance Tab Based on Artifact Percentage Condition
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-MAINTENANCE-VIEW-02       manual    CP-2.26.0       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-MAINTENANCE-VIEW-03: Device Listed in Maintenance Tab Based on Battery Quality Condition
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-MAINTENANCE-VIEW-03       manual    CP-2.26.0       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-MAINTENANCE-VIEW-04: Device Removed from Maintenance Tab When RMA Is Requested
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-MAINTENANCE-VIEW-04       manual    CP-2.26.0       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-MAINTENANCE-VIEW-05: Device is automatically added back to the Maintenance tab if a previously requested RMA is canceled
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-MAINTENANCE-VIEW-05       manual    CP-2.26.0       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-MAINTENANCE-VIEW-06: Reset Maintenance Conditions When Device Is Transferred to Another Facility
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-MAINTENANCE-VIEW-06       manual    CP-2.26.0       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BF-PHY-FLEET-MAINTENANCE-FILTER-01: Filter Maintenance list by facility in case the user only associates with multiple facilities
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-MAINTENANCE-FILTER-01        manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-MAINTENANCE-SEARCH-01: Search Maintenance devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-MAINTENANCE-SEARCH-01       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-MAINTENANCE-PAGINATION-01: Check pagination tool works properly in Maintenance tab
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]     BF-PHY-FLEET-MAINTENANCE-PAGINATION-01   manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-MAINTENANCE-REQUEST-01: Facility has not subscibed Protect+ program-Iinitiate an RMA request with reason "Return for Maintenance" for a device
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-MAINTENANCE-REQUEST-01       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-MAINTENANCE-REQUEST-02: Facility has subscibed Protect+ program-Iinitiate an RMA request with reason "Protect+ Program" for a device
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-MAINTENANCE-REQUEST-02       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-MAINTENANCE-REQUEST-03: Facility has not subscibed Protect+ program-Iinitiate an RMA request with reason "Return for Maintenance" for multiple devices
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-MAINTENANCE-REQUEST-03       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-MAINTENANCE-REQUEST-04: Facility has subscibed Protect+ program-Iinitiate an RMA request with reason "Protect+ Program" for multiple devices
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-MAINTENANCE-REQUEST-04       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-MAINTENANCE-REQUEST-05: Cannot initiate an RMA request with reason "Return for Maintenance" for multiple devices exceeded max RMA devices
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-MAINTENANCE-REQUEST-05       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-MAINTENANCE-REQUEST-06: Cannot initiate an RMA request with reason "Protect+ Program" for multiple devices exceeded max RMA devices
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-MAINTENANCE-REQUEST-06       manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Fleet
...
BF-PHY-FLEET-RETURN-01-CP2.16.8: Active Facility-View list of Waiting for Return
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RETURN-01-CP2.16.8       manual       R1      CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RETURN-02-CP2.16.8: Mark as returned for a device
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RETURN-02-CP2.16.8       manual       R1      CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RETURN-03-CP2.16.8: Mark as returned for multiple devices
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RETURN-03-CP2.16.8       manual       R1      CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RETURN-04-CP2.16.8: Search for device by device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RETURN-04-CP2.16.8       manual       R1      CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RETURN-05-CP2.16.8: Search for device by Study ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RETURN-05-CP2.16.8       manual       R1      CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RETURN-06-CP2.16.8: Sort the list by Study stop date
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RETURN-06-CP2.16.8       manual       R1      CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RETURN-07-CP2.16.8: Check pagination tool
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RETURN-07-CP2.16.8       manual       R1      CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-FLEET-RETURN-08-CP2.16.8: Waiting for Return tab is hidden for Test Facility
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RETURN-08-CP2.16.8       manual       R1      CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BF-PHY-FLEET-RETURN-08-CP2.21.0: Return date time displayed same as Delivered time from Shippo info (if any)
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-FLEET-RETURN-08-CP2.21.0       manual       R1      CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
Check RMA Request Details  # Check rma details without pending
    ...
    ${details_devices}      Get Rma Details Device Info
    ${expected_model_info}          Create List    Bioflux      Biocore/Biotres
    ${expected_shipping_status_info}    Create List    Delivered    Pending
    Run Keyword And Continue On Failure    List Should Contain Value    ${expected_model_info}              ${details_devices}[0][Model]
    Run Keyword And Continue On Failure    List Should Contain Value    ${expected_shipping_status_info}    ${details_devices}[0][Shipping status]
...
Clear RMA Request
    Navigate To Fleet
    Navigate To Fleet Tab    RMA Request
    Filter Fleet Rma Request    by_status=Pending       search_by=Device ID     text_search=8174000009
