...
Metadata    sid     BF-FACILITY-ADMIN
...
Force Tags      BF-FACILITY-ADMIN     web
Test Timeout    1h

*** Test Cases ***
BF-FACILITY-ADMIN-VIEW-FACILITY-01: Facility View List – Multiple Facilities Displayed in Scrollable Modal
   [Documentation]     Author: Thanh Tieu
    ...
    [Tags]      BF-FACILITY-ADMIN-VIEW-FACILITY-01    manual     CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-VIEW-FACILITY-02:Facility View List – No Modal for Single Facility
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]      BF-FACILITY-ADMIN-VIEW-FACILITY-02    manual     CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BF-FACILITY-ADMIN-VIEW-FACILITY-03: Facility Detail – Display Facility Information Sections
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]      BF-FACILITY-ADMIN-VIEW-FACILITY-03    manual     CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}



BF-FACILITY-ADMIN-VIEW-FACILITY-04: Facility Detail – Update Panel When Switching Facility
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]      BF-FACILITY-ADMIN-VIEW-FACILITY-04    manual     CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-EDIT-FACILITY-01: Add Clinic Support Contact – Valid Input Saves and Displays New Contact
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]      BF-FACILITY-ADMIN-EDIT-FACILITY-01    manual     CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BF-FACILITY-ADMIN-EDIT-FACILITY-02: Add Clinic Support Contact – Show Error for Missing Required Fields
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]      BF-FACILITY-ADMIN-EDIT-FACILITY-02    manual     CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BF-FACILITY-ADMIN-EDIT-FACILITY-03: Edit Clinic Support Contact – Valid Input Updates Contact Information
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]      BF-FACILITY-ADMIN-EDIT-FACILITY-03    manual     CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BF-FACILITY-ADMIN-EDIT-FACILITY-04: Edit Clinic Support Contact – Show Error When Required Fields Are Invalid or Empty
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]      BF-FACILITY-ADMIN-EDIT-FACILITY-04    manual     CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-EDIT-FACILITY-05: Delete Clinic Support Contact – Confirm Deletion Removes the Contact
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]      BF-FACILITY-ADMIN-EDIT-FACILITY-05    manual     CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BF-FACILITY-ADMIN-EDIT-FACILITY-06: Delete Clinic Support Contact – Cancel Button Keeps the Contact
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]      BF-FACILITY-ADMIN-EDIT-FACILITY-06    manual     CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-REFERRING-PHYSICIAN-01: View Referring Physician list
    [Documentation]    Author: Thanh Tieu
    ...
    ...     **Others
    ...     Update date: 6/17/2025 - Thanh Tieu
    [Tags]    BF-FACILITY-ADMIN-REFERRING-PHYSICIAN-01    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}


BF-FACILITY-ADMIN-REFERRING-PHYSICIAN-02: Search Referring Physician by Full Name (Case Insensitive)
    [Documentation]     Author: Thanh Tieu
    ...
    ...  Description:
    ...
    [Tags]      BF-FACILITY-ADMIN-REFERRING-PHYSICIAN-02   manual    CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-REFERRING-PHYSICIAN-03: Filter Referring Physician List by Status
    [Documentation]     Author: Thanh Tieu
    ...
    ...    Description:
    ...
    [Tags]      BF-FACILITY-ADMIN-REFERRING-PHYSICIAN-03    manual    CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}



BF-FACILITY-ADMIN-REFERRING-PHYSICIAN-04: Add Referring Physician - Manual entry
    ...
    ...     **Others
    ...     Update date: 6/17/2025 - Thanh Tieu
    [Tags]    BF-FACILITY-ADMIN-REFERRING-PHYSICIAN-04    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-REFERRING-PHYSICIAN-05: Add Referring Physician - Search by NPI
    [Documentation]    Author: Thanh Tieu
    ...
    ...     **Others
    ...     Update date: 6/17/2025 - Thanh Tieu
    [Tags]    BF-FACILITY-ADMIN-REFERRING-PHYSICIAN-05    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-REFERRING-PHYSICIAN-06: Edit Referring Physician
    [Documentation]    Author: Thanh Tieu
    ...
    ...     **Others
    ...     Update date: 6/17/2025 - Thanh Tieu
    [Tags]    BF-FACILITY-ADMIN-REFERRING-PHYSICIAN-06    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-REFERRING-PHYSICIAN-07: Toggle Referring Physician status (Activate/Deactivate)
    [Documentation]    Author: Thanh Tieu
    ...
    ...     **Others
    ...     Update date: 6/17/2025 - Thanh Tieu
    [Tags]    BF-FACILITY-ADMIN-REFERRING-PHYSICIAN-07    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-VIEW-01: View the list of Active and Deactivated Users
    [Documentation]     Author: Thanh Tieu
    ...     Description:
    ...
    ...         - Email
    ...         - Phone number
    ...         - Role(s): Admin, Billing User, Physician, or Technician
    ...
    [Tags]     BF-FACILITY-ADMIN-USER-MANAGEMENT-VIEW-01    manual     CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}     ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-SEARCH-01: Search by Full Name on User List
    [Documentation]    Author: Thanh Tieu
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-SEARCH-01    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-SEARCH-02: Search by Email on User List
    [Documentation]    Author: Thanh Tieu
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-SEARCH-02    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-SEARCH-03: Search by Username on General Facility
    [Documentation]    Author: Thanh Tieu
    ...    Description: Verify that Facility Admin can search by username if the facility is not part of Mercy organization.
    ...    Precondition:
    ...        - The user is logged in as Facility Admin from a Non-Mercy facility.
    ...        - The user is on the User Management page.
    ...
    ...    Test Steps:
    ...        1. Locate the search field.
    ...        2. Select "Username" in search filter (if applicable).
    ...        3. Enter valid username and press Enter.
    ...
    ...    Expected Results:
    ...        - Matching user(s) are shown with the entered username.
    ...        - Username search is disabled if current facility is Mercy.
    ...
    ...    **Others
    ...    Update date: 6/17/2025 - Thanh Tieu

    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-SEARCH-03    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-01: Filter users by role on User Management page
    [Documentation]    Author: Thanh Tieu
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-01    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-01A: Filter only Admin users
    [Documentation]    Author: Thanh Tieu
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-01A    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-01B: Filter only Technician users
    [Documentation]    Author: Thanh Tieu
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-01B    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-01C: Filter only Physician users
    [Documentation]    Author: Thanh Tieu
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-01C    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-01D: Filter only Billing users
    [Documentation]    Author: Thanh Tieu
    ...    Description:
    ...        Verify filtering only Billing user role.
    ...
    ...    Precondition:
    ...
    ...    Test Steps:
    ...        1. Select filter.
    ...        2. Check only "Billing user".
    ...
    ...    Expected Results:
    ...        - List shows only users with Billing role.
    ...        - If no results, display "There is no data to display".
    ...
    ...    **Others
    ...    Update date: 6/17/2025 - Thanh Tieu

    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-01D    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-02: Combine search and filter on the User Management list
    [Documentation]    Author: Thanh Tieu
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-02    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-03: Search and filter match - should display correct users
    [Documentation]    Author: Thanh Tieu
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-03    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-04: Search matches but filter does not - should show no data
    [Documentation]    Author: Thanh Tieu
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-04    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-05: Filter matches but search does not - should show no data
    [Documentation]    Author: Thanh Tieu
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-FILTER-05    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-01: Verify visibility and actions of 'New User' button
    [Documentation]    Author: Thanh Tieu
    ...
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-01    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-02: Manual Entry - Verify step 1: User information
    [Documentation]    Author: Thanh Tieu
    ...
    ...    Description:
    ...
    ...    2. Select different combinations of roles (Admin, Billing, Technician, Physician).
    ...       - Try selecting Technician then Physician and vice versa.
    ...    3. Enter text into Title, First name, Last name, Username.
    ...    4. Enter duplicate Username and click “Next”.
    ...    5. Enter email already in use and click “Next”.
    ...
    ...    Expected Results:
    ...    - Facility field behaves based on facility count.
    ...    - Selecting Technician disables Physician and vice versa.
    ...    - Duplicate username shows “Username existed.”
    ...    - Duplicate email shows “The email already exists. Please try another.”
    ...
    ...    **Others
    ...    Update date: 6/17/2025 - Thanh Tieu

    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-02    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-03: Manual Entry - Verify step 2: Contact information and phone number validation
    [Documentation]    Author: Thanh Tieu
    ...
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-03    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}


BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-04: Verify toggling "Include physician contact" setting (Physician role only)
    [Documentation]    Author: Thanh Tieu
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-04    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-05: Manual Entry - Verify successful user creation and Welcome email
    [Documentation]    Author: Thanh Tieu
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-05    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-06: Search by NPI - Validate auto-filled fields after NPI lookup
    [Documentation]    Author: Thanh Tieu
    ...
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-06    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-07: Search by NPI - Search with invalid NPI number
    [Documentation]    Author: Thanh Tieu
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-07    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-08: Search by NPI - No matching NPI is found.
    [Documentation]    Author: Thanh Tieu
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-08    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-09: Search by NPI - Quit and discard entered data
    [Documentation]    Author: Thanh Tieu
    ...    Description:
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-CREATE-USER-09    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-RESET-PASSWORD-01: Display “Reset password” button for Active users
    [Documentation]    Author: Thanh Tieu
    ...
    [Tags]      BF-FACILITY-ADMIN-USER-MANAGEMENT-RESET-PASSWORD-01    manual    CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-RESET-PASSWORD-02: Reset password successfully when user has valid email
    [Documentation]    Author: Thanh Tieu
    ...
    [Tags]      BF-FACILITY-ADMIN-USER-MANAGEMENT-RESET-PASSWORD-02    manual    CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-RESET-PASSWORD-03: Show error if no valid email exists
    [Documentation]    Author: Thanh Tieu
    ...
    [Tags]      BF-FACILITY-ADMIN-USER-MANAGEMENT-RESET-PASSWORD-03    manual    CP-2.31.0        R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-MANAGEMENT-RESET-PASSWORD-04: Hide “Reset password” button for Deactivated users
    [Documentation]    Author: Thanh Tieu
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-MANAGEMENT-RESET-PASSWORD-04    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-PROFILE-AVATAR-01: Default avatar display
    [Documentation]    Author: Thanh Tieu
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-PROFILE-AVATAR-01    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-PROFILE-AVATAR-02: Custom avatar display
    [Documentation]    Author: Thanh Tieu
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-PROFILE-AVATAR-02    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-PROFILE-DROPDOWN-NAVIGATION-01: Show dynamic portal list based on user roles
    [Documentation]    Author: Thanh Tieu
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-PROFILE-DROPDOWN-NAVIGATION-01    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-PROFILE-DROPDOWN-NAVIGATION-02: Show only “Sign out” if no accessible portal
    [Documentation]    Author: Thanh Tieu
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-PROFILE-DROPDOWN-NAVIGATION-02    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-PROFILE-DROPDOWN-NAVIGATION-03: No duplicate portals for overlapping roles
    [Documentation]    Author: Thanh Tieu
    ...
    ...
    ...    Test Steps:
    ...    - Login as a user with overlapping roles (e.g., Billing + Technician).
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-PROFILE-DROPDOWN-NAVIGATION-03    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-FACILITY-ADMIN-USER-PROFILE-DROPDOWN-NAVIGATION-04: Navigation works correctly when clicking portal entry
    [Documentation]    Author: Thanh Tieu
    ...
    [Tags]    BF-FACILITY-ADMIN-USER-PROFILE-DROPDOWN-NAVIGATION-04    manual    CP-2.31.0        R1
    Manual Should Be Passed    ${TEST_NAME}    ${TEST_DOCUMENTATION}
