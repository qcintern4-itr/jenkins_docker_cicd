...
Metadata    sid     BF-PHY-CP-STUDIES-ACTIVE
...
Force Tags          BF-PHY-CP-STUDIES-ACTIVE        web
Test Timeout        1h

*** Test Cases ***
BF-PHY-CP-STUDIES-ACTIVE-VIEW-01: View a list of active studies
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-01      auto      R1
...
BF-PHY-CP-STUDIES-ACTIVE-VIEW-02: View study info of a Draft/Ongoing study that not running with Biodirect service
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-02      auto
    Navigate To Studies Page
    Open New Study
    ...
    ${check_active}     Check Active Button Items Available
    ${studies}        Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-VIEW-03: View study info of End of duration study that not running with Biodirect service
    [Documentation]  Author: Nhan Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-03      manual    R2      manual_updated
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-VIEW-04: View study info of a study running Biodirect and its order is being processed/initiated
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-04      auto
    Navigate To Studies Page
    Open New Study
    ${current_page}     Get Current New Study Page
    Run Keyword And Continue On Failure    Should Be Equal    ${current_page}       Patient information       # PAGE 1
...
BF-PHY-CP-STUDIES-ACTIVE-VIEW-05: View study info of a study running Biodirect and its order is in shipping process
    [Documentation]  Author: Nhan Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-05      manual    R2      manual_updated
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-VIEW-06: View study info of a study running Biodirect and its order is in returning process
    [Documentation]  Author: Nhan Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-06     manual    R2      manual_updated
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-VIEW-07-CP-2.16.2: Can view the Disclaimer alert icon of single study in Starting/Ongoing status
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-07-CP-2.16.2     manual      CP-2.16.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-VIEW-08-CP-2.16.2: Can view the Disclaimer alert icon of HOLTER AND FOLLOW ON STUDY in Starting/Ongoing status
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-08-CP-2.16.2     manual      CP-2.16.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-VIEW-09-CP-2.16.2: Can view the Disclaimer alert icon of FOLLOW ON STUDY in Starting/Ongoing status
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-09-CP-2.16.2     manual        CP-2.16.2      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-VIEW-10-CP-2.16.2: Cannot view the Disclaimer alert icon
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-10-CP-2.16.2     manual        CP-2.16.2      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BF-PHY-CP-STUDIES-ACTIVE-VIEW-11-CP-2.16.2: Can view the offline warning icon
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-11-CP-2.16.2     manual      CP-2.16.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-VIEW-12-CP-2.16.5: Bioflux-Can view the Reference code on active study list when study status is Draft/Starting/Ongoing
    [Documentation]  Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-12-CP-2.16.5     manual      CP-2.16.5    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-VIEW-13-CP-2.16.2: Biolfux-Can resend ref code when study status is Ongoing
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-13-CP-2.16.2     manual      CP-2.16.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-VIEW-14-CP-2.16.2: Biolfux-Cannot resend ref code when study status is Draft/Starting/Completed/Done
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-14-CP-2.16.2     manual      CP-2.16.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-VIEW-15-CP-2.16.2: Biolfux-Cannot resend ref code if the duration between 2 clicking times is less than 5 minutes
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-15-CP-2.16.2     manual      CP-2.16.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-VIEW-16-CP-2.16.5: Biocore/Biotres-Can view the Reference code on active study list when study status is Draft/Starting/Ongoing/Completed
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     Description: The user can view the Reference code on active study list
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-16-CP-2.16.5     manual      CP-2.16.5
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-VIEW-17-CP-2.16.2: Biocore/Biotres-Can resend ref code when study status is Ongoing/Completed
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-17-CP-2.16.2     manual      CP-2.16.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-VIEW-18-CP-2.16.2: Biocore/Biotres-Cannot resend ref code when study status is Draft/Starting/Done
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-18-CP-2.16.2     manual      CP-2.16.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-VIEW-19-CP-2.16.2: Biocore/Biotres-Cannot resend ref code if the duration between 2 clicking times is less than 5 minutes
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-19-CP-2.16.2     manual      CP-2.24.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-VIEW-20-CP-2.24.2: Display App Paired Icon on the Active Study Card
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...     Ensure the App Paired Icon is displayed on the Active Study Card for a study that meets the pairing criteria
    ...
    ...     Precondition:
    ...     1. A study is in the Active state
    ...     2. The device has been paired with at least one Biocare Health patient account since the study start date
    ...
    ...     Test Steps:
    ...     1. User on Active Studies tab
    ...
    ...     Expected Results:
    ...     The App Paired Icon is displayed on the Active Study Card

    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-20-CP-2.24.2     manual      CP-2.24.2 R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-VIEW-21-CP-2.24.2: Display "App paired" text on hover over the App Paired Icon
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...     Ensure that hovering over the App Paired Icon displays the text "App paired"
    ...
    ...     Precondition:
    ...     1. A study is in the Active state
    ...     2. The device has been paired with at least one Biocare Health patient account since the study start date
    ...
    ...     Test Steps:
    ...     1. User on Active Studies tab
    ...     2. Hover over the App Paired Icon for a study
    ...
    ...     Expected Results:
    ...     The tooltip displays the text "App paired"

    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-21-CP-2.24.2     manual      CP-2.24.2 R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-VIEW-22-CP-2.24.2: App Paired Icon is not displayed when the device is not connected to the Biocare Health app
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...     Ensure that the App Paired Icon is not displayed if the device has not been connected to the Biocare Health app since the study start date.
    ...
    ...     Precondition:
    ...     1. A study is in the Active state
    ...     2. The device has not connected to the Biocare Health app via any method
    ...
    ...     Test Steps:
    ...     1. User on Active Studies tab
    ...
    ...
    ...     Expected Results:
    ...     The App Paired Icon is not displayed on the Active Study Card

    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-VIEW-22-CP-2.24.2     manual      CP-2.24.2 R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-01: Can abort a Draft study (single type) running Biocore device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-01     auto      CP-2.25.1     R1
...
BF-PHY-CP-STUDIES-ACTIVE-ABORT-02: Can abort a Draft study (FO type) running Biocore device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-02     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-03: Can abort a Draft study (single type) running Biocore Pro device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-03     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-04: Can abort a Draft study (FO type) running Biocore Pro device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-04     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-05: Can abort a Draft study (single type) running Bioflux device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-05     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-06: Can abort a Draft study (FO type) running Bioflux device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-06     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-07: Can abort a Starting study (single type) running Biocore device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-07     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-08: Can abort a Starting study (FO type) running Biocore device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-08     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-09: Can abort a Starting study (single type) running Biocore Pro device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-09     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-10: Can abort a Starting study (FO type) running Biocore Pro device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-10     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-11: Can abort a Starting study (single type) running Bioflux device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-11     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-12: Can abort a Starting study (FO type) running Bioflux device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-12     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-13: Cannot abort a Ongoing study
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-13     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-14: Can abort a Biodirect study in status Not started-Created from Clinic for Biocore (single type)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-14    manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-15: Can abort a Biodirect study in status Not started-Created from Clinic for Biocore (FO type)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-15     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-16: Can abort a Biodirect study in status Not started-Created from Clinic for Biocore Pro (single type)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-16     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-17: Can abort a Biodirect study in status Not started-Created from Clinic for Biocore Pro (FO type)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-17     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-18: Can abort a Biodirect study in status Not started-Created from Clinic for Bioflux (single type)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-18     auto      CP-2.25.1     R1
...
BF-PHY-CP-STUDIES-ACTIVE-ABORT-19: Can abort a Biodirect study in status Not started-Created from Clinic for Bioflux (FO type)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-19     auto      CP-2.25.1     R1
    [Template]    Abort A Study With Running Biodirect
    FOLLOW-ON STUDY

BF-PHY-CP-STUDIES-ACTIVE-ABORT-20: Cannot abort a Biodirect study in status Not started-Created from HeartSecure
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-20     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-ABORT-21: Check mail sent to Service team and Patient in case Study is aborted successfully
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-ABORT-21     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-REFCODE-01: Normal study-Can manual send ref code when study status is Starting
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-REFCODE-01     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-REFCODE-02: Normal study-Can auto send ref code when study status is Started
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-REFCODE-02     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-REFCODE-03: Normal study-Can manual resend ref code
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-REFCODE-03     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-REFCODE-04: Biodirect Bioflux study-Auto send ref code when study status is Started
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-REFCODE-04     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-REFCODE-05: Biodirect study-Can manual send ref code when study status is Starting
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-REFCODE-05     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-REFCODE-06: Biodirect Biocore study-Not Auto send ref code when study status is Started
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-REFCODE-06     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-REFCODE-07: Biodirect Biocore Pro study-Not Auto send ref code when study status is Started
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-REFCODE-07     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-REFCODE-08: Biodirect HeartSecure study-Not Auto send ref code when study status is Started
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-REFCODE-08     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-FILTER-FACILITY-01: View the name of the facility in case the user only associates with one facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-FILTER-FACILITY-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Studies Page
#    Filter Studies    study_state=Active
...
BF-PHY-CP-STUDIES-ACTIVE-FILTER-FACILITY-02: Filter by a specific facility in case the user associates with multiple facilities
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-FILTER-FACILITY-02     auto    R1
    Navigate To Studies Page
    Filter Studies    study_state=Active
...
BF-PHY-CP-STUDIES-ACTIVE-SEARCH-01: View all search attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-SEARCH-01      auto    R1
    Navigate To Studies Page
    Filter Studies    study_state=Active
...
BF-PHY-CP-STUDIES-ACTIVE-SEARCH-02: Search by Patient Name attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-SEARCH-02      manual    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    [Template]    Filter Active - Studies
#    Patient name        # Facing bug: https://itrvn.atlassian.net/browse/BF-3368

BF-PHY-CP-STUDIES-ACTIVE-SEARCH-03: Search by Study ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-SEARCH-03      auto    R1
    [Template]    Filter Active - Studies
    Study ID

BF-PHY-CP-STUDIES-ACTIVE-SEARCH-04: Search by Patient ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The user can search by Study ID attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-SEARCH-04      auto    R1
    [Template]    Filter Active - Studies
    Patient ID

BF-PHY-CP-STUDIES-ACTIVE-SEARCH-05: Search by Device ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-SEARCH-05       manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BF-PHY-CP-STUDIES-ACTIVE-STOP-01: Stop an active study
    [Documentation]     Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-STOP-01      auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
...
BF-PHY-CP-STUDIES-ACTIVE-STOP-02: Cannot stop an active study when device is offline
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-STOP-02     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-STOP-03: Can stop an active study when study status is paused and device is online
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-STOP-03     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-GET-ECG-01: Can get ECG when study status is Started/Resumed and device is online
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-GET-ECG-01     auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-GET-ECG-02: Cannot get ECG when study status is Draft/Starting/Paused/Completed
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    ...     Expected Results:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-GET-ECG-02     auto   R1
    Navigate To Studies Page
    Filter Studies    study_state=Active
    # Draft
    ${studies}      Get Active Studies
    ...
    # random choice chose an invalid study => Failed

BF-PHY-CP-STUDIES-ACTIVE-GET-ECG-03: Cannot get ECG when device is offline
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-GET-ECG-03     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-01: View study details of MCT/MCT PEEK/CARDIAC EVENT/HOLTER/EXT HOLTER study
    [Documentation]    Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-01       auto    R1    CP-2.20.0
    Navigate To Studies Page
    Filter Studies    study_state=Active
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-DETAILS-02: View study details of 'Holter & Follow-on' study
    [Documentation]    Author: Trinh Nguyen
    ...     Description: The user can view the detailed information of the study
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-02       auto
    Navigate To Studies Page
    Filter Studies    study_state=Active
...
BF-PHY-CP-STUDIES-ACTIVE-DETAILS-03-CP-2.16.2: Can view the Disclaimer modal in study details of a study
    [Documentation]    Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-03-CP-2.16.2       manual       CP-2.16.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-04-CP-2.16.2: Can view the offline alert message in study details of a study
    [Documentation]    Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-04-CP-2.16.2       manual       CP-2.16.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-DETAILS-05: View study details of MCT/MCT PEEK/CARDIAC EVENT/HOLTER/EXT HOLTER study when create new study
    [Documentation]    Author: Trinh Nguyen
    ...     Description: The user can view the detailed information of the study
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-05      auto      CP-2.20.0
    [Setup]    Create A Study With Not Running Biodirect
    Navigate To Studies Page
    ${studies}        Get Active Studies
    ${study_id}       Set Variable    ${studies}[0][Study]
    Filter Studies      search_by=Study ID      text_search=${study_id}
    ...
    ${studies}        Get Active Studies
    Run Keyword And Continue On Failure    Should Be Empty    ${studies}
BF-PHY-CP-STUDIES-ACTIVE-DETAILS-06-CP-2.24.2: Display App Paired Icon in study details of a study
    [Documentation]    Author: Tam Ho
    ...     Description:
    ...     Ensure the App Paired Icon is displayed on the Active Study Card for a study that meets the pairing criteria
    ...
    ...     Precondition:
    ...     1. The device has been paired with at least one Biocare Health patient account since the study start date
    ...
    ...     Test Steps:
    ...     1. Open the Study Details
    ...     2. Observe the Study information
    ...
    ...     Expected Results:
    ...     1. The App Paired Icon is displayed next to the device ID

    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-06-CP-2.24.2       manual       CP-2.16.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-DETAILS-07-CP-2.24.2: Display App Paired Icon in study details of a study
    [Documentation]    Author: Tam Ho
    ...     Description:
    ...     Ensure that a "High Sampling Rate" tag is displayed next to the App Paired Icon for devices operating at a high sampling rate
    ...
    ...     Precondition:
    ...     1. Device High Sampling Rate
    ...     2. The device has been paired with at least one Biocare Health patient account since the study start date
    ...
    ...     Test Steps:
    ...     1. Open the Study Details
    ...
    ...
    ...     Expected Results:
    ...     1. A "High Sampling Rate" tag is displayed next to the App Paired Icon

    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-07-CP-2.24.2       manual       CP-2.16.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-DETAILS-08-CP-2.24.2: App Paired Icon is not displayed when the device is not connected to the Biocare Health app
    [Documentation]    Author: Tam Ho
    ...     Description:
    ...     Ensure that the App Paired Icon is not displayed if the device has not been connected to the Biocare Health app since the study start date.
    ...
    ...     Precondition:
    ...     1. The device has not connected to the Biocare Health app via any method
    ...
    ...     Test Steps:
    ...     1. Open the Study Details
    ...     2. Observe the Study information
    ...
    ...     Expected Results:
    ...     The App Paired Icon is not displayed in the Study Details view

    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-08-CP-2.24.2       manual       CP-2.16.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-01: Can abort a Draft study (single type) running Biocore device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-01     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-02: Can abort a Draft study (FO type) running Biocore device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-02     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-03: Can abort a Draft study (single type) running Biocore Pro device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-03     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-04: Can abort a Draft study (FO type) running Biocore Pro device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-04     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-05: Can abort a Draft study (single type) running Bioflux device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-05     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-06: Can abort a Draft study (FO type) running Bioflux device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-06     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-07: Can abort a Starting study (single type) running Biocore device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-07     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-08: Can abort a Starting study (FO type) running Biocore device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-08     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-09: Can abort a Starting study (single type) running Biocore Pro device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-09     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-10: Can abort a Starting study (FO type) running Biocore Pro device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-10     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-11: Can abort a Starting study (single type) running Bioflux device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-11     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-12: Can abort a Starting study (FO type) running Bioflux device
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-12     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-13: Cannot abort a Ongoing study
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-13     manual      CP-2.25.1     R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-14: Can abort a Biodirect study in status Not started-Created from Clinic for Biocore (single type)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-14     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-15: Can abort a Biodirect study in status Not started-Created from Clinic for Biocore (FO type)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-15     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-16: Can abort a Biodirect study in status Not started-Created from Clinic for Biocore Pro (single type)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-16     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-17: Can abort a Biodirect study in status Not started-Created from Clinic for Biocore Pro (FO type)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-17     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-18: Can abort a Biodirect study in status Not started-Created from Clinic for Bioflux (single type)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-18     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-19: Can abort a Biodirect study in status Not started-Created from Clinic for Bioflux (FO type)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-19     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-20: Cannot abort a Biodirect study in status Not started-Created from HeartSecure
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ABORT-20     manual      CP-2.25.1     R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-01: Normal study-Can manual send ref code when study status is Starting
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-01     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-02: Normal study-Can auto send ref code when study status is Started
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-02     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-03: Normal study-Can manual resend ref code
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-03     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-04: Biodirect Bioflux study-Auto send ref code when study status is Started
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-04     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-05: Biodirect study-Can manual send ref code when study status is Starting
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-05     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-06: Biodirect Biocore study-Not Auto send ref code when study status is Started
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-06     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-07: Biodirect Biocore Pro study-Not Auto send ref code when study status is Started
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-07     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-08: Biodirect HeartSecure study-Not Auto send ref code when study status is Started
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REFCODE-08     manual      CP-2.25.1     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-PATIENT-01: View patient details of a study
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-PATIENT-01     auto    R1
...
BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-01: View list of reports sent by the Call center of a study
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-01       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-02: Search Interim/EOU report by Report ID
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-02      manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-03: Search Notification/Event report by Report ID
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-03       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-04: Check a tooltip shall displayed when user hovers over the error tag
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-04       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-05: Can sort report by Report ID/Last Modified/Type/Reviewed
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-05       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-06: Check the pagination tool is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-06       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-07: Check user can go to the Report View page by clicking the Edit report button
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-07       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-08: View Interim/EOU report details in study management page
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-08       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-09: View Notification/Event report details in study management page
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-09       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-10: Can mark the reports as reviewed/unreviewed
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-10       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-11: Can navigate to the report screen of the study management page by clicking the close button
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-11       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-12: MCT study/EOU old report format-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-12       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-13: MCT study/EOU new report format-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-13       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-14: MCT Peek study/EOU old report format-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-14       manual     R1      deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-15: MCT Peek study/EOU new report format-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-15       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-16: Holter/Ext.Holter study/EOU old report format-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-16       manual     R1      deactive
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-17: Holter/Ext.Holter study/EOU new report format-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-17       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-18: Cardiac Event study/EOU old report format-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-18       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-19: EOU-Download report
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-19       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-20: Interim-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-20       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-21: Interim-Download report
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-21       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-22: Notification-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-22       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-23: Notification-Download report
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-23       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-24: Event-Add Interpretation and Signature
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-24       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-25: Event-Download report
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-25       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-26: Event-View ECG strip
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-26       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-27: Cannot view Event/Notification report in case the financial hold of facility is 80 or 90 days
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-27       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-28: Cannot view Interim/EOU report in case the financial hold of facility is 80 or 90 days
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-28       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-29: The report tab shall not be displayed for aborted studies
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-REPORT-29       manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-01: View components display on Events list
    [Documentation]  Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-01       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-01-CP2.21.0: Display patient manual events, regardless of symptom, validitity, open or closed
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-01-CP2.21.0       manual      R1     CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-02-CP2.21.0: Display auto events with status valid and closed
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-02-CP2.21.0       manual      R1     CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-03-CP2.21.0: Not display manual events (Evaluation trips, baseline, resumed) unless status valid and closed
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-03-CP2.21.0       manual      R1     CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-04-CP2.21.0: Check if an event is annotated with a section of ECG strip marked that strip shall be shown as annotated
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-04-CP2.21.0       manual      R1     CP-2.21.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-02: Filter event list by range date of study duration
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-02       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-03: Sort event list by descending/escending order
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-03       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-04: Filter event list by event type
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-04       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-05: Reload the event list by "Manual reload" button
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-05       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-06: Search for an event by Event ID
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-06       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-07: View ECG details of an event
    [Documentation]  Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-07       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-08: For aborted studies, this Events tab shall not be displayed
    [Documentation]  Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-EVENT-08       manual      R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-01:View details of the ECG Viewer tab
    [Documentation]     Author: Trinh Nguyen
    ...     Description: The user can details of the ECG Viewer tab
    ...
    ...     Precondition:
    ...     - The user is on the ECG Viewer tab of the STUDY MANAGEMENT page of an active/completed study
    ...
    ...     Test Steps:
    ...
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-02: Check there is message displayed in case study running on Biodirect service has not been started by the patient
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-02     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-03: Check there is message displayed in case the event data of the selected date has not been uploaded to the system yet
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-03     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-04: The user can view the HR chart of a specific date by selecting the date from the drop-down selection
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-04     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-05: Check there is a message displayed in case the event data of the selected date has not been uploaded to the system yet
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-05     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-06: Check the Refresh button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-06     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-07: Check the Show event indicators checkbox is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-07     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-08: Check the Show event indicators checkbox is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-08     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-09: Check case there shall be highlighted blank spaces between the heartbeat lines in case there is no heart rate data at any time period in the HR chart
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-09     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-10: Check there shall be a vertical line indicating the time and the heart rate at that time when the user hovers over the HR chart
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-10     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-11: Check the label shall displayed the time and NA for HR at that time in case the user hovers over the period of time on the HR chart that does not have data
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-11     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-12: Check details of the ECG chart when the user clicks on the HR chart
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-12     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-13: Check the user cannot click on the HR chart of the time periods that do not have any data
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-13     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-14: Check details of the Event information bar under the HR chart when user clicks on the HR chart
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-14     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-15: Check behavior when the user clicks on the HR chart and drags
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-15     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-16: Check the Reset zoom button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-16     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-17: Check case the user selects the vertical line and then zooms in the HR chart
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-17     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-18: Check the user can only zoom in and zoom out one time
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-18     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-19: Check case the user clicks on an event in the event list while zooming in
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-19     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-20: Check details of the ECG chart
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-20     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-21: Check case the user clicks on an event in the event list while zooming in
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-21     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-22: Check Speed filter on ECG chart is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-22     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-23: Check Gain filter on ECG chart is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-23     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-24: Check High Pass filter tool on ECG chart is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-24     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-25: Check Low Pass filter tool on ECG chart is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-25     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-26: Check Show/Hide Channels button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-26     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-27: Check the Beat marker tool is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-27     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-28: Check the View all strip button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-28     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-29: Check user can Add beat marker
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-29     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-30: Check user can Remove beat marker
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-30     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-31: Check Horizontal Caliper button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-31     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-32: Check Vertical Caliper button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-32     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-33: Check Beat Calipers button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-33     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-34: Check Text Annotation button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-34     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-35: Check Mark 10 Sec button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-35     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-36: Check Mark 20 Sec button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-36     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-37: Check Mark a Pattern button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-37     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-38: Check Hide Beat Markers button is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-38     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-39: Check details of the Event section
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-39     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-40: Check result when user clicks on the row of an event
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-40     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-41: Check the event type filter is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-41     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-42: Check the user can access the ECG Viewer Guideline
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-42     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-43: Check the Do not show this again checkbox is working properly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-43     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-44: Check the Pagination tool below the Event lists is working prorerly
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-44     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-45: The ECG Viewer tab shall not be dislayed for aborted studies
    [Documentation]     Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-ECG-VIEWER-45     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-01: Create an manual Instant report
    [Documentation]  Author: Nhan Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-01       manual    R1      CP-2.29.0    
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-02: Create an Instant Report With Overlapping Time Frame (No New Data Uploaded) and The previous report is generated
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/14/2025-TamHo
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-02       manual    R2      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-03: Create an Instant Report With Overlapping Time Frame (No New Data Uploaded) and The previous report is generating
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/14/2025-TamHo
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-03       manual    R2      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-04: Create an Instant Report With Overlapping Time Frame (New Data Uploaded)
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/14/2025-TamHo
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-04       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-05: Create an Instant Report With Overlapping Time Frame (No New Data Uploaded) and The previous report is generated + Artifact
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/14/2025-TamHo
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-05       manual    R2      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-06: View the List of Instant Reports
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/14/2025-TamHo
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-06       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-07: View a Generated Instant Report
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/14/2025-TamHo
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-07       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-08: Check the pagniation tool is working
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     - Last updated: 03/14/2025-TamHo
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-08       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-09: Instant-Download report
    [Documentation]  Author: Nhan Nguyen
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-INSTANT-09       manual    R1      CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-RETURN-01-CP2.16.8: Return Status tab not available for Test facility
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-RETURN-01-CP2.16.8       manual     R1     CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-RETURN-02-CP2.16.8: For Active facility - Edit Return status
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-RETURN-02-CP2.16.8       manual     R1     CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-RETURN-03-CP2.16.8: For Active facility - Edit Notes
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-RETURN-03-CP2.16.8       manual     R1     CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-RETURN-04-CP2.16.8: For Active facility - Create a return shipping label
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-RETURN-04-CP2.16.8       manual     R1     CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-RETURN-05-CP2.16.8: For Active facility - Check "Device returned" toggle disabled
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-RETURN-05-CP2.16.8       manual     R1     CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-DETAILS-RETURN-06-CP2.16.8: For Active facility - View Return Status of FO study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-RETURN-06-CP2.16.8       manual     R1     CP-2.16.8
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-DETAILS-BIODIRECT-STATUS-01:Display Shipping Label Details for Sending Device Status
    [Documentation]     Author: Tam Ho
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-BIODIRECT-STATUS-01       manual     R1     CP-2.25.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-DETAILS-BIODIRECT-STATUS-02:Display Shipping Label Details for Returning Device Status
    [Documentation]     Author: Tam Ho
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-BIODIRECT-STATUS-02       manual     R1     CP-2.25.2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-DETAILS-BIODIRECT-STATUS-03: Display message "No shipping label created yet" when Study Biodirect has not shipment label
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-DETAILS-BIODIRECT-STATUS-03      manual    CP-2.25.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-01: Can change study type of a study
    [Documentation]     Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-01       auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-02: Can change study type of a study with the study has Biocore/Biotres device
    [Documentation]     Author: Trinh Nguyen
    ...     Description: The user can change the study type with the study has Biocore/Biotres device does not have
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-02         auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-03: Can change study type of a study
    [Documentation]     Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-03       manual     CP-2.14.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-04: Can change study type of a study
    [Documentation]     Author: Trinh Nguyen
    ...     Description: The user can change the study type with the study has Biocore/Biotres device has
    ...     the auto-events detection enabled and firmware version has been updated to the latest
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-04       manual     CP-2.14.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-05: Can change study type of a study
    [Documentation]     Author: Trinh Nguyen
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-05      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-06: Biocore/Biotres (No Auto tag + FW <1.5.0)-Can change to Holter/Ext.Holter study type when study duration <=2d and ongoing time <= first 12h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-06      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-07: Biocore/Biotres (No Auto tag + FW <1.5.0)-Can change to Holter/Ext.Holter study type when study duration >2d and ongoing time >= first 48h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-07      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-08: Biocore/Biotres (No Auto tag + FW <1.5.0)-Cannot change to MCT/MCT Peek/Cardiac event/HnFO study type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-08      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-09: Biocore/Biotres (No Auto tag + FW >=1.5.0)-Can change to Holter/Ext.Holter study type when study duration <=2d and ongoing time <= first 12h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-09      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-10: Biocore/Biotres (No Auto tag + FW >=1.5.0)-Can change to Holter/Ext.Holter study type when study duration >2d and ongoing time <= first 48h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-10      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-11: Biocore/Biotres (No Auto tag + FW >=1.5.0)-Cannot change to MCT/MCT Peek/Cardiac/HnFO event study type
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-11    manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-12: Biocore/Biotres (Auto tag + FW <1.5.0)-Can change to Holter/Ext.Holter study type when study duration <=2d and ongoing time <= first 12h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-12      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-13: Biocore/Biotres (Auto tag + FW <1.5.0)-Can change to Holter/Ext.Holter study type when study duration >2d and ongoing time <= first 48h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-13      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-14: Biocore/Biotres (Auto tag + FW >=1.5.0)-Can change to any study type when study duration <=2d and ongoing time <= first 12h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-14    manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-15: Biocore/Biotres (Auto tag + FW >=1.5.0)-Can change to any study type when study duration >2d and ongoing time <= first 48h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-15    manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-16: Bioflux-Can change to any study type when study duration <=2d and ongoing time <= first 12h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-16    manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-17: Bioflux-Can change to any study type when study duration > 2d and ongoing time <= first 48h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-17    manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-18: Biocore/Biotres-Cannot change type when study duration <= 2d and ongoing time > first 12h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-18      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-19: Biocore/Biotres-Cannot change type when study duration > 2d and ongoing time > first 48h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-19      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-20: Bioflux-Cannot change type when study duration <= 2d and ongoing time > first 12h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-20      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-21: Bioflux-Cannot change type when study duration > 2d and ongoing time > first 48h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-21      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-20-CP2.25.3: Biocore Pro-Cannot change type when study duration <= 2d and ongoing time > first 12h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-20-CP2.25.3      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-21-CP2.25.3: Biocore Pro-Cannot change type when study duration > 2d and ongoing time > first 48h
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-21-CP2.25.3      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-22: Biocore/Biotres-Cannot change type for Test study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-22      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-22-CP2.25.3: Biocore Pro-Cannot change type for Test study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-22-CP2.25.3      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-23: Bioflux-Cannot change type for Test study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-23      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-24: Biocore/Biotres-Cannot change type when study status is Not started/Draft/Starting
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-24      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-24-CP2.25.3: Biocore Pro-Cannot change type when study status is Not started/Draft/Starting
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-24-CP2.25.3      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-25: Bioflux-Cannot change type when study status is Not started/Draft/Starting
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-25      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-26: Biocore/Biotres-Cannot change type when device is offline
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-26      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-26-CP2.25.3: Biocore Pro-Cannot change type when device is offline
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-26-CP2.25.3      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-27: Bioflux-Cannot change type when device is offline
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-27      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-28: Biocore/Biotres-Cannot change type when study status is Completed/Done
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-28      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-28-CP2.25.3: Biocore Pro-Cannot change type when study status is Completed/Done
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-28-CP2.25.3      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-29: Bioflux-Cannot change type when study status is Completed/Done
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-29      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-30: Bioflux-Cannot change type when study status is Completed/Done
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-30      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-31: Can change duration between 1 and 3d for Holter study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-31      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-31-CP2.25.3: Can change duration between 1 and 72h for Holter study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-31-CP2.25.3      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-32: Can change duration between 1 and 30d for MCT/MCT peek/Cardiac/Ext.Holter study
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-32      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-33: Cannot change duration when device is offline
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-33      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-34: Cannot change duration when study status is aborted
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-34      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-35: Cannot change duration when study status is Not started/Draft/Starting
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-35      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-36: Edit Patient return visit
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-36      auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-37: Change Referring physician
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-37      auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-38: Physician cannot change Interpreting physician
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-38     auto    deactive
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-39: Edit Diagnosis info and Patient medication
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-39      auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-40: Physician can edit Physician admendments notes
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-40      auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-41: Bioflux-Can resend ref code when study status is Started/Ongoing
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-41      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-42: Bioflux-Cannot resend ref code when study status is Draft/Starting/Completed/Done
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-42      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-43: Bioflux-Cannot resend ref code if the duration between 2 clicking times is less than 5 minutes
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-43      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-44: Biocore/Biotres-Can resend ref code for Holter/Ext.Holter when study status is Started/Ongoing/Completed
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-44      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-45: Biocore/Biotres-Cannot resend ref code for Holter/Ext.Holter when study status is Draft/Starting/Done
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-45      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-46: Biocore/Biotres-Can resend ref code for MCT/MCT Peek/Cardiac event when study status is Draft/Starting/Ongoing/Completed
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-46     manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-47: Biocore/Biotres-Cannot resend ref code for MCT/MCT Peek/Cardiac event when study status is Done
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-47      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-48: Biocore/Biotres-Cannot resend ref code if the duration between 2 clicking times is less than 5 minutes
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-48       manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    ${study_id}     ${friendly_id}      Api Study - Create
#    Navigate To Studies Page
#    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
...
#    [Teardown]      Run Keywords     Api Stop Study           ${AWS_TOKEN}     study_id=${friendly_id}
#    ...             AND              Api Delete Studies       ${AWS_TOKEN}     studyIds=${study_id}
BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-49: Referring physician can be edited for all study statuses except Aborted
    [Documentation]     Author: Tam Ho
    ...     Description:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-49      manual   R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-50: New Interpreting physician cannot be created during editing
    [Documentation]     Author: Tam Ho
    ...     Description:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-STUDY-INFO-50      manual   R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-EDIT-PATIENT-INFO-01: Edit Patient info
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-PATIENT-INFO-01     auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-EDIT-PATIENT-INFO-02: Edit Patient contact
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-PATIENT-INFO-02       auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-EDIT-PATIENT-INFO-03: Edit Patient's secondary contact
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-PATIENT-INFO-03     auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-EDIT-PATIENT-INFO-04: Edit Patient's insurance
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-PATIENT-INFO-04     auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-EDIT-PATIENT-INFO-05: Edit Patient's medical history
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-EDIT-PATIENT-INFO-05     auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-QUICK-ACCESS-01: Quick access to study info and can go to study management page here
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-QUICK-ACCESS-01     auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-QUICK-ACCESS-02: Quick access to patient info
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-QUICK-ACCESS-02     auto
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-QUICK-ACCESS-03: Quick access to device info
    [Documentation]     Author: Nhan Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-QUICK-ACCESS-03     auto     CP-2.23.0
    ${study_id}     ${friendly_id}      Api Study - Create
    Navigate To Studies Page
    Filter Studies  study_state=Active    search_by=Study ID      text_search=${friendly_id}
    ${studies}      Get Active Studies
...
BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-01: Biocore/Biotres/Biocore Pro-Cannot view live ECG of Draft study
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-01      manual    CP-2.20.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-02: Biocore/Biotres/Biocore Pro-View live ECG of Ongoing study and device is connected to Diagnostics app via BT
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...     Precondition:
    ...     - Biocore/Biotres/Biocore Pro is connected to Diagnostics app via BT
    ...     - Biocore/Biotres/Biocore Pro is online
    ...
    ...     Test Steps:
    ...
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-02      manual     R1    CP-2.20.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-03: Biocore/Biotres/Biocore Pro-View live ECG in case of no user action in the streaming pop-up within 10m
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-03      manual     R1    CP-2.20.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-04: Biocore/Biotres/Biocore Pro-Cannot view live ECG of Ongoing study and device is connected to Diagnostics app via USB
    [Documentation]  Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-04      manual    CP-2.20.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-05: Biocore Pro-View live ECG of Ongoing study and device is Online via Cellular
    [Documentation]  Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-05      manual    CP-2.25.0    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-06: Automatic Stop of Live ECG Streaming After 5 Minutes
    [Documentation]  Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-06      manual    CP-2.25.0    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-07: Restart Live ECG Streaming via Cellular After 5-Minute Auto Stop
    [Documentation]  Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-07      manual    CP-2.25.0    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-08: Live ECG Available When Facility Setting Is Off and Device Online via Bluetooth
    [Documentation]  Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-08      manual    CP-2.25.0    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-09: Display Message When Device Offline
    [Documentation]  Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-09      manual    CP-2.25.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-10: Display Message When Device online Via USB
    [Documentation]  Author: Tam Ho
    ...
    ...
    ...     2. The View Live ECG button is disabled and cannot be clicked
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-10      manual    CP-2.25.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-11: Display Message for Bioflux
    [Documentation]  Author: Tam Ho
    ...
    ...
    ...     2. The View Live ECG button is disabled and cannot be clicked
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-11      manual    CP-2.25.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-12: Display Message for paused study
    [Documentation]  Author: Tam Ho
    ...
    ...
    ...     2. The View Live ECG button is disabled and cannot be clicked
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-12      manual    CP-2.25.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-13: Display Message for Biocore Pro FW<1.0.0.35
    [Documentation]  Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-13      manual    CP-2.25.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-14: Display Message when device biocore Pro online via cellular and facility setting is off
    [Documentation]  Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-LIVEECG-14      manual    CP-2.25.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-1: Display Biodirect Tag on Studies with Biodirect Service
    [Documentation]  Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-1      manual    CP-2.25.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-2: Display Shipment Details in Biodirect Drawer
    [Documentation]  Author: Tam Ho
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-2      manual    CP-2.25.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-3: Display message "No shipping label created yet" in Biodirect Drawer
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    ...     1. Display message "No shipping label created yet"
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-3      manual    CP-2.25.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-4: Biodirect status is "Preparing device for shipment " when The Biodirect ticket is in the Order tab
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-4      manual    CP-2.25.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-5: Biodirect status is "Preparing device for shipment " when The Biodirect ticket is Pending tab + no Outbound shipment label
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-5      manual    CP-2.25.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-6: Biodirect status is "Device is being shipped " when The Biodirect ticket is Pending tab + Outbound shipment label (no status Delivered)
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-6      manual    CP-2.25.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-7: Biodirect status is "Device delivered to patient " when The Biodirect ticket is Pending tab + Outbound shipment label status "Delivered"
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-7      manual    CP-2.25.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-8: Biodirect status is "Device delivered to patient " when The Biodirect ticket is marked as complete follow-up
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-8      manual    CP-2.25.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-9: Biodirect status is "Device delivered to patient " when The Biodirect ticket is automatically moved to the Running tab
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-9      manual    CP-2.25.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-10: Biodirect status is "Device is being returned " when The Biodirect ticket is in the Complete tab + Inbound shipment label (no status Delivered)
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-10      manual    CP-2.25.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-11: Biodirect status is "Device returned " when The Biodirect ticket Biodirect ticket is marked as Confirm Return (Done tab)
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-11      manual    CP-2.25.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-12: Biodirect status is "Device returned " when Biodirect ticket is automatically moved to "Done"
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-12      manual    CP-2.25.2    R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-13: Biodirect status of Study 1 is applied to Study 2 in a Follow-On Study
    [Documentation]  Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BF-PHY-CP-STUDIES-ACTIVE-BIODIRECT-STATUS-13      manual    CP-2.25.2    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
