*** Settings ***
Documentation   Test Suite - Call Center QALEADLEAD Leader Portal - View Reports
Metadata    sid     BFCC-QALEAD-REPORTS-VIEW
...
Force Tags      BFCC-QALEAD-REPORTS-VIEW   web
Test Timeout    10m

*** Test Cases ***
BFCC-QALEAD-REPORTS-VIEW-PENDING-01: View a list of Interim reports created automatically on Interim reports sub-tab
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-01      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-02: View report screen in case the user only associates with one facility on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-03: Filter a facility in case the user associates with multiples facility on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-03      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-04: Quick access to Study information on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-04      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-05: Quick access to Patient information on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-05      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-06: Access to the Report editing screen on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-06      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-07: Access to the Study Management screen on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-07      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-08: Manually sort the report list by Study ID on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-08      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-09: Manually sort the report list by Report ID on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-09      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-10: Manually sort the report list by Creation Time on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-10      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-11: Manually sort the report list by Duration on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-11      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BFCC-QALEAD-REPORTS-VIEW-PENDING-12: Manually sort the report list by Patient name on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-12      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-13: Manually sort the report list by Patient ID on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-13      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-14: Manually sort the report list by Report Status on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-14      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-15: Automatically sort the report list by SLA priority (default) on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-15      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-16: Automatically sort the report list by CODE RED on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-16      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-17: Check pagination tool works properly on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-17      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-18: View a list of EOU reports of MCT/Cardiac Event studies on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    ...     Version: CP2.16.9
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-18      auto   CP-2.16.9
    Navigate To Reports
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-19: View report screen in case the user only associates with one facility on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can view the name of the facility in case the user only
    ...     associates with one facility
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-19      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-20: Filter a facility in case the user associates with multiples facility on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can filter a specific facility
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-20      auto
    Navigate To Reports
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-21: Quick access to Study information on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-21      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=End of Use reports
    ${reports}      Get Pending Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-22: Quick access to Patient information on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-22      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=End of Use reports
    ${reports}      Get Pending Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-23-CP2.16.9: View details of New report status column on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-23-CP2.16.9      manual   CP-2.16.9
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-24: Access to the Report editing screen on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-24      auto
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-25: Access to the Study Management screen on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-25         auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=End of Use reports
    ${reports}      Get Pending Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-26: Initiate the process of running AI for EOU report on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-26      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-27: Manually sort the report list by Study ID on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-27      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=End of Use reports      facility=All facilities
    ${reports}      Get Pending Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-28: Manually sort the report list by Study Type on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-28      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-29: Manually sort the report list by Upload Date on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-29      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=End of Use reports      facility=All facilities
    ${reports}      Get Pending Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-30: Manually sort the report list by Return Visit on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-30      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=End of Use reports      facility=All facilities
    ${reports}      Get Pending Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-31: Manually sort the report list by Duration on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-31      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=End of Use reports      facility=All facilities
    ${reports}      Get Pending Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-32: Manually sort the report list by Patient Name on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-32      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-33: Manually sort the report list by Report Status on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-33      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-34: Automatically sort the report list by SLA priority (default) on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-34      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-35: Automatically sort the report list by CODE RED on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-35      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-36: Check pagination tool works properly on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-36      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=End of Use reports      facility=All facilities
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-37: View a list of EOU reports of Holter/Extended Holter/MCT Peek studies on Holter End of Use Reports reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-37      auto   CP-2.16.9
    Navigate To Reports
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-38: View report screen in case the user only associates with one facility on Holter End of Use Reports reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can view the name of the facility in case the user only
    ...     associates with one facility
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-38      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-39: Filter a facility in case the user associates with multiples facility on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can filter a specific facility
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-39      auto
    Navigate To Reports
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-40: Quick access to Study information on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-40      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=Holter End of Use reports
    ${reports}      Get Pending Holter Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-41: Quick access to Patient information on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-41      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=Holter End of Use reports
    ${reports}      Get Pending Holter Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-42-CP2.16.9: View details of New report status column on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-42-CP2.16.9      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-43: Access to the Report editing screen on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-43      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=Holter End of Use reports
    ${reports}      Get Pending Holter Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-44: Access to the Study Management screen on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-44      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=Holter End of Use reports
    ${reports}      Get Pending Holter Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-45: Initiate the process of running AI for EOU report on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-45      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-46: Manually sort the report list by Study ID on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-46      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=Holter End of Use reports      facility=All facilities
    ${reports}      Get Pending Holter Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-47: Manually sort the report list by Study Type on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-47      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-48: Manually sort the report list by Upload Date on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-48      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=Holter End of Use reports      facility=All facilities
    ${reports}      Get Pending Holter Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-49: Manually sort the report list by Return Visit on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-49      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=Holter End of Use reports      facility=All facilities
    ${reports}      Get Pending Holter Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-50: Manually sort the report list by Duration on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-50      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=Holter End of Use reports      facility=All facilities
    ${reports}      Get Pending Holter Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-PENDING-51: Manually sort the report list by Patient Name on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-51      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-52: Manually sort the report list by Report Status on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-52      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-53: Automatically sort the report list by SLA priority (default) on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-53      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-54: Automatically sort the report list by CODE RED on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-54      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-PENDING-55: Check pagination tool works properly on Holter End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-PENDING-55      auto
    Navigate To Reports
    Filter Reports      report_state=Pending        report_type=Holter End of Use reports      facility=All facilities
    ${current_pagination}     Get Current Pagination
#    Run Keyword And Continue On Failure    Should Be Equal    ${current_pagination}[Rows]     10 rows
...
BFCC-QALEAD-REPORTS-VIEW-READY-01: View a list of Notification Reports in the “Ready” tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-01      auto
...
BFCC-QALEAD-REPORTS-VIEW-READY-02: View report screen in case the user only associates with one facility on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can view the name of the facility in case the user only
    ...     associates with one facility
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-03: Filter a facility in case the user associates with multiples facility on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can filter a specific facility
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-03      auto
    Navigate To Reports
...
BFCC-QALEAD-REPORTS-VIEW-READY-04: View a list of Notification reports with "Assignee: You” is selected on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     **Others**
    ...     Update Date: 11/21/2023 - Trinh Nguyen
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-04     auto
...
BFCC-QALEAD-REPORTS-VIEW-READY-05: View a list of Notification reports with “Assignee: Unassigned” is selected Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-05      auto
    Navigate To Reports
...
BFCC-QALEAD-REPORTS-VIEW-READY-06: View a list of Notification reports with “Assignee: All” is selected Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-06      auto
    Navigate To Reports
    Filter Reports    report_state=Ready        report_type=Notification reports        by_assignee=Unassigned
    ${notification_report}     Get Ready Notification Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${notification_report}
...
BFCC-QALEAD-REPORTS-VIEW-READY-07: Quick access to Study information on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-07     auto
    Navigate To Reports
...
BFCC-QALEAD-REPORTS-VIEW-READY-08: Quick access to Patient information on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-08      auto
    Navigate To Reports
    Filter Reports    report_state=Ready        report_type=Notification reports        by_assignee=All     facility=All facilities
    ${notification_report}     Get Ready Notification Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${notification_report}
...
BFCC-QALEAD-REPORTS-VIEW-READY-09: Dismiss notification on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-09      auto
    [Setup]    Create Ready Notification Reports
    Navigate To Reports
    Filter Reports    report_state=Ready        report_type=Notification reports        by_assignee=All
    ${notification_report}     Get Ready Notification Reports
...
BFCC-QALEAD-REPORTS-VIEW-READY-10: Can go to edit report screen by using edit button on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-10      auto
    [Setup]    Create Ready Notification Reports
    Navigate To Reports
    Filter Reports    report_state=Ready        report_type=Notification reports        by_assignee=All
    ${notification_report}     Get Ready Notification Reports
...
BFCC-QALEAD-REPORTS-VIEW-READY-11: Can access to the Study management screen by using Manage study button on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-11      auto
    [Setup]    Create Ready Notification Reports
    Navigate To Reports
    Filter Reports    report_state=Ready        report_type=Notification reports        by_assignee=All
    ${notification_report}     Get Ready Notification Reports
...
BFCC-QALEAD-REPORTS-VIEW-READY-12: Can create report by using the Create notification report button on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-12      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-13: Can assign a study for an user by using assign button on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-13      auto
    [Setup]     Unassign Multiple "Notification reports" Reports
...
BFCC-QALEAD-REPORTS-VIEW-READY-14: Mark call completed status for Notification reports on Call required sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-14      auto
...
BFCC-QALEAD-REPORTS-VIEW-READY-15: Quick access to Study information on Call required sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-15      auto
    [Setup]    Create Ready Call Required
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=Call required
    ${call_required}     Get Ready Call Required Reports
...
BFCC-QALEAD-REPORTS-VIEW-READY-16: Quick access to Patient information on Call required sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-16      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=Call required
    ${call_required}     Get Ready Call Required Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${call_required}
...
BFCC-QALEAD-REPORTS-VIEW-READY-17: Can go to edit report screen by using edit button on Call required sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-17      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=Call required
    ${call_required}     Get Ready Call Required Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${call_required}
...
BFCC-QALEAD-REPORTS-VIEW-READY-18: Can access to the Study management screen by using Manage study button on Call required sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-18      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=Call required
    ${call_required}     Get Ready Call Required Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${call_required}
...
BFCC-QALEAD-REPORTS-VIEW-READY-19: View information of Interim reports list on the Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-19      auto
...
BFCC-QALEAD-REPORTS-VIEW-READY-20: View report screen in case the user only associates with one facility on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can view the name of the facility in case the user only
    ...     associates with one facility
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-20      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-21: Filter a facility in case the user associates with multiples facility on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can filter a specific facility
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-21      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=Interim reports      by_assignee=All
...
BFCC-QALEAD-REPORTS-VIEW-READY-22: Quick access to Study information on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-22      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=Interim reports       by_assignee=All
    ${interim_reports}     Get Ready Interim Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${interim_reports}
...
BFCC-QALEAD-REPORTS-VIEW-READY-23: Access to the Report editing screen on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-23      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=Interim reports       by_assignee=All
    ${interim_reports}     Get Ready Interim Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${interim_reports}
...
BFCC-QALEAD-REPORTS-VIEW-READY-24: Access to the Study Management screen on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-24      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=Interim reports       by_assignee=All
    ${interim_reports}     Get Ready Interim Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${interim_reports}
...
BFCC-QALEAD-REPORTS-VIEW-READY-25: Manually sort the report list by Study ID on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-25      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=Interim reports       by_assignee=All
    ${interim_reports}     Get Ready Interim Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${interim_reports}
...
BFCC-QALEAD-REPORTS-VIEW-READY-26: Manually sort the report list by Report ID on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-26      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=Interim reports       by_assignee=All
    ${interim_reports}     Get Ready Interim Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${interim_reports}
...
BFCC-QALEAD-REPORTS-VIEW-READY-27: Manually sort the report list by Creation Time on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-27      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-28: Manually sort the report list by Duration on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-28      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=Interim reports       by_assignee=All
    ${interim_reports}     Get Ready Interim Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${interim_reports}
...
BFCC-QALEAD-REPORTS-VIEW-READY-29: Manually sort the report list by Patient name on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-29      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-30: Manually sort the report list by Patient ID on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-30      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-31: Manually sort the report list by Study Type on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-31      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-32: Automatically sort the report list by SLA priority (default) on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-32      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-33: Can assign a study for an user by using assign button on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-33     auto
...
BFCC-QALEAD-REPORTS-VIEW-READY-34: View a list of Interim reports with "Assignee: You” is selected on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-34     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-35: View a list of Interim reports with “Assignee: Unassigned” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-35      auto
    Navigate To Reports
...
BFCC-QALEAD-REPORTS-VIEW-READY-36: View a list of Interim reports with “Assignee: All” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-36      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-37: View a list of Interim reports with “Report type: Artifact reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-37      auto
    [Setup]    Create Ready Interim Report
...
BFCC-QALEAD-REPORTS-VIEW-READY-38: View a list of Interim reports with “Report type: All reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-38      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-39: View a list of EOU reports in Ready tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    ...      allow the Call Center QALEAD user to self-assign the task that has not been assigned to any assignee. When the user
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-39     auto   CP-2.16.9
...
BFCC-QALEAD-REPORTS-VIEW-READY-40: View report screen in case the user only associates with one facility on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can view the name of the facility in case the user only
    ...     associates with one facility
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-40      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-41: Filter a facility in case the user associates with multiples facility on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can filter a specific facility
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-41      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=End of Use reports      by_assignee=All
...
BFCC-QALEAD-REPORTS-VIEW-READY-42: Quick access to Study information on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-42     auto
    Navigate To Reports
...
BFCC-QALEAD-REPORTS-VIEW-READY-43: Quick access to Patient information on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-43      auto
    Navigate To Reports
    Filter Reports    report_state=Ready        report_type=End of Use reports        by_assignee=All     facility=All facilities
    ${eou_report}     Get Ready Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${eou_report}
...
BFCC-QALEAD-REPORTS-VIEW-READY-44-CP2.16.9: View details of New report status column on EOU sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-44-CP2.16.9     manual   CP-2.16.9
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-45: Access to the Report editing screen on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-45       auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=End of Use reports       by_assignee=All
    ${eou_reports}     Get Ready Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${eou_reports}
...
BFCC-QALEAD-REPORTS-VIEW-READY-46: Access to the Study Management screen on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-46      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=End of Use reports       by_assignee=All
    ${eou_reports}     Get Ready Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${eou_reports}
...
BFCC-QALEAD-REPORTS-VIEW-READY-47: Initiate the process of running AI for EOU report on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-47      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-48: Manually sort the report list by Study ID on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-48      auto
    Navigate To Reports
...
BFCC-QALEAD-REPORTS-VIEW-READY-49: Manually sort the report list by Study Type on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-49      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-50: Manually sort the report list by Upload Date on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-50      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-51: Manually sort the report list by Duration on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-51      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=End of Use reports      facility=All facilities       by_assignee=All
    ${reports}      Get Ready Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-READY-52: Manually sort the report list by Patient Name on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-52      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-53: Manually sort the report list by Return Visit on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-53      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=End of Use reports      facility=All facilities       by_assignee=All
    ${reports}      Get Ready Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-READY-54: Automatically sort the report list by SLA priority (default) on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-54      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-55: Automatically sort the report list by CODE RED on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-55      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-56: Check pagination tool works properly on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-56      auto
    Navigate To Reports
    Filter Reports      report_state=Ready        report_type=End of Use reports      facility=All facilities       by_assignee=All
    ${current_pagination}     Get Current Pagination
#    Run Keyword And Continue On Failure    Should Be Equal    ${current_pagination}[Rows]     10 rows
...
BFCC-QALEAD-REPORTS-VIEW-READY-57: Can assign a study for an user by using assign button on End of Use reports reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     Expected Results:
    ...     1.
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-57      auto
...
BFCC-QALEAD-REPORTS-VIEW-READY-58: View a list of End of Use reports with "Assignee: You” is selected on End of Use reports reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-58     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-59: View a list of End of Use reports with “Assignee: Unassigned” is selected End of Use reports reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-59      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-60: View a list of End of Use reports with “Assignee: All” is selected End of Use reports reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-60      auto
    Navigate To Reports
...
BFCC-QALEAD-REPORTS-VIEW-READY-62: View a list of End of Use reports with “Report type: Artifact reports” is selected End of Use reports reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-62      auto
...
BFCC-QALEAD-REPORTS-VIEW-READY-63: View a list of End of Use reports with “Report type: All reports” is selected End of Use reports reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-63      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-READY-64: Access to the AI Report editing screen on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-READY-64      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-01: View a list of Event Reports in the “Sent” tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-01      auto
...
BFCC-QALEAD-REPORTS-VIEW-SENT-02: View report screen in case the user only associates with one facility on Event reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can view the name of the facility in case the user only
    ...     associates with one facility
    ...
    ...     2. All the data associated with that facility shall be displayed
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-03: Filter a facility in case the user associates with multiples facility on Event reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can filter a specific facility
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-03       auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Event reports      facility=All facilities
    ${event_reports}    Get Sent Event Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${event_reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-04: Quick access to Study information on Event reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-04      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Event reports      facility=All facilities
    ${event_reports}    Get Sent Event Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${event_reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-05: Quick access to Patient information on Event reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-05       auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Event reports      facility=All facilities
    ${event_reports}    Get Sent Event Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${event_reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-06: Can go to edit report screen by using edit button on Event reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-06      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Event reports      facility=All facilities
    ${event_reports}    Get Sent Event Reports
...
BFCC-QALEAD-REPORTS-VIEW-SENT-07: Can access to the Study management screen by using Manage study button on Event reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-07      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Event reports      facility=All facilities
    ${event_reports}    Get Sent Event Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${event_reports}      msg=The notification report not found
...
BFCC-QALEAD-REPORTS-VIEW-SENT-08: Manually sort the report list by Study ID on Event reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-08      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Event reports      facility=All facilities
    ${reports}      Get Sent Event Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-09: Manually sort the report list by Event ID on Event reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-09       auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Event reports      facility=All facilities
    ${reports}      Get Sent Event Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-10: Manually sort the report list by Event Type on Event reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-10      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-11: Manually sort the report list by Patient Name on Event reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-11      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-12: Manually sort the report list by Patient ID on Event reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-12      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-13: Manually sort the report list by Study Type on Event reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-13      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-14: Manually sort the report list by Report Date on Event reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-14      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-15: Check pagination tool works properly on Event reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-15      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Event reports      facility=All facilities
    ${current_pagination}     Get Current Pagination
#    Run Keyword And Continue On Failure    Should Be Equal    ${current_pagination}[Rows]     10 rows
...
BFCC-QALEAD-REPORTS-VIEW-SENT-16: View a list of Notification Reports in the “Sent” tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-16      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-17: View report screen in case the user only associates with one facility on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can view the name of the facility in case the user only
    ...     associates with one facility
    ...
    ...     2. All the data associated with that facility shall be displayed
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-17      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-18: Filter a facility in case the user associates with multiples facility on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can filter a specific facility
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-18      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-19: Quick access to Study information on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-19      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-20: Quick access to Patient information on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-20      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-21: Can go to edit report screen by using edit button on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-21      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-22: Can access to the Study management screen by using Manage study button on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-22      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-23: Manually sort the report list by Study ID on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-23      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-24: Manually sort the report list by Report ID on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-24      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-25: Manually sort the report list by Duration on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-25      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-26: Manually sort the report list by Patient Name on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-26      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-27: Manually sort the report list by Patient ID on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-27      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-28: Manually sort the report list by Study Type on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-28      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-29: Manually sort the report list by Report Date on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-29      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-30: View information of Interim reports list on the Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-30      auto
...
BFCC-QALEAD-REPORTS-VIEW-SENT-31: View report screen in case the user only associates with one facility on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can view the name of the facility in case the user only
    ...     associates with one facility
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-31      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-32: Filter a facility in case the user associates with multiples facility on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can filter a specific facility
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-32     auto
    [Setup]    Create Sent Interim Report
    Navigate To Reports
...
BFCC-QALEAD-REPORTS-VIEW-SENT-33: Quick access to Patient information on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-33      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Interim reports       by_report=All reports
    ${interim_reports}     Get Sent Interim Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${interim_reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-65: Quick access to Patient information on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-65      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Interim reports       by_report=All reports
    ${interim_reports}     Get Sent Interim Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${interim_reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-34: Access to the Report editing screen on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-34      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Interim reports       by_report=All reports
    ${interim_reports}     Get Sent Interim Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${interim_reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-35: Access to the Study Management screen on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-35      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Interim reports       by_report=All reports
    ${interim_reports}     Get Sent Interim Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${interim_reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-36: Manually sort the report list by Study ID on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-36      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Interim reports       by_report=All reports
    ${interim_reports}     Get Sent Interim Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${interim_reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-37: Manually sort the report list by Report ID on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-37      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Interim reports       by_report=All reports
    ${interim_reports}     Get Sent Interim Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${interim_reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-38: Manually sort the report list by Duration on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-38     auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=Interim reports       by_report=All reports
    ${interim_reports}     Get Sent Interim Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${interim_reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-39: Manually sort the report list by Patient Name on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-39      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-40: Manually sort the report list by Patient ID on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-40      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-41: Manually sort the report list by Study Type on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-41      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-42: Manually sort the report list by Report Date on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-42      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-43: View a list of Interim reports with “Report type: Artifact reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-43      auto
    [Setup]    Create Ready Interim Report
    Mark Artifact Ready Interim Report    is_mark=${True}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-44: View a list of Interim reports with “Report type: All reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-44     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-45: View a list of EOU reports in Sent tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-45    auto   CP-2.16.9
...
BFCC-QALEAD-REPORTS-VIEW-SENT-46: View report screen in case the user only associates with one facility on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can view the name of the facility in case the user only
    ...     associates with one facility
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-46      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-47: Filter a facility in case the user associates with multiples facility on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The user can filter a specific facility
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-47      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=End of Use reports
...
BFCC-QALEAD-REPORTS-VIEW-SENT-48: Quick access to Study information on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-48      auto
    Navigate To Reports
    Filter Reports    report_state=Sent        report_type=End of Use reports
...
BFCC-QALEAD-REPORTS-VIEW-SENT-49: Quick access to Patient information on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-49      auto
    Navigate To Reports
    Filter Reports    report_state=Sent        report_type=End of Use reports
    ${eou_report}     Get Sent Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${eou_report}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-50-CP2.16.9: View details of New report status column on EOU sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-50-CP2.16.9    manual   CP-2.16.9
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-51: Access to the Report editing screen on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-51      auto
    Navigate To Reports
    Filter Reports    report_state=Sent        report_type=End of Use reports
    ${eou_reports}     Get Sent Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${eou_reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-52: Access to the Study Management screen on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-52      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=End of Use reports
    ${eou_reports}     Get Sent Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${eou_reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-53: Initiate the process of running AI for EOU report on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-53      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-54: Manually sort the report list by Study ID on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-54      auto
    Navigate To Reports
...
BFCC-QALEAD-REPORTS-VIEW-SENT-55: Manually sort the report list by Study Type on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-55      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-56: Manually sort the report list by Upload Date on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-56      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-57: Manually sort the report list by Duration on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-57      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=End of Use reports      facility=All facilities
    ${reports}      Get Sent Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-58: Manually sort the report list by Patient Name on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-58      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-59: Manually sort the report list by Return Visit on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-59      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=End of Use reports      facility=All facilities
    ${reports}      Get Sent Eou Reports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${reports}
...
BFCC-QALEAD-REPORTS-VIEW-SENT-60: Manually sort the report list by Report Date on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-60      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-61: Check pagination tool works properly on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-61      auto
    Navigate To Reports
    Filter Reports      report_state=Sent        report_type=End of Use reports
    ${current_pagination}     Get Current Pagination
#    Run Keyword And Continue On Failure    Should Be Equal    ${current_pagination}[Rows]     10 rows
...
BFCC-QALEAD-REPORTS-VIEW-SENT-62: View a list of End of Use reports with “Report type: Artifact reports” is selected on End of Use reports reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-62      auto
    [Setup]    Create Ready End Of Use Reports
    Mark Artifact Ready Interim Report    is_mark=${True}
    Filter Interim Report    is_click=${True}       is_send=${True}
    Navigate To Reports
...
BFCC-QALEAD-REPORTS-VIEW-SENT-63: View a list of End of Use reports with “Report type: All reports” is selected on End of Use reports reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-63      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-REPORTS-VIEW-SENT-64: Access to the AI Report editing screen on End of Use reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-REPORTS-VIEW-SENT-64      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
