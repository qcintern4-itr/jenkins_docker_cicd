...
BFCC-SUPVR-PROCESS-EVENT-DETAILS-01: Change the type of an Auto event
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-DETAILS-01     auto
...
BFCC-SUPVR-PROCESS-EVENT-DETAILS-02: Mark an event as valid or invalid
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-DETAILS-02     auto
...
BFCC-SUPVR-PROCESS-EVENT-DETAILS-03: Include a strip of Manual event in a report
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-DETAILS-03       auto
    Navigate To Event Detail With Event Type Is "Manual"
    Switch Tab
    Navigate To Event Tab      Event Details
...
BFCC-SUPVR-PROCESS-EVENT-DETAILS-05: Mark call status
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-DETAILS-05       auto
    [Setup]    Navigate To Event Details
...
BFCC-SUPVR-PROCESS-EVENT-DETAILS-10: Edit event tags
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-DETAILS-10       auto
    [Setup]    Navigate To Event Details
...
BFCC-SUPVR-PROCESS-EVENT-DETAILS-14: View Study Settings
    ...
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-DETAILS-14      auto
...
BFCC-SUPVR-PROCESS-EVENT-DETAILS-15: Mark an event as Process Later
    [Documentation]     Author: Nhan Nguyen
    ...     **Others**
    ...     Update date: 8/18/2023 - Nhan Nguyen

    [Tags]      BFCC-SUPVR-PROCESS-EVENT-DETAILS-15       auto
    Navigate To Tab Menu      Studies
    Navigate To Studies Type        Completed
...
BFCC-SUPVR-PROCESS-EVENT-DETAILS-16: Unmark an event as Process Later
    [Documentation]     Author: Nhan Nguyen
    ...     **Others**
    ...     Update date: 8/18/2023 - Nhan Nguyen

    [Tags]      BFCC-SUPVR-PROCESS-EVENT-DETAILS-16       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BFCC-SUPVR-PROCESS-EVENT-CRITERIA-01: View Notification Criteria
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-CRITERIA-01      auto
    Navigate To Tab Menu      Studies
    Navigate To Studies Type        Completed
    ${completed}        Get Completed Studies On Page
...
BFCC-SUPVR-PROCESS-EVENT-REPORT-01: Generate event report
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-01        auto
    Navigate To Tab Menu      Studies
    Navigate To Studies Type        Completed
    Filter Studies          search_by=Study ID      text_search=${STUDY_ID_COMPELTED}
    Manage Complete Study On        row=1
...
BFCC-SUPVR-PROCESS-EVENT-REPORT-02: Regenerate event report
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-02        auto
...
BFCC-SUPVR-PROCESS-EVENT-REPORT-03: Upload an event report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-03        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BFCC-SUPVR-PROCESS-EVENT-REPORT-04: Set event report status to Ready
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-04        auto
    [Setup]    Create Event Report Has The Status Is Generated
    Navigate to report screen has the notification reports with study id is "${study_id}"
    Filter Study Reports    text_search=${event_search}
    ${study_reports}        Get Study Reports
...
BFCC-SUPVR-PROCESS-EVENT-REPORT-05: Send event report in the case the user does not assign the report to himself or herself
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-05        auto
...
BFCC-SUPVR-PROCESS-EVENT-REPORT-06: Send event report in the case the study has already been assigned to another QA user
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The CCQA, QA Leader, Supervisor can send an event report
    ...
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-06        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-PROCESS-EVENT-REPORT-07: Send event report in the case the study has already been assigned to yourself
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The CCQA, QA Leader, Supervisor can send an event report
    ...
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-07        auto
...
BFCC-SUPVR-PROCESS-EVENT-REPORT-08: Email an event report to clinic
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-08        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-PROCESS-EVENT-REPORT-09: Auto-fax a report to the clinic
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-09        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-PROCESS-EVENT-REPORT-10: Auto-fax a report to the physician
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-10        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-PROCESS-EVENT-REPORT-11: Manual fax a report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-11        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BFCC-SUPVR-PROCESS-EVENT-REPORT-12: Recall an event report
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-12        auto
...
BFCC-SUPVR-PROCESS-EVENT-REPORT-13: Dismiss an event report in the case the user does not assign the report to himself or herself
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-13        auto
    [Setup]    Create Event Report Has The Status Is Generated
    Navigate to report screen has the notification reports with study id is "${study_id}"
    ${study_reports}        Get Study Reports
...
BFCC-SUPVR-PROCESS-EVENT-REPORT-14: Dismiss an event report in the case the study has already been assigned to another QA user
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The CCQA, QA Leader, Supervisor can dismiss an event report
    ...
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-14        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Reports
...
BFCC-SUPVR-PROCESS-EVENT-REPORT-15: Dismiss an event report in the case the study has already been assigned to yourself
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The CCQA, QA Leader, Supervisor can dismiss an event report
    ...
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-15        auto
    Create Ready Notification Reports With Study Id Is "${STUDY_ID_ASSIGN}[study_id_1]"
    Navigate to report screen has the notification reports with study id is "${study_id}"
    Filter Study Reports    text_search=${event_search}
    ${study_reports}        Get Study Reports
...
BFCC-SUPVR-PROCESS-EVENT-REPORT-16: Re-enable an event report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-16        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BFCC-SUPVR-PROCESS-EVENT-DETAILS-19: Edit technician comments
    ...
    ...     Version:
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-DETAILS-19       auto
    Navigate To Event Details
...
BFCC-SUPVR-PROCESS-EVENT-DETAILS-20: Verify UI for the Event Information in "Event Details" screen
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Version:
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-DETAILS-20       auto
    Navigate To Event Detail With Event Type Is "Manual"
    Switch Tab
    Navigate To Event Tab      Event Details
    ${event_details}    Get Event Details
...
BFCC-SUPVR-PROCESS-EVENT-DETAILS-21: Verify UI for the Event Information in "Event Details" screen
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: Verify UI for the Event Information in "Event Details" screen
    ...
    ...
    ...     Version:
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-DETAILS-21       auto
...
BFCC-SUPVR-PROCESS-EVENT-REPORT-22: Regenerate event report with report status is ready
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: The user can regenerate an event report of a Valid event
    ...
    ...
    ...     Version:
    ...
    [Tags]      BFCC-SUPVR-PROCESS-EVENT-REPORT-22        auto
    [Setup]     Create Event Report Has The Status Is Ready
    Navigate To Report Screen Has The Notification Reports With Study Id Is "${study_id}"
    ${study_reports}        Get Study Reports
    ${report_status}        Evaluate    [item for item in ${study_reports} if item.get('Report Status') == 'Ready']
