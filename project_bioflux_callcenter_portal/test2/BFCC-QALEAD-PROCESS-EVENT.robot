*** Settings ***
Documentation   Test Suite - Call Center QA Leader Portal - Process Event
Metadata    sid     BFCC-QALEAD-PROCESS-EVENT
...
Force Tags      BFCC-QALEAD-PROCESS-EVENT     web
Test Timeout    10m

*** Test Cases ***
BFCC-QALEAD-PROCESS-EVENT-DETAILS-01: Change the type of an Auto event
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-01       auto
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-02: Mark an event as valid or invalid
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-02       auto
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-03: Include a strip of Manual event in a report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-03       auto
    Navigate To Event Detail With Event Type Is "Manual"
    Switch Tab
    Navigate To Event Tab      Event Details
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-04: Include/exclude a strip of Auto event in a report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-04       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-DETAILS-05: Mark call status
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-05      auto
    [Setup]    Navigate To Event Details
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-06: Edit an MCT event using ECG viewer
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-06       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-DETAILS-07: Edit an event using AI assist tool
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-07       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-DETAILS-08: Edit event parameters of an Auto event that has completed ans its params uploaded
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-08       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-DETAILS-09: Edit event parameters of an Auto event that has not been fully uploaded
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-09       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-DETAILS-10: Edit event tags
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-10       auto
    [Setup]    Navigate To Event Details
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-11: Edit technician comments
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-11       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    [Setup]    Navigate To Event Details
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-12: View full data of an Auto event
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can edit technician comments
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-12       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

#BFCC-QALEAD-PROCESS-EVENT-DETAILS-13: View Event Information
#    [Documentation]     Author: Nhan Nguyen
#    ...
...
#
#    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-13       manual
#    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-DETAILS-14: View Study Settings
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can view Event Information
    ...
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-14      auto
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-15: Mark an event as Process Later
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can view Event Information
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-15       auto
    Navigate To Tab Menu      Studies
    Navigate To Studies Type        Completed
    Filter Studies    search_by=Study ID         text_search=${STUDY_ID_COMPELTED}
    Manage Complete Study On        row=1
    ...
    #BFCC-QALEAD-PROCESS-EVENT-DETAILS-16 Unmark an event as Process Later
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-16: Unmark an event as Process Later
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-16       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-CRITERIA-01: View Notification Criteria
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-CRITERIA-01      auto
    Navigate To Tab Menu      Studies
    Navigate To Studies Type        Completed
...
BFCC-QALEAD-PROCESS-EVENT-LOCK-01: Locking an event when the user is Editing an Event
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-LOCK-01      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#    Navigate To Tab Menu      Studies
#    Navigate To Studies Type        Completed
#    Manage Complete Study On        row=1
...
#    Run Keyword And Continue On Failure    Should Be Equal    ${actual_msg}     Someone else is also viewing this event.
#    ${number}       Get Count User Opening
#    ${status} =  Evaluate  ${number} > 1
#    Run Keyword And Continue On Failure    Should Be True    ${status}

BFCC-QALEAD-PROCESS-EVENT-LOCK-02: Locking events on the event list on the EVENTS page
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can lock an event so that it won’t be able to be processed by more than one user at a time.
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-LOCK-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-REPORT-01: Generate event report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-01        auto
    Navigate To Tab Menu      Studies
    Navigate To Studies Type        Completed
    Filter Studies          search_by=Study ID      text_search=${STUDY_ID_COMPELTED}
    Manage Complete Study On        row=1
...
BFCC-QALEAD-PROCESS-EVENT-REPORT-02: Regenerate event report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-02        auto
...
BFCC-QALEAD-PROCESS-EVENT-REPORT-03: Upload an event report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-03        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-REPORT-04: Set event report status to Ready
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-04        auto
    [Setup]    Create Event Report Has The Status Is Generated
    Navigate to report screen has the notification reports with study id is "${study_id}"
    Filter Study Reports    text_search=${event_search}
    ${study_reports}        Get Study Reports
    ...
    Navigate To Reports
    Filter Reports    search_by=Study ID    text_search=${actual_event_report}[STUDY ID]     report_state=Ready      report_type=Notification reports      by_assignee=All
...
BFCC-QALEAD-PROCESS-EVENT-REPORT-05: Send event report in the case the user does not assign the report to himself or herself
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-05        auto
...
BFCC-QALEAD-PROCESS-EVENT-REPORT-06: Send event report in the case the study has already been assigned to another QA user
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The CCQA, QA Leader, Supervisor can send an event report
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-06        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-REPORT-07: Send event report in the case the study has already been assigned to yourself
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The CCQA, QA Leader, Supervisor can send an event report
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-07        auto
...
BFCC-QALEAD-PROCESS-EVENT-REPORT-08: Email an event report to clinic
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-08        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-REPORT-09: Auto-fax a report to the clinic
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-09        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-REPORT-10: Auto-fax a report to the physician
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-10        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-REPORT-11: Manual fax a report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-11        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-REPORT-12: Recall an event report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-12        auto
...
BFCC-QALEAD-PROCESS-EVENT-REPORT-13: Dismiss an event report in the case the user does not assign the report to himself or herself
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-13        auto
    [Setup]    Create Event Report Has The Status Is Generated
    Navigate to report screen has the notification reports with study id is "${study_id}"
    ${study_reports}        Get Study Reports
...
BFCC-QALEAD-PROCESS-EVENT-REPORT-14: Dismiss an event report in the case the study has already been assigned to another QA user
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The CCQA, QA Leader, Supervisor can dismiss an event report
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-14        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-REPORT-15: Dismiss an event report in the case the study has already been assigned to yourself
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The CCQA, QA Leader, Supervisor can dismiss an event report
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-15        auto
    Create Ready Notification Reports With Study Id Is "${STUDY_ID_ASSIGN}[study_id_1]"
    Assign Event Reports To You
    Navigate to report screen has the notification reports with study id is "${study_id}"
    Filter Study Reports    text_search=${event_search}
...
BFCC-QALEAD-PROCESS-EVENT-REPORT-16: Re-enable an event report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-16        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-REPORT-17: Download event report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-17        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-REPORT-18: Details of Event Report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-18        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-DETAILS-22: Edit technician comments
    ...
    ...     Version:
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-22       auto
    Navigate To Event Details
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-23: Verify UI for the Event Information in "Event Details" screen
    [Documentation]     Author: Thang Tran
    ...
    ...
    ...     Version:
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-23       auto
    Navigate To Event Detail With Event Type Is "Manual"
    Switch Tab
    Navigate To Event Tab      Event Details
    ${event_details}    Get Event Details
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-24: Verify UI for the Event Information in "Event Details" screen
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: Verify UI for the Event Information in "Event Details" screen
    ...
    ...
    ...     Version:
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-24      auto
...
BFCC-QALEAD-PROCESS-EVENT-REPORT-22: Regenerate event report with report status is ready
    [Documentation]     Author: Thang Tran
    ...
    ...     Description: The user can regenerate an event report of a Valid event
    ...
    ...
    ...     Version:
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-22        auto
    [Setup]     Create Event Report Has The Status Is Ready
    Navigate To Report Screen Has The Notification Reports With Study Id Is "${study_id}"
    ${study_reports}        Get Study Reports
    ${report_status}        Evaluate    [item for item in ${study_reports} if item.get('Report Status') == 'Ready']
...
Navigate to event details
    ...
    Navigate To Studies Type        Completed
    ${completed}        Get Completed Studies On Page
    ${studies_id}       Evaluate    [item['Study ID'].split(' | ')[0] for item in ${completed} if item['Total Events'].split()[0] != '0']
    ${study_id}    Evaluate  random.choice(${studies_id})    random
    Filter Studies    search_by=Study ID         text_search=${study_id}
    Manage Complete Study On        row=1
    Navigate To Study Management Type    events
