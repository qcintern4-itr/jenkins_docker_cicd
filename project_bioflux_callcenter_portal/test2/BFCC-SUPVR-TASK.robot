*** Settings ***
Documentation   Test Suite - Call Center Supervisor Portal - Task page
Metadata    sid     BFCC-SUPVR-TASK
...
Force Tags      BFCC-SUPVR-TASK    web
Test Timeout    10m

*** Test Cases ***

BFCC-SUPVR-TASK-OVERVIEW-01: View the overview of the performance of all the QA users
    ...
    [Tags]      BFCC-SUPVR-TASK-OVERVIEW-01      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-OVERVIEW-02: Receive a performance report automatically from the system
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-OVERVIEW-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-OVERVIEW-03: View a list of QA team on the Task page
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-OVERVIEW-03      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-UNASSIGNED-01: View Notification reports subtab in Unassign tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-01      auto
...
BFCC-SUPVR-TASK-UNASSIGNED-02: Assign a Notification reports to an assignee
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-02      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Notification reports
    ${study_id_assigned}        Assign Unassigned Task On   assignee=Super    row=1
...
BFCC-SUPVR-TASK-UNASSIGNED-03: Assign multiple Notification reports to an assignee
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-03      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Notification reports
    ${study_id_assigned}     Assign Unassigned Task On   assignee=Super    row=1,2
...
BFCC-SUPVR-TASK-UNASSIGNED-04: Check case the supervisor wants to assign the same study that another supervisor/leader is assigning on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-04      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-UNASSIGNED-05: Quick access to Study information on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-05      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Notification reports
    ${unassigned_notification_report}     Get Unassigned Task
...
BFCC-SUPVR-TASK-UNASSIGNED-06: Quick access to Patient information on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-06      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Notification reports
    ${unassigned_notification_report}     Get Unassigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${unassigned_notification_report}
...
BFCC-SUPVR-TASK-UNASSIGNED-07: Manually sort the report list by Study ID on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-07      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Notification reports
    ${unassigned_notification_report}     Get Unassigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${unassigned_notification_report}
...
BFCC-SUPVR-TASK-UNASSIGNED-08: Manually sort the report list by Study Type on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-08      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-UNASSIGNED-09: Manually sort the report list by Priority on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-09      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-UNASSIGNED-10: Check pagination tool works properly on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-10     auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Notification reports
...
BFCC-SUPVR-TASK-UNASSIGNED-11: View Interim reports sub-tab in Unassign tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The Call Center Supervisor and Call Center QA Leader can view and assign reports to Call Center QA users
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-11  CP-2.16.4       auto
...
BFCC-SUPVR-TASK-UNASSIGNED-12: Assign a reports to an assignee on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-12      auto
    Navigate To Task
...
BFCC-SUPVR-TASK-UNASSIGNED-13: Assign multiple reports to an assignee on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-13      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Interim reports
    ${study_id_assigned}     Assign Unassigned Task On   assignee=Super    row=1,2
    ${study_id_assigned}     Evaluate    [item['Study ID'] for item in ${study_id_assigned}]
...
BFCC-SUPVR-TASK-UNASSIGNED-14: Check case the supervisor wants to assign the same study that another supervisor/leader is assigning on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-14      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-UNASSIGNED-15: Quick access to Study information on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-15      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Interim reports
    ${unassigned_interim_report}     Get Unassigned Task
...
BFCC-SUPVR-TASK-UNASSIGNED-16: Quick access to Patient information on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-16      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Interim reports
    ${unassigned_interim_report}     Get Unassigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${unassigned_interim_report}
...
BFCC-SUPVR-TASK-UNASSIGNED-17: Manually sort the report list by Study ID on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-17      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Interim reports
    ${unassigned_interim_report}     Get Unassigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${unassigned_interim_report}
...
BFCC-SUPVR-TASK-UNASSIGNED-18: Manually sort the report list by Report ID Type on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-18      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Interim reports
    ${unassigned_interim_report}     Get Unassigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${unassigned_interim_report}
...
BFCC-SUPVR-TASK-UNASSIGNED-19: Manually sort the report list by Study Type on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-19      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-UNASSIGNED-20: Manually sort the report list by Upload Time on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-20      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-UNASSIGNED-21: View a list of Interim reports with “Report type: Artifact reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-21  CP-2.16.4       auto
...
BFCC-SUPVR-TASK-UNASSIGNED-22-CP2.16.4: View a list of Interim reports with “Report type: Normal reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-22-CP2.16.4  CP-2.16.4       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-UNASSIGNED-23-CP2.16.4: View a list of Interim reports with “Report type: All reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-23-CP2.16.4  CP-2.16.4       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-UNASSIGNED-24: Check pagination tool works properly on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-24      auto
    Navigate To Task
    Filter Task        task_type=Unassigned        by_report=Interim reports    by_report_type=All reports
    ${current_pagination}     Get Current Pagination
#    Run Keyword And Continue On Failure    Should Be Equal    ${current_pagination}[Rows]     10 rows
...
BFCC-SUPVR-TASK-UNASSIGNED-25: View EOU reports subtab in Unassign tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The Call Center Supervisor and Call Center QA Leader can view and assign reports to Call Center QA users
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-25  CP-2.16.4       auto
...
BFCC-SUPVR-TASK-UNASSIGNED-26: Assign a reports to an assignee on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-26      auto
    Navigate To Task
...
BFCC-SUPVR-TASK-UNASSIGNED-27: Assign multiple reports to an assignee on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-27      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=End of Use reports
    ${study_id_assigned}     Assign Unassigned Task On   assignee=Super    row=1,2
    ${study_id_assigned}     Evaluate    [item['Study ID'] for item in ${study_id_assigned}]
...
BFCC-SUPVR-TASK-UNASSIGNED-28: Check case the supervisor wants to assign the same study that another supervisor/leader is assigning on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-28      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-UNASSIGNED-29: Quick access to Study information on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-29      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=End of Use reports
    ${unassigned_eou_report}     Get Unassigned Task
...
BFCC-SUPVR-TASK-UNASSIGNED-30: Quick access to Patient information on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-30       auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=End of Use reports
    ${unassigned_eou_report}     Get Unassigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${unassigned_eou_report}
...
BFCC-SUPVR-TASK-UNASSIGNED-31: Manually sort the report list by Study ID on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-31      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=End of Use reports
    ${unassigned_eou_report}     Get Unassigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${unassigned_eou_report}
...
BFCC-SUPVR-TASK-UNASSIGNED-32: Manually sort the report list by Study Type on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-32      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-UNASSIGNED-33: Manually sort the report list by Upload Time on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-33      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-UNASSIGNED-34: View a list of EOU reports with “Report type: Artifact reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-34  CP-2.16.4       auto
...
BFCC-SUPVR-TASK-UNASSIGNED-35-CP2.16.4: View a list of EOU reports with “Report type: Normal reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-35-CP2.16.4  CP-2.16.4       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-UNASSIGNED-36-CP2.16.4: View a list of EOU reports with “Report type: All reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-36-CP2.16.4  CP-2.16.4       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-UNASSIGNED-37: Check pagination tool works properly on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-UNASSIGNED-37       auto
    Navigate To Task
    Filter Task        task_type=Unassigned        by_report=End of Use reports    by_report_type=All reports
    ${current_pagination}     Get Current Pagination
#    Run Keyword And Continue On Failure    Should Be Equal    ${current_pagination}[Rows]     10 rows
...
BFCC-SUPVR-TASK-ASSIGNED-01: View Notification reports subtab in Assigned tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The Call Center Supervisor and Call Center QA Leader can view and assign reports to Call Center QA users
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-01      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Notification reports
    ${unassigned_notification_report}     Get Unassigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${unassigned_notification_report}
    Assign Unassigned Task On   assignee=Super    row=1,2
    Filter Task         task_type=Assigned        by_report=Notification reports
    ${assigned_notification_report}     Get Assigned Task
...
BFCC-SUPVR-TASK-ASSIGNED-02: Unassign one assignee on the Notification report sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-02      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Notification reports
    ${unassigned_study_id}     Assign Unassigned Task On   assignee=Super    row=1
    Filter Task         task_type=Assigned        by_report=Notification reports
...
BFCC-SUPVR-TASK-ASSIGNED-03: Unassign multiple assignees on the Notification report sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-03      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Notification reports
    Assign Unassigned Task On   assignee=Super    row=1,2
    Filter Task         task_type=Assigned        by_report=Notification reports
...
BFCC-SUPVR-TASK-ASSIGNED-04: Check case the supervisor wants to unassign the same study that another supervisor/leader is unassigning on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-04      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-ASSIGNED-05: Change the assignee by selecting another QA user from the assignee dropdown list on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-05      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Notification reports
    ${unassigned_study_id}     Assign Unassigned Task On   assignee=Super    row=1
    Filter Task         task_type=Assigned        by_report=Notification reports
...
BFCC-SUPVR-TASK-ASSIGNED-06: Quick access to Study information on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-06      auto
    Navigate To Task
    Filter Task         task_type=Assigned        by_report=Notification reports
    ${assigned_notification_report}     Get Assigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${assigned_notification_report}
...
BFCC-SUPVR-TASK-ASSIGNED-07: Quick access to Patient information on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-07      auto
    Navigate To Task
    Filter Task         task_type=Assigned        by_report=Notification reports
    ${assigned_notification_report}     Get Assigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${assigned_notification_report}
...
BFCC-SUPVR-TASK-ASSIGNED-08: Manually sort the report list by Study ID on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-08      auto
    Navigate To Task
    Filter Task         task_type=Assigned        by_report=Notification reports
    ${assigned_notification_report}     Get Assigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${assigned_notification_report}
...
BFCC-SUPVR-TASK-ASSIGNED-09: Manually sort the report list by Study Type on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-09      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-ASSIGNED-10: Manually sort the report list by Priority on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-10      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-ASSIGNED-11: Check pagination tool works properly on Notification reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-11      auto
    Navigate To Task
    Filter Task         task_type=Assigned        by_report=Notification reports
    ${current_pagination}     Get Current Pagination
#    Run Keyword And Continue On Failure    Should Be Equal    ${current_pagination}[Rows]     10 rows
...
BFCC-SUPVR-TASK-ASSIGNED-12: View Interim reports sub-tab in Unassign tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The Call Center Supervisor and Call Center QA Leader can view and assign reports to Call Center QA users
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-12  CP-2.16.4       auto
    [Setup]    Create Interim Report Unassigned
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Interim reports       by_report_type=All reports
    ${task_interim_report}     Get Unassigned Task
    ...
    Run Keyword And Continue On Failure    Should Not Be Empty    ${task_interim_report}
    Run Keyword And Continue On Failure    List Should Contain Value    ${task_study_id}        ${study_id}
    Assign Unassigned Task On   assignee=Super    row=1
    Filter Task         task_type=Assigned        by_report=Interim reports
    ${assigned_notification_report}     Get Assigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${assigned_notification_report}
    ${assignee}     Evaluate    [item['Assignee'] for item in ${assigned_notification_report}]
...
BFCC-SUPVR-TASK-ASSIGNED-13: Unassign a reports to an unassignee on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-13      auto
    Navigate To Task
    Filter Task         task_type=Assigned        by_report=Interim reports
...
BFCC-SUPVR-TASK-ASSIGNED-14: Unassign multiple reports to an unassignee on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-14      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Interim reports
    ${unassigned_study_id}     Assign Unassigned Task On   assignee=Super    row=1, 2
    Filter Task         task_type=Assigned        by_report=Interim reports
...
BFCC-SUPVR-TASK-ASSIGNED-15: Check case the supervisor wants to assign the same study that another supervisor/leader is assigning on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-15      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-ASSIGNED-16: Change the assignee by selecting another QA user from the assignee dropdown list on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-16      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=Interim reports
    ${unassigned_study_id}     Assign Unassigned Task On   assignee=Super    row=1
    Filter Task         task_type=Assigned        by_report=Interim reports
    ...
    ${reports}       Evaluate    [item['Assignee'] for item in ${reports}]
    Run Keyword And Continue On Failure    List Should Contain Value    ${reports}        CCQA QA01
    Filter Study Reports        text_search=${assigned_notification_report}[0][Report ID]
    Edit Report On    row=1
    Navigate To Event Tab    PDF Report
    ${assigned_check}       Check Active Assignee Available
    Run Keyword And Continue On Failure    Should Be True    ${assigned_check}[Assigned]

BFCC-SUPVR-TASK-ASSIGNED-17: Quick access to Study information on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-17      auto
    Navigate To Task
    Filter Task         task_type=Assigned        by_report=Interim reports
    ${assigned_interim_report}     Get Assigned Task
...
BFCC-SUPVR-TASK-ASSIGNED-18: Quick access to Patient information on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-18      auto
    Navigate To Task
    Filter Task         task_type=Assigned        by_report=Interim reports
    ${assigned_interim_report}     Get Assigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${assigned_interim_report}
...
BFCC-SUPVR-TASK-ASSIGNED-19: Manually sort the report list by Study ID on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-19      auto
    Navigate To Task
    Filter Task         task_type=Assigned        by_report=Interim reports
    ${assigned_interim_report}     Get Assigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${assigned_interim_report}
...
BFCC-SUPVR-TASK-ASSIGNED-20: Manually sort the report list by Report ID Type on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-20      auto
    Navigate To Task
    Filter Task         task_type=Assigned        by_report=Interim reports
    ${assigned_interim_report}     Get Assigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${assigned_interim_report}
...
BFCC-SUPVR-TASK-ASSIGNED-21: Manually sort the report list by Study Type on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-21      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-ASSIGNED-22: Manually sort the report list by Upload Time on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-22      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-ASSIGNED-23: View a list of Interim reports with “Report type: Artifact reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-23  CP-2.16.4       auto
    [Setup]    Unassign Multiple "Interim reports" Reports
    Create Interim Report Unassigned
    Mark Artifact Ready Interim Report    is_mark=${True}
    Navigate To Task
    ...
    Run Keyword And Continue On Failure    Should Not Be Empty    ${unassigned_interim_report}
    Run Keyword And Continue On Failure    List Should Contain Value    ${artifact_study_id}     ${study_id}
    Assign To Me Ready Interim Reports By    assignee=Super      study_id=${study_id}
    # check artifact
...
BFCC-SUPVR-TASK-ASSIGNED-24-CP2.16.4: View a list of Interim reports with “Report type: Normal reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-24-CP2.16.4  CP-2.16.4       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-ASSIGNED-25-CP2.16.4: View a list of Interim reports with “Report type: All reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-25-CP2.16.4  CP-2.16.4       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-ASSIGNED-26: Check pagination tool works properly on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-26      auto
    Navigate To Task
    Filter Task        task_type=Assigned        by_report=Interim reports    by_report_type=All reports
    ${current_pagination}     Get Current Pagination
#    Run Keyword And Continue On Failure    Should Be Equal    ${current_pagination}[Rows]     10 rows
...
BFCC-SUPVR-TASK-ASSIGNED-27: View EOU reports subtab in Assign tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description: The Call Center Supervisor and Call Center QA Leader can view and assign reports to Call Center QA users
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-27  CP-2.16.4       auto
#    [Setup]    Create End Of Use Reports Unassigned With Study Id "${STUDY_ID_ASSIGN}[study_id_9]"
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=End of Use reports       by_report_type=All reports
    ...
    ${unassigned_study_id}        Evaluate    [item['Study ID'] for item in ${task_eou_report}]
    Run Keyword And Continue On Failure    Should Not Be Empty    ${task_eou_report}
    Assign To Me Ready Interim Reports By       assignee=Super      row=1
...
BFCC-SUPVR-TASK-ASSIGNED-28: Unassign a reports to an unassignee on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-28      auto
    Navigate To Task
    Filter Task         task_type=Assigned        by_report=End of Use reports
    ${expected_study_id}     Unassign Assigned Task On      row=1
    ${expected_study_id}     Set Variable    ${expected_study_id}[0][Study ID]
...
BFCC-SUPVR-TASK-ASSIGNED-29: Unassign multiple reports to an unassignee on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-29     auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=End of Use reports
    ${unassigned_study_id}     Assign Unassigned Task On   assignee=Super    row=1, 2
    Filter Task         task_type=Assigned        by_report=End of Use reports
...
BFCC-SUPVR-TASK-ASSIGNED-30: Check case the supervisor wants to assign the same study that another supervisor/leader is assigning on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-30      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-ASSIGNED-31: Change the assignee by selecting another QA user from the assignee dropdown list on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-31      auto
    Navigate To Task
    Filter Task         task_type=Unassigned        by_report=End of Use reports
    ${unassigned_study_id}     Assign Unassigned Task On   assignee=Super    row=1
    Filter Task         task_type=Assigned        by_report=End of Use reports
...
BFCC-SUPVR-TASK-ASSIGNED-32: Quick access to Study information on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-32      auto
    Navigate To Task
    Filter Task         task_type=Assigned        by_report=End of Use reports
    ${assigned_eou_report}     Get Assigned Task
...
BFCC-SUPVR-TASK-ASSIGNED-33: Quick access to Patient information on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-33      auto
    Navigate To Task
    Filter Task         task_type=Assigned        by_report=End of Use reports
    ${assigned_eou_report}     Get Assigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${assigned_eou_report}
...
BFCC-SUPVR-TASK-ASSIGNED-34: Manually sort the report list by Study ID on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-34       auto
    Navigate To Task
    Filter Task         task_type=Assigned        by_report=End of Use reports
    ${assigned_eou_report}     Get Assigned Task
    Run Keyword And Continue On Failure    Should Not Be Empty    ${assigned_eou_report}
...
BFCC-SUPVR-TASK-ASSIGNED-35: Manually sort the report list by Study Type on Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-35      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-ASSIGNED-36: Manually sort the report list by Upload Time on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-36      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-ASSIGNED-37: View a list of EOU reports with “Report type: Artifact reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-37  CP-2.16.4       auto
    [Setup]    Unassign Multiple "End of Use reports" Reports
    Create End Of Use Reports Unassigned With Study Id "${STUDY_ID_ASSIGN}[study_id_9]"
    Mark Artifact Ready Interim Report    is_mark=${True}
    Navigate To Task
...
BFCC-SUPVR-TASK-ASSIGNED-38-CP2.16.4: View a list of EOU reports with “Report type: Normal reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-38-CP2.16.4  CP-2.16.4       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-ASSIGNED-39-CP2.16.4: View a list of EOU reports with “Report type: All reports” is selected Interim reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-39-CP2.16.4  CP-2.16.4       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-TASK-ASSIGNED-40: Check pagination tool works properly on EOU reports sub-tab
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-TASK-ASSIGNED-40      auto
    Navigate To Task
    Filter Task        task_type=Assigned        by_report=End of Use reports    by_report_type=All reports
    ${current_pagination}     Get Current Pagination
#    Run Keyword And Continue On Failure    Should Be Equal    ${current_pagination}[Rows]     10 rows
