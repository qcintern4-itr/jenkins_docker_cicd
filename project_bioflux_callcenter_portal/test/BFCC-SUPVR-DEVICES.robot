*** Settings ***
Documentation   Test Suite - Call Center Supervisor Portal - Devices page
Metadata    sid     BFCC-SUPVR-DEVICES
...
Force Tags      BFCC-SUPVR-DEVICES     web
Test Timeout    1h

*** Test Cases ***
BFCC-SUPVR-DEVICES-VIEW-INSTUDY-01: View the information displays in the devices running studies
    ...
    [Tags]      BFCC-SUPVR-DEVICES-VIEW-INSTUDY-01        manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-DEVICES-VIEW-INSTUDY-02: Sort the devices running studies by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-VIEW-INSTUDY-02        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-DEVICES-VIEW-INSTUDY-02-1: Sort the devices running studies by Artifact Reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-VIEW-INSTUDY-02-1        manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-DEVICES-VIEW-INSTUDY-03: Check pagination tool works properly
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-VIEW-INSTUDY-03        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-DEVICES-VIEW-INSTUDY-QUICK-ACCESS-01-CP-2.23.0: Quick access to device info
    ...
    [Tags]      BFCC-SUPVR-DEVICES-VIEW-INSTUDY-QUICK-ACCESS-01-CP-2.23.0        manual    CP-2.23.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-DEVICES-VIEW-EOL-01: View the information displays in the EOL devices
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-VIEW-EOL-01        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-DEVICES-VIEW-EOL-02: Sort the EOL devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-VIEW-EOL-02        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-DEVICES-VIEW-EOL-03: Check pagination tool works properly
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-VIEW-EOL-03        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-DEVICES-VIEW-EOL-QUICK-ACCESS-01-CP-2.23.0: Quick access to device info
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-VIEW-EOL-QUICK-ACCESS-01-CP-2.23.0        manual    CP-2.23.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-DEVICES-VIEW-ALL-01: View the information displays in the all devices
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-VIEW-ALL-01      auto
...
BFCC-SUPVR-DEVICES-VIEW-ALL-02: Sort the all devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-VIEW-ALL-02        auto
    Navigate To Devices
    Navigate To Devices Menu    All devices
...
BFCC-SUPVR-DEVICES-VIEW-ALL-03: Check pagination tool works properly
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-VIEW-ALL-03        auto
    Navigate To Devices
    Navigate To Devices Menu    All devices
    Filter Devices        facility=All facilities       by_model=All models
...
BFCC-SUPVR-DEVICES-VIEW-ALL-QUICK-ACCESS-01-CP-2.23.0: Quick access to device info
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-VIEW-ALL-QUICK-ACCESS-01-CP-2.23.0        manual    CP-2.23.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-DEVICES-SEARCH-01: Search on device list
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-SEARCH-01        auto
    Navigate To Devices
    Navigate To Devices Menu    All devices
    # Default text seach
...
BFCC-SUPVR-DEVICES-FILTER-FACILITY-01: Filter by facility
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-FILTER-FACILITY-01       auto
    Navigate To Devices
    # All tab
    Navigate To Devices Menu    All devices
    ${filter_values}        Get Devices Current Filter Values
...
BFCC-SUPVR-DEVICES-FILTER-FACILITY-02: The user is removed from the Call Center Group
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-FILTER-FACILITY-02     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-DEVICES-FILTER-FACILITY-03: The facility is removed from the Facility Group
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-FILTER-FACILITY-03     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-DEVICES-FILTER-MODEL-01: Filter by model
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-FILTER-MODEL-01      auto
    # Run on 'all' tab
    Navigate To Devices
    Navigate To Devices Menu    All devices
...
BFCC-SUPVR-DEVICES-QUICKACCESS-01: Quick access to device information
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-DEVICES-QUICKACCESS-01     auto
    Navigate To Devices
    Navigate To Devices Menu    All devices
    Filter Devices        facility=All facilities       by_model=All models
    ${devices}        Get All Devices
