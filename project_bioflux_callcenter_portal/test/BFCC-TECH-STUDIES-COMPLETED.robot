*** Settings ***
Documentation   Test Suite - Call Center Technician Portal - Completed studies page
Metadata    sid     BFCC-TECH-STUDIES-COMPLETED
...
Force Tags       BFCC-TECH-STUDIES-COMPLETED    web
Test Timeout     1h

*** Test Cases ***
BFCC-TECH-STUDIES-COMPLETED-FILTER-FACILITY-01: View the name of the facility in case the user only associates with one facility
    ...
    [Tags]  BFCC-TECH-STUDIES-COMPLETED-FILTER-FACILITY-01       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDIES-COMPLETED-FILTER-FACILITY-02: Select a specific facility in case the user associates with multiples facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    ...     2. After the user has selected the desired facilty, all the data associated with that
    ...     facility shall be reflected accordingly

    [Tags]  BFCC-TECH-STUDIES-COMPLETED-FILTER-FACILITY-02      auto
    Navigate To Studies
...
BFCC-TECH-STUDIES-COMPLETED-SEARCH-01: View all search attributes on the STUDIES page        # Failed (The default search option is showing `Study ID`)
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     - Patient ID
    ...     - Device ID
    ...     2. The default search option should be Study ID

    [Tags]  BFCC-TECH-STUDIES-COMPLETED-SEARCH-01       auto
    Navigate To Studies
    Filter Studies    study_type=Completed
...
BFCC-TECH-STUDIES-COMPLETED-SEARCH-02: Search by Patient Name attributes on the STUDIES page     # Failed: Related to bug (search by patient name) via clinic
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     5. All entered text will be deleted
     ...
     [Tags]  BFCC-TECH-STUDIES-COMPLETED-SEARCH-02       manual
     Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#     [Template]    Filter Studies Completed
#     Patient Name

BFCC-TECH-STUDIES-COMPLETED-SEARCH-03: Search by Study ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-TECH-STUDIES-COMPLETED-SEARCH-03       auto
    [Template]    Filter Studies Completed
    Study ID

BFCC-TECH-STUDIES-COMPLETED-SEARCH-04: Search by Patient ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The user can search by Study ID attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BFCC-TECH-STUDIES-COMPLETED-SEARCH-04       auto
    [Template]    Filter Studies Completed
    Patient ID

BFCC-TECH-STUDIES-COMPLETED-SEARCH-05: Search by Device ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-TECH-STUDIES-COMPLETED-SEARCH-05       auto
    [Template]    Filter Studies Completed
    Device ID

BFCC-TECH-STUDIES-COMPLETED-QUICK-ACCESS-01-CP-2.23.0: Quick access to device info
    [Documentation]  Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BFCC-TECH-STUDIES-COMPLETED-QUICK-ACCESS-01-CP-2.23.0       auto    CP-2.23.0
    Navigate To Studies
    Filter Studies    study_type=Completed
