...
Metadata    sid     BFCC-QALEAD-OPTIMIZE-ECG
...
Force Tags      BFCC-QALEAD-OPTIMIZE-ECG     web
Test Timeout    1h

*** Test Cases ***
BFCC-QALEAD-OPTIMIZE-ECG-01: Check event params display properly
    ...
    [Tags]  BFCC-QALEAD-OPTIMIZE-ECG-01      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-OPTIMIZE-ECG-02: Check View full event button display properly
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-QALEAD-OPTIMIZE-ECG-02      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-OPTIMIZE-ECG-03: Check text "Event data not available" display and hide properly
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-QALEAD-OPTIMIZE-ECG-03      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-OPTIMIZE-ECG-05: Check message "Full event data not available" displayed
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-QALEAD-OPTIMIZE-ECG-05      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-OPTIMIZE-ECG-05-1: Check message "Full event data not available" hidden
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-QALEAD-OPTIMIZE-ECG-05-1      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
