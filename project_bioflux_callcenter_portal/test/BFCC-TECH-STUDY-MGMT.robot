*** Settings ***
Documentation   Test Suite - Call Center Technician Portal - Study Management page
Metadata    sid     BFCC-TECH-STUDY-MGMT
...
Force Tags      BFCC-TECH-STUDY-MGMT     web
Test Timeout    1h

*** Test Cases ***
BFCC-TECH-STUDY-MGMT-01-CP2.16.7: Hide "Generate event data" button on More options
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-01-CP2.16.7      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-01-CP2.16.7: Can view Strip image of events that have Open status
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-01-CP2.16.7      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-02-CP2.16.7: Can view Strip image of events that have closed by the user
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-02-CP2.16.7      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-03-CP2.16.7: Cannot view Strip image of events that have closed as invalid by the system
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-03-CP2.16.7      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-04-CP2.16.7: Can view Strip image of events in Event Card that have closed as invalid by the system before and the user changes to Valid
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-04-CP2.16.7      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-05-CP2.16.7: Can view Strip image of events in Strip Selection of EOU/Interim/Notification report that have closed as invalid by the system before and the user changes to Valid
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-05-CP2.16.7      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-06-CP2.16.7: Only can view Event details if the study is archived
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-06-CP2.16.7      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-07-CP2.16.7: Search for events closed as invalid by the system
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-07-CP2.16.7      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-08-CP2.16.7: Search for events closed by the user
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-08-CP2.16.7      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-09-CP2.16.7: Filter by Closed status and check results for events closed as invalid by system
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-09-CP2.16.7      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-10-CP2.16.7: Filter by Invalid status and check results for events closed as invalid by system
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EVENTS-VIEW-10-CP2.16.7      manual   CP-2.16.7
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EDIT-NOTES-01: Taking a note in a study note section while on the Study details tab of the Study management page
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EDIT-NOTES-01      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EDIT-NOTES-02: Taking a note on the study note section while in slide-over pop-up
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EDIT-NOTES-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EDIT-NOTES-03: Taking a note on the study note section while on the Notification Criteria tab of the Event Edit page
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EDIT-NOTES-03      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EDIT-NOTES-04: Canot take a note if the study has been aborted
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EDIT-NOTES-04      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BFCC-TECH-STUDY-MGMT-EDIT-NOTES-05: Canot take a note if the input more than 400 characters
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EDIT-NOTES-05      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-VIEW-LOG-01: View the study log in case the clinic is running a single study (MCT, MCT Peek, Cardiac Event, Holter, Extended Holter)
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-VIEW-LOG-01      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-VIEW-LOG-02: View the study log in case the Biolfux Support user started a new Bioflux Direct order while running on the existing device that the patient still has on hand
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-VIEW-LOG-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-VIEW-LOG-03: View the study log in case there is a notification as part of a flagged study
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-VIEW-LOG-03      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-VIEW-LOG-04: View the study log in case the system changes the diagnosis lead automatically
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-VIEW-LOG-04      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-VIEW-LOG-05: View the study log in case the study is aborted
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-VIEW-LOG-05      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EDIT-LOG-01: Log information of a study while on the study details tab of the study management page
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EDIT-LOG-01      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EDIT-LOG-02: Log information of a study while on the notification criteria tab of the event edit page
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EDIT-LOG-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-EDIT-LOG-03: Cannot log information of a study in case the study has been aborted
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-EDIT-LOG-03      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-VIEW-DETAIL-01: View study details of the ‘+normal+' STUDY MANAGEMENT page
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-VIEW-DETAIL-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-VIEW-DETAIL-02: View study details of the ‘+Holter & Follow-on+' STUDY MANAGEMENT page
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-VIEW-DETAIL-02     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-CHANGE-DURATION-01: Can change duration of the study
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-CHANGE-DURATION-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-FILTER-01: Can filter by Trigger time
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-FILTER-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-FILTER-02: Can filter by Event data availability
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-FILTER-02     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-FILTER-03: Can reset filter
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-FILTER-03     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-FILTER-04: Can combine Advance filter with other filter options (status. validity, and type) while filtering for the event data
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-FILTER-04     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-UPDATE-SETTING-01: Update study setting for active studies while is in Online mode
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-UPDATE-SETTING-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-UPDATE-SETTING-02: Update study setting for active studies while is in Offline mode
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-UPDATE-SETTING-02     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-UPDATE-RMA-01: Update RMA information of a study
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-UPDATE-RMA-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-UPDATE-LCS-01: Update Low Cell Signal information of a study
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-UPDATE-LCS-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-VIEW-REPORT-01: View Summary reports of a study
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-VIEW-REPORT-01     auto
    Navigate To Studies
    ...
    ${summary_reports}      Get Study Details Summary Reports Role Technician
    ${actual_header}       Evaluate    [k for k, v in ${summary_reports}[0].items()]
    ${expected_header}     Create List    Report ID    Date Of Service    Time Monitored    Report Status    Type    Last Modified    Generated By    New Report Status
    Run Keyword And Continue On Failure    Should Be Equal    ${actual_header}      ${expected_header}

BFCC-TECH-STUDY-MGMT-VIEW-REPORT-02: View Notification reports of a study
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-VIEW-REPORT-02     auto
    Navigate To Studies
    Filter Studies    study_type=Completed    search_by=Study ID    text_search=${STUDY_ID_COMPLETED}[study_id]
    Manage Completed Studies On  row=1
    Navigate Study Management Report Tab
    Navigate Study Management Notification Report Tab
    ${notification_reports}      Get Study Details Notification Reports Role Technician
    Log    ${notification_reports}
    ${actual_header}       Evaluate    [k for k, v in ${notification_reports}[0].items()]
    ${expected_header}     Create List    Report ID    Date Of Service    Report Status    Last Modified
    Run Keyword And Continue On Failure    Should Be Equal    ${actual_header}      ${expected_header}
    
BFCC-TECH-STUDY-MGMT-SEARCH-REPORT-01: Search Interim/EOU report by Report ID
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-SEARCH-REPORT-01     auto
    Navigate To Studies
    Filter Studies    study_type=Completed    search_by=Study ID    text_search=${STUDY_ID_COMPLETED}[study_id]
    Manage Completed Studies On  row=1
    Navigate Study Management Report Tab
...
BFCC-TECH-STUDY-MGMT-SEARCH-REPORT-02: Search Notification report by Report ID
    [Documentation]     Author: Tam Ho
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-SEARCH-REPORT-02     auto
    Navigate To Studies
    Filter Studies    study_type=Completed    search_by=Study ID    text_search=${STUDY_ID_COMPLETED}[study_id]
    Manage Completed Studies On  row=1
    Navigate Study Management Report Tab
...
BFCC-TECH-STUDY-MGMT-REPORTS-01: Verify Reports Tab Visibility
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-01     CP-2.29.0    auto
    Navigate To Studies
    Filter Studies    study_type=Completed    search_by=Study ID    text_search=${STUDY_ID_COMPLETED}[study_id]
    Manage Completed Studies On  row=1
    Navigate Study Management Report Tab
    
BFCC-TECH-STUDY-MGMT-REPORTS-02: Verify Reports Tab is Hidden for Aborted Studies
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-02     auto    CP-2.29.0
    Navigate To Studies
...
BFCC-TECH-STUDY-MGMT-REPORTS-03: Reports Tab-Verify Report Filters
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-03     CP-2.29.0    auto
    Navigate To Studies
    Filter Studies    study_type=Completed    search_by=Study ID    text_search=${STUDY_ID_COMPLETED}[study_id]
    Manage Completed Studies On  row=1
    Navigate Study Management Report Tab
...
BFCC-TECH-STUDY-MGMT-REPORTS-04: Verify Report Fields in Summary Reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-04     auto    CP-2.29.0
    Navigate To Studies
    Filter Studies    study_type=Completed    search_by=Study ID    text_search=${STUDY_ID_COMPLETED}[study_id]
    Manage Completed Studies On  row=1
    Navigate Study Management Report Tab
...
BFCC-TECH-STUDY-MGMT-REPORTS-05: Summary Reports-Verify Report ID for EOU Reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-05     auto    CP-2.29.0
    Navigate To Studies
    Filter Studies    study_type=Completed    search_by=Study ID    text_search=${STUDY_ID_COMPLETED}[study_id]
    Manage Completed Studies On  row=1
    Navigate Study Management Report Tab
...
BFCC-TECH-STUDY-MGMT-REPORTS-06: Summary Reports-Verify Artifact Report Displays Error Tag For Interim, EOU Reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-06    manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-07: Summary Reports-Verify Generated By Field
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-07     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-08: Summary Reports-Verify Report Status Field
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-08     auto    CP-2.29.0
    Navigate To Studies
    Filter Studies    study_type=Completed    search_by=Study ID    text_search=${STUDY_ID_COMPLETED}[study_id]
    Manage Completed Studies On  row=1
    Navigate Study Management Report Tab
...
BFCC-TECH-STUDY-MGMT-REPORTS-09: Summary Reports-Verify Report Status "Not Generated" displayed properly for Interim reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-09     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-10: Summary Reports-Verify Report Status "Not Generated" displayed properly for EOU reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...    Description: Verify Status "Not Generated" displayed properly
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-10    manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-11: Summary Reports-Verify Report Status "Generated" displayed properly for Interim reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-11     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-12: Summary Reports-Verify Report Status "Generated" displayed properly for EOU reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...    Description: Verify Status "Generated" displayed properly
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-12    manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-13: Summary Reports-Verify Report Status "Ready" displayed properly for Interim reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-13     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-14: Summary Reports-Verify Report Status "Ready" displayed properly for EOU reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...    Description: Verify Status "Ready" displayed properly
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-14     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-15: Summary Reports-Verify Report Status "Sent" displayed properly for Interim reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-15     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-16: Summary Reports-Verify Report Status "Sent" displayed properly for EOU reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...    Description: Verify Status "Ready" displayed properly
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-16     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-17: Summary Reports-Verify Last Modified time displayed properly for EOU reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-17     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-18: Summary Reports-Verify Last Modified time displayed properly for Interim reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-18     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-19: Summary Reports-Verify Assignee displayed for EOU/Interim reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-19     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-20: Summary Reports-Verify New report status displayed for EOU reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-20     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-21: Summary Reports-Verify New report status displayed for Interim reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-21     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-22: Summary Reports-Verify Pagination working properly
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-22     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-23: Summary Reports-Can sort the report list by Report ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...    Description: Verify Pagination working properly
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-23     auto    CP-2.29.0
    Navigate To Studies
    Filter Studies    study_type=Completed    search_by=Study ID    text_search=${STUDY_ID_COMPLETED}[study_id]
    Manage Completed Studies On  row=1
    Navigate Study Management Report Tab
...
BFCC-TECH-STUDY-MGMT-REPORTS-24: Summary Reports-Can sort the report list by Last Modified
    [Documentation]     Author: Nhan Nguyen
    ...
    ...    Description: Verify Pagination working properly
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-24     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-25: Summary Reports-Can sort the report list by Report Status
    [Documentation]     Author: Nhan Nguyen
    ...
    ...    Description: Verify Pagination working properly
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-25     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-26: Summary Reports-Can sort the report list by Type
    [Documentation]     Author: Nhan Nguyen
    ...
    ...    Description: Verify Pagination working properly
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-26     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-27: Summary Reports-Can sort the report list by Assignee
    [Documentation]     Author: Nhan Nguyen
    ...
    ...    Description: Verify Pagination working properly
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-27     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-28: Summary Reports-Verify Edit navigation by clicking on a row
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-28     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BFCC-TECH-STUDY-MGMT-REPORTS-29: Verify Report Fields in Notification Reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-29    CP-2.29.0     auto
    Navigate To Studies
    Filter Studies    study_type=Completed    search_by=Study ID    text_search=${STUDY_ID_COMPLETED}[study_id]
    Manage Completed Studies On  row=1
    Navigate Study Management Report Tab
...
BFCC-TECH-STUDY-MGMT-REPORTS-30: Notification Reports-Verify the display of Report ID
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-30     manual    CP-2.29.0    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-31: Notification Reports-Verify Report Status display
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-31     auto    CP-2.29.0    R2
    Navigate To Studies
    Filter Studies    study_type=Completed    search_by=Study ID    text_search=${STUDY_ID_COMPLETED}[study_id]
    Manage Completed Studies On  row=1
    Navigate Study Management Report Tab
...
BFCC-TECH-STUDY-MGMT-REPORTS-32: Notification Reports-Verify Date of Service field display for Notification reports
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-32     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-33: Notification Reports-Verify Date of Service field display for Event reports
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-33     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-34: Notification Reports-Verify Last Modified field is displayed
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-34     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-35: Notification Reports-Verify Assignee display when assigned to other QA
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-35     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-36: Notification Reports-Verify Assignee display when assigned to current user
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-36     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-37: Notification Reports-Verify Edit navigation by clicking on a row
    [Documentation]     Author: Thanh Tieu
    ...
    ...    Description: Verify that user can edit any report records on the table.
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-37     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-38: Notification Reports-Verify sorting by Report ID
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-38     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-39: Notification Reports-Verify sorting by Report Status
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-39     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-40: Notification Reports-Verify sorting by Last Modified
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-40     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-REPORTS-41: Notification Reports-Verify sorting by Assignee
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-REPORTS-41     manual    CP-2.29.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-UPDATE-FACILITY-NOTES-01: Making a note in a Facility Note section by clicking on the facility name in the study management page
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-UPDATE-FACILITY-NOTES-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-UPDATE-FACILITY-NOTES-02: Making a note in a Facility Note section by clicking on the facility name in the Event Edit page
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-UPDATE-FACILITY-NOTES-02     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-GET-ECG-01: Can get a sample of ECG strip from a device
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-GET-ECG-01    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-RESEND-REFCODE-01: Resend the reference code in case the patient locates in the US
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-RESEND-REFCODE-01    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-RESEND-REFCODE-02: Resend the reference code in case the patient locates in the US and has the mail filled out
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-RESEND-REFCODE-02    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-RESEND-REFCODE-03: Resend the reference code in case the patient locates outside the US
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-RESEND-REFCODE-03    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BFCC-TECH-STUDY-MGMT-DIAGNOSIS-01: View Diagnosis info
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-DIAGNOSIS-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-01: View ECG viewer tab in active/completed studies
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-01     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-02: HR Chart-Verify HR chart is displayed with default date and time range
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-02     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-03: HR Chart-Verify date selection in HR chart
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-03    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-04: HR Chart-Verify Next/Previous date navigation
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-04    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-05: HR Chart-Disable navigation buttons when study has only one day of data
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-05    manual    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-06: HR Chart-Disable “Previous” on first study day
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-06    manual    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-07: HR Chart-Disable “Next” on last study day
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-07    manual    R2
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-08: HR Chart-Verify “Refresh” button functionality
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-08    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-09: HR Chart-Verify “Show events indicator” checkbox default state
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-09    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-10: HR Chart-Verify toggle of “Show events indicator” checkbox
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-10    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-11: HR Chart-Verify zoom in/out on HR chart
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-11    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-12: HR Chart-HR chart zoom < 1 hour range is centered in 1-hour window
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-12    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-13: HR Chart-HR chart zoom ≥ 1 hour shows full range
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-13    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-14: HR Chart-Reset Zoom returns chart to default view
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-14    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-15: HR Chart-Verify highlighted event areas in HR chart
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-15    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-16: HR Chart-Verify no data area on HR chart
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-16    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-17: HR Chart-Verify hover tooltip in HR chart with Available data
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-17    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-18: HR Chart-Verify hover tooltip in HR chart with No data
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-18    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-19: HR Chart-Verify hover tooltip in HR chart with HR cannot be calculated data
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-19    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BFCC-TECH-STUDY-MGMT-ECG-VIEWER-20: Event Information–Standard trigger time display
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-20    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-21: Event Information–Trigger time spans across to next day
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-21    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-22: Event Information–Trigger time spans across to previous day
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-22    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-23: ECG Viewer-ECG Viewer shows 5-minute data preview
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-23    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-24: ECG Viewer-Use ECG Viewer Tools
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-24    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-25: ECG Viewer-Adjust ECG Settings
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-25    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-26: ECG Viewer-Preview Channel Navigation
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-26    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-27: ECG Viewer-Beat Marker Interaction
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-27    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-28: Event section-Display All Manual Events
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-28    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-29: Event section-Filter Auto Manual Events
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-29    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-30: Event section-Filter Auto Events
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-30    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-31: Event section-Display Event Information
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-31    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-32: Event section-Comment Truncation
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-32    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-33: Event section-Tooltip on Long Comment
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-33    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-34: Event section-Hover over the Event will shows "Open event" Button
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-34    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-35: Event section-Navigate to Event Details
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-35    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-36: Event section-Highlight Selected Event in HR Chart
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-36    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BFCC-TECH-STUDY-MGMT-ECG-VIEWER-37: Event filter-Display Event Filter Dropdown
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-37    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-38: Event filter-Select Filter Option: "Brady"
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-38    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-39: Event filter-Select Filter Option: "Tachy"
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-39    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-40: Event filter-Select Filter Option: "AFib"
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-40    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-41: Event filter-Select Filter Option: "Pause"
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-41    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-42: Event filter-Select Filter Option: "Auto"
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-42    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BFCC-TECH-STUDY-MGMT-ECG-VIEWER-43: Event filter-Select Filter Option: "Sinus"
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-43    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-44: Event filter-Select Filter Option: "Manual"
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-44    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-45: Event filter-No Event Available after Filter
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-45    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDY-MGMT-ECG-VIEWER-46: Verify ECG Viewer tab is hidden for aborted studies
    [Documentation]     Author: Thanh Tieu
    ...
    ...
    [Tags]  BFCC-TECH-STUDY-MGMT-ECG-VIEWER-46    manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
