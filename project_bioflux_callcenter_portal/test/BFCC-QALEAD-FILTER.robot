*** Settings ***
Documentation   Test Suite - Call Center QA Leader Portal - Filter data
Metadata    sid     BFCC-QALEAD-FILTER
...
Force Tags      BFCC-QALEAD-FILTER     web
Test Timeout    1h

*** Test Cases ***
BFCC-QALEAD-FILTER-01: View portal in the case the user belongs to a call center group that has not been assigned a facility group
    ...
    [Tags]      BFCC-QALEAD-FILTER-01        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-FILTER-02: View portal in the case the user belongs to a call center group that has been assigned a facility group
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-FILTER-02        auto
...
BFCC-QALEAD-FILTER-03: View options of facility dropdown list
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-FILTER-03        auto
...
BFCC-QALEAD-FILTER-04: Search for a facility on the dropdown list
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-FILTER-04        auto
    Navigate To Devices
...
BFCC-QALEAD-FILTER-05: Filter data by a specific facility
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-FILTER-05        manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-FILTER-06: Behavior in the case a facility is removed from a facility group
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-FILTER-06        manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-FILTER-07: Behavior in the case a facility group is removed from a call center group
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-FILTER-07        manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
BFCC-QALEAD-FILTER-08: Can filter studies by device model
    ...
    [Tags]      BFCC-QALEAD-FILTER-08        auto
    Navigate To Devices
