*** Settings ***
Documentation   Test Suite - Call Center QA Leader Portal - Devices page
Metadata    sid     BFCC-QALEAD-DEVICES
...
Force Tags      BFCC-QALEAD-DEVICES     web
Test Timeout    1h

*** Test Cases ***
BFCC-QALEAD-DEVICES-VIEW-INSTUDY-01: View the information displays in the devices running studies
    ...
    [Tags]      BFCC-QALEAD-DEVICES-VIEW-INSTUDY-01        manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-DEVICES-VIEW-INSTUDY-02: Sort the devices running studies by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-VIEW-INSTUDY-02        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-DEVICES-VIEW-INSTUDY-02-1: Sort the devices running studies by Artifact Reports
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-VIEW-INSTUDY-02-1        manual       R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-DEVICES-VIEW-INSTUDY-03: Check pagination tool works properly
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-VIEW-INSTUDY-03        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-DEVICES-VIEW-INSTUDY-QUICK-ACCESS-01-CP-2.23.0: Quick access to device info
    ...
    [Tags]      BFCC-QALEAD-DEVICES-VIEW-INSTUDY-QUICK-ACCESS-01-CP-2.23.0        manual    CP-2.23.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BFCC-QALEAD-DEVICES-VIEW-EOL-01: View the information displays in the EOL devices
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-VIEW-EOL-01        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-DEVICES-VIEW-EOL-02: Sort the EOL devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-VIEW-EOL-02        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-DEVICES-VIEW-EOL-03: Check pagination tool works properly
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-VIEW-EOL-03        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-DEVICES-VIEW-EOL-QUICK-ACCESS-01-CP-2.23.0: Quick access to device info
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-VIEW-EOL-QUICK-ACCESS-01-CP-2.23.0        manual    CP-2.23.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BFCC-QALEAD-DEVICES-VIEW-ALL-01: View the information displays in the all devices
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-VIEW-ALL-01     auto
...
BFCC-QALEAD-DEVICES-VIEW-ALL-02: Sort the all devices by Device ID
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The user can sort the list manually
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-VIEW-ALL-02        auto
    Navigate To Devices
    Navigate To Devices Menu    All devices
...
BFCC-QALEAD-DEVICES-VIEW-ALL-03: Check pagination tool works properly
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description: The device’s table is divided into pages
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-VIEW-ALL-03        auto
    Navigate To Devices
    Navigate To Devices Menu    All devices
    Filter Devices        facility=All facilities       by_model=All models
    ...
    ${current_pagination}     Get Devices Current Pagination
    Run Keyword And Continue On Failure    Should Be Equal    ${current_pagination}[Page]     1
    Custom Devices Size Per Page    rows=30 rows
    ${current_pagination}     Get Devices Current Pagination
    ${devices}        Get Devices On Page
    ...
    Custom Devices Size Per Page    rows=50 rows
    ${current_pagination}     Get Devices Current Pagination
    ${devices}        Get Devices On Page
    Run Keyword And Continue On Failure    Should Be Equal    ${current_pagination}[Rows]     50 rows
    Run Keyword And Continue On Failure    Should Be Equal    ${current_pagination}[Page]     1
    Run Keyword And Continue On Failure    Length Should Be   ${devices}                      50

BFCC-QALEAD-DEVICES-VIEW-ALL-QUICK-ACCESS-01-CP-2.23.0: Quick access to device info
    [Documentation]     Author: Trinh Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-VIEW-ALL-QUICK-ACCESS-01-CP-2.23.0        manual    CP-2.23.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}


BFCC-QALEAD-DEVICES-SEARCH-01: Search on device list
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-SEARCH-01     auto
    Navigate To Devices
    Navigate To Devices Menu    All devices
    # Default text seach
...
BFCC-QALEAD-DEVICES-FILTER-FACILITY-01: Filter by facility
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-FILTER-FACILITY-01    auto
    Navigate To Devices
    # All tab
    Navigate To Devices Menu    All devices
    ${filter_values}        Get Devices Current Filter Values
...
BFCC-QALEAD-DEVICES-FILTER-FACILITY-02: The user is removed from the Call Center Group
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-FILTER-FACILITY-02     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-DEVICES-FILTER-FACILITY-03: The facility is removed from the Facility Group
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-FILTER-FACILITY-03     manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-DEVICES-FILTER-MODEL-01: Filter by model
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-FILTER-MODEL-01     auto
    # Run on 'all' tab
    Navigate To Devices
    Navigate To Devices Menu    All devices
...
BFCC-QALEAD-DEVICES-QUICKACCESS-01: Quick access to device information
    [Documentation]     Author: Nhan Nguyen
    ...
    ...
    [Tags]      BFCC-QALEAD-DEVICES-QUICKACCESS-01     auto
    Navigate To Devices
    Navigate To Devices Menu    All devices
    Filter Devices        facility=All facilities       by_model=All models
    ${devices}        Get All Devices
    ...
    ${expect_general_info}  Create List    Model    Firmware version    Timezone    Operator    Network mode    Device lifetime
    ${expect_last_sync}     Create List    RSSI     Lead on     Battery level   SD card free space      Charging state     Last connect
    Run Keyword And Continue On Failure    Lists Should Be Equal    ${device_info_view}[GENERAL INFO]           ${expect_general_info}
    Run Keyword And Continue On Failure    Lists Should Be Equal    ${device_info_view}[LAST SYNCED STATUS]     ${expect_last_sync}
    Run Keyword And Continue On Failure    Should Be Equal    ${devices}[0][Model]          ${device_info_view}[GENERAL INFO][Model]
