*** Settings ***
Documentation   Test Suite - Call Center Supervisor Portal - Support page
Metadata    sid     BFCC-SUPVR-SUPPORT
...
Force Tags      BFCC-SUPVR-SUPPORT     web
Test Timeout    1h

*** Test Cases ***
BFCC-SUPVR-SUPPORT-VIEW-01: View list of Support requests on the Open tab
...
#    ...     - The user goes to the details ticket, the icon will disappear on the list
    [Tags]  BFCC-SUPVR-SUPPORT-VIEW-01    CP-2.12.0     auto
    Navigate To Support
...
BFCC-SUPVR-SUPPORT-VIEW-02: View list of Support request on the Resolved tab
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The Call Center QA, QA Leader and Supervisor can view list of Support requests
    ...
    ...     Precondition:
    ...
    [Tags]  BFCC-SUPVR-SUPPORT-VIEW-02  CP-2.12.0       auto
    Navigate To Support
...
BFCC-SUPVR-SUPPORT-VIEW-03: Check pagination tool works properly
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]      BFCC-SUPVR-SUPPORT-VIEW-03  CP-2.16.4       auto
    Navigate To Support
    Navigate To Support Menu    Resolved
...
BFCC-SUPVR-SUPPORT-SEARCH-01: Search in report requests list
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     2. At step 2, the search value and its result should remain until it cleared out
      ...
      [Tags]  BFCC-SUPVR-SUPPORT-SEARCH-01  CP-2.12.0       auto
      Navigate To Support
      Navigate To Support Menu    Open
...
BFCC-SUPVR-SUPPORT-FILTER-01: Filter the list of Support requests
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-SUPVR-SUPPORT-FILTER-01    CP-2.12.0      auto       R3
...
BFCC-SUPVR-SUPPORT-FILTER-FACILITY-01-CP2.16.4: View the name of the facility in case the user only associates with one facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BFCC-SUPVR-SUPPORT-FILTER-FACILITY-01-CP2.16.4  CP-2.16.4       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-SUPPORT-FILTER-FACILITY-02: Select a specific facility in case the user associates with multiples facility
    [Documentation]     Author: Trinh Nguyen
    ...
   ...
   [Tags]  BFCC-SUPVR-SUPPORT-FILTER-FACILITY-02  CP-2.16.4       auto
    Navigate To Support
    Navigate To Support Menu    Resolved
    ${supports}      Get Resolved Supports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${supports}
...
BFCC-SUPVR-SUPPORT-SORT-01: Sort the Support request list manually
    [Documentation]     Author: Trinh Nguyen
    ...
   ...
   [Tags]  BFCC-SUPVR-SUPPORT-SORT-01     CP-2.16.4       auto
    Navigate To Support
    Navigate To Support Menu    Resolved
    ${supports}      Get Resolved Supports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${supports}
...
BFCC-SUPVR-SUPPORT-VIEW-DETAILS-OPEN-01-CP2.16.4: View details of open support request
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-SUPVR-SUPPORT-VIEW-DETAILS-OPEN-01-CP2.16.4  CP-2.12.0       manual     CP-2.16.4
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-SUPPORT-DETAILS-RESOLVED-01-CP2.16.4: View details of resolved support request
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-SUPVR-SUPPORT-DETAILS-RESOLVED-01-CP2.16.4   CP-2.12.0       manual     CP-2.16.4
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-SUPVR-SUPPORT-COMMUNICATION-01: Leave the message in the input field
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-SUPVR-SUPPORT-COMMUNICATION-01   CP-2.12.0       auto       CP-2.16.4
    Navigate To Support
    Navigate To Support Menu    open
...
BFCC-SUPVR-SUPPORT-COMMUNICATION-02: Leave a note in the Internal notes text field
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-SUPVR-SUPPORT-COMMUNICATION-02   CP-2.12.0       auto       CP-2.16.4
    Navigate To Support
    Navigate To Support Menu    open
    ${supports}     Get Open Supports
    Run Keyword And Continue On Failure    Should Not Be Empty      ${supports}
...
BFCC-SUPVR-SUPPORT-RESOLVE-01: Resolve the support request
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-SUPVR-SUPPORT-RESOLVE-01   CP-2.12.0       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
