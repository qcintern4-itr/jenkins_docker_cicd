*** Settings ***
Documentation   Test Suite - Call Center QA Leader Portal - Completed studies page
Metadata    sid     BFCC-QALEAD-STUDIES-COMPLETED
...
Force Tags       BFCC-QALEAD-STUDIES-COMPLETED     web
Test Timeout     1h

*** Test Cases ***
BFCC-QALEAD-STUDIES-COMPLETED-FILTER-FACILITY-01: View the name of the facility in case the user only associates with one facility
    ...
    [Tags]  BFCC-QALEAD-STUDIES-COMPLETED-FILTER-FACILITY-01       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-STUDIES-COMPLETED-FILTER-FACILITY-02: Select a specific facility in case the user associates with multiples facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BFCC-QALEAD-STUDIES-COMPLETED-FILTER-FACILITY-02        auto
    Navigate To Studies
...
BFCC-QALEAD-STUDIES-COMPLETED-SEARCH-01: View all search attributes on the STUDIES page        # Failed (The default search option is showing `Study ID`)
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-QALEAD-STUDIES-COMPLETED-SEARCH-01     auto
    Navigate To Studies
...
BFCC-QALEAD-STUDIES-COMPLETED-SEARCH-02: Search by Patient Name attributes on the STUDIES page     # Failed: Related to bug (search by patient name) via clinic
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     5. All entered text will be deleted
     ...
     [Tags]  BFCC-QALEAD-STUDIES-COMPLETED-SEARCH-02     manual
     Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
#     [Template]    Filter Studies Completed
#     Patient Name

BFCC-QALEAD-STUDIES-COMPLETED-SEARCH-03: Search by Study ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-QALEAD-STUDIES-COMPLETED-SEARCH-03     auto
    [Template]    Filter Studies Completed
    Study ID

BFCC-QALEAD-STUDIES-COMPLETED-SEARCH-04: Search by Patient ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The user can search by Study ID attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BFCC-QALEAD-STUDIES-COMPLETED-SEARCH-04     auto
    [Template]    Filter Studies Completed
    Patient ID

BFCC-QALEAD-STUDIES-COMPLETED-SEARCH-05: Search by Device ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-QALEAD-STUDIES-COMPLETED-SEARCH-05     auto
    [Template]    Filter Studies Completed
    Device ID

BFCC-QALEAD-STUDIES-COMPLETED-QUICK-ACCESS-01-CP-2.23.0: Quick access to device info
    [Documentation]  Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BFCC-QALEAD-STUDIES-COMPLETED-QUICK-ACCESS-01-CP-2.23.0       auto    CP-2.23.0
    Navigate To Studies
    Filter Studies    study_type=Completed
