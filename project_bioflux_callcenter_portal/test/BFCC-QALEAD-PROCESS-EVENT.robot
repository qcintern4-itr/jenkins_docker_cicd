...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-01: Change the type of an Auto event
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-01        manual
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-02: Mark an event as valid or invalid
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-02        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-03: Include a strip of Manual event in a report
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-03        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-05: Mark call status
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-05        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-10: Edit event tags
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-10        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BFCC-QALEAD-PROCESS-EVENT-DETAILS-14: View Study Settings
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-14        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-DETAILS-15: Mark and Unmark an event as Process Later
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-DETAILS-15        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BFCC-QALEAD-PROCESS-EVENT-CRITERIA-01: View Notification Criteria
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-CRITERIA-01        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BFCC-QALEAD-PROCESS-EVENT-REPORT-01: Generate event report
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-01        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BFCC-QALEAD-PROCESS-EVENT-REPORT-02: Regenerate event report
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-02        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BFCC-QALEAD-PROCESS-EVENT-REPORT-04: Set event report status to Ready
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-04        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
    
BFCC-QALEAD-PROCESS-EVENT-REPORT-04-CP2.22.0: Display notification of Afib Detected for Afib events in status Ready
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-04-CP2.22.0       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-REPORT-05: Send event report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-05        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
...
BFCC-QALEAD-PROCESS-EVENT-REPORT-12: Recall an event report
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-12        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QALEAD-PROCESS-EVENT-REPORT-13: Dismiss and reenable event report
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QALEAD-PROCESS-EVENT-REPORT-13        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
