*** Settings ***
Documentation   Test Suite - Call Center QA Portal - Support page
Metadata    sid     BFCC-QA-SUPPORT
Metadata    owner   Nhan Nguyen
#Metadata    version     2.16.4.0
...
Force Tags      BFCC-QA-SUPPORT     web
Test Timeout    1h

*** Test Cases ***
BFCC-QA-SUPPORT-VIEW-01: View list of Support requests on the Open tab
...
#    ...     - The user goes to the details ticket, the icon will disappear on the list
    [Tags]  BFCC-QA-SUPPORT-VIEW-01    CP-2.12.0    auto
    Navigate To Support
...
BFCC-QA-SUPPORT-VIEW-02: View list of Support request on the Resolved tab
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The Call Center QA, QA Leader and Supervisor can view list of Support requests
    ...
    ...     Precondition:
    ...
    ...     - Resolved By
    ...      + If the ticket is resolved through email or old tickets, the name will be ‘User Operation’
    ...
    ...     **Others**
    ...     Update Date: 8/16/2023 - Trinh Nguyen
    [Tags]  BFCC-QA-SUPPORT-VIEW-02  CP-2.12.0    auto
    Navigate To Support
    ...
    ${request_id}       Set Variable    ${supports}[Request ID]
    Filter Support    text_search=${request_id}
    View Resolved Support Facility Information On    row=1
    ${header}   Get Header Facility Information
    Run Keyword And Continue On Failure    Should Be Equal    ${header}         FACILITY INFORMATION

BFCC-QA-SUPPORT-VIEW-03: Check pagination tool works properly
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]      BFCC-QA-SUPPORT-VIEW-03        CP-2.16.4       auto
    Navigate To Support
    Navigate To Support Menu    Resolved
...
BFCC-QA-SUPPORT-SEARCH-01: Search in report requests list
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     2. At step 2, the search value and its result should remain until it cleared out
      ...
      [Tags]  BFCC-QA-SUPPORT-SEARCH-01  CP-2.12.0    auto
      Navigate To Support
      Navigate To Support Menu    Open
...
BFCC-QA-SUPPORT-FILTER-01: Filter the list of Support requests
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-QA-SUPPORT-FILTER-01    CP-2.12.0    auto
...
BFCC-QA-SUPPORT-FILTER-FACILITY-01: View the name of the facility in case the user only associates with one facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BFCC-QA-SUPPORT-FILTER-FACILITY-01  CP-2.16.4       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QA-SUPPORT-FILTER-FACILITY-02: Select a specific facility in case the user associates with multiples facility
    [Documentation]     Author: Trinh Nguyen
    ...
   ...
   [Tags]  BFCC-QA-SUPPORT-FILTER-FACILITY-02  CP-2.16.4       auto
    Navigate To Support
    Navigate To Support Menu    Resolved
    ${supports}      Get Resolved Supports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${supports}
...
BFCC-QA-SUPPORT-SORT-01: Sort the Support request list manually
    [Documentation]     Author: Trinh Nguyen
    ...
   ...
   [Tags]  BFCC-QA-SUPPORT-SORT-01  CP-2.16.4      auto
    Navigate To Support
    Navigate To Support Menu    Resolved
    ${supports}      Get Resolved Supports
    Run Keyword And Continue On Failure    Should Not Be Empty    ${supports}
...
BFCC-QA-SUPPORT-VIEW-DETAILS-OPEN-01: View details of open support request with category is "Report request/Abort study"
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     Last update: 12/08/2023 - Thang Tran
    ...
    [Tags]  BFCC-QA-SUPPORT-VIEW-DETAILS-OPEN-01  CP-2.12.0       auto     CP-2.16.4
    Navigate To Support
    Navigate To Support Menu    open
...
BFCC-QA-SUPPORT-VIEW-DETAILS-OPEN-02: View details of open support request with category is "Change study type"
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The Call Center QA, QA Leader and Supervisor can view details of open support request
    ...
    ...     Precondition:
    ...
    ...     Last update: 12/08/2023 - Thang Tran
    ...
    [Tags]  BFCC-QA-SUPPORT-VIEW-DETAILS-OPEN-02  CP-2.12.0       manual     CP-2.16.4
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QA-SUPPORT-VIEW-DETAILS-RESOLVED-01: View details of resolved support request
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-QA-SUPPORT-VIEW-DETAILS-RESOLVED-01  CP-2.12.0       manual     CP-2.16.4
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QA-SUPPORT-COMMUNICATION-01: Leave the message in the input field
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-QA-SUPPORT-COMMUNICATION-01   CP-2.12.0       auto       CP-2.16.4
    Navigate To Support
    Navigate To Support Menu    open
    ${supports}     Get Open Supports
    Run Keyword And Continue On Failure    Should Not Be Empty      ${supports}
...
BFCC-QA-SUPPORT-COMMUNICATION-02: Leave a note in the Internal notes text field
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-QA-SUPPORT-COMMUNICATION-02   CP-2.12.0       auto       CP-2.16.4
    Navigate To Support
    Navigate To Support Menu    open
    ${supports}     Get Open Supports
    Run Keyword And Continue On Failure    Should Not Be Empty      ${supports}
...
BFCC-QA-SUPPORT-RESOLVE-01: Resolve the support request
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-QA-SUPPORT-RESOLVE-01   CP-2.12.0       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
