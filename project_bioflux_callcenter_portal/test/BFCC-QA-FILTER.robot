*** Settings ***
Documentation   Test Suite - Call Center QA Portal - Filter data
Metadata    sid     BFCC-QA-FILTER
...
Force Tags      BFCC-QA-FILTER     web
Test Timeout    1h

*** Test Cases ***
BFCC-QA-FILTER-01: View portal in the case the user belongs to a call center group that has not been assigned a facility group
    ...
    ...     2. A message stating: “There is no data to display” shall be displayed on the STUDIES, REPORTS, DEVICES, and SUPPORT pages
    ...
    ...     **Others**
    ...     Update date: 8/18/2023 - Nhan Nguyen
    ...

    [Tags]      BFCC-QA-FILTER-01        manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QA-FILTER-02: View portal in the case the user belongs to a call center group that has been assigned a facility group
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    ...
    ...     Expected Results:
    ...     1. There shall be a facility dropdown list on the STUDIES, REPORTS, DEVICES, and TASK pages.
...
BFCC-QA-FILTER-03: View options of facility dropdown list
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
...
BFCC-QA-FILTER-04: Search for a facility on the dropdown list
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
...
BFCC-QA-FILTER-05: Filter data by a specific facility
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    ...     2. The selected facility shall be applied to other pages (Reports, Studies, Devices, Support)
    ...
    ...     **Others**
    ...     Update date: 8/18/2023 - Nhan Nguyen
    ...

    [Tags]      BFCC-QA-FILTER-05        manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QA-FILTER-06: Behavior in the case a facility is removed from a facility group
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QA-FILTER-06        manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QA-FILTER-07: Behavior in the case a facility group is removed from a call center group
    [Documentation]     Author: Nhan Nguyen
    ...
    ...     Description:
    ...
    ...
    [Tags]      BFCC-QA-FILTER-07        manual     R1
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QA-FILTER-08: Can filter studies by device model
