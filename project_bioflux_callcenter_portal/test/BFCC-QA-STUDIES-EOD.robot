*** Settings ***
Documentation   Test Suite - Call Center QA Portal - EOD studies page
Metadata    sid     BFCC-QA-STUDIES-EOD
...
Force Tags      BFCC-QA-STUDIES-EOD      web
Test Timeout    1h

*** Test Cases ***
BFCC-QA-STUDIES-EOD-FILTER-FACILITY-01:View the name of the facility in case the user only associates with one facility
    ...
    [Tags]  BFCC-QA-STUDIES-EOD-FILTER-FACILITY-01      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QA-STUDIES-EOD-FILTER-FACILITY-02: Select a specific facility in case the user associates with multiples facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BFCC-QA-STUDIES-EOD-FILTER-FACILITY-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QA-STUDIES-EOD-SEARCH-01: View all search attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-QA-STUDIES-EOD-SEARCH-01        auto
    Navigate To Studies
...
BFCC-QA-STUDIES-EOD-SEARCH-02: Search by Patient Name attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     5. All entered text will be deleted
     ...
     [Tags]  BFCC-QA-STUDIES-EOD-SEARCH-02      auto
    Navigate To Studies
    Navigate To Studies Type    EOD
    ${search_options}       Get Studies Filter Options
    ${search_by_options}    Create List    Patient Name
    Run Keyword And Continue On Failure    Should Be Equal           ${search_options}[Search by]       ${search_by_options}
    ${current_values}       Get Studies Current Filter Values
    Run Keyword And Continue On Failure    Should Be Equal    ${current_values}[Search By]      Study ID

BFCC-QA-STUDIES-EOD-SEARCH-03: Search by Study ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-QA-STUDIES-EOD-SEARCH-03       auto
    Navigate To Studies
    Navigate To Studies Type    EOD
    ${search_options}       Get Studies Filter Options
    ${search_by_options}    Create List    Study ID
    Run Keyword And Continue On Failure    Should Be Equal           ${search_options}[Search by]       ${search_by_options}
    ${current_values}       Get Studies Current Filter Values
    Run Keyword And Continue On Failure    Should Be Equal    ${current_values}[Search By]      Study ID

BFCC-QA-STUDIES-EOD-SEARCH-04: Search by Patient ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The user can search by Study ID attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BFCC-QA-STUDIES-EOD-SEARCH-04       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QA-STUDIES-EOD-SEARCH-05: Search by Device ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-QA-STUDIES-EOD-SEARCH-05       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-QA-STUDIES-EOD-QUICK-ACCESS-01-CP-2.23.0: Quick access to device info
    [Documentation]  Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BFCC-QA-STUDIES-EOD-QUICK-ACCESS-01-CP-2.23.0       manual   CP-2.23.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
