*** Settings ***
Documentation   Test Suite - Call Center Technician Portal - Search Reports
Metadata    sid     BFCC-TECH-REPORTS-SEARCH
...
Force Tags      BFCC-TECH-REPORTS-SEARCH  web
Test Timeout    1h

*** Test Cases ***
BFCC-TECH-REPORTS-SEARCH-01: Test
    ...
    [Tags]      BFCC-TECH-REPORTS-SEARCH-01       manual
