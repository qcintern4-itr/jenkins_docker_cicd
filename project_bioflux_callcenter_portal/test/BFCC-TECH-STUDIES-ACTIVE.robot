*** Settings ***
Documentation   Test Suite - Call Center Technician Portal - Active studies page
Metadata    sid     BFCC-TECH-STUDIES-ACTIVE
...
Force Tags      BFCC-TECH-STUDIES-ACTIVE        web
Test Timeout    1h

*** Test Cases ***
BFCC-TECH-STUDIES-ACTIVE-FILTER-FACILITY-01:View the name of the facility in case the user only associates with one facility
    ...
    [Tags]  BFCC-TECH-STUDIES-ACTIVE-FILTER-FACILITY-01      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDIES-ACTIVE-FILTER-FACILITY-02: Select a specific facility in case the user associates with multiples facility
    [Documentation]     Author: Trinh Nguyen
    ...
    ...
    [Tags]  BFCC-TECH-STUDIES-ACTIVE-FILTER-FACILITY-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDIES-ACTIVE-SEARCH-01: View all search attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-TECH-STUDIES-ACTIVE-SEARCH-01      auto
    Navigate To Studies
...
BFCC-TECH-STUDIES-ACTIVE-SEARCH-02: Search by Patient Name attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    ...     5. All entered text will be deleted
     ...
     [Tags]  BFCC-TECH-STUDIES-ACTIVE-SEARCH-02      manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDIES-ACTIVE-SEARCH-03: Search by Study ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-TECH-STUDIES-ACTIVE-SEARCH-03       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDIES-ACTIVE-SEARCH-04: Search by Patient ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...     Description: The user can search by Study ID attributes on the Inbox page
    ...
    ...     Precondition:
    ...
    [Tags]  BFCC-TECH-STUDIES-ACTIVE-SEARCH-04       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDIES-ACTIVE-SEARCH-05: Search by Device ID attributes on the STUDIES page
    [Documentation]  Author: Trinh Nguyen
    ...
    [Tags]  BFCC-TECH-STUDIES-ACTIVE-SEARCH-05       manual
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}

BFCC-TECH-STUDIES-ACTIVE-QUICK-ACCESS-01-CP-2.23.0: Quick access to device info
    [Documentation]  Author: Trinh Nguyen
    ...     Description:
    ...
    ...     Precondition:
    ...
    [Tags]  BFCC-TECH-STUDIES-ACTIVE-QUICK-ACCESS-01-CP-2.23.0       manual   CP-2.23.0
    Manual Should Be Passed     ${TEST_NAME}    ${TEST_DOCUMENTATION}
