...
try:
    ...
    from project_bioflux_callcenter_portal.lib import ConfigHandler
...
class WebPage(WebPageModel):
    ...
    def __init__(self, browser, env, locators):
        super().__init__(project_name='bioflux_callcenter_portal', browser=browser, env=env, locators=locators)
